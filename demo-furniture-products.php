				...
				<div class="container">
					...
					<div class="row justify-content-between align-items-center">
						...
						<div class="col-auto mb-4 d-flex">
							...
							<div class="dropdown sortbuttons">
								<button class="button button-border m-0 button-dark border-width-1 border-default text-transform-none ls-0 fw-normal h-bg-color dropdown-toggle" type="button" id="catButton" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Choose Category</button>
							...
							<div class="dropdown sortbuttons ms-2">
								<button class="button button-border m-0 button-dark border-width-1 border-default text-transform-none ls-0 fw-normal h-bg-color dropdown-toggle" type="button" id="sortButton" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Sort by default</button>
					...
					<div id="shop" class="shop row gutter-30 col-mb-30 mt-3">
						...
						<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="grid-inner">
								<div class="product-image">
									<a href="demo-furniture-single.php"><img src="demos/furniture/images/shop/2.jpg" alt="Light Grey Sofa"></a>
									<a href="demo-furniture-single.php"><img src="demos/furniture/images/shop/2-1.jpg" alt="Light Grey Sofa"></a>
								...
								<div class="product-desc">
									<div class="product-title mb-0"><h4 class="mb-0"><a class="fw-medium" href="demo-furniture-single.php">Light Grey Sofa</a></h4></div>
						...
						<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="grid-inner">
								<div class="product-image">
									<a href="demo-furniture-single.php"><img src="demos/furniture/images/shop/3.jpg" alt="Celling Lights"></a>
									<a href="demo-furniture-single.php"><img src="demos/furniture/images/shop/3-1.jpg" alt="Celling Lights"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-light me-2"><i class="uil uil-shopping-cart"></i></a>
											<a href="demos/furniture/ajax/quick-view.php" class="btn btn-light" data-lightbox="ajax"><i class="bi-eye"></i></a>
								...
								<div class="product-desc">
									<div class="product-title mb-0"><h4 class="mb-0"><a class="fw-medium" href="demo-furniture-single.php">Celling Lights</a></h4></div>
						...
						<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="grid-inner">
								<div class="product-image">
									<a href="demo-furniture-single.php"><img src="demos/furniture/images/shop/4-1.jpg" alt="High Stand Chair"></a>
									<a href="demo-furniture-single.php"><img src="demos/furniture/images/shop/4.jpg" alt="High Stand Chair"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-light me-2"><i class="uil uil-shopping-cart"></i></a>
											<a href="demos/furniture/ajax/quick-view.php" class="btn btn-light" data-lightbox="ajax"><i class="bi-eye"></i></a>
								...
								<div class="product-desc">
									<div class="product-title mb-0"><h4 class="mb-0"><a class="fw-medium" href="demo-furniture-single.php">High Stand Chair</a></h4></div>
						...
						<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="grid-inner">
								<div class="product-image">
									<a href="demo-furniture-single.php"><img src="demos/furniture/images/shop/5.jpg" alt="Dining Sofa with Tea-table"></a>
									<a href="demo-furniture-single.php"><img src="demos/furniture/images/shop/5-1.jpg" alt="Dining Sofa with Tea-table"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-light me-2"><i class="uil uil-shopping-cart"></i></a>
											<a href="demos/furniture/ajax/quick-view.php" class="btn btn-light" data-lightbox="ajax"><i class="bi-eye"></i></a>
								...
								<div class="product-desc">
									<div class="product-title mb-0"><h4 class="mb-0"><a class="fw-medium" href="demo-furniture-single.php">Dining Sofa with Tea-table</a></h4></div>
						...
						<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="grid-inner">
								<div class="product-image">
									<a href="demo-furniture-single.php"><img src="demos/furniture/images/shop/6.jpg" alt="Bathroom Cloths Shelves"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-light me-2"><i class="uil uil-shopping-cart"></i></a>
											<a href="demos/furniture/ajax/quick-view.php" class="btn btn-light" data-lightbox="ajax"><i class="bi-eye"></i></a>
								...
								<div class="product-desc">
									<div class="product-title mb-0"><h4 class="mb-0"><a class="fw-medium" href="demo-furniture-single.php">Bathroom Cloths Shelves</a></h4></div>
						...
						<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="grid-inner">
								<div class="product-image">
									<a href="demo-furniture-single.php"><img src="demos/furniture/images/shop/7.jpg" alt="Golden Lamp for Room"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-light me-2"><i class="uil uil-shopping-cart"></i></a>
											<a href="demos/furniture/ajax/quick-view.php" class="btn btn-light" data-lightbox="ajax"><i class="bi-eye"></i></a>
								...
								<div class="product-desc">
									<div class="product-title mb-0"><h4 class="mb-0"><a class="fw-medium" href="demo-furniture-single.php">Golden Lamp for Room</a></h4></div>
						...
						<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="grid-inner">
								<div class="product-image">
									<a href="demo-furniture-single.php"><img src="demos/furniture/images/shop/8.jpg" alt="White Cuddle Chair with Cusions"></a><a href="demo-furniture-single.php"><img src="demos/furniture/images/shop/8-1.jpg" alt="White Cuddle Chair with Cusions"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-light me-2"><i class="uil uil-shopping-cart"></i></a>
											<a href="demos/furniture/ajax/quick-view.php" class="btn btn-light" data-lightbox="ajax"><i class="bi-eye"></i></a>
								...
								<div class="product-desc">
									<div class="product-title mb-0"><h4 class="mb-0"><a class="fw-medium" href="demo-furniture-single.php">White Cuddle Chair with Cusions</a></h4></div>
						...
						<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="grid-inner">
								<div class="product-image">
									<a href="demo-furniture-single.php"><img src="demos/furniture/images/shop/9.jpg" alt="Golden Lamp for Room"></a>
									<a href="demo-furniture-single.php"><img src="demos/furniture/images/shop/9-1.jpg" alt="Golden Lamp for Room"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-light me-2"><i class="uil uil-shopping-cart"></i></a>
											<a href="demos/furniture/ajax/quick-view.php" class="btn btn-light" data-lightbox="ajax"><i class="bi-eye"></i></a>
