...
<head>
	...
	<meta name="description" content="Create Headphones Store &amp; Sound Systems Websites with Canvas Template. Get Canvas to build powerful websites easily with the Highly Customizable &amp; Best Selling Bootstrap Template, today.">
	...
	<div id="wrapper">
		...
		<section id="content">
			<div class="content-wrap py-0">
				...
				<!-- Promo Section
				============================================= -->
				<div class="promo promo-border promo-dark dark promo-full mb-0" style="padding: 60px 0 !important">
					<div class="container">
					...
					<div class="row">
						<div class="col-6 col-sm">
							...
							<div class="w-100 d-flex mb-2">
								...
								<a href="#" class="social-icon rounded-circle text-white bg-x-twitter" style="--cnvs-socialicon-size:1.75rem; --cnvs-socialicon-gap:0.5rem;">
