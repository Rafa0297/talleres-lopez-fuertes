				...
				<div class="container">
					<div class="header-row">
						...
						<div class="header-misc">
							<a href="demo-forum.php" class="button button-border border-default px-4 rounded-1 fw-medium text-transform-none ls-0 m-0 px-3 h-op-09">Sign In</a>
						</div>
						...
						<nav class="primary-menu">
							...
							<ul class="menu-container pe-0 pe-md-3">
								...
								<li class="menu-item current"><a class="menu-link" href="demo-forum-signin.php"><div>Sign In Page</div></a></li>
							</ul>
