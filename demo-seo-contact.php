...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Contact Us - SEO Demo | Canvas</title>
	...
	<div id="wrapper">
					...
					<div class="header-row">
						...
						<nav class="primary-menu with-arrows">
							...
							<ul class="menu-container">
								...
								<li class="menu-item current"><a class="menu-link" href="demo-seo-contact.php"><div>Contact</div></a></li>
							</ul>
		...
		<section id="content">
			...
			<div class="content-wrap pb-0">
				...
				<div class="container mb-3">
					<div class="row justify-content-between">
						<div class="col-lg-3 col-md-6">
							<div class="feature-box flex-column text-center">
								<div class="fbox-image text-center mb-3">
									<img height="120" src="demos/seo/images/icons/seo.svg" alt="Feature Icon">
								</div>
								<div class="fbox-content">
									<h3 class="text-transform-none ls-0 mb-4">Location:</h3>
						...
						<div class="col-lg-3 col-md-6">
							<div class="feature-box flex-column text-center">
								<div class="fbox-image text-center mb-3">
									<img height="120" src="demos/seo/images/icons/social.svg" alt="Feature Icon">
								</div>
								<div class="fbox-content">
									<h3 class="text-transform-none ls-0 mb-4">Contact Us:</h3>
									<p class="text-smaller mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</p>
						...
						<div class="col-lg-3 col-md-6">
							<div class="feature-box flex-column text-center">
								...
								<div class="fbox-content">
									<h3 class="text-transform-none ls-0 mb-4">Live Chat:</h3>
									<p class="text-smaller mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</p>
				...
				<!-- Google Map
				============================================= -->
				<section class="gmap vh-60 mt-6" data-address="Melbourne, Australia" data-markers='[{address: "Melbourne, Australia", html: jQuery("#map-marker-1").php(), icon:{ image: "images/icons/map-icon-red.png", iconsize: [32, 39], iconanchor: [32,39] } }]'></section>
				...
				<!-- Form Section
				============================================= -->
				<div class="section mt-0 mb-3" style="background: url('demos/seo/images/sections/1.jpg') no-repeat center center; background-size: cover; padding: 100px 0;">
					<div class="container">
