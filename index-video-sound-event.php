				...
				<div class="swiper swiper-parent">
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide dark">
							...
							<a href="#" id="video-slider-mute"><i class="bi-volume-up"></i><i class="bi-volume-off"></i></a>
							<div class="video-wrap no-placeholder">
								<video id="slide-video" poster="images/videos/explore-poster.jpg" preload="auto" loop autoplay playsinline>
								...
								<div class="team">
									...
									<div class="team-desc team-desc-bg">
										...
										<div class="d-flex justify-content-center mt-4">
											<a href="#" class="social-icon si-small bg-light rounded-circle text-white bg-facebook">
												<i class="fa-brands fa-facebook-f"></i>
												<i class="fa-brands fa-facebook-f"></i>
											</a>
											<a href="#" class="social-icon si-small bg-light rounded-circle text-white bg-x-twitter">
												<i class="fa-brands fa-x-twitter"></i>
												<i class="fa-brands fa-x-twitter"></i>
											</a>
											<a href="#" class="social-icon si-small bg-light rounded-circle text-white bg-google">
