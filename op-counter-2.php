...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>One Page with Hero Counter - Layout 2 | Canvas</title>
...
<body class="stretched">
	...
	<div id="wrapper">
		...
		<!-- Header
		============================================= -->
		<header id="header" class="full-header transparent-header border-full-header dark header-size-custom" data-sticky-shrink="false">
			<div id="header-wrap">
				<div class="container">
		...
		<section id="slider" class="slider-element min-vh-100 include-header">
			<div class="slider-inner">
				...
				<div class="parallax scroll-detect h-100 w-100 dark">
					<img src="images/parallax/home/2.jpg" class="parallax-bg">
					<div class="vertical-middle text-center">
						<div class="container py-5">
							<div class="emphasis-title mb-6">
								<h1 style="font-size: 52px;">Our Numbers Speak for Themselves.</h1>
								<p class="lead">No Bragging, No Non-Sense, No Boredome. Just Plain Old Exceptional Creators &amp; Designers.</p>
							</div>
							<div class="text-center mx-auto" style="max-width: 500px;">
								<div class="row col-mb-30">
									<div class="col-md-6">
										<div class="counter counter-xlarge"><span data-from="500" data-to="3547" data-refresh-interval="100" data-speed="2000"></span></div>
										<h5 class="mt-0">Clients Served</h5>
									</div>
									<div class="col-md-6">
										<div class="counter counter-xlarge"><span data-from="5" data-to="184" data-refresh-interval="100" data-speed="3000"></span></div>
										<h5 class="mt-0">Projects Completed</h5>
									</div>
									<div class="col-md-6">
										<div class="counter counter-xlarge"><span data-from="1" data-to="59" data-refresh-interval="10" data-speed="2500"></span></div>
										<h5 class="mt-0">Awards Acquired</h5>
									</div>
									<div class="col-md-6">
										<div class="counter counter-xlarge"><span data-from="250" data-to="35412" data-refresh-interval="100" data-speed="3500"></span></div>
										<h5 class="mt-0">Admirers Earned</h5>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="video-wrap">
						<div class="video-overlay" style="background: rgba(0,0,0,0.75);"></div>
					</div>
				</div>

				<a href="#" data-scrollto="#section-about" data-easing="easeInOutExpo" data-speed="1250" data-offset="70" class="one-page-arrow dark"><i class="bi-chevron-down infinite animated fadeInDown"></i></a>
