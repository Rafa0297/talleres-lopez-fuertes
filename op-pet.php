...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Pet - One Page | Canvas</title>

	<style>

		.pet-search input,
		.pet-search .input-group-text {
		...
		.pet-search .input-group:first-child { border-right: 1px solid #EEE !important; }

		.pet-search .input-group-lg > .form-control:not(textarea),
		.pet-search .input-group-lg > .custom-select,
		.pet-search .button { height: calc(3.75em + 1rem + 2px); }

		.slider-element,
		.pet-search .button { background-color: #CCCABE; }

		.pet-search input::-moz-placeholder { color: #BBB; }
		.pet-search input:-ms-input-placeholder { color: #BBB; }
		.pet-search input::-webkit-input-placeholder { color: #BBB; }
				...
				<div class="vertical-middle">
					<div class="container">
						...
						<div class="row align-items-center justify-content-start text-start h-100">
							<div class="col-md-9">
								<div class="emphasis-title dark mb-5">
									<h2 data-animate="fadeInUp faster" class="mb-0" style="font-size: 70px; font-weight: 700; font-family: 'Playfair Display', serif !important; line-height: 1.2">Pet Lovers?<br>Find the Right Companion.</h2>
								</div>
								<form id="pet-search" class="row ms-md-0 mb-0 pet-search align-items-center bg-white shadow h-shadow-lg" action="search.php" method="get" data-animate="fadeInUp faster" data-delay="300">
									<div class="input-group align-items-center input-group-lg col-md">
										<i class="input-group-text uil uil-search"></i>
										<input type="text" name="pet-search-type" class="form-control" value="" placeholder="Enter a keyword..">
									</div>
									<div class="input-group align-items-center input-group-lg col-md">
										<i class="input-group-text uil uil-location-arrow"></i>
										<input type="text" name="pet-search-location" class="form-control" value="" placeholder="Enter Your Location..">
									</div>
									<div class="col-md-auto p-1">
										<a href="#" class="button button-large button-light text-dark m-0 d-flex align-items-center justify-content-center px-5 h-op-09">Submit</a>
									</div>
								</form>
							</div>
						</div>
