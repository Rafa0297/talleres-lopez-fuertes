...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Accessories - Car | Canvas</title>
		...
		<div class="side-panel-wrap">
			...
			<div class="widget">
				...
				<div class="widget quick-contact-widget form-widget border-0 pt-0">
					...
					<form id="quick-contact-form" name="quick-contact-form" action="demos/car/include/form.php" method="post" class="quick-contact-form mb-0">
					...
					<div class="page-menu-row justify-content-lg-center">
						...
						<nav class="page-menu-nav">
							<ul class="page-menu-container one-page-menu" data-easing="easeInOutExpo" data-offset="120">
								<li class="page-menu-item"><a href="#" data-href="#section-wheel" data-highlight="yellow"><div>Tyres & Wheels</div></a></li>
								<li class="page-menu-item"><a href="#" data-href="#section-music" data-highlight="yellow"><div>Music Systems</div></a></li>
								<li class="page-menu-item"><a href="#" data-href="#section-engines" data-highlight="yellow"><div>Engines & Parts</div></a></li>
								<li class="page-menu-item"><a href="#" data-href="#section-seats" data-highlight="yellow"><div>Seat Covers</div></a></li>
								<li class="page-menu-item"><a href="#" data-href="#section-lights" data-highlight="yellow"><div>Lights</div></a></li>
							</ul>
						</nav>
			...
			<div class="content-wrap">
				...
				<div class="container">
					...
					<div id="section-wheel" class="page-section">
						<div class="heading-block text-center section border-bottom-0 py-5 mt-0">
						...
						<div id="oc-wheel" class="owl-carousel shop-carousel carousel-widget" data-margin="30" data-nav="true" data-pagi="false" data-items-xs="1" data-items-sm="2" data-items-md="3" data-items-lg="4" data-autoplay="5000">
							<div class="product text-center">
								<div class="product-image px-4 py-1">
									<a href="#"><img src="demos/car/images/accessories/wheels/1.jpg" alt="Image"></a>
								</div>
								...
								<div class="product-desc">
									...
									<a href="#" class="button button-rounded button-small m-0"><i class="bi-cart"></i> Add to Cart</a>
								</div>
							</div>

							<div class="product text-center">
								<div class="product-image px-4 py-1">
									<a href="#"><img src="demos/car/images/accessories/wheels/2.jpg" alt="Image"></a>
								</div>
							...
							<div class="product text-center">
								<div class="product-image px-4 py-1">
									<a href="#"><img src="demos/car/images/accessories/wheels/3.jpg" alt="Image"></a>
								</div>
							...
							<div class="product text-center">
								<div class="product-image px-4 py-1">
									<a href="#"><img src="demos/car/images/accessories/wheels/4.jpg" alt="Image"></a>
								</div>
							...
							<div class="product text-center">
								<div class="product-image px-4 py-1">
									<a href="#"><img src="demos/car/images/accessories/wheels/5.jpg" alt="Image"></a>
								</div>
							...
							<div class="product text-center">
								<div class="product-image px-4 py-1">
									<a href="#"><img src="demos/car/images/accessories/wheels/6.jpg" alt="Image"></a>
								</div>
					...
					<div id="section-music" class="page-section">
						<div class="heading-block section border-bottom-0 py-5 text-center">
						...
						<div class="owl-carousel shop-carousel carousel-widget mb-5" data-margin="30" data-nav="true" data-pagi="false" data-items-xs="1" data-items-sm="2" data-items-md="3" data-items-lg="4" data-autoplay="5000">
							<div class="product text-center">
								<div class="product-image px-4 py-1">
									<a href="#"><img src="demos/car/images/accessories/music/1.jpg" alt="Image"></a>
								</div>
							...
							<div class="product text-center">
								<div class="product-image px-4 py-1">
									<a href="#"><img src="demos/car/images/accessories/music/2.jpg" alt="Image"></a>
								</div>
							...
							<div class="product text-center">
								<div class="product-image px-4 py-1">
									<a href="#"><img src="demos/car/images/accessories/music/3.jpg" alt="Image"></a>
								</div>
							...
							<div class="product text-center">
								<div class="product-image px-4 py-1">
									<a href="#"><img src="demos/car/images/accessories/music/4.jpg" alt="Image"></a>
								</div>
					...
					<div id="section-engines" class="page-section">
						...
						<div class="owl-carousel shop-carousel carousel-widget mb-5" data-margin="30" data-nav="true" data-pagi="false" data-items-xs="1" data-items-sm="2" data-items-md="3" data-items-lg="4" data-autoplay="5000">
							<div class="product text-center">
								<div class="product-image px-4 py-1">
									<a href="#"><img src="demos/car/images/accessories/engines/1.jpg" alt="Image"></a>
								</div>
							...
							<div class="product text-center">
								<div class="product-image px-4 py-1">
									<a href="#"><img src="demos/car/images/accessories/engines/2.jpg" alt="Image"></a>
								</div>
							...
							<div class="product text-center">
								<div class="product-image px-4 py-1">
									<a href="#"><img src="demos/car/images/accessories/engines/3.jpg" alt="Image"></a>
								</div>
							...
							<div class="product text-center">
								<div class="product-image px-4 py-1">
									<a href="#"><img src="demos/car/images/accessories/engines/4.jpg" alt="Image"></a>
								</div>
							...
							<div class="product text-center">
								<div class="product-image px-4 py-1">
									<a href="#"><img src="demos/car/images/accessories/engines/5.jpg" alt="Image"></a>
								</div>
							...
							<div class="product text-center">
								<div class="product-image px-4 py-1">
									<a href="#"><img src="demos/car/images/accessories/engines/6.jpg" alt="Image"></a>
								</div>
					...
					<div id="section-seats" class="page-section">
						...
						<div class="owl-carousel shop-carousel carousel-widget mb-5" data-margin="30" data-nav="true" data-pagi="false" data-items-xs="1" data-items-sm="2" data-items-md="3" data-items-lg="4" data-autoplay="5000">
							<div class="product text-center">
								<div class="product-image px-4 py-1">
									<a href="#"><img src="demos/car/images/accessories/seats/1.jpg" alt="Image"></a>
								</div>
							...
							<div class="product text-center">
								<div class="product-image px-4 py-1">
									<a href="#"><img src="demos/car/images/accessories/seats/2.jpg" alt="Image"></a>
								</div>
							...
							<div class="product text-center">
								<div class="product-image px-4 py-1">
									<a href="#"><img src="demos/car/images/accessories/seats/3.jpg" alt="Image"></a>
								</div>
							...
							<div class="product text-center">
								<div class="product-image px-4 py-1">
									<a href="#"><img src="demos/car/images/accessories/seats/4.jpg" alt="Image"></a>
								</div>
					...
					<div id="section-lights" class="page-section">
						...
						<div class="owl-carousel shop-carousel carousel-widget mb-5" data-margin="30" data-nav="true" data-pagi="false" data-items-xs="1" data-items-sm="2" data-items-md="3" data-items-lg="4" data-autoplay="5000">
							<div class="product text-center">
								<div class="product-image px-4 py-1">
									<a href="#"><img src="demos/car/images/accessories/lights/1.jpg" alt="Image"></a>
								</div>
							...
							<div class="product text-center">
								<div class="product-image px-4 py-1">
									<a href="#"><img src="demos/car/images/accessories/lights/2.jpg" alt="Image"></a>
								</div>
							...
							<div class="product text-center">
								<div class="product-image px-4 py-1">
									<a href="#"><img src="demos/car/images/accessories/lights/3.jpg" alt="Image"></a>
								</div>
							...
							<div class="product text-center">
								<div class="product-image px-4 py-1">
									<a href="#"><img src="demos/car/images/accessories/lights/4.jpg" alt="Image"></a>
								</div>
							...
							<div class="product text-center">
								<div class="product-image px-4 py-1">
									<a href="#"><img src="demos/car/images/accessories/lights/5.jpg" alt="Image"></a>
								</div>
				...
				<div class="section m-0 footer-stick" style="background: #FFF url('demos/car/images/features/section-bg.jpg') left bottom no-repeat; background-size: cover; padding: 120px 0">
					<div class="container">
						<div class="row">
							<div class="col-md-6">
								<h2 class="h2 fw-bold mb-4">You still can't find your Car's Parts, then please Contact Us!</h2>
								<a href="contact.php" class="button button-color button-large button-rounded">Contact Now</a>
							</div>
						</div>
					</div>
				</div>
