	...
	<div id="wrapper">
		...
		<section id="slider" class="slider-element min-vh-100 include-header">
			<div class="slider-inner">
				...
				<div class="row align-items-stretch w-100 h-100 position-relative position-md-absolute position-lg-relative m-0">
					...
					<div class="col-lg-5 col-md-6 bg-contrast-100">
						<div class="vertical-middle">
							<div class="subscribe-widget" data-loader="button">
								<div class="col-padding">
									<div class="heading-block border-bottom-0 mb-4">
										<h1 style="line-height: 1.4;font-size: 24px;">Subscribe Now</h1>
										<span style="font-size:16px; top-margin: 20px;" class="fw-light">Stay in Touch to get Exclusive Offers &amp; Daily Digest</span>
									</div>
									<div class="widget-subscribe-form-result"></div>
									<form id="slider-subscribe-form" action="include/subscribe.php" method="post" class="row mb-0">
										<div class="col-6 mb-3">
											<input type="text" class="form-control required" name="widget-subscribe-form-fname" placeholder="First Name">
										</div>
										<div class="col-6 mb-3">
											<input type="text" class="form-control required" name="widget-subscribe-form-lname" placeholder="Last Name">
										</div>
										<div class="w-100"></div>
										<div class="col-12 mb-3">
											<input type="email" class="form-control required" name="widget-subscribe-form-email" placeholder="Enter Email Address">
										</div>
										<div class="col-12">
											<button type="submit" class="button button-dark button-3d button-rounded w-100 m-0" value="submit"><i class="bi-send"></i> Subscribe Now</button>
										</div>
									</form>
								</div>
							</div>
