...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>One Page with Registration Form &amp; Testimonials | Canvas</title>
...
<body class="stretched" data-loader="11" data-loader-color="#543456">
	...
	<div id="wrapper">
		...
		<section id="slider" class="slider-element slider-parallax min-vh-100 include-header">
			<div class="slider-inner" style="background-image: url('images/slider/rev/ken-2.jpg');">
					...
					<div class="container py-5">
						<div class="row align-items-center col-mb-50">
								...
								<div class="card" style="border-color: #eee;">
									<div class="card-body" style="padding: 30px;">
										<div class="heading-block border-bottom-0 mb-4">
											...
											<span style="font-size: 15px;" class="fw-light text-capitalize ls-1 mt-0">Get Started within 5 Minutes.</span>
										</div>
							...
							<div class="offset-lg-1 col-md-5">
								<h2>Client's Confidence:</h2>
								<div class="fslider testimonial testimonials-lg bg-transparent border-0 shadow-none p-0" data-animation="fade" data-arrows="false" data-pagi="false">
