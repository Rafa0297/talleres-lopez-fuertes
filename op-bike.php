...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Bike Shop - One Page Canvas Slider | Canvas</title>
...
<body class="stretched overlay-menu">
	...
	<div id="wrapper">
		...
		<!-- Slider
		============================================= -->
		<section id="slider" class="slider-element swiper_wrapper h-auto border-bottom border-default" data-grab="false" data-autoheight="true">
					...
					<div class="swiper-wrapper">
							...
							<div class="container py-6">
								<div class="row align-items-center h-100">
									<div class="col-md-6 mt-5 mt-md-0">
										<div class="fslider flex-thumb-grid grid-5" data-speed="400" data-arrows="false" data-thumbs="true">
											<div class="flexslider">
												<div class="slider-wrap">
													<div class="slide" data-thumb="one-page/images/page/bike/1/thumbs/1.png">
														<img src="one-page/images/page/bike/1/1.png" alt="Image">
													</div>
													<div class="slide" data-thumb="one-page/images/page/bike/1/thumbs/2.png">
														<img src="one-page/images/page/bike/1/2.png" alt="Image">
													</div>
													<div class="slide" data-thumb="one-page/images/page/bike/1/thumbs/3.png">
														<img src="one-page/images/page/bike/1/3.png" alt="Image">
													</div>
													<div class="slide" data-thumb="one-page/images/page/bike/1/thumbs/4.png">
														<img src="one-page/images/page/bike/1/4.png" alt="Image">
													</div>
												</div>
											</div>
										</div>
									...
									<div class="col-md-6 px-5">
										<div class="heading-block border-bottom-0 mb-4">
											<div class="rating-stars mb-2" data-animate="fadeInUp"><i class="bi-star-fill text-warning"></i><i class="bi-star-fill text-warning"></i><i class="bi-star-fill text-warning"></i><i class="bi-star-fill text-warning"></i><i class="bi-star-half text-warning"></i></div>
											<h2 class="fw-semibold" data-animate="fadeInUp">Mountain Bikes</h2>
										</div>
										<p data-animate="fadeInUp" class="text-black-50">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Assumenda, animi. Nihil repellendus nemo praesentium eos illo assumenda, velit similique repellat.</p>
										<h3 class="fw-semibold mt-4" data-animate="fadeInUp">$1100 <small class="text-black-50 ms-1 ls-0 fw-semibold"><del>$1300</del></small></h3>
										<div class="mb-4 d-flex align-items-start align-items-lg-center justify-content-between flex-column flex-lg-row">
											<a href="#" class="button button-large button-rounded m-0 button-dark" data-animate="fadeInUp"><i class="bi-cart"></i> Add to Cart</a>
											<div class="d-flex align-items-center justify-content-between" data-animate="fadeInUp" data-delay="200">
												<h6 class="fs-6 fw-semibold mb-0 me-4">Share:</h6>
												<div class="d-flex">
													<a href="#" class="social-icon si-small border-transparent text-black-50 me-1 h-bg-facebook" title="Facebook">
														<i class="fa-brands fa-facebook-f"></i>
														<i class="fa-brands fa-facebook-f"></i>
													</a>

													<a href="#" class="social-icon si-small border-transparent text-black-50 me-1 h-bg-x-twitter" title="Twitter">
														<i class="fa-brands fa-x-twitter"></i>
														<i class="fa-brands fa-x-twitter"></i>
													</a>

													<a href="#" class="social-icon si-small border-transparent text-black-50 me-1 h-bg-pinterest" title="Pinterest">
														<i class="fa-brands fa-pinterest-p"></i>
														<i class="fa-brands fa-pinterest-p"></i>
													</a>

													<a href="#" class="social-icon si-small border-transparent text-black-50 me-1 h-bg-email3 me-0" title="Mail">
						...
						<div class="swiper-slide bg-white">
							<div class="container py-6">
								<div class="row align-items-center h-100">
									<div class="col-md-6 mt-5 mt-md-0">
										<div class="fslider flex-thumb-grid grid-5" data-speed="400" data-slideshow="false" data-arrows="false" data-thumbs="true">
											<div class="flexslider">
												<div class="slider-wrap">
													<div class="slide" data-thumb="one-page/images/page/bike/2/thumbs/1.png">
														<img src="one-page/images/page/bike/2/1.png" alt="Image">
													</div>
													<div class="slide" data-thumb="one-page/images/page/bike/2/thumbs/2.png">
														<img src="one-page/images/page/bike/2/2.png" alt="Image">
													</div>
													<div class="slide" data-thumb="one-page/images/page/bike/2/thumbs/3.png">
														<img src="one-page/images/page/bike/2/3.png" alt="Image">
													</div>
												</div>
											</div>
										</div>
									</div>
									<div class="col-md-6 px-5 mt-5 mt-md-0">
										<div class="heading-block border-bottom-0 mb-4">
											<div class="rating-stars mb-2" data-animate="fadeInUp"><i class="bi-star-fill text-warning"></i><i class="bi-star-fill text-warning"></i><i class="bi-star-fill text-warning"></i><i class="bi-star-fill text-warning"></i><i class="bi-star-half text-warning"></i></div>
											<h2 class="fw-semibold" data-animate="fadeInUp">Kids Bikes</h2>
										</div>
										<p data-animate="fadeInUp" class="text-black-50">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Assumenda, animi. Nihil repellendus nemo praesentium eos illo assumenda, velit similique repellat.</p>
										<h3 class="fw-semibold mt-4" data-animate="fadeInUp">$990 <small class="text-black-50 ms-1 ls-0 fw-semibold"><del>$1200</del></small></h3>
