...
<head>
	...
	<meta name="description" content="Create Photography &amp; Video Agency Websites with Canvas Template. Get Canvas to build powerful websites easily with the Highly Customizable &amp; Best Selling Bootstrap Template, today.">
	...
	<!-- Niche Demos -->
	<link rel="stylesheet" href="demos/photography/photography.css">
	<link rel="stylesheet" href="demos/photography/css/photography-addons.css">
...
<body class="stretched side-header side-header-right open-header">
	...
	<div id="wrapper">
		...
		<div class="co-name d-none d-lg-block text-center"><img src="demos/photography/images/logo-dark@2x.png" alt="Canvas Logo"></div>
				...
				<div class="container">
					<div class="header-row align-items-lg-start">
						...
						<div id="logo" class="d-block d-lg-none d-xl-block">
							<a href="demo-photography.php">
								<img class="logo-default ms-0" srcset="demos/photography/images/logo.png, demos/photography/images/logo@2x.png 2x" src="demos/photography/images/logo@2x.png" alt="Canvas Logo">
								<img class="logo-dark ms-0" srcset="demos/photography/images/logo-dark.png, demos/photography/images/logo-dark@2x.png 2x" src="demos/photography/images/logo-dark@2x.png" alt="Canvas Logo">
							</a>
						</div><!-- #logo end -->
		...
		<section id="slider" class="slider-element swiper_wrapper min-vh-75 min-vh-md-100" data-loop="true" data-speed="1200" data-autoplay="5000">
			<div class="slider-inner">
				...
				<div class="swiper swiper-parent">
					<div class="swiper-wrapper">
						<div class="swiper-slide dark">
							...
							<div class="swiper-slide-bg" style="background-image: url('demos/photography/images/slider/1.jpg');"></div>
						</div>
						<div class="swiper-slide dark">
							<div class="container">
								<div class="slider-text">
							...
							<div class="swiper-slide-bg" style="background-image: url('demos/photography/images/slider/2.jpg');"></div>
						</div>
						<div class="swiper-slide dark">
							<div class="container">
								<div class="slider-text">
							...
							<div class="swiper-slide-bg" style="background-image: url('demos/photography/images/slider/3.jpg');"></div>
						</div>
						<div class="swiper-slide dark">
							<div class="container">
								<div class="slider-text">
							...
							<div class="swiper-slide-bg" style="background-image: url('demos/photography/images/slider/4.jpg');"></div>
						</div>
						<div class="swiper-slide dark">
							<div class="container">
								<div class="slider-text">
							...
							<div class="swiper-slide-bg" style="background-image: url('demos/photography/images/slider/5.jpg');"></div>
						</div>
						<div class="swiper-slide dark">
							<div class="container">
								<div class="slider-text">
				...
				<a href="#" data-scrollto="#content" data-offset="0" class="dark one-page-arrow"><i class="bi-grid"></i></a>
		...
		<section id="content">
			...
			<div class="content-wrap">
				<div class="container dark">
						...
						<div class="grid-item col-12 col-sm-6 col-md-4 col-lg-3" data-size="1280x853">
							<a href="demos/photography/images/items/1.jpg" class="img-wrap img-grayscale" data-animate="fadeInUp" onclick="return false;">
								...
								<div class="description description-grid">
									...
									<div class="details">
										<ul>
											<li><i class="icon bi-camera"></i><span>Canon PowerShot S95</span></li>
											<li><i class="icon bi-eye"></i><span>22.5mm</span></li>
											<li><i class="icon bi-printer"></i><span>&fnof;/5.6</span></li>
											<li><i class="icon bi-gear"></i><span>1/1000</span></li>
											<li><i class="icon bi-sun"></i><span>80</span></li>
										</ul>
									</div>
								</div>
							</a>
					...
					<!-- /grid -->
					<div class="preview">
						<button class="action action-close"><i class="bi-x-lg"></i><span class="text-hidden">Close</span></button>
				...
				<!-- Author area
				============================================= -->
				<div class="section dark mt-6 mb-0" style="padding: 100px 0;">
					<div class="container">
						<div class="row">
							...
							<div class="col-lg-5 col-md-7 offset-lg-1">
								<div class="mt-5 d-block d-md-none d-lg-none d-xl-block"></div>
								<div class="heading-block border-0">
									<h2 class="ls-5">Gianpaolo Rocher</h2>
				...
				<div class="section bg-transparent footer-stick">
					<div class="container">
						<div class="heading-block dark text-center border-0">
							<h3 class="ls-1">Pictures By Album</h3>
						...
						<div class="row dark g-4">
							<div class="col-md-3 text-center">
								<a href="#">
									...
									<h5 class="ls-1 fw-normal">Wedding</h5>
								</a>
							</div>
							<div class="col-md-3 text-center">
								<a href="#">
									...
									<h5 class="ls-1 fw-normal">Nature</h5>
								</a>
							</div>
							<div class="col-md-3 text-center">
								<a href="#">
									...
									<h5 class="ls-1 fw-normal">Animal</h5>
								</a>
							</div>
							<div class="col-md-3 text-center">
								<a href="#">
									...
									<h5 class="ls-1 fw-normal">Model</h5>
								</a>
							</div>
							<div class="col-md-3 text-center">
								<a href="#">
									...
									<h5 class="ls-1 fw-normal">Bikini</h5>
								</a>
							</div>
							<div class="col-md-3 text-center">
								<a href="#">
									...
									<h5 class="ls-1 fw-normal">Home</h5>
								</a>
							</div>
							<div class="col-md-3 text-center">
								<a href="#">
									...
									<h5 class="ls-1 fw-normal">Sea</h5>
								</a>
							</div>
							<div class="col-md-3 text-center">
								<a href="#">
									...
									<h5 class="ls-1 fw-normal">Tattoo</h5>
								</a>
							</div>
						</div>
					</div>
				...
				<div class="container">
					...
					<div class="w-100 text-center mt-4">
						...
						<div class="d-flex justify-content-center">
							...
							<a href="mailto:noreply@canvas.com" class="social-icon si-small rounded-circle text-white bg-google">
	...
	<script>
		(function() {
			...
			jQuery('.grid-container').one( 'layoutComplete', function(){
