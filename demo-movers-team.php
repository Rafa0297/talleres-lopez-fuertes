...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Team - Movers Demo | Canvas</title>
					...
					<div class="header-row justify-content-between flex-row-reverse flex-lg-row">
						...
						<nav class="primary-menu with-arrows">
							...
							<ul class="menu-container">
								...
								<li class="menu-item current"><a class="menu-link" href="demo-movers-team.php"><div>Team</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-movers-faqs.php"><div>FAQs</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-movers-blog.php"><div>Blog</div></a></li>
			...
			<div class="content-wrap pb-0">
				...
				<div class="container mb-5">
					<div class="heading-block">
						<h3 class="text-transform-none mb-3 fw-semibold ls-0">Our Leadership</h3>
					</div>
					<div class="row col-mb-50 mb-0">
							...
							<div class="team">
								...
								<div class="team-desc text-start">
									<div class="team-title">
										<h4 class="text-transform-none ls-0 fw-semibold">John Doe</h4>
						...
						<div class="col-lg-3 col-md-6">
							...
							<div class="team">
								...
								<div class="team-desc text-start">
									<div class="team-title">
										<h4 class="text-transform-none ls-0 fw-semibold">Josh Clark</h4>
						...
						<div class="col-lg-3 col-md-6">
							...
							<div class="team">
								...
								<div class="team-desc text-start">
									<div class="team-title">
										<h4 class="text-transform-none ls-0 fw-semibold">Barry Tone</h4>
						...
						<div class="col-lg-3 col-md-6">
							...
							<div class="team">
								...
								<div class="team-desc text-start">
									<div class="team-title">
										<h4 class="text-transform-none ls-0 fw-semibold">Jackson Pot</h4>
						...
						<div class="col-lg-3 col-md-6">
							...
							<div class="team">
								...
								<div class="team-desc text-start">
									<div class="team-title">
										<h4 class="text-transform-none ls-0 fw-semibold">Lance Bogrol</h4>
						...
						<div class="col-lg-3 col-md-6">
							...
							<div class="team">
								...
								<div class="team-desc text-start">
									<div class="team-title">
										<h4 class="text-transform-none ls-0 fw-semibold">Weir Doe</h4>
										<h5 class="fw-medium color mb-0">Support</h5>
									</div>
								</div>
							</div>
						...
						<div class="col-lg-3 col-md-6">
							...
							<div class="team">
								...
								<div class="team-desc text-start">
									<div class="team-title">
										<h4 class="text-transform-none ls-0 fw-semibold">Fletch Skinner</h4>
						...
						<div class="col-lg-3 col-md-6">
							...
							<div class="team">
								...
								<div class="team-desc text-start">
									<div class="team-title">
										<h4 class="text-transform-none ls-0 fw-semibold">Desmond Eagle</h4>
										<h5 class="fw-medium color mb-0">Delivery Boy</h5>
									</div>
								</div>
							</div>
						...
						<div class="col-lg-3 col-md-6">
							...
							<div class="team">
								...
								<div class="team-desc text-start">
									<div class="team-title">
										<h4 class="text-transform-none ls-0 fw-semibold">Brian Cumin</h4>
										<h5 class="fw-medium color mb-0">Delivery Boy</h5>
									</div>
								</div>
							</div>
