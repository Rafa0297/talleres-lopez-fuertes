					...
					<div class="swiper swiper-parent">
						<div class="swiper-wrapper">
							<div class="swiper-slide">
								<div class="container">
									<div class="slider-caption slider-caption-center dark">
										<h2>Slider One</h2>
										<p>Create just what you need for your Perfect Website. Choose from a wide range of Elements &amp; simply put them on our Canvas.</p>
										<div>
											<a href="block-slider-7.php" class="button button-large button-light button-white px-4 py-3 text-dark m-0 mt-4" target="_blank">Horizontal Pagination</a>
										</div>
									</div>
								</div>
							...
							<div class="swiper-slide">
								...
								<div class="swiper-slide-bg" style="background-image: url('demos/store/images/slider/3.jpg');"></div>
							</div>
						</div>
