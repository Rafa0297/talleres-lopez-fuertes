	...
	<div id="wrapper">
					...
					<div class="col-12 col-md-auto">
						...
						<div class="top-links on-click">
							<ul class="top-links-container">
								<li class="top-links-item"><a href="index.php">Home</a>
									<ul class="top-links-sub-menu">
										<li class="top-links-item"><a href="about.php">About</a></li>
										<li class="top-links-item"><a href="faqs.php">FAQs</a></li>
										<li class="top-links-item"><a href="contact.php">Contact</a></li>
										<li class="top-links-item"><a href="sitemap.php">Sitemap</a></li>
									</ul>
								</li>
								<li class="top-links-item"><a href="faqs.php">FAQs</a></li>
								<li class="top-links-item"><a href="contact.php">Contact</a></li>
								<li class="top-links-item"><a href="login-register.php">Login</a>
		...
		<section id="content">
			<div class="content-wrap">
				...
				<div class="section header-stick mb-6 py-3">
					<div class="container">
				...
				<div class="container">
					...
					<div class="row gx-5 col-mb-80">
						<main class="postcontent col-lg-9">
														...
														<div class="bg-overlay">
															<div class="bg-overlay-content text-overlay-mask desc-sm dark desc-sm align-items-end justify-content-start p-4">
																<div class="portfolio-desc py-0">
																	...
																	<span><i class="bi-star-fill me-1"></i><i class="bi-star-fill me-1"></i><i class="bi-star-fill me-1"></i><i class="bi-star-half me-1"></i><i class="bi-star"></i></span>
																</div>
															</div>
														</div>
													</a>
									...
									<div class="row posts-md col-mb-30">
											...
											<div class="grid-inner">
												...
												<div class="entry-meta">
													<ul>
														...
														<li><a href="blog-single.php#comments"><i class="uil uil-comments-alt"></i> 15</a></li>
													</ul>
												</div>
												<div class="entry-content">
													<p class="mb-0">Neque nesciunt molestias soluta esse debitis. Magni impedit quae consectetur consequuntur.</p>
												</div>
											</div>
										</div>
											...
											<div class="grid-inner">
												...
												<div class="entry-meta">
													<ul>
														...
														<li><a href="blog-single.php#comments"><i class="uil uil-comments-alt"></i> 25</a></li>
													</ul>
												</div>
												<div class="entry-content">
													<p class="mb-0">Eaque iusto quod assumenda beatae, nesciunt aliquid. Vel, eos eligendi?</p>
												</div>
											</div>
										</div>
										...
										<div class="entry col-sm-6 col-md-4">
											<div class="grid-inner">
												...
												<div class="entry-title title-xs text-transform-none">
													<h3><a href="blog-single.php">Combat malaria positive social change civil society. Fundraise inspire.</a></h3>
												</div>
												<div class="entry-meta">
													<ul>
														<li><i class="uil uil-schedule"></i> 19th Dec 2021</li>
														<li><a href="blog-single.php#comments"><i class="uil uil-comments-alt"></i> 19</a></li>
													</ul>
												</div>
												<div class="entry-content">
													<p class="mb-0">Combat malaria positive social change civil society fundraise inspire.</p>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="row posts-md col-mb-30">
										<div class="entry col-sm-6 col-md-4">
											<div class="grid-inner">
												...
												<div class="entry-title title-xs text-transform-none">
													<h3><a href="blog-single.php">MIT's new robot glove can give you extra fingers</a></h3>
												</div>
												<div class="entry-meta">
													<ul>
														<li><i class="uil uil-schedule"></i> 22nd Jan 2013</li>
														<li><a href="blog-single.php#comments"><i class="uil uil-comments-alt"></i> 14</a></li>
													</ul>
												</div>
												<div class="entry-content">
													<p class="mb-0">Magni impedit quae consectetur consequuntur adipisci veritatis modi a, officia cum.</p>
												</div>
											</div>
										</div>
										...
										<div class="entry col-sm-6 col-md-4">
											<div class="grid-inner">
												...
												<div class="entry-title title-xs text-transform-none">
													<h3><a href="blog-single.php">Beyonce Dropped A '50 Shades Of Grey', Teaser On Instagram Last Night</a></h3>
												</div>
												<div class="entry-meta">
													<ul>
														<li><i class="uil uil-schedule"></i> 19th Apr 2021</li>
														<li><a href="blog-single.php#comments"><i class="uil uil-comments-alt"></i> 55</a></li>
													</ul>
												</div>
												<div class="entry-content">
													<p class="mb-0">Neque nesciunt molestias soluta esse debitis. Magni impedit quae consectetur consequuntur.</p>
										...
										<div class="entry col-sm-6 col-md-4">
											<div class="grid-inner">
												...
												<div class="entry-title title-xs text-transform-none">
													<h3><a href="blog-single.php">A Baseball Team Blew Up A Bunch Of Justin Bieber And Miley Cyrus Merch</a></h3>
												</div>
												<div class="entry-meta">
													<ul>
														<li><i class="uil uil-schedule"></i> 26th Apr 2021</li>
														<li><a href="blog-single.php#comments"><i class="uil uil-comments-alt"></i> 41</a></li>
													</ul>
												</div>
												<div class="entry-content">
													<p class="mb-0">Eaque iusto quod assumenda beatae, nesciunt aliquid. Vel, eos eligendi emo perferendis dolorem voluptatem.</p>
												</div>
											</div>
										</div>
									</div>
							...
							<div class=" mt-4">
								...
								<ul class="nav canvas-tabs tabs nav-tabs mb-3" id="canvas-tab2" role="tablist">
									<li class="nav-item" role="presentation">
										<button class="nav-link active" id="canvas-home-tab" data-bs-toggle="pill" data-bs-target="#home2" type="button"
											role="tab" aria-controls="canvas-home" aria-selected="true"><i class="bi-camera-video mx-1"></i><span class="d-none d-md-inline-block ms-1"> Video News</span></button>
									</li>
									<li class="nav-item" role="presentation">
										<button class="nav-link" id="canvas-profile-tab" data-bs-toggle="pill" data-bs-target="#profile2" type="button"
											role="tab" aria-controls="canvas-profile" aria-selected="false"><i class="bi-film mx-1"></i><span class="d-none d-md-inline-block ms-1"> Movie Reviews</span></button>
									</li>
									<li class="nav-item" role="presentation">
										<button class="nav-link" id="canvas-contact-tab" data-bs-toggle="pill" data-bs-target="#contact2" type="button"
											role="tab" aria-controls="canvas-contact" aria-selected="false"><i class="bi-music-note-beamed mx-1"></i><span class="d-none d-md-inline-block ms-1"> Music</span></button>
									</li>
									<li class="nav-item" role="presentation">
										<button class="nav-link" id="canvas-about-tab" data-bs-toggle="pill" data-bs-target="#about2" type="button"
											role="tab" aria-controls="canvas-about" aria-selected="false"><i class="bi-bar-chart mx-1"></i><span class="d-none d-md-inline-block ms-1"> Opinion Polls</span></button>
									</li>
								</ul>
											...
											<div class="col-md-7">
												<div class="posts-md">
													<div class="entry">
														...
														<div class="entry-title title-sm">
															<h3><a href="blog-single.php">Review: Dallas Buyers Club</a></h3>
														</div>
														<div class="entry-meta">
															<ul>
																<li><i class="uil uil-schedule"></i> 10th Feb 2021</li>
																<li><a href="blog-single.php#comments"><i class="uil uil-comments-alt"></i> 13</a></li>
																<li class="color"><i class="bi-star-fill"></i> <i class="bi-star-fill"></i> <i class="bi-star-fill"></i> <i class="bi-star-fill"></i> <i class="bi-star-half"></i></li>
																<li><i class="bi-heart-fill text-danger"></i> 95%</li>
															</ul>
														</div>
														<div class="entry-content">
														...
														<div class="grid-inner row align-items-center g-0">
															...
															<div class="col ps-3">
																...
																<div class="entry-meta no-separator">
																	<ul>
																		<li class="text-dark"><i class="bi-star-fill"></i><i class="bi-star-fill"></i><i class="bi-star-half"></i><i class="bi-star"></i><i class="bi-star"></i></li>
																		<li><i class="bi-heart-fill text-warning"></i> 48%</li>
																	</ul>
																</div>
															</div>
														</div>
											...
											<div class="col-md-7">
												<div class="posts-md">
													<div class="entry">
														...
														<div class="entry-title title-sm">
															<h3><a href="blog-single.php">Afrojack vs Thirty Seconds To Mars - Do Or Die (Club Remix)</a></h3>
														</div>
														<div class="entry-meta">
															<ul>
																<li><i class="uil uil-schedule"></i> 10th Feb 2021</li>
																...
																<li><i class="bi-heart-fill text-danger"></i> 85%</li>
															</ul>
														</div>
														<div class="entry-content">
															<p>Morbi tincidunt, dui sit amet facilisis feugiat, odio metus gravida ante, ut pharetra massa metus id nunc. Duis scelerisque molestie turpis. Cupiditate quia nesciunt repellat animi amet magnam officiis!</p>
											...
											<div class="col-md-7">
												<div class="posts-md">
													<div class="entry">
														...
														<div class="entry-title title-sm">
															<h3><a href="blog-single.php">America Should Stay Out of Foreign Troubles?</a></h3>
														</div>
														<div class="entry-meta">
															<ul>
																<li><i class="uil uil-schedule"></i> 5th July, 2021</li>
																<li><i class="bi-hand-thumbs-up text-success"></i> 69.3%</li>
																<li><i class="bi-hand-thumbs-down text-danger"></i> 31.7%</li>
															</ul>
														</div>
													</div>
												</div>
							...
							<div class="sidebar-widgets-wrap">
								...
								<div class="widget">
									<div class="row gutter-20 col-mb-30">
										<div class="col-4">
											<a href="#" class="social-icon bg-dark h-bg-facebook float-none mb-3">
										...
										<div class="col-4">
											<a href="#" class="social-icon bg-dark h-bg-x-twitter float-none mb-3">
										...
										<div class="col-4">
											<a href="#" class="social-icon bg-dark h-bg-rss float-none mb-3">
								...
								<div class="widget">
									...
									<div class="fslider customjs testimonial twitter-scroll twitter-feed" data-username="envato" data-count="3" data-animation="slide" data-arrows="false">
										<div class="row gx-2">
											<div class="col-auto">
												<i class="i-plain color fa-brands fa-x-twitter" style="--cnvs-i-size:2rem"></i>
											</div>
											<div class="col">
												<div class="flexslider">
								...
								<div class="widget">
									...
									<div id="flickr-widget" class="flickr-feed masonry-thumbs grid-container row row-cols-5 customjs" data-id="613394@N22" data-count="15" data-type="group" data-lightbox="gallery"></div>
					...
					<div id="oc-images" class="owl-carousel image-carousel carousel-widget posts-md" data-margin="30" data-nav="false" data-items-xs="1" data-items-sm="2" data-items-md="3" data-items-xl="4">
						...
						<div class="oc-item">
							<div class="entry">
								...
								<div class="entry-title title-xs text-transform-none">
									<h4><a href="blog-single.php">A Baseball Team Blew Up A Bunch Of Justin Bieber And Miley Cyrus Merch</a></h4>
								</div>
								<div class="entry-meta">
									<ul>
										<li><i class="uil uil-schedule"></i> 13th Jun 2021</li>
										<li><a href="blog-single.php#comments"><i class="uil uil-comments-alt"></i> 53</a></li>
									</ul>
								</div>
							</div>
						</div>
						<div class="oc-item">
							<div class="entry">
								...
								<div class="entry-title title-xs text-transform-none">
									<h4><a href="blog-single.php">UK government weighs Tesla's Model S for its ??5 million electric vehicle fleet</a></h4>
								</div>
								<div class="entry-meta">
									<ul>
										<li><i class="uil uil-schedule"></i> 24th Feb 2021</li>
										<li><a href="blog-single.php#comments"><i class="uil uil-comments-alt"></i> 17</a></li>
									</ul>
								</div>
							</div>
						</div>
						<div class="oc-item">
							<div class="entry">
								...
								<div class="entry-title title-xs text-transform-none">
									<h4><a href="blog-single.php">MIT's new robot glove can give you extra fingers</a></h4>
								</div>
								<div class="entry-meta">
									<ul>
						...
						<div class="oc-item">
							<div class="entry">
								...
								<div class="entry-title title-xs text-transform-none">
									<h4><a href="blog-single.php">Yen dips on modest reduction in risk aversion, markets still wary</a></h4>
								</div>
								<div class="entry-meta">
									<ul>
										<li><i class="uil uil-schedule"></i> 15th Jan 2021</li>
										<li><a href="blog-single.php#comments"><i class="uil uil-comments-alt"></i> 54</a></li>
									</ul>
								</div>
							</div>
						</div>
						<div class="oc-item">
							<div class="entry">
								...
								<div class="entry-title title-xs text-transform-none">
									<h4><a href="blog-single.php">Beyonce Dropped A '50 Shades Of Grey', Teaser On Instagram Last Night</a></h4>
								</div>
								<div class="entry-meta">
									<ul>
										<li><i class="uil uil-schedule"></i> 27th Jul 2021</li>
										<li><a href="blog-single.php#comments"><i class="uil uil-comments-alt"></i> 61</a></li>
									</ul>
								</div>
							</div>
						</div>
						<div class="oc-item">
							<div class="entry">
								...
								<div class="entry-title title-xs text-transform-none">
									<h4><a href="blog-single.php">Want To Know The New 'Star Wars' Plot? Then This Is The Post For You</a></h4>
								</div>
								<div class="entry-meta">
									<ul>
										<li><i class="uil uil-schedule"></i> 10th Feb 2021</li>
										<li><a href="blog-single.php#comments"><i class="uil uil-comments-alt"></i> 34</a></li>
									</ul>
								</div>
							</div>
						</div>
						<div class="oc-item">
							<div class="entry">
								...
								<div class="entry-title title-xs text-transform-none">
									<h4><a href="blog-single.php">Toyotas next minivan will let you shout at your kids without turning around</a></h4>
								</div>
								<div class="entry-meta">
									<ul>
										<li><i class="uil uil-schedule"></i> 21st Oct 2021</li>
										<li><a href="blog-single.php#comments"><i class="uil uil-comments-alt"></i> 11</a></li>
									</ul>
								</div>
							</div>
						</div>
						<div class="oc-item">
							<div class="entry">
								...
								<div class="entry-title title-xs text-transform-none">
									<h4><a href="blog-single.php">You can now listen to headphones through your hoodie</a></h4>
								</div>
								<div class="entry-meta">
									<ul>
										<li><i class="uil uil-schedule"></i> 20th Nov 2021</li>
										<li><a href="blog-single.php#comments"><i class="uil uil-comments-alt"></i> 07</a></li>
									</ul>
								</div>
							</div>
						</div>
					...
					<img src="images/magazine/ad.jpg" alt="Ad" class="aligncenter mt-6 mb-0">
