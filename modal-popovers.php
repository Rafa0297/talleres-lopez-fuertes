...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Modal &amp; Popovers | Canvas</title>
			...
			<div class="container">
				<div class="page-title-row pb-5 align-items-lg-end">
					...
					<div class="page-title-content">
						<h1>Modal &amp; Popovers</h1>
						<span>Get Attention of your Visitors</span>
					...
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Modal &amp; Popovers</li>
					</ol>
				...
				<div class="container">
					...
					<div class="row justify-content-center text-center">
						<div class="col-lg-9">
							...
							<div class="divider divider-center my-6"><i class="bi-circle-fill"></i></div>
