				...
				<div class="container">
					<div class="header-row">
						...
						<div class="header-misc d-none d-lg-flex">
							<a href="#" class="button button-3d button-small button-rounded">Get Started</a>
						</div>
							...
							<div class="slider-wrap">
								<div class="slide">
									<div class="row flex-column text-center align-items-center gy-3">
										...
										<div class="col-lg-6">
											<p class="mb-3 fs-4 font-secondary">Similique fugit repellendus expedita excepturi iure perferendis provident quia eaque. Repellendus, vero numquam?</p>
								...
								<div class="slide">
									<div class="row flex-column text-center align-items-center gy-3">
										...
										<div class="col-lg-6">
											<p class="mb-3 fs-4 font-secondary">Natus voluptatum enim quod necessitatibus quis expedita harum provident eos obcaecati id culpa corporis molestias.</p>
								...
								<div class="slide">
									<div class="row flex-column text-center align-items-center gy-3">
										...
										<div class="col-lg-6">
											<p class="mb-3 fs-4 font-secondary">Incidunt deleniti blanditiis quas aperiam recusandae consequatur ullam quibusdam cum libero illo rerum!</p>
