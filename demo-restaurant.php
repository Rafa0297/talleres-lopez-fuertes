	...
	<div id="wrapper">
						...
						<div class="swiper-slide">
							<div class="container dark">
								<div class="slider-caption">
									<div>
										<h2 class="font-secondary ls-0 fw-normal text-transform-none" data-animate="fadeIn">Taste from Italy.</h2>
										...
										<div class="static-content position-relative d-flex justify-content-start mt-5" data-animate="fadeIn" data-delay="800">
											...
											<img class="ms-4" src="demos/restaurant/images/icons/wifi-white.svg" width="42" height="42" alt="Image">
										</div>
									</div>
								</div>
							</div>
						...
						<div class="swiper-slide">
							<div class="container dark">
								<div class="slider-caption slider-caption-center" style="margin-top: -30px;">
									<div>
										<img data-animate="fadeIn" src="demos/restaurant/images/slider-logo.png" alt="Image" style="width: 120px; margin-bottom: 10px;">
										<h2 class="font-secondary ls-0 fw-normal text-transform-none" data-animate="fadeIn" data-delay="400">Make your Chocolate.</h2>
						...
						<div class="swiper-slide">
							<div class="container dark">
								<div class="slider-caption slider-caption-right">
									<div>
										<h2 class="font-secondary ls-0 fw-normal text-transform-none" data-animate="fadeIn">Hello &amp; Welcome.</h2>
							...
							<div class="swiper-slide-bg" style="background-image: url('demos/restaurant/images/slider/2.jpg'); background-position: center bottom;"></div>
						</div>
					</div>
		...
		<section id="content">
			...
			<div class="content-wrap" style="overflow: visible;">
				...
				<div class="section m-0" style="padding: 40px 0; background: url('demos/restaurant/images/sections/4.jpg') center center no-repeat; background-size: 100% auto">
					<div class="container">
						...
						<div class="row col-mb-50">
							<div class="col-lg-3">
								<div class="feature-box media-box" style="max-width: 400px;">
									<div class="fbox-media" style="width: 70px; height: auto;">
										<img src="demos/restaurant/images/icons/bowl.svg" alt="Image">
									</div>
							...
							<div class="col-lg-3">
								<div class="feature-box media-box" style="max-width: 400px;">
									<div class="fbox-media" style="width: 70px; height: auto;">
										<img src="demos/restaurant/images/icons/spoon.svg" alt="Image">
									</div>
									<div class="fbox-content px-0">
										<h3>Ample Options</h3>
							...
							<div class="col-lg-3">
								<div class="feature-box media-box" style="max-width: 400px;">
									<div class="fbox-media" style="width: 70px; height: auto;">
										<img src="demos/restaurant/images/icons/glass.svg" alt="Image">
									</div>
									<div class="fbox-content px-0">
						...
						<div class="row align-items-stretch">
							...
							<div class="col-lg-5" style="background-color: #FFF; padding: 0; box-shadow: -4px 1px 15px 3px rgba(0,0,0,0.07);">
								<div id="food-menu-carousel" class="menu-carousel owl-carousel image-carousel food-menu-carousel carousel-widget customjs">
									...
									<div class="oc-item">
										<img class="mt-4" src="demos/restaurant/images/items/food/1.jpg" alt="Image 1">
										<div class="food-content">
											...
											<a href="#" class="more-link">See More Details <i class="bi-arrow-right"></i></a>
										</div>
									</div>
									<div class="oc-item">
										<img class="mt-4" src="demos/restaurant/images/items/food/2.jpg" alt="Image 2">
										<div class="food-content">
											<div class="d-flex flex-column flex-sm-row justify-content-sm-between mb-4">
												<div class="heading-block border-bottom-0 mb-0">
									...
									<div class="oc-item">
										<img class="mt-4" src="demos/restaurant/images/items/food/3.jpg" alt="Image 3">
										<div class="food-content">
											<div class="d-flex flex-column flex-sm-row justify-content-sm-between mb-4">
												<div class="heading-block border-bottom-0 mb-0">
									...
									<div class="oc-item">
										<img class="mt-4" src="demos/restaurant/images/items/food/4.jpg" alt="Image 4">
										<div class="food-content">
											<div class="d-flex flex-column flex-sm-row justify-content-sm-between mb-4">
												<div class="heading-block border-bottom-0 mb-0">
									...
									<div class="oc-item">
										<img class="mt-4" src="demos/restaurant/images/items/food/5.jpg" alt="Image 1">
										<div class="food-content">
											<div class="d-flex flex-column flex-sm-row justify-content-sm-between mb-4">
												<div class="heading-block border-bottom-0 mb-0">
									...
									<div class="oc-item">
										<img class="mt-4" src="demos/restaurant/images/items/food/6.jpg" alt="Image 2">
										<div class="food-content">
											<div class="d-flex flex-column flex-sm-row justify-content-sm-between mb-4">
												<div class="heading-block border-bottom-0 mb-0">
									...
									<div class="oc-item">
										<img class="mt-4" src="demos/restaurant/images/items/food/7.jpg" alt="Image 3">
										<div class="food-content">
											<div class="d-flex flex-column flex-sm-row justify-content-sm-between mb-4">
												<div class="heading-block border-bottom-0 mb-0">
									...
									<div class="oc-item">
										<img class="mt-4" src="demos/restaurant/images/items/food/8.jpg" alt="Image 4">
										<div class="food-content">
											<div class="d-flex flex-column flex-sm-row justify-content-sm-between mb-4">
												<div class="heading-block border-bottom-0 mb-0">
									...
									<div class="oc-item">
										<img class="mt-4" src="demos/restaurant/images/items/food/9.jpg" alt="Image 4">
										<div class="food-content">
											<div class="d-flex flex-column flex-sm-row justify-content-sm-between mb-4">
												<div class="heading-block border-bottom-0 mb-0">
					...
					<div class="container">
						...
						<div class="row col-mb-50">
							<div class="col-sm-6 col-lg-4">
								<div class="feature-box media-box">
									<div class="fbox-media">
										<a href="demo-restaurant-reservation.php" ><img style="border-radius: 2px;" src="demos/restaurant/images/featured/1.jpg" alt="Why choose Us?"></a>
									</div>
									<div class="fbox-content px-0">
							...
							<div class="col-sm-6 col-lg-4">
								<div class="feature-box media-box">
									<div class="fbox-media">
										<a href="demo-restaurant-gallery.php" ><img style="border-radius: 2px;" src="demos/restaurant/images/featured/2.jpg" alt="Effective Planning"></a>
									</div>
									<div class="fbox-content px-0">
							...
							<div class="col-sm-6 col-lg-4">
								<div class="feature-box media-box">
									<div class="fbox-media">
										<a href="demo-restaurant-about-us.php" ><img style="border-radius: 2px;" src="demos/restaurant/images/featured/3.jpg" alt="Why choose Us?"></a>
									</div>
									<div class="fbox-content px-0">
				...
				<div class="section mb-0" style="background: #fee749 url('demos/restaurant/images/sections/4.jpg') no-repeat center right; background-size: cover; padding: 60px 0;">
					<div class="heading-block text-center mb-0 border-bottom-0">
						...
						<div class="row align-items-stretch">
							<div class="col-lg-5" style="background-color: #FFF; padding: 0; box-shadow: -4px 1px 15px 3px rgba(0,0,0,0.07);">
								<div id="dessert-menu-carousel" class="menu-carousel owl-carousel image-carousel carousel-widget customjs">
									...
									<div class="oc-item">
										<img class="mt-4" src="demos/restaurant/images/items/desserts/1.jpg" alt="Image 1">
										<div class="food-content">
											<div class="d-flex flex-column flex-sm-row justify-content-sm-between mb-4">
												<div class="heading-block border-bottom-0 mb-0">
									...
									<div class="oc-item">
										<img class="mt-4" src="demos/restaurant/images/items/desserts/2.jpg" alt="Image 2">
										<div class="food-content">
											<div class="d-flex flex-column flex-sm-row justify-content-sm-between mb-4">
												<div class="heading-block border-bottom-0 mb-0">
									...
									<div class="oc-item">
										<img class="mt-4" src="demos/restaurant/images/items/desserts/3.jpg" alt="Image 3">
										<div class="food-content">
											<div class="d-flex flex-column flex-sm-row justify-content-sm-between mb-4">
												<div class="heading-block border-bottom-0 mb-0">
									...
									<div class="oc-item">
										<img class="mt-4" src="demos/restaurant/images/items/desserts/4.jpg" alt="Image 4">
										<div class="food-content">
											<div class="d-flex flex-column flex-sm-row justify-content-sm-between mb-4">
												<div class="heading-block border-bottom-0 mb-0">
									...
									<div class="oc-item">
										<img class="mt-4" src="demos/restaurant/images/items/desserts/5.jpg" alt="Image 1">
										<div class="food-content">
											<div class="d-flex flex-column flex-sm-row justify-content-sm-between mb-4">
												<div class="heading-block border-bottom-0 mb-0">
									...
									<div class="oc-item">
										<img class="mt-4" src="demos/restaurant/images/items/desserts/6.jpg" alt="Image 2">
										<div class="food-content">
											<div class="d-flex flex-column flex-sm-row justify-content-sm-between mb-4">
												<div class="heading-block border-bottom-0 mb-0">
									...
									<div class="oc-item">
										<img class="mt-4" src="demos/restaurant/images/items/desserts/7.jpg" alt="Image 3">
										<div class="food-content">
											<div class="d-flex flex-column flex-sm-row justify-content-sm-between mb-4">
												<div class="heading-block border-bottom-0 mb-0">
									...
									<div class="oc-item">
										<img class="mt-4" src="demos/restaurant/images/items/desserts/8.jpg" alt="Image 4">
										<div class="food-content">
											<div class="d-flex flex-column flex-sm-row justify-content-sm-between mb-4">
												<div class="heading-block border-bottom-0 mb-0">
									...
									<div class="oc-item">
										<img class="mt-4" src="demos/restaurant/images/items/desserts/9.jpg" alt="Image 4">
										<div class="food-content">
											<div class="d-flex flex-column flex-sm-row justify-content-sm-between mb-4">
												<div class="heading-block border-bottom-0 mb-0">
				...
				<div class="section bg-transparent">
					<div class="d-none d-lg-block" style="background: #FFF url('demos/restaurant/images/sections/3.jpg') no-repeat center center / cover; height: 100%;position: absolute; top: 0; left: 0; width: 100%"></div>
					<div class="container">
						...
						<div class="row">
							<div class="col-lg-6 col-md-6 col-12"><img src="demos/restaurant/images/sections/1.jpg" alt="Image"></div>
							<div class="col-lg-4 col-md-6 col-12">
								<a href="demo-restaurant-about-us.php" class="button button-border button-large button-black button-dark button-rounded text-transform-none ls-0 font-primary service-button">Our Service</a>
								<img src="demos/restaurant/images/sections/2.jpg" alt="Image" class="d-none d-md-block" style="margin: 0 0 0 -80px;">
							</div>
						</div>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-lg-3 col-md-6">
								<div class="team">
									<div class="team-image imagescalein">
										<a href="demo-restaurant-about-us.php"><img src="demos/restaurant/images/chefs/1.jpg" alt="John Doe"></a>
									</div>
									<div class="team-desc">
							...
							<div class="col-lg-3 col-md-6">
								<div class="team">
									<div class="team-image imagescalein">
										<a href="demo-restaurant-about-us.php"><img src="demos/restaurant/images/chefs/2.jpg" alt="Josh Clark"></a>
									</div>
									<div class="team-desc">
										<div class="team-title">
							...
							<div class="col-lg-3 col-md-6">
								<div class="team">
									<div class="team-image imagescalein">
										<a href="demo-restaurant-about-us.php"><img src="demos/restaurant/images/chefs/3.jpg" alt="Mary Jane"></a>
									</div>
									<div class="team-desc">
										<div class="team-title">
							...
							<div class="col-lg-3 col-md-6">
								<div class="team">
									<div class="team-image imagescalein">
										<a href="demo-restaurant-about-us.php"><img src="demos/restaurant/images/chefs/4.jpg" alt="Nix Maxwell"></a>
									</div>
									<div class="team-desc">
										<div class="team-title">
				...
				<div style="background: #FFF url('demos/restaurant/images/sections/7.jpg') no-repeat top right; background-size: 100% auto; padding-top: 50px">
					<div class="container">
						...
						<div class="row posts-md col-mb-30 mb-0">
							...
							<div class="col-lg-4 col-md-6">
								<div class="entry">
									<div class="entry-image mb-0">
										<a href="demos/restaurant/images/blogs/1.jpg" data-lightbox="image"><img src="demos/restaurant/images/blogs/1.jpg" alt="Image 1"></a>
									</div>
									<div class="entry-title mt-0 p-4 title-xs text-transform-none">
										...
										<h2 class="mb-0"><a href="demo-restaurant-blog.php">Make Ahead Super Green Vegan Quinoa Sandwich.</a></h2>
									</div>
								</div>
							</div>
							...
							<div class="col-lg-4 col-md-6">
								<div class="entry">
									<div class="entry-image mb-0">
										<a href="demos/restaurant/images/blogs/2.jpg" data-lightbox="image"><img src="demos/restaurant/images/blogs/2.jpg" alt="Image 2"></a>
									</div>
									<div class="entry-title mt-0 p-4 title-xs text-transform-none">
										<div class="entry-meta mt-0 mb-2">
											<ul>
										...
										<h2 class="mb-0"><a href="demo-restaurant-blog.php">We Delivered Heart Shape Cornbread Waffles.</a></h2>
									</div>
								</div>
							</div>
							...
							<div class="col-lg-4 col-md-6">
								<div class="entry">
									<div class="entry-image mb-0">
										<a href="demos/restaurant/images/blogs/3.jpg" data-lightbox="image"><img src="demos/restaurant/images/blogs/3.jpg" alt="Image 3"></a>
									</div>
									<div class="entry-title mt-0 p-4 title-xs text-transform-none">
										<div class="entry-meta mt-0 mb-2">
											<ul>
										...
										<h2 class="mb-0"><a href="demo-restaurant-blog.php">Top Delicious Recipes from world's Best Chefs.</a></h2>
									</div>
								</div>
							</div>
					...
					<div class="row g-5">
						...
						<div class="col-lg-3 col-md-6 text-center">
							...
							<div class="d-flex justify-content-center">
								...
								<a href="#" class="social-icon border-transparent h-bg-x-twitter">
