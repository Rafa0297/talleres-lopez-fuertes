...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Blog - Travel | Canvas</title>
...
<body class="stretched">
	...
	<div id="wrapper">
					...
					<div class="header-row">
						...
						<nav class="primary-menu style-4 menu-spacing-margin">
							...
							<ul class="menu-container">
								...
								<li class="menu-item current"><a class="menu-link" href="demo-travel-blog.php"><div><i class="bi-newspaper"></i>Blog</div></a></li>
		...
		<!-- Page Title
		============================================= -->
		<section class="page-title page-title-center page-title-parallax parallax scroll-detect include-header include-topbar">
			<img src="demos/travel/images/blog/full/page-title.jpg" class="parallax-bg" style="height: 120%; top: -15%;">
			<div class="container">
		...
		<section id="content">
			<div class="content-wrap">
				...
				<div class="container">
					...
					<h4>Featured Post</h4>
					<div class="row mb-5 entry">
						<div class="col-lg-6">
							<div class="entry-image mb-0">
								<a href="#"><img src="demos/travel/images/blog/full/1.jpg" alt="Paris"></a>
							</div>
						</div>
						<div class="col-lg-6" style="margin-top: 20px;">
							...
							<div class="entry-meta">
								<ul>
									<li><i class="uil uil-schedule"></i> 16th June</li>
									<li><i class="uil uil-folder-open"></i> <a href="#">Tips</a>, <a href="#">News</a></li>
									<li><a href="#"><i class="uil uil-comments-alt"></i> 19 Comments</a></li>
									<li><a href="#"><i class="bi-newspaper"></i></a></li>
								</ul>
							</div>
							<div class="entry-content">
								<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nisi nemo animi nostrum accusantium, perferendis culpa iste est hic minima magnam, vel libero id! Quibusdam facilis debitis sequi eligendi voluptates magni ipsa, aliquid voluptatum iste vel! Facilis amet aliquam quidem explicabo et dolore distinctio enim accusamus atque, sapiente beatae odit impedit optio commodi libero est natus ducimus recusandae vero, soluta voluptas?</p>
								<a href="#" class="more-link">Read more <i class="bi-arrow-right"></i></a>
							</div>
						</div>
					</div>
					...
					<div class="row posts-md col-mb-50 mb-0">
						...
						<div class="entry col-md-6">
							<div class="grid-inner row align-items-center">
								<div class="col-lg-6">
									<div class="entry-image mb-0">
										<a href="#"><img src="demos/travel/images/blog/5.jpg" alt="Paris"></a>
									</div>
								</div>
								<div class="col-lg-6 mt-3 mt-lg-0">
						...
						<div class="entry col-md-6">
							<div class="grid-inner row align-items-center">
								<div class="col-lg-6">
									<div class="entry-image mb-0">
										<a href="#"><img src="demos/travel/images/blog/6.jpg" alt="Paris"></a>
									</div>
								</div>
								<div class="col-lg-6 mt-3 mt-lg-0">
									<span class="before-heading">Sightseeing</span>
									...
									<div class="entry-meta">
										<ul>
											<li><i class="uil uil-schedule"></i> 21th December</li>
											<li><a href="#"><i class="uil uil-comments-alt"></i> 12</a></li>
										</ul>
									</div>
									<div class="entry-content">
