...
<head>
	...
	<link href="https://fonts.googleapis.com/css2?family=Source+Sans+Pro:wght@300;400;600;700&family=Roboto:wght@300;400;500;700&family=Nunito:wght@400;600;900&display=swap" rel="stylesheet">
	...
	<!-- Document Title
	============================================= -->
	<title>Tourism - One Page Module | Canvas</title>
...
<body class="stretched">
	...
	<div id="wrapper">
		...
		<!-- Header
		============================================= -->
		<header id="header" class="full-header border-full-header transparent-header dark header-size-custom" data-sticky-class="not-dark" data-sticky-offset="full" data-sticky-offset-negative="auto" data-sticky-shrink="false">
		...
		<section id="slider" class="slider-element min-vh-100 include-header">
			...
			<div class="slider-inner" style="background: linear-gradient(to bottom, rgba(0,0,0,.2), rgba(0,0,0,.5)), url('one-page/images/page/tourism/hero.jpg') 50% 10% no-repeat; background-size: cover !important; background-attachment: fixed" data-top-top="background-position: 50% 10%;" data-top-bottom="background-position: 50% 90%;">

				<div class="container dark">
					<div class="vertical-middle ignore-header">
						<div class="d-flex">
							<div class="col-lg-6">
								<h2 class="display-3 text-uppercase ls-2 mb-3" style="font-weight: 900;">Beautiful Vietnam</h2>
								<p class="lead">Phosfluorescently scale seamless "outside the box" thinking rather than intuitive partnerships. Distinctively facilitate client-based partnerships.</p>
							</div>
						</div>
					</div>
					...
					<div class="row position-absolute d-none d-lg-flex" style="bottom: 0px; z-index: 4">
						<div class="col-md-6 col-xl-4">
							<h4><a href="#" class="text-white">Sa Pa, Vietnam <i class="bi-arrow-right" style="font-size: 13px;"></i></a><br><small class="fw-normal text-white-50 ">Terraced Rice Fields, Muong Hoa Valley</small></h4>
						</div>
						<div class="col-md-6 col-xl-4">
							<h4><a href="#" class="text-white">Hanoi City, Vietnam <i class="bi-arrow-right" style="font-size: 13px;"></i></a><br><small class="fw-normal text-white-50">Capital Of Vietnam</small></h4>
						</div>
						<div class="col-xl-4 d-none d-xl-block">
							<h4><a href="#" class="text-white">Hạ Long Bay, Vietnam <i class="bi-arrow-right" style="font-size: 13px;"></i></a><br><small class="fw-normal text-white-50">1000 of Towering Limestone Islands</small></h4>
						</div>
					</div>
				</div>
				...
				<div class="card position-absolute shadow-lg dark p-3 d-none d-lg-block" style="background: #222; width: 21rem; bottom: 0; right: 0; z-index: 5;">
					<div class="card-body">
						<h6 class="card-title text-uppercase ls-4 fw-bold mb-4 text-white-50">Recommendations</h6>
						<h5 class="h6 fw-semibold mb-4">
							<a href="#" class="text-light mb-2 d-block">Know more about Capital</a>
							<span class="fw-normal text-white-50">Hanoi, Capital Of Vietnam</span>
						</h5>
						<h5 class="h6 fw-semibold mb-4">
							<a href="#" class="text-light mb-2 d-block">Rice Field in the Town</a>
							<span class="fw-normal text-white-50">Terraced Rice Fields, Muong Hoa Valley</span>
						</h5>

						<a href="https://www.youtube.com/watch?v=P3Huse9K6Xs"  data-lightbox="iframe" class="image_fade d-block position-relative mb-4 rounded shadow-lg" style="background: url('one-page/images/tourism.jpg') center center / cover; height: 150px;">
							<i class="bi-play"></i>
						</a>

						<h5 class="h6 fw-semibold mb-0">
							<a href="#" class="text-light mb-2 d-block">Visit Dragon City</a>
							<span class="fw-normal text-white-50">1000 of Towering Limestone Islands</span>
						</h5>
					</div>
				</div>
