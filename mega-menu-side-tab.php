...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Mega Menu Side Tab | Canvas</title>
					...
					<div class="header-row">
						...
						<nav class="primary-menu with-arrows on-click">
							...
							<ul class="menu-container">
								...
								<!-- Mega Menu
								============================================= -->
								<li class="mega-menu menu-item"><a class="menu-link" href="#"><div>Side Tab <small>(on Click)</small></div></a>
									<!-- Mega Menu Content
									============================================= -->
													...
													<li class="menu-item">
														<div class="widget">
															<div class="list-group list-group-flush" id="side-tabs" role="tablist" aria-orientation="vertical">
																<a class="list-group-item border-default active" data-bs-toggle="tab" href="#mega-menu-tab-health" role="tab" aria-controls="mega-menu-tab-health" aria-selected="true"><img src="demos/news/images/posts/lifestyle/1.jpg" width="36" height="36" alt="Image" class="rounded-circle">Health / Fitness</a>
																<a class="list-group-item border-default" data-bs-toggle="tab" href="#mega-menu-tab-entertainment" role="tab" aria-controls="mega-menu-tab-entertainment" aria-selected="false"><img src="demos/news/images/posts/lifestyle/2.jpg" width="36" height="36" alt="Image" class="rounded-circle">Entertainment</a>
																<a class="list-group-item border-default" data-bs-toggle="tab" href="#mega-menu-tab-artist" role="tab" aria-controls="mega-menu-tab-artist" aria-selected="false"><img src="demos/news/images/posts/lifestyle/3.jpg" width="36" height="36" alt="Image" class="rounded-circle">Artist</a>
																<a class="list-group-item border-default" data-bs-toggle="tab" href="#mega-menu-tab-recipes" role="tab" aria-controls="mega-menu-tab-recipes" aria-selected="false"><img src="demos/news/images/posts/lifestyle/4.jpg" width="36" height="36" alt="Image" class="rounded-circle">Recipes</a>
															</div>
														</div>
													</li>
												</ul>
															...
															<div class="tab-content">
																<div class="tab-pane pt-4 pt-md-0 show active" id="mega-menu-tab-health" role="tabpanel" aria-labelledby="mega-menu-tab-health">
																	<div class="row col-mb-30">
																		...
																		<div class="col-md-4 entry mb-0">
																			<div class="entry-image mb-3">
																				<a href="#"><img src="demos/news/images/posts/lifestyle/meditation.jpg" alt="Image 3"></a>
																			</div>
																			<div class="entry-title title-xs text-transform-none">
																		...
																		<div class="col-md-4 entry mb-0">
																			<div class="entry-image mb-3">
																				<a href="#"><img src="demos/news/images/posts/lifestyle/3.jpg" alt="Image 3"></a>
																			</div>
																			<div class="entry-title title-xs text-transform-none">
																...
																<div class="tab-pane pt-4 pt-md-0" id="mega-menu-tab-entertainment" role="tabpanel" aria-labelledby="mega-menu-tab-entertainment">
																	<div class="row col-mb-30">
																		<div class="col-md-4 entry mb-0">
																			<div class="entry-image mb-3">
																				<a href="#"><img src="demos/news/images/posts/lifestyle/2.jpg" alt="Image 3"></a>
																			</div>
																			<div class="entry-title title-xs text-transform-none">
																				<h3><a href="#">A Surprising Tool to Help You Lifestyle</a></h3>
																			</div>
																		...
																		<div class="col-md-4 entry mb-0">
																			<div class="entry-image mb-3">
																				<a href="#"><img src="demos/news/images/posts/lifestyle/party.jpg" alt="Image 3"></a>
																			</div>
																			<div class="entry-title title-xs text-transform-none">
																				<h3><a href="#">Toyotas next minivan will let you.</a></h3>
																			</div>
																		...
																		<div class="col-md-4 entry mb-0">
																			<div class="entry-image mb-3">
																				<a href="#"><img src="demos/news/images/posts/lifestyle/movies.jpg" alt="Image 3"></a>
																			</div>
																			<div class="entry-title title-xs text-transform-none">
																				<h3><a href="#">Lifestyle Your Way to Success</a></h3>
																			</div>
																...
																<div class="tab-pane pt-4 pt-md-0" id="mega-menu-tab-artist" role="tabpanel" aria-labelledby="mega-menu-tab-artist">
																	<div class="row col-mb-30">
																		<div class="col-md-4 entry mb-0">
																			<div class="entry-image mb-3">
																				<a href="#"><img src="demos/news/images/posts/lifestyle/author.jpg" alt="Image 3"></a>
																			</div>
																			<div class="entry-title title-xs text-transform-none">
																				<h3><a href="#">A Surprising Tool to Help You Lifestyle</a></h3>
																			</div>
																		...
																		<div class="col-md-4 entry mb-0">
																			<div class="entry-image mb-3">
																				<a href="#"><img src="demos/news/images/posts/lifestyle/painter.jpg" alt="Image 3"></a>
																			</div>
																			<div class="entry-title title-xs text-transform-none">
																				<h3><a href="#">Toyotas next minivan will let you.</a></h3>
																			</div>
																		...
																		<div class="col-md-4 entry mb-0">
																			<div class="entry-image mb-3">
																				<a href="#"><img src="demos/news/images/posts/lifestyle/book.jpg" alt="Image 3"></a>
																			</div>
																			<div class="entry-title title-xs text-transform-none">
																				<h3><a href="#">Lifestyle Your Way to Success</a></h3>
																			</div>
																...
																<div class="tab-pane" id="mega-menu-tab-recipes" role="tabpanel" aria-labelledby="mega-menu-tab-recipes">
																	<div class="row col-mb-30">
																		<div class="col-md-4 entry mb-0">
																			<div class="entry-image mb-3">
																				<a href="#"><img src="demos/news/images/posts/lifestyle/recipes-1.jpg" alt="Image 3"></a>
																			</div>
																			<div class="entry-title title-xs text-transform-none">
																				<h3><a href="#">A Surprising Tool to Help You Lifestyle</a></h3>
																			</div>
																		...
																		<div class="col-md-4 entry mb-0">
																			<div class="entry-image mb-3">
																				<a href="#"><img src="demos/news/images/posts/lifestyle/recipes-2.jpg" alt="Image 3"></a>
																			</div>
																			<div class="entry-title title-xs text-transform-none">
																				<h3><a href="#">Toyotas next minivan will let you.</a></h3>
																			</div>
																		...
																		<div class="col-md-4 entry mb-0">
																			<div class="entry-image mb-3">
																				<a href="#"><img src="demos/news/images/posts/lifestyle/chef.jpg" alt="Image 3"></a>
																			</div>
																			<div class="entry-title title-xs text-transform-none">
																				<h3><a href="#">Lifestyle Your Way to Success</a></h3>
																			</div>
								...
								<li class="mega-menu menu-item"><a class="menu-link" href="#"><div>Help <small>(on Click)</small></div></a>
									<!-- Mega Menu Content
									============================================= -->
											...
											<div class="row justify-content-center">
												...
												<ul class="sub-menu-container mega-menu-column col-lg-4 text-lg-center menu-item-2">
													<li class="menu-item-title">
														<a class="menu-link text-black-50" href="#">Helps &amp; Supports</a>
														<ul class="sub-menu-container">
															<li class="menu-item">
																<a class="menu-link" href="#">Supports</a>
															</li>
															<li class="menu-item">
															...
															<li class="menu-item">
																<a class="menu-link" href="#">Email Us</a>
															</li>
														</ul>
													</li>
												</ul>
					...
					<div class="page-menu-row">
						...
						<nav class="page-menu-nav">
							<ul class="page-menu-container">
								...
								<li class="page-menu-item current"><a href="mega-menu-side-tab.php"><div>Side Tab + Click</div></a></li>
							</ul>
						</nav>
				...
				<div class="page-title-row">
					...
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">Mega Menu Side Tabs</li>
						</ol>
					</nav>
