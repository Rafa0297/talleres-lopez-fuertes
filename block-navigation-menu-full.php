...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Overlay Menu - Navigation | Canvas</title>
...
<body class="stretched overlay-menu block-menu-full dark">
								...
								<div class="row mx-auto mw-md">
									...
									<div class="col-lg-7">
										<ul class="menu-container">
											...
											<li class="menu-item menu-smaller mt-0 mt-lg-4">
												<a class="menu-link" href="#">
													<div>Blog</div>
												</a>
											</li>
											<li class="menu-item menu-smaller">
												<a class="menu-link" href="#">
													<div>FAQs</div>
												</a>
											</li>
									...
									<div class="col-lg-5 d-none d-lg-block">
										...
										<div class="mt-4">
											<a href="#" class="social-icon mb-0 si-small text-white border-transparent bg-facebook">
												<i class="fa-brands fa-facebook-f"></i>
												<i class="fa-brands fa-facebook-f"></i>
											</a>

											<a href="#" class="social-icon mb-0 si-small text-white border-transparent bg-x-twitter">
												<i class="fa-brands fa-x-twitter"></i>
												<i class="fa-brands fa-x-twitter"></i>
											</a>

											<a href="#" class="social-icon mb-0 si-small text-white border-transparent bg-google">
												<i class="fa-brands fa-google"></i>
												<i class="fa-brands fa-google"></i>
											</a>

											<a href="#" class="social-icon mb-0 si-small text-white border-transparent bg-pinterest">
