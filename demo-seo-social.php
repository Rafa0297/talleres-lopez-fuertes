...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Social Marketing - SEO Demo | Canvas</title>
...
<body class="stretched">
	...
	<div id="wrapper">
		...
		<section class="page-title page-title-parallax parallax scroll-detect page-title-center dark include-header include-topbar">
			<img src="demos/seo/images/servies/social-title.jpg" class="parallax-bg">
				...
				<div class="container">
					<div class="row align-items-end">
						...
						<div class="col-lg-6 mt-4 mt-lg-0">
							<img src="demos/seo/images/services/social.svg" alt="Image">
						</div>
					</div>
					...
					<div class="row mt-4 col-mb-50 mb-0">
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box">
								<div class="fbox-icon mb-4">
									<a href="#"><i class="fa-brands fa-facebook-f bg-facebook border-0"></i></a>
								</div>
								<div class="fbox-content">
									<h3 class="text-transform-none">FaceBook Marketing</h3>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box">
								<div class="fbox-icon mb-4">
									<a href="#"><i class="fa-brands fa-instagram bg-instagram border-0"></i></a>
								</div>
								<div class="fbox-content">
									<h3 class="text-transform-none">Instagram Marketing</h3>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box">
								<div class="fbox-icon mb-4">
									<a href="#"><i class="fa-brands fa-twitter bg-x-twitter border-0"></i></a>
								</div>
								<div class="fbox-content">
									<h3 class="text-transform-none">Twitter Marketing</h3>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box">
								<div class="fbox-icon mb-4">
									<a href="#"><i class="bi-envelope bg-google border-0"></i></a>
								</div>
								<div class="fbox-content">
									<h3 class="text-transform-none">Email Marketing</h3>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box">
								<div class="fbox-icon mb-4">
									<a href="#"><i class="fa-brands fa-pinterest-p bg-pinterest border-0"></i></a>
								</div>
								<div class="fbox-content">
									<h3 class="text-transform-none">Pinterest Marketing</h3>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box">
								<div class="fbox-icon mb-4">
									<a href="#"><i class="bi-file-earmark-richtext border-0"></i></a>
								</div>
								<div class="fbox-content">
									<h3 class="text-transform-none">Sales Banner</h3>
