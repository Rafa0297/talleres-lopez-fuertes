			...
			<div class="slider-inner">
				...
				<div class="vertical-middle">
					<div class="container text-center">
						<div class="inline-block pulse animated infinite"><a id="play-hero-video" href="https://vimeo.com/117770305" class="big-video-button mb-5" data-lightbox="iframe"><i class="uil uil-play"></i></a></div>
						<div class="emphasis-title mx-auto" style="max-width: 700px;">
							<h1 class="fw-light ls-1" style="font-size: 52px;">We are a Creative Media Agency with a Flare for Perfection.</h1>
						</div>
						<a href="#" class="button button-border fw-medium button-circle" data-scrollto="#section-works" data-easing="easeInOutExpo" data-speed="1250" data-offset="70">View our Works</a>
					</div>
				</div>
