    ...
    <section id="carpinteria-aluminio" class="py-5">
      <div class="container">
        ...
        <div class="text-center mb-5">
          <h2 class="fw-bold text-uppercase" style="color:#003b6f;">Mosquiteras</h2>
          <p class="lead text-muted mx-auto" style="max-width: 700px; text-align: justify">
            Las mosquiteras son una solución eficaz y discreta para proteger los espacios interiores de insectos y
            alérgenos, permitiendo la entrada de aire fresco y luz natural. Disponibles en diversos materiales y
            diseños, se adaptan a diferentes tipos de ventanas y puertas, ofreciendo comodidad y seguridad sin
            comprometer la estética del hogar.
          </p>
        </div>
        ...
        <div class="row align-items-center g-5">
          <!-- Imagen principal -->
          <div class="col-lg-6">
            <img src="demos/construction/images/products/mosquiteras/1.png" alt="Carpintería de Aluminio"
              class="img-fluid rounded shadow-sm w-100">
          </div>

          <!-- Descripción -->
          <div class="col-lg-6">
            <h3 class="fw-semibold mb-3">Protección, confort y ventilación natural</h3>
            <p>
              Nuestras mosquiteras ofrecen una solución práctica y discreta para mantener los espacios libres de
              insectos
              sin renunciar a la ventilación ni a la entrada de luz natural. Disponibles en múltiples modelos y
              acabados,
              se adaptan perfectamente a cualquier tipo de ventana o puerta.
            </p>
            <ul class="list-unstyled">
              <li><i class="fa-solid fa-check text-danger me-2"></i> Evita la entrada de insectos y polvo</li>
              <li><i class="fa-solid fa-check text-danger me-2"></i> Permite la circulación del aire sin obstáculos</li>
              <li><i class="fa-solid fa-check text-danger me-2"></i> Sistemas enrollables, correderos y fijos a medida
              </li>
            </ul>
          </div>
        ...
        <div class="row align-items-center g-5">
          <!-- Descripción -->
          <div class="col-lg-6">
            <p style="text-align: justify;">Uno de los métodos más antiguos para mantener a raya a los insectos es crear
              una barrera entre nosotros y ellos. Nuestras mosquiteras se presentan en muchas formas, tamaños y diseños.
              <br><br>
              Talleres López Fuertes fabrica las mosquiteras a medidas tanto en enrollables, plisados, fijos o
              correderas, trabajando con marcas que nos permite alcanzar grandes dimensiones. Todos nuestros diseños se
              ofrecen en una variedad de colores.
            </p>

          </div>
          <!-- Imagen secundaria -->
          <div class="col-lg-6">
            <img src="demos/construction/images/products/mosquiteras/2.jpg" alt="Carpintería de Aluminio"
              class="img-fluid rounded shadow-sm w-100">
          </div>
        ...
        <div style="margin-top: 30px;" class="container">
          ...
          <div id="portfolio" class="portfolio row gutter-20">
            ...
            <article class="portfolio-item col-12 col-sm-6 col-md-4 pf-media pf-icons">
              <div class="grid-inner">
                <div class="portfolio-image">
                  <img src="demos/construction/images/products/mosquiteras/3.jpg" alt="The Atmosphere">
                  <div class="bg-overlay">
                    <div class="bg-overlay-content dark" data-hover-animate="fadeIn">
                      <a href="demos/construction/images/products/mosquiteras/3.jpg"
            ...
            <article class="portfolio-item col-12 col-sm-6 col-md-4 pf-illustrations">
              <div class="grid-inner">
                <div class="portfolio-image">
                  <img src="demos/construction/images/products/mosquiteras/4.webp" alt="Wavelength Structure">
                  <div class="bg-overlay">
                    <div class="bg-overlay-content dark" data-hover-animate="fadeIn">
                      <a href="demos/construction/images/products/mosquiteras/4.webp"
                        class="overlay-trigger-icon bg-light text-dark" data-hover-animate="zoomIn"
                        data-hover-animate-out="zoomOut" data-hover-speed="350"><i class="uil uil-search-plus"></i></a>
                    </div>
                    <div class="bg-overlay-bg dark" data-hover-animate="fadeIn"></div>
            ...
            <article class="portfolio-item col-12 col-sm-6 col-md-4 pf-graphics pf-uielements">
              <div class="grid-inner">
                <div class="portfolio-image">
                  <img src="demos/construction/images/products/mosquiteras/5.jpg" alt="Greenhouse Garden">
                  <div class="bg-overlay">
                    <div class="bg-overlay-content dark" data-hover-animate="fadeIn">
                      <a href="demos/construction/images/products/mosquiteras/5.jpg"
                        class="overlay-trigger-icon bg-light text-dark" data-hover-animate="zoomIn"
                        data-hover-animate-out="zoomOut" data-hover-speed="350"><i class="uil uil-search-plus"></i></a>
                    </div>
                    <div class="bg-overlay-bg dark" data-hover-animate="fadeIn"></div>
