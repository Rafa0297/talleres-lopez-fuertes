...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Radios &amp; Switches | Canvas</title>
			...
			<div class="container">
				<div class="page-title-row pb-5 align-items-lg-end">
					...
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Radios &amp; Switches</li>
					</ol>
						...
						<div class="col-lg-9">
							...
							<div class="row col-mb-30">
								...
								<div class="col-12">
									...
									<div class="row">
										<div class="col-md-2 col-6">
										<input class="bt-switch" type="checkbox" checked data-on-text="<i class='bi-hand-thumbs-up'></i>" data-off-text="<i class='bi-hand-thumbs-down'></i>">
										</div>
										<div class="col-md-2 col-6">
											<input class="bt-switch" type="checkbox" checked data-on-text="<i class='bi-emoji-smile'></i>" data-off-text="<i class='bi-emoji-frown'></i>" data-on-color="info" data-off-color="danger">
										</div>
										<div class="col-md-2 col-6">
											<input class="bt-switch" type="checkbox" checked data-on-text="<i class='fa-solid fa-lock'></i>" data-off-text="<i class='fa-solid fa-unlock'></i>" data-on-color="default" data-off-color="danger">
										</div>
										<div class="col-md-2 col-6">
											<input class="bt-switch" type="checkbox" checked data-on-text="<i class='bi-envelope-open'></i>" data-off-text="<i class='bi-envelope'></i>" data-on-color="success" data-off-color="danger">
										</div>
										<div class="col-md-2 col-6">
											<input class="bt-switch" type="checkbox" checked data-on-text="<i class='bi-check-circle-fill'></i>" data-off-text="<i class='bi-x-circle'></i>" data-on-color="white" data-off-color="black">
										</div>
										<div class="col-md-2 col-6">
											<input class="bt-switch" type="checkbox" checked data-on-text="<i class='bi-check-lg'></i>" data-off-text="<i class='bi-x-lg'></i>"  data-on-color="black" data-off-color="white">
										</div>
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-12">
									<label class="d-block mb-3">Switcher inside Modal:</label>
												...
												<div class="modal-content">
													...
													<div class="modal-body section bg-transparent m-0">
														<div class="row col-mb-50">
															...
															<div class="col-sm-6">
																<div class="switch">
																	<input id="switch-toggle-12" class="switch-toggle switch-toggle-round text-center" type="checkbox">
