	...
	<div id="side-panel">
		...
		<div class="side-panel-wrap">
			...
			<div class="widget">
				...
				<a href="index.php"><img src="demos/car/images/logo@2x.png" alt="Canvas Logo" height="50"></a>
	...
	<div id="wrapper">
					...
					<div class="header-row flex-lg-row-reverse">
						...
						<nav class="primary-menu with-arrows">
							<ul class="menu-container">
								<li class="menu-item current"><a class="menu-link" href="demo-car.php"><div>Home</div></a></li>
								<!-- Mega Menu -->
								<li class="menu-item mega-menu"><a class="menu-link" href="demo-car-single.php"><div>Models</div></a>
													...
													<li class="menu-item">
														<div class="widget text-center">
															...
															<div class="owl-carousel image-carousel carousel-widget text-center" data-margin="20" data-nav="false" data-pagi="true" data-items-xs="1" data-items-sm="2" data-items-md="4" data-items-lg="6" data-items-xl="6">
																<div class="oc-item"><a href="demo-car-single.php"><img src="demos/car/images/mega-menu/1.png" alt="Car">BMW 1 Series ActiveE</a></div>
																<div class="oc-item"><a href="demo-car-single.php"><img src="demos/car/images/mega-menu/4.png" alt="Car">Mercedes-Benz S-Class</a></div>
																<div class="oc-item"><a href="demo-car-single.php"><img src="demos/car/images/mega-menu/5.png" alt="Car">Gran Turismo</a></div>
																<div class="oc-item"><a href="demo-car-single.php"><img src="demos/car/images/mega-menu/6.png" alt="Car">Mclaren 675LT SPIDER</a></div>
																<div class="oc-item"><a href="demo-car-single.php"><img src="demos/car/images/mega-menu/7.png" alt="Car">Honda City</a></div>
																<div class="oc-item"><a href="demo-car-single.php"><img src="demos/car/images/mega-menu/8.png" alt="Car">Toyota Qualis</a></div>
																<div class="oc-item"><a href="demo-car-single.php"><img src="demos/car/images/mega-menu/9.png" alt="Car">Honda WR-V</a></div>
																<div class="oc-item"><a href="demo-car-single.php"><img src="demos/car/images/mega-menu/10.png" alt="Car">Suzuki Breeza</a></div>
																<div class="oc-item"><a href="demo-car-single.php"><img src="demos/car/images/mega-menu/2.png" alt="Car">Chevrolet Spark</a></div>
																<div class="oc-item"><a href="demo-car-single.php"><img src="demos/car/images/mega-menu/3.png" alt="Car">Honda JaZZ</a></div>
								...
								<li class="menu-item"><a class="menu-link" href="demo-car-listing.php"><div>Car Listing</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-car-dealers.php"><div>Dealers</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-car-accessories.php"><div>Accessories</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-car-interiors.php"><div>Interiors</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-car-faqs.php"><div>FAQs</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-car-blog.php"><div>Blog</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-car-contact.php"><div>Contacts</div></a></li>
							</ul>
		...
		<section id="slider" class="slider-element dark swiper_wrapper" data-effect="fade" data-loop="true" data-dots="true" data-speed="1000" data-autoplay="4500" style="min-height: 650px;">
			...
			<div class="slider-text mb-5">
				...
				<a href="https://www.youtube.com/watch?v=RKD2fNVP7kw" class="play-icon shadow" data-lightbox="iframe"><i class="fa-brands fa-google-play"></i></a>
			</div>
			...
			<div id="page-menu-wrap">
				<div class="container">
					<div class="page-menu-row">
						...
						<div class="page-menu-title"><span>Porsche</span> 911 GTS Models</div>
					...
					<div class="row">
						...
						<div class="col-md-8">
							...
							<div id="section-spec" class="page-section mt-5">
								...
								<p>From March 2021, a total of five variants will be available in Germany: the 911 Carrera GTS with rear-wheel drive, the 911 Carrera 4 GTS with all-wheel drive – both of the above available as a Coupé and Cabriolet – and the 911 Targa 4 GTS with all-wheel drive.</p>
								<div class="row">
										...
										<table class="table">
											...
											<tbody>
												<tr>
													...
													<td class="text-end fw-semibold">Rear engine</td>
												</tr>
												<tr>
												...
												<tr>
													...
													<td class="text-end fw-semibold">2,981 cm³</td>
												</tr>
												<tr>
													<td scope="row" class="text-black-50">Power (kW):</td>
													<td class="text-end fw-semibold">331 kW</td>
												</tr>
												<tr>
													<td scope="row" class="text-black-50">Power (hp):</td>
													<td class="text-end fw-semibold">450 PS</td>
												</tr>
											 </tbody>
										</table>
									</div>
									...
									<div class="col-lg-6 mt-4">
										...
										<div class="d-flex justify-content-end">
											<a href="#" class="button button-rounded button-dark m-0 text-transform-none">View all Specs <i class="bi-arrow-right"></i></a>
										</div>
									</div>
								</div>
							</div>
								...
								<table class="table table-striped">
									...
									<tbody>
										<tr>
											...
											<td style="vertical-align: middle" class="fw-semibold">$2,15,600</td>
										</tr>
										<tr>
											...
											<td style="vertical-align: middle" class="fw-semibold">$2,36,809</td>
										</tr>
										<tr>
											...
											<td style="vertical-align: middle" class="fw-semibold">$2,66,606</td>
										</tr>
										<tr>
											...
											<td style="vertical-align: middle" class="fw-semibold">$2,47,225</td>
										</tr>
										<tr>
											...
											<td style="vertical-align: middle" class="fw-semibold">$3,23,153</td>
										</tr>
										<tr>
											...
											<td style="vertical-align: middle" class="fw-semibold">$3,62,538</td>
										</tr>
										<tr>
											...
											<td style="vertical-align: middle" class="fw-semibold">$4,27,675</td>
										</tr>
									 </tbody>
								</table>
							</div>
								...
								<div class="fslider flex-thumb-grid grid-6" data-animation="fade" data-speed="900" data-pagi="false" data-thumbs="true">
									<div class="flexslider">
										<div class="slider-wrap">
											<div class="slide" data-thumb="demos/car/images/single/911cars/thumbs/1.jpg">
												<img src="demos/car/images/single/911cars/1.jpg" alt="Image">
											...
											<div class="slide" data-thumb="demos/car/images/single/911cars/thumbs/2.jpg">
												<img src="demos/car/images/single/911cars/2.jpg" alt="Image">
												<div class="bg-overlay">
													<div class="bg-overlay-content justify-content-start align-items-end">
											...
											<div class="slide" data-thumb="demos/car/images/single/911cars/thumbs/3.jpg">
												<img src="demos/car/images/single/911cars/3.jpg" alt="Image">
												<div class="bg-overlay">
													<div class="bg-overlay-content justify-content-start align-items-end">
											...
											<div class="slide" data-thumb="demos/car/images/single/911cars/thumbs/4.jpg">
												<img src="demos/car/images/single/911cars/4.jpg" alt="Image">
												<div class="bg-overlay">
													<div class="bg-overlay-content justify-content-start align-items-end">
											...
											<div class="slide" data-thumb="demos/car/images/single/911cars/thumbs/5.jpg">
												<img src="demos/car/images/single/911cars/5.jpg" alt="Image">
												<div class="bg-overlay">
													<div class="bg-overlay-content justify-content-start align-items-end">
											...
											<div class="slide" data-thumb="demos/car/images/single/911cars/thumbs/6.jpg">
												<img src="demos/car/images/single/911cars/6.jpg" alt="Image">
												<div class="bg-overlay">
													<div class="bg-overlay-content justify-content-start align-items-end">
											...
											<div class="slide" data-thumb="demos/car/images/single/911cars/thumbs/7.jpg">
												<img src="demos/car/images/single/911cars/7.jpg" alt="Image">
												<div class="bg-overlay">
													<div class="bg-overlay-content justify-content-start align-items-end">
											...
											<div class="slide" data-thumb="demos/car/images/single/911cars/thumbs/8.jpg">
												<img src="demos/car/images/single/911cars/8.jpg" alt="Image">
												<div class="bg-overlay">
													<div class="bg-overlay-content justify-content-start align-items-end">
											...
											<div class="slide" data-thumb="demos/car/images/single/911cars/thumbs/9.jpg">
												<img src="demos/car/images/single/911cars/9.jpg" alt="Image">
												<div class="bg-overlay">
													<div class="bg-overlay-content justify-content-start align-items-end">
											...
											<div class="slide" data-thumb="demos/car/images/single/911cars/thumbs/10.jpg">
												<img src="demos/car/images/single/911cars/10.jpg" alt="Image">
												<div class="bg-overlay">
													<div class="bg-overlay-content justify-content-start align-items-end">
											...
											<div class="slide" data-thumb="demos/car/images/single/911cars/thumbs/11.jpg">
												<img src="demos/car/images/single/911cars/11.jpg" alt="Image">
												<div class="bg-overlay">
													<div class="bg-overlay-content justify-content-start align-items-end">
											...
											<div class="slide" data-thumb="demos/car/images/single/911cars/thumbs/12.jpg">
												<img src="demos/car/images/single/911cars/12.jpg" alt="Image">
												<div class="bg-overlay">
													<div class="bg-overlay-content justify-content-start align-items-end">
						...
						<div class="col-md-4">
							<div class="mb-4">
								<h2 class="mb-0 h1 fw-semibold ls-0">450 PS/331 kW</h2>
								<small>Power (hp)/Power (kW)</small>
							</div>
							<div class="line line-sm my-3"></div>
							<div>
								<h2 class="mb-0 fw-semibold h2 ls-0">3.6 s</h2>
								...
								<div class="card-body">
									...
									<div class="card-text d-flex justify-content-between align-items-center">
										<div>
											...
											<h4 class="mb-0 ls-1 h1 fw-bold">19</h4>
										</div>
										<div>
										...
										<div>
											...
											<h4 class="mb-0 ls-1 h1 fw-bold">24</h4>
										</div>
									</div>
								</div>
							</div>

							<img class="mt-5" src="demos/car/images/single/features.jpg" alt="Image">
							<div class="card mt-5 shadow-sm">
								<div class="card-body">
									<h3 class="card-title">Get to know On-Road-Price in your City.</h3>
									<p>Lorem ipsum dolor sit amet, consectetur adipisg elit. Perspiciatis maxime consequuntur, beatae modi corporis.</p>
									<a href="#" class="button button-rounded m-0 button-large w-100 side-panel-trigger text-center text-transform-none">On Road Price</a>
								</div>
							</div>
					...
					<div id="section-brochures" class="page-section clearix mb-5">
						...
						<div class="row">
							<div class="col-md-4 mt-5">
								<i class="i-plain bi-cloud-arrow-down inline-block mb-4" style="font-size: 42px"></i>
							...
							<div class="col-md-4 mt-5">
								<i class="i-plain bi-file-earmark inline-block mb-4" style="font-size: 42px"></i>
								<div class="heading-block border-0 mb-2">
									<h4>Via Bluetooth® - The new PCM</h4>
									<small class="subtitle text-muted">(PDF 204.92 KB)</small>
								</div>
								<p>Dynamic, comfortable and efficient – the new Porsche 911 GTS models, press release, 01/09/2021, Porsche AG</p>
								<a href="#" class="button button-rounded m-0">Download</a>
							</div>
							<div class="col-md-4 mt-5">
								<i class="i-plain bi-file-earmark-richtext-fill inline-block mb-4" style="font-size: 42px"></i>
								<div class="heading-block border-0 mb-2">
									<h4>Media Package</h4>
