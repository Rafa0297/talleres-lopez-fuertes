	...
	<div id="wrapper">
		...
		<section id="content">
			<div class="content-wrap py-0">
				...
				<div id="section-home" class="page-section bg-contrast-100">

					<div class="container">

						<h2 class="mx-auto mb-6 font-body text-center" style="max-width: 700px; font-size: 40px;">Create a website with <span>Canvas</span>. Be it Business, Portfolio, Photography, eCommerce &amp; much more.</h2>
						...
						<div id="slider-services" class="owl-carousel carousel-widget" data-margin="20" data-loop="true" data-nav="false" data-pagi="true" data-autoplay="5000" data-items-sm="1" data-items-md="2" data-items-xl="3">
							...
							<div class="intro-services text-center col-padding" style="background-color: #FFF;">
								<i class="i-plain color i-xlarge icon-et-laptop inline-block mb-3"></i>
								<div class="heading-block border-bottom-0 mb-3">
									<h4>Responsive &amp; Retina</h4>
									<p class="text-muted">Scalable on Devices.</p>
								</div>
								<div><a href="#" data-scrollto="#section-services" data-offset="70" class="button button-dark button-rounded button-small fw-semibold">View More</a></div>
							</div>

							<div class="intro-services text-center col-padding" style="background-color: #FFF;">
								<i class="i-plain color i-xlarge icon-et-book-open inline-block mb-3"></i>
								<div class="heading-block border-bottom-0 mb-3">
							...
							<div class="intro-services text-center col-padding" style="background-color: #FFF;">
								<i class="i-plain color i-xlarge icon-et-browser inline-block mb-3"></i>
								<div class="heading-block border-bottom-0 mb-3">
							...
							<div class="intro-services text-center col-padding" style="background-color: #FFF;">
								<i class="i-plain color i-xlarge icon-et-paintbrush inline-block mb-3"></i>
								<div class="heading-block border-bottom-0 mb-3">
							...
							<div class="intro-services text-center col-padding" style="background-color: #FFF;">
								<i class="i-plain color i-xlarge icon-et-envelope inline-block mb-3"></i>
								<div class="heading-block border-bottom-0 mb-3">
									<h4>AJAX Contact Form</h4>
									<p>All Forms are Perfectly Working.</p>
								</div>
								<div><a href="#" data-scrollto="#section-contact" data-offset="70" class="button button-dark button-rounded button-small fw-semibold">View More</a></div>
							</div>
