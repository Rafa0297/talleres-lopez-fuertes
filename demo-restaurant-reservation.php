...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Reservation | Canvas</title>
			...
			<div class="p-5 reservation-form rounded bg-white">
				...
				<div class="form-widget mt-4 mt-lg-0" data-loader="button">
					...
					<form class="mb-0 row" id="template-contactform" name="template-contactform" action="include/form.php" method="post">
						...
						<div class="col-sm-6 mb-3">
							<input type="text" id="template-contactform-phone" name="template-contactform-phone" value="" class="form-control border-form-control required" placeholder="Phone">
						</div>
						<div class="col-sm-6 mb-3">
						...
						<div class="col-sm-6 mb-3">
							<input type="text" id="template-contactform-date" name="template-contactform-date" value="" class="form-control border-form-control form-input-datepicker required" placeholder="Select Reservation Date">
						</div>

						<div class="col-6 mb-3">
							<select class="form-select border-0 border-bottom rounded-0" style="border-color:#999 !important;">
						...
						<div class="col-12 mb-0">
							<button class="button button-circle button-large text-white ms-0 mt-3" type="submit" id="template-contactform-submit" name="template-contactform-submit" value="submit">Reserve Now</button>
						</div>
