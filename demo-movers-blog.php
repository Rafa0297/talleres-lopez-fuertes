...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Blog - Movers Demo | Canvas</title>
					...
					<div class="header-row justify-content-between flex-row-reverse flex-lg-row">
						...
						<nav class="primary-menu with-arrows">
							...
							<ul class="menu-container">
								<li class="menu-item"><a class="menu-link" href="demo-movers.php"><div>Home</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-movers-company.php"><div>Our Company</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-movers-rates.php"><div>Rates</div></a>
									<ul class="sub-menu-container" data-class="up-lg:not-dark">
										<li class="menu-item"><a class="menu-link" href="demo-movers-rates.php"><div><i class="bi-house"></i>Home Moving</div></a></li>
										<li class="menu-item"><a class="menu-link" href="demo-movers-rates.php"><div><i class="bi-building"></i>Office Moving</div></a></li>
										<li class="menu-item"><a class="menu-link" href="demo-movers-rates.php"><div><i class="bi-globe"></i>International Moving</div></a></li>
										<li class="menu-item"><a class="menu-link" href="demo-movers-rates.php"><div><i class="fa-solid fa-paw"></i>Pet Shifting</div></a></li>
										<li class="menu-item"><a class="menu-link" href="demo-movers-rates.php"><div><i class="bi-car-front"></i>Car Shifting</div></a></li>
										<li class="menu-item"><a class="menu-link" href="demo-movers-rates.php"><div><i class="bi-truck"></i>Hire Truck</div></a></li>
									</ul>
								</li>
								<li class="menu-item"><a class="menu-link" href="demo-movers-team.php"><div>Team</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-movers-faqs.php"><div>FAQs</div></a></li>
								<li class="menu-item current"><a class="menu-link" href="demo-movers-blog.php"><div>Blog</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-movers-contact.php"><div>Contact Us</div></a></li>
							</ul>
					...
					<div class="post-grid row col-mb-30">
							...
							<div class="grid-inner card">
								...
								<div class="p-4">
									<div class="entry-title title-sm">
										<h3 class="text-transform-none ls-0 h5"><a href="blog-single.php">Rules of COVID 19</a></h3>
									</div>
						...
						<div class="entry col-lg-4 col-md-6">
							<div class="grid-inner card">
								...
								<div class="p-4">
									<div class="entry-title title-sm">
										<h3 class="text-transform-none ls-0 h5"><a href="blog-single.php">International Shipment available</a></h3>
									</div>
									<div class="entry-meta">
										<ul>
											<li><i class="uil uil-schedule"></i> 10th Feb 2021</li>
						...
						<div class="entry col-lg-4 col-md-6">
							<div class="grid-inner card">
								...
								<div class="p-4">
									<div class="entry-title title-sm">
										<h3 class="text-transform-none ls-0 h5"><a href="blog-single.php">Partnership with Amazon</a></h3>
									</div>
									<div class="entry-meta">
										<ul>
											<li><i class="uil uil-schedule"></i> 10th Feb 2021</li>
						...
						<div class="entry col-lg-4 col-md-6">
							<div class="grid-inner card">
								...
								<div class="p-4">
									<div class="entry-title title-sm">
										<h3 class="text-transform-none ls-0 h5"><a href="blog-single.php">Coronavirus: Safe and Cleaness</a></h3>
									</div>
									<div class="entry-meta">
										<ul>
											<li><i class="uil uil-schedule"></i> 10th Feb 2021</li>
						...
						<div class="entry col-lg-4 col-md-6">
							<div class="grid-inner card">
								...
								<div class="p-4">
									<div class="entry-title title-sm">
										<h3 class="text-transform-none ls-0 h5"><a href="blog-single.php">7 Tips to make Moving Home Easier for Kids</a></h3>
									</div>
									<div class="entry-meta">
										<ul>
											<li><i class="uil uil-schedule"></i> 10th Feb 2021</li>
						...
						<div class="entry col-lg-4 col-md-6">
							<div class="grid-inner card">
								...
								<div class="p-4">
									<div class="entry-title title-sm">
										<h3 class="text-transform-none ls-0 h5"><a href="blog-single.php">Long Distance or Inter - City Moving Services</a></h3>
									</div>
									<div class="entry-meta">
										<ul>
											<li><i class="uil uil-schedule"></i> 10th Feb 2021</li>
					...
					<div class="container">
						<div class="row align-items-center justify-content-center text-center my-4">
							...
							<div class="col-sm-8">
								...
								<a href="demo-movers-contact.php" class="button button-white button-light button-rounded fw-medium m-0">Get In Touch</a>
							</div>
					...
					<div class="row justify-content-between align-items-center">
						...
						<div class="col-md-6 d-md-flex flex-md-column align-items-md-end mt-4 mt-md-0">
							<div class="copyrights-menu copyright-links text-black-50">
								<a href="demo-movers-company.php">About</a>/<a href="demo-movers-rates.php">Rates</a>/<a href="demo-movers-faqs.php">FAQs</a>/<a href="demo-movers-contact.php">Contact</a>
							</div>
						</div>
					</div>
