...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>One Page with Dots Menu | Canvas</title>
...
<body class="stretched">
	...
	<div id="wrapper">
		...
		<!-- Header
		============================================= -->
		<header id="header" class="full-header transparent-header border-full-header d-none no-sticky header-size-custom">
			<div id="header-wrap">
				<div class="container">
		...
		<!-- Slider
		============================================= -->
		<section id="slider" class="slider-element slider-parallax min-vh-100">
			<div class="slider-inner" style="background-image: url('images/parallax/home/6.jpg');">

				<div class="vertical-middle slider-element-fade">
					<div class="container text-center py-5">
						<div class="emphasis-title">
							<h1 class="fw-semibold ls-4 text-uppercase mb-4" style="font-size: 48px;">Discover <span class="nocolor d-none d-md-inline-block">/</span> Create <span class="nocolor d-none d-md-inline-block">/</span> Design <span class="nocolor d-none d-md-inline-block">/</span> Publish</h1>
							<p class="lead">We are an Amazing bunch of Happy Creative People who Oozes Charm.</p>
						</div>
						<a href="#" class="button button-dark fw-normal ls-2 button-rounded" data-scrollto="#section-contact" data-easing="easeInOutExpo" data-speed="1250" data-offset="0">Get in Touch</a>
						<a href="#" class="button button-border button-rounded" data-scrollto="#section-works" data-easing="easeInOutExpo" data-speed="1250" data-offset="0">View our Works</a>
					</div>
				</div>
