...
<head>
	...
	<meta name="description" content="Create Non-Profit &amp; NGO Websites with Canvas Template. Get Canvas to build powerful websites easily with the Highly Customizable &amp; Best Selling Bootstrap Template, today.">
...
<body class="stretched">
	...
	<div id="wrapper">
				...
				<div class="container">
					<div class="header-row justify-content-lg-between">
						...
						<div class="header-misc">
							<a href="demo-nonprofit-causes-single.php" class="button button-rounded button-light"><div>Donate</div></a>
						</div>
						...
						<nav class="primary-menu with-arrows me-lg-auto">
							...
							<ul class="menu-container align-self-start">
								...
								<li class="menu-item"><a class="menu-link" href="demo-nonprofit.php"><div>Home</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-nonprofit-about.php"><div>About</div></a></li>
								<li class="menu-item current"><a class="menu-link" href="demo-nonprofit-causes.php"><div>Causes</div></a>
									<ul class="sub-menu-container">
										<li class="menu-item"><a class="menu-link" href="demo-nonprofit-causes-single.php"><div>Single Page</div></a></li>
									</ul>
								</li>
								<li class="menu-item"><a class="menu-link" href="demo-nonprofit-events.php"><div>Events</div></a></li>
		...
		<section class="page-title dark page-title-parallax parallax scroll-detect page-title-center">
			<img src="demos/nonprofit/images/cause/page-title.jpg" class="parallax-bg">
			<div class="container">
			...
			<div class="video-overlay z-1" style="background: linear-gradient(to bottom, rgba(6, 54, 57,.9), rgba(6, 54, 57,.9))"></div>
			...
			<div class="content-wrap overflow-visible">
				...
				<div class="container">
					<div class="row col-mb-30">
						...
						<div class="col-12">
							<div class="donor-img d-flex align-items-center rounded mx-auto shadow-sm w-100" style="height: 500px; background: url('demos/nonprofit/images/others/3.jpg') no-repeat center center / cover"></div>
							<div class="card bg-white border-0 text-center py-sm-4 px-sm-5 p-2 shadow-sm" style="position: absolute; top: 50%; right: 80px; transform: translateY(-50%);">
								<div class="card-body">
									...
									<a href="demo-nonprofit-causes-single.php" class="button-svg">View More</a>
								</div>
							</div>
						</div>
						...
						<div class="col-lg-4 col-md-6">
							<div class="charity-card h-shadow shadow-ts card rounded-5">
								<a href="demo-nonprofit-causes-single.php">
									<img src="demos/nonprofit/images/cause/grid/1.jpg" alt="Image" class="card-img-top">
								</a>
								<div class="px-4 py-3 charity-card-title">
									<small class="text-uppercase fw-normal ls-1 mb-2 d-block">Homeless</small>
									<h3 class="mb-3"><a href="demo-nonprofit-causes-single.php">Clean Water for All</a></h3>
								...
								<div class="p-4">
									<p class="mb-0 text-black-50">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aut atque quidem consequuntur officiis vitae illo.</p>
								</div>
							</div>
						</div>
						...
						<div class="col-lg-4 col-md-6">
							<div class="charity-card h-shadow shadow-ts card rounded-5">
								<a href="demo-nonprofit-causes-single.php">
									<img src="demos/nonprofit/images/cause/grid/2.jpg" alt="Image" class="card-img-top">
								</a>
								<div class="px-4 py-3 charity-card-title">
									<small class="text-uppercase fw-normal ls-1 mb-2 d-block">Education</small>
									<h3 class="mb-3"><a href="demo-nonprofit-causes-single.php">Education for All</a></h3>
									<div class="skill-progress mb-3" data-percent="57" style="--cnvs-progress-height: 0.25rem;">
										<div class="skill-progress-title">
											<div class="counter counter-inherit" style="font-size: 15px;">
												$<span data-from="0" data-to="76500" data-refresh-interval="10" data-speed="1100" data-comma="true"></span> Donated of $170,000
											</div>
										</div>
										<div class="skill-progress-bar">
											<div class="skill-progress-percent bg-color"></div>
						...
						<div class="col-lg-4 col-md-6">
							<div class="charity-card h-shadow shadow-ts card rounded-5">
								<a href="demo-nonprofit-causes-single.php">
									<img src="demos/nonprofit/images/cause/grid/3.jpg" alt="Image" class="card-img-top">
								</a>
								<div class="px-4 py-3 charity-card-title">
									<small class="text-uppercase fw-normal ls-1 mb-2 d-block">Food</small>
									<h3 class="mb-3"><a href="demo-nonprofit-causes-single.php">Food for Hungry</a></h3>
									<div class="skill-progress mb-3" data-percent="57" style="--cnvs-progress-height: 0.25rem;">
										<div class="skill-progress-title">
											<div class="counter counter-inherit" style="font-size: 15px;">
												$<span data-from="0" data-to="76500" data-refresh-interval="10" data-speed="1100" data-comma="true"></span> Donated of $170,000
						...
						<div class="col-lg-4 col-md-6">
							<div class="charity-card h-shadow shadow-ts card rounded-5">
								<a href="demo-nonprofit-causes-single.php">
									<img src="demos/nonprofit/images/cause/grid/4.jpg" alt="Image" class="card-img-top">
								</a>
								<div class="px-4 py-3 charity-card-title">
									<small class="text-uppercase fw-normal ls-1 mb-2 d-block">Medicine</small>
									<h3 class="mb-3"><a href="demo-nonprofit-causes-single.php">Help from Injuries</a></h3>
									<div class="skill-progress mb-3" data-percent="57" style="--cnvs-progress-height: 0.25rem;">
										<div class="skill-progress-title">
											<div class="counter counter-inherit" style="font-size: 15px;">
												$<span data-from="0" data-to="76500" data-refresh-interval="10" data-speed="1100" data-comma="true"></span> Donated of $170,000
						...
						<div class="col-lg-4 col-md-6">
							<div class="charity-card h-shadow shadow-ts card rounded-5">
								<a href="demo-nonprofit-causes-single.php">
									<img src="demos/nonprofit/images/cause/grid/5.jpg" alt="Image" class="card-img-top">
								</a>
								<div class="px-4 py-3 charity-card-title">
									<small class="text-uppercase fw-normal ls-1 mb-2 d-block">Education</small>
									<h3 class="mb-3"><a href="demo-nonprofit-causes-single.php">Donation for Children</a></h3>
									<div class="skill-progress mb-3" data-percent="57" style="--cnvs-progress-height: 0.25rem;">
										<div class="skill-progress-title">
											<div class="counter counter-inherit" style="font-size: 15px;">
												$<span data-from="0" data-to="76500" data-refresh-interval="10" data-speed="1100" data-comma="true"></span> Donated of $170,000
						...
						<div class="col-lg-4 col-md-6">
							<div class="charity-card h-shadow shadow-ts card rounded-5">
								<a href="demo-nonprofit-causes-single.php">
									<img src="demos/nonprofit/images/cause/grid/6.jpg" alt="Image" class="card-img-top">
								</a>
								<div class="px-4 py-3 charity-card-title">
									<small class="text-uppercase fw-normal ls-1 mb-2 d-block">Cloths</small>
									<h3 class="mb-3"><a href="demo-nonprofit-causes-single.php">Cloths Donate for All</a></h3>
									<div class="skill-progress mb-3" data-percent="87" style="--cnvs-progress-height: 0.25rem;">
										<div class="skill-progress-title">
											<div class="counter counter-inherit" style="font-size: 15px;">
												$<span data-from="0" data-to="31500" data-refresh-interval="10" data-speed="1100" data-comma="true"></span> Donated of $110,000
											</div>
										</div>
										<div class="skill-progress-bar">
											<div class="skill-progress-percent bg-color"></div>
			...
			<div class="container">
				...
				<div class="footer-widgets-wrap dark" style="background: radial-gradient(rgba(0,45,64,.5), rgba(0,45,64,.1), rgba(0,45,64,.5)), url('demos/nonprofit/images/others/footer.jpg') repeat center center / cover;  padding: 150px 0">
					<div class="mx-auto text-center" style="max-width: 700px;">
						...
						<a href="demo-nonprofit-causes-single.php" class="button button-rounded button-xlarge button-white bg-white button-light text-dark shadow text-transform-none ls-0 ms-0 mt-5">Donate Now</a>
					</div>
				</div>
