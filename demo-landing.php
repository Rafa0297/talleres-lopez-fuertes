...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Landing Demo | Canvas</title>
...
<body class="stretched">
	...
	<div id="wrapper">
					...
					<div class="header-row">
						...
						<nav class="primary-menu with-arrows">
							...
							<ul class="me-0 border-0 menu-container">
								<li class="menu-item"><a class="menu-link" href="demo-landing.php"><div>Home</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-landing-features.php"><div>Features</div></a>
									<ul class="sub-menu-container" data-class="up-lg:not-dark">
										<li class="menu-item"><a class="menu-link" href="demo-landing-features.php"><div><i class="bi-box"></i>Products</div></a></li>
										<li class="menu-item"><a class="menu-link" href="demo-landing-features.php"><div><i class="bi-download"></i>Downloads</div></a></li>
										<li class="menu-item"><a class="menu-link" href="demo-landing-features.php"><div><i class="fa-regular fa-life-ring"></i>Support</div></a></li>
										<li class="menu-item"><a class="menu-link" href="demo-landing-features.php"><div><i class="bi-file-earmark-richtext"></i>Documentaion</div></a></li>
										<li class="menu-item"><a class="menu-link" href="demo-landing-features.php"><div><i class="uil uil-play"></i>Tutorials</div></a></li>
										<li class="menu-item"><a class="menu-link" href="demo-landing-features.php"><div><i class="bi-flag"></i>Solutions</div></a></li>
										<li class="menu-item"><a class="menu-link" href="demo-landing-features.php"><div><i class="uil uil-search"></i>FAQs</div></a></li>
									</ul>
								</li>
								<li class="menu-item"><a class="menu-link" href="demo-landing-about.php"><div>About</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-landing-pricing.php"><div>Pricing</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-landing-contact.php"><div>Contact</div></a></li>
							</ul>
		...
		<!-- Slider
		============================================= -->
		<section id="slider" class="slider-element dark min-vh-100 include-header" style="background-image: url('demos/landing/images/hero/1.svg');">
					...
					<div class="container">
						<div class="row align-items-lg-center g-0">
							...
							<div class="col-lg-6 col-md-6">
								<h2 class="display-3 fw-bold text-white">Our Design<br>Your Business.</h2>
								<p class="lead mb-4 fw-normal">Best Wallet App for your upcoming Projects.</p>
								<div>
			...
			<div class="content-wrap pb-0">
				...
				<div class="container">
					<div class="mx-auto text-center mt-4 mb-5 heading-block" style="max-width: 640px;">
						...
						<h2 class="text-transform-none mb-4">Powerful &amp; Best Features for Canvas App</h2>
						<p class="lead fw-normal font-primary mb-5">Dynamically underwhelm end-to-end experiences for premier methodologies. Objectively benchmark front-end bandwidth vis-a-vis flexible e-services. Globally drive business convergence without backward-compatible markets.</p>
					</div>
						...
						<div class="row justify-content-around col-mb-80 mb-0">
							...
							<div class="col-md-5">
								<div class="feature-box media-box">
									...
									<div class="fbox-content">
										<h2 class="h4 fw-bold mb-4">International Transactions</h2>
						...
						<div class="row justify-content-around col-mb-80 mb-0">
							...
							<div class="col-md-5">
								<div class="feature-box media-box">
									...
									<div class="fbox-content">
										<h2 class="h4 fw-bold mb-4">Detailed Documentation</h2>
				...
				<div class="row align-items-stretch align-content-stretch g-0 mt-5">
					...
					<div class="col-md-6 order-md-2" style="background: url('demos/landing/images/section/1.jpg') center center / cover; min-height: 300px"></div>

					<div class="col-md-6 bg-color dark order-md-1">
						<div class="section-features">
							<h2 class="mb-3 h4 fw-semibold">Intrinsicly synergistic benefits.</h2>
							<p class="h6 fw-normal mb-5"> Enthusiastically morph unique web-readiness via impactful platforms. Intrinsicly matrix premium expertise for diverse expertise. Intrinsicly drive collaborative bandwidth for accurate testing.</p>

							<h2 class="mb-3 h4 fw-semibold">Appropriately target customers.</h2>
							<p class="h6 fw-normal">Energistically incentivize front-end web services via enabled collaboration and idea-sharing. Conveniently whiteboard effective niche markets before flexible ROI.</p>
							<p class="h6 fw-normal mb-5">Phosfluorescently build turnkey convergence without goal-oriented systems.</p>

							<h2 class="mb-3 h4 fw-semibold">Completely exploit focused.</h2>
							<p class="h6 fw-normal mb-0">Continually enable leveraged users after functional web-readiness. Interactively conceptualize accurate resources whereas distinctive e-markets.</p>
						</div>
					</div>
				</div>
					...
					<div class="container">
						<div class="row align-items-center">
							...
							<div class="col-lg-5 col-md-6 mb-4 mb-md-0">
								<img src="demos/landing/images/section/2.jpg" alt="Image">
							</div>

							<div class="col-md-6 offset-lg-1">
								<div class="heading-block border-bottom-0 mb-4">
									<i class="bi-file-earmark-richtext display-5 color mb-4"></i>
									<h3 class="text-transform-none ls-0">Version 7 is now 3x Faster.</h3>
								</div>
								<p class="fw-normal lead">Enthusiastically morph unique web-readiness via impactful platforms. Intrinsicly matrix premium expertise for diverse expertise. Intrinsicly drive collaborative bandwidth for accurate testing.</p>

								<div class="mb-5">
									<div class="skill-progress" data-percent="60" style="--cnvs-progress-height: 0.75rem;--cnvs-progress-rounded:0.5rem;">
										<div class="skill-progress-title d-flex justify-content-between align-items-center mb-2">
											<h4 class="mb-0">Version 7.x</h4>
											<div class="badge bg-dark">
												<div class="counter counter-inherit counter-instant"><span data-from="0" data-to="90" data-refresh-interval="30" data-speed="1100">0</span>% Optimized</div>
											</div>
										</div>
								...
								<a href="#" class="btn text-white bg-color rounded-3 px-4 py-3 fw-semibold text-uppercase shadow-sm">Learn More <i class="bi-arrow-right ms-1"></i></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="section m-0" style="padding: 100px 0; background-color: rgba(61,128,228,0.05)">
					...
					<div class="container">
						...
						<div class="heading-block mx-auto text-center" style="max-width: 500px">
							...
							<p class="h6 fw-normal text-black-50">Recusandae ducimus, sequi, sapiente possimus optio impedit efficient services. Completely promote.</p>
						</div>

					</div>

					<div class="owl-carousel owl-carousel-full image-carousel carousel-widget" data-margin="40" data-center="true" data-loop="true" data-nav="false" data-pagi="true" data-items-xs="2" data-items-sm="3" data-items-md="4" data-items-lg="4" data-items-xl="5">
				...
				<div class="section m-0 parallax" style="padding: 100px 0; background-color:rgb(61,128,228);" data-0-top="background-color:rgb(61,128,228);" data-top-bottom="background-color:rgb(0,0,0);">
					<div class="container">
						...
						<div class="row justify-content-center dark mt-5">
							<div class="col-md-7">
								<h2 class="text-center text-white mb-5 mt-4 fw-semibold">Frequently Asked Questions</h2>
					...
					<div class="container">
						<div class="row">
							<div class="col-lg-6 mb-5">
								...
								<p class="fw-normal mb-2 h6 text-muted">Enthusiastically morph unique web-readiness via impactful platforms. Intrinsicly matrix premium expertise for diverse expertise. Intrinsicly drive collaborative bandwidth for accurate testing.</p>

								<div class="row my-5">
									<div class="col-md-9">
										<div class="feature-box fbox-plain">
											<div class="fbox-icon">
												<a href="#"><i class="bi-display text-primary"></i></a>
											</div>
											<div class="fbox-content">
									...
									<div class="col-md-9">
										<div class="feature-box fbox-plain">
											<div class="fbox-icon">
												<a href="#"><i class="bi-lightbulb text-warning"></i></a>
											</div>
											<div class="fbox-content">
									...
									<div class="col-md-9">
										<div class="feature-box fbox-plain">
											<div class="fbox-icon">
												<a href="#"><i class="fa-regular fa-life-ring text-danger"></i></a>
											</div>
											<div class="fbox-content">
						...
						<div class="fslider testimonial testimonial-full text-center bg-transparent mx-auto" data-animation="fade" data-pagi="false">
							<div class="flexslider">
								<div class="slider-wrap mw-sm mx-auto">
									<div class="slide">
										<img src="demos/landing/images/clients/skype.svg" alt="Customer Testimonials">
									...
									<div class="slide">
										<img src="demos/landing/images/clients/netflix.svg" alt="Customer Testimonials">
									...
									<div class="slide">
										<img src="demos/landing/images/clients/nat-geo.svg" alt="Customer Testimonials">
					...
					<div class="row mx-auto">
						...
						<div class="col-md-8">
							<div class="row">
								...
								<div class="col-md-3 col-6 mt-4 mt-md-0">
									<div class="widget widget_links">
										...
										<h4 class="ls-0">Get to Know us</h4>
							...
							<div class="row align-items-center">
								...
								<div class="col-md-4 mt-3 mt-md-0">
									...
									<a href="#" class="social-icon si-small text-white bg-android" title="Android">
						...
						<div class="col-md-4 mt-4 mt-md-0">
							<div class="widget">
								...
								<h4 class="ls-0">From the Blog</h4>

								<article class="entry">
									<div class="entry-image mb-3">
										<a href="demo-news-single.php"><img src="demos/landing/images/blog-img.jpg" alt="Image 3"></a>
									</div>
									<div class="entry-title title-xs">
										<h3 class="mb-2"><a href="demo-news-single.php">A Surprising Tool to Help you Lifestyle</a></h3>
									</div>
									<div class="entry-desc">
										<p class="text-black-50">Quickly maintain covalent supply chains for multidisciplinary scenarios. Competently visualize.</p>
									</div>
								</article>
							</div>
						</div>
				...
				<div class="container">
					...
					<div class="row col-mb-30">
						...
						<div class="col-md-6 text-center text-md-end">
							<a href="#" class="btn color bg-white rounded px-3 py-2 text-transform-none ls-0 shadow-sm"><i class="fa-brands fa-apple me-2"></i>App Store</a>
							<a href="#" class="btn color bg-white rounded px-3 py-2 text-transform-none ls-0 shadow-sm ms-2"><i class="fa-brands fa-google-play me-2"></i>Play Store</a>
						</div>
					</div>
