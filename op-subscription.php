...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>One Page with Subscription Form | Canvas</title>

</head>

<body class="stretched side-push-panel" data-loader="9" data-loader-color="theme">
	...
	<div id="wrapper">
		...
		<section id="slider" class="slider-element slider-parallax min-vh-100 dark include-header">
			<div class="slider-inner" style="background-image: url('one-page/images/page/main.jpg');">

				<div class="vertical-middle">
					<div class="container text-center">
						<div class="subscribe-widget" data-loader="button">
							<div class="heading-block border-bottom-0 mb-4">
								<h1>Stay in Touch to get Exclusive Offers</h1>
								<span style="font-size:20px;" class="mt-0">Coupon Codes &amp; Insider Tips to get the Best out of our Products</span>
							</div>
							<div class="widget-subscribe-form-result"></div>
							<form id="slider-subscribe-form" action="include/subscribe.php" method="post" class="mb-0 mx-auto" style="max-width: 500px;">
								<input type="email" name="widget-subscribe-form-email" class="form-control form-control-lg not-dark mb-4 required" placeholder="Enter Email Address">
