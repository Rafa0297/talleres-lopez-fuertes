...
<head>
	...
	<meta name="description" content="Create Cleaner Rental Websites with Canvas Template. Get Canvas to build powerful websites easily with the Highly Customizable &amp; Best Selling Bootstrap Template, today.">
...
<body class="stretched">
	...
	<div id="wrapper">
				...
				<div class="row justify-content-between">
					<div class="col-12 col-md-auto">
						...
						<div class="top-links">
							<ul class="top-links-container">
								...
								<li class="top-links-item"><a href="login-register.php"><img src="demos/seo/images/flags/eng.png" alt="Lang">English</a>
					...
					<div class="col-12 col-md-auto">
						...
						<ul id="top-social">
							...
							<li><a href="tel:+1.11.85412542" class="h-bg-call"><span class="ts-icon"><i class="fa-solid fa-phone"></i></span><span class="ts-text">+1.111.222.333</span></a></li>
							<li><a href="mailto:noreply@canvas.com" class="h-bg-email3"><span class="ts-icon"><i class="bi-envelope-fill"></i></span><span class="ts-text">noreply@canvas.com</span></a></li>
						</ul><!-- #top-social end -->
				...
				<div class="container-fluid pe-0">
					<div class="header-row">
						...
						<div id="logo" class="col col-sm-auto">
							<a href="demo-cleaner.php">
								<img class="logo-default" srcset="demos/cleaner/images/logo.png, demos/cleaner/images/logo@2x.png 2x" src="demos/cleaner/images/logo@2x.png" alt="Canvas Logo">
							</a>
						</div><!-- #logo end -->
						...
						<div class="header-misc">
							<a href="#section-price" data-scrollto="#section-price" data-offset="60" class="button button-light text-dark fw-semibold ls-1 text-uppercase fw-bold"><i class="bi-currency-dollar me-1"></i>Cost Calculate</a>
						</div>
						...
						<nav class="primary-menu">
							...
							<ul class="menu-container border-end-0 me-0">
								<li class="menu-item active">
									<a class="menu-link ls-1 text-uppercase fw-bold" href="#"><div>Home</div></a>
								</li>
								<li class="menu-item">
									<a class="menu-link ls-1 text-uppercase fw-bold" href="#"><div>About Us</div></a>
								</li>
								<li class="menu-item">
									<a class="menu-link ls-1 text-uppercase fw-bold" href="#"><div>Services</div></a>
								</li>
								<li class="menu-item">
									<a class="menu-link ls-1 text-uppercase fw-bold" href="#"><div>FAQs</div></a>
								</li>
								<li class="menu-item">
									<a class="menu-link ls-1 text-uppercase fw-bold" href="#"><div>Contact</div></a>
								</li>
							</ul>
		...
		<!-- Slider
		============================================= -->
		<section id="slider" class="slider-element" style="background: url('demos/cleaner/images/hero.jpg') center center no-repeat; background-size: cover; height: 700px">
					...
					<div class="row py-5">
						...
						<div class="col-xl-6 col-lg-7 col-md-10">
							<div class="slider-title dark">
								<h1 class="">Busy in Work Life? Don't have Enough Time for Cleaning?</h1>
							...
							<div class="card border-0 p-3 shadow-lg" style="background-color: rgba(255,255,255,0.85)">
								<div class="form-widget card-body"  data-alert-type="inline">
									...
									<form id="form-cleaning" name="form-cleaning" action="include/form.php" method="post" class="row form-cleaning mb-0">
										...
										<div class="col-sm-6">
											<div class="input-group form-group">
												<span class="input-group-text bg-color text-white"><img src="demos/cleaner/images/icons/cleaner2.svg" alt="" width="20"></span>
										...
										<div class="col-sm-6">
											<div class="input-group form-group">
												<span class="input-group-text bg-color text-white"><i class="bi-map"></i></span>
												<input type="text" name="form-cleaning-location" id="form-cleaning-location" class="form-control required" value="" placeholder="Location">
											</div>
										</div>
										...
										<div class="col-sm-6">
											<div class="input-group form-group">
												...
												<input type="text" class="form-control cleaning-date datetimepicker-input required" name="form-cleaning-date-&-time" id="form-cleaning-date" value="Select your Date & Time">
											</div>
										</div>

										<div class="col-sm-6">
											<div class="form-group input-group">
												<span class="input-group-text bg-color text-white"><i class="bi-layers"></i></span>
												<input type="number" name="form-cleaning-area" min="200" id="form-cleaning-area" class="form-control required" value="" placeholder="Area (sqft.)">
											</div>
										</div>

										<div class="col-sm-6">
											<div class="input-group form-group">
												<span class="input-group-text bg-color text-white"><i class="bi-envelope-paper"></i></span>
												<input type="email" name="form-cleaning-email" id="form-cleaning-email" class="form-control required" value="" placeholder="Your Email">
											</div>
										</div>

										<div class="col-sm-6">
											<div class="input-group form-group">
												<span class="input-group-text bg-color text-white"><i class="bi-telephone-outbound"></i></span>
												<input type="text" name="form-cleaning-phone" id="form-cleaning-phone" class="form-control required" value="" placeholder="Contact Number">
											</div>
										</div>

										<input type="text" class="d-none" id="form-cleaning-botcheck" name="form-cleaning-botcheck" value="">
										...
										<div class="col-12">
											<button type="submit" name="form-cleaning-submit" class="btn btn-lg bg-color text-white fw-semibold w-100 mt-2">Book Now</button>
										</div>
					...
					<div class="row justify-content-center col-mb-50">
						<div class="col-md-4">
							<div class="feature-box mx-0 fbox-small fbox-center border-0">
								...
								<h2 class="mt-4 h5 mb-3 text-transform-none fw-semibold ls-0"><span>1.</span> Book your Cleaner &amp; Time</h2>
								<p>Seamlessly e-enable value-added deliverables and progressive models. Enthusiastically whiteboard fully tested channels.</p>
						...
						<div class="col-md-4">
							<div class="feature-box mx-0 fbox-small fbox-center border-0">
								...
								<p>Credibly enable market positioning resources after principle-centered customer service. Competently negotiate interdependent.</p>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="feature-box mx-0 fbox-small fbox-center border-0">
								...
								<p>Quickly disintermediate multidisciplinary relationships via functional e-tailers. Collaboratively grow cutting-edge information without.</p>
							</div>
						</div>
					</div>
				</div>
				...
				<div id="section-price" class="section mb-0 mt-6" style="padding-bottom: 100px; overflow: visible">
					...
					<div class="container">
						<div class="form-widget">
							<div class="form-result"></div>
							<form id="cleaner-form" name="cleaner-form" action="include/form.php" method="post" class="cleaner-form mb-0"  enctype="multipart/form-data">
								<div class="form-process"></div>
								<div class="row gutter-40">
									<div class="col-lg-8">
										<div class="heading-block border-bottom-0">
											<h2 class="mb-3 text-transform-none ls-0">Cleaning Cost Calculator</h2>
											<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sed voluptate vero esse ea hic quod veniam quam accusamus laboriosam ipsam provident.</p>
										</div>

										<div class="row">
											<div class="col-md-6 form-group">
												<label for="cleaner-form-area" class="mb-3">Select Area:</label><br>
												<input id="cleaner-form-area" name="cleaner-form-area" class="clean-area required input-range-slider">
											</div>

											<div class="col-md-6 form-group">
												<label for="cleaner-form-rooms" class="mb-3">Select Rooms:</label><br>
												<input id="cleaner-form-rooms" name="cleaner-form-rooms" class="clean-rooms required input-range-slider">
											</div>

											<div class="col-md-6 form-group">
												<label for="cleaner-form-bathrooms" class="mb-3">Select Bathrooms:</label><br>
												<input id="cleaner-form-bathrooms" name="clean-form-bathrooms" class="clean-bathrooms required input-range-slider">
											</div>

											<div class="col-md-6 form-group">
												<label for="cleaner-form-livingrooms" class="mb-3">Select Living Rooms:</label><br>
												<input id="cleaner-form-livingrooms" name="clean-form-livingrooms" class="clean-livingrooms required input-range-slider">
											</div>

											<div class="col-12 form-group mb-4">
												<label class="mb-3">Others Requirment: <small class="text-transform-none ls-0 text-black-50">(Select Multiples)*</small></label><br>
												<div class="btn-group w-100" role="group">
													<input type="checkbox" name="clean-form-others[]" class="btn-check" id="clean-form-others-clean-garden" data-price="4" autocomplete="off" value="Clean Garden">
													<label for="clean-form-others-clean-garden" class="btn btn-outline-secondary px-4 fw-semibold ls-0 text-transform-none">Clean Garden</label>

													<input type="checkbox" name="clean-form-others[]" class="btn-check" id="clean-form-others-play-room" data-price="5" autocomplete="off" value="Play Room">
													<label for="clean-form-others-play-room" class="btn btn-outline-secondary px-4 fw-semibold ls-0 text-transform-none">Play Room</label>

													<input type="checkbox" name="clean-form-others[]" class="btn-check" id="clean-form-others-garage" data-price="5.4" autocomplete="off" value="Garage">
													<label for="clean-form-others-garage" class="btn btn-outline-secondary px-4 fw-semibold ls-0 text-transform-none">Garage</label>

													<input type="checkbox" name="clean-form-others[]" class="btn-check" id="clean-form-others-gym" data-price="4.2" autocomplete="off" value="Gym">
													<label for="clean-form-others-gym" class="btn btn-outline-secondary px-4 fw-semibold ls-0 text-transform-none">Gym</label>
												</div>
											</div>

											<div class="col-md-6 form-group mb-4">
												<label for="clean-form-name">Name:</label>
												<input type="text" name="clean-form-name" id="clean-form-name" class="form-control required" value="" placeholder="Enter your Full Name">
											</div>
											<div class="col-6 form-group mb-4">
												<label for="clean-form-email">Email:</label>
												<input type="email" name="clean-form-email" id="clean-form-email" class="form-control required" value="" placeholder="Enter your Email">
											</div>

											<div class="col-12">
												<label for="clean-form-message">Additional Message <small class="text-transform-none ls-0 text-black-50">(Optional):</small></label>
												<textarea name="clean-form-message" id="clean-form-message" class="form-control" cols="30" rows="6"></textarea>
											</div>
									...
									<div class="col-lg-4 mt-4 mt-md-0">
										<div class="card text-center border-0 shadow-sm">
											...
											<div class="card-body py-4">
												...
												<button type="submit" name="clean-form-submit" class="button button-rounded button-light button-large second-bg-color text-dark w-100 ls-0 m-0">Book Now</button>
											</div>
										</div>
										...
										<div class="toggle">
											...
											<div class="toggle-content text-black-50">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Assumenda, dolorum, vero ipsum molestiae minima odio quo voluptate illum excepturi quam cum voluptates doloribus.</div>
										</div>
					...
					<div class="container">
						<div class="row justify-content-between align-items-center">
							...
							<div class="col-lg-6 col-md-7">
								...
								<div id="oc-testi" class="owl-carousel testimonials-carousel carousel-widget card" data-margin="10" data-nav="false" data-pagi="true" data-items="1" data-autoplay="5000" data-loop="true">
									<div class="card-body p-4">
										<div class="row">
											...
											<div class="col">
												<h4 class="fw-normal">Holisticly iterate world-class niches before best-of-breed initiatives. Seamlessly optimize goal-oriented outsourcing before low-risk high-yield processes. Uniquely deploy extensive networks for leading-edge models.</h4>
									...
									<div class="card-body p-4">
										<div class="row">
											<div class="col-auto">
												<a href="#"><img class="rounded-circle" src="images/testimonials/2.jpg" alt="Customer Testimonails"></a>
											</div>
											<div class="col">
				...
				<div class="footer-widgets-wrap">
					...
					<div class="row">
						<div class="col-6 col-lg-4">
							...
							<p class="text-white-50">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cumque repellat possimus sapiente officiis alias, eius libero fugiat ex error tempore.</p>
							<div class="d-flex">
								<a href="#" class="social-icon bg-white bg-opacity-25 border-transparent rounded-circle si-small h-bg-facebook">
									<i class="fa-brands fa-facebook-f"></i>
									<i class="fa-brands fa-facebook-f"></i>
								</a>
								<a href="#" class="social-icon bg-white bg-opacity-25 border-transparent rounded-circle si-small h-bg-x-twitter">
									<i class="fa-brands fa-x-twitter"></i>
									<i class="fa-brands fa-x-twitter"></i>
								</a>
								<a href="#" class="social-icon bg-white bg-opacity-25 border-transparent rounded-circle si-small h-bg-youtube">
									<i class="fa-brands fa-youtube"></i>
									<i class="fa-brands fa-youtube"></i>
								</a>
								<a href="#" class="social-icon bg-white bg-opacity-25 border-transparent rounded-circle si-small h-bg-appstore">
