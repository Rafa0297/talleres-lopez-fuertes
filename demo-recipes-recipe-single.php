...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Recipe Single - Recipes | Canvas</title>
		...
		<section id="slider" class="slider-element dark parallax include-header" style="background: #111 url('demos/recipes/images/recipe-single.jpg') center center / cover; padding: 230px 0;" data-0="background-position:0px -200px;" data-400="background-position:0px -100px;">
			...
			<div class="container">
				<div class="mx-auto text-center" style="max-width: 800px">
					<h3 class="text-transform-none fw-bold mb-5 display-4" data-animate="zoomIn">Spinach Artichoke Dip Pasta with Chicken</h3>
				</div>
						...
						<div class="card-body px-4">
							<div class="row align-items-center justify-content-between py-3">
								<div class="col-12 col-xl">
									<div class="row justify-content-center col-mb-30">
										<div class="col-4 col-md">
											<h6 class="text-black-50 text-uppercase font-body fw-normal ls-1 mb-1">Energy</h6>
											<h4 class="mb-0">2635</h4>
										</div>

										<div class="col-4 col-md">
											<h6 class="text-black-50 text-uppercase font-body fw-normal ls-1 mb-1">Calories</h6>
											<h4 class="mb-0">700</h4>
										</div>

										<div class="col-4 col-md">
											<h6 class="text-black-50 text-uppercase font-body fw-normal ls-1 mb-1">Sugar</h6>
											<h4 class="mb-0">12gm</h4>
										</div>

										<div class="col-4 col-md">
											<h6 class="text-black-50 text-uppercase font-body fw-normal ls-1 mb-1">Fat</h6>
											<h4 class="mb-0">7gm</h4>
										</div>

										<div class="col-4 col-md">
											<h6 class="text-black-50 text-uppercase font-body fw-normal ls-1 mb-1">Carbs</h6>
											<h4 class="mb-0">82gm</h4>
										</div>

										<div class="col-4 col-md">
											<h6 class="text-black-50 text-uppercase font-body fw-normal ls-1 mb-1">Protein</h6>
								...
								<div class="col-12 text-center col-xl-auto mt-5 mt-xl-0">
									<a href="#" class="button button-circle m-0"><i class="bi-cloud-download"></i> Download</a>
								</div>
							</div>
							...
							<div class="row justify-content-between mt-5 mb-4">
								<div class="col-lg-4">
									<div class="d-flex justify-content-between align-items-center mb-4">
										...
										<a href="javascript:window.print()" id="print-button" class="social-icon si-small text-white bg-print" title="Print">
									...
									<h4>Share:</h4>
									<a href="#" class="social-icon si-small text-light bg-facebook" title="Facebook">
										<i class="fa-brands fa-facebook-f"></i>
										<i class="fa-brands fa-facebook-f"></i>
									</a>
									<a href="#" class="social-icon si-small text-light bg-x-twitter" title="Twitter">
										<i class="fa-brands fa-x-twitter"></i>
										<i class="fa-brands fa-x-twitter"></i>
									</a>
									<a href="#" class="social-icon si-small text-light bg-pinterest" title="Pinterest">
										<i class="fa-brands fa-pinterest-p"></i>
										<i class="fa-brands fa-pinterest-p"></i>
									</a>
									<a href="#" class="social-icon si-small text-light bg-instagram" title="Instagram">
										<i class="bi-instagram"></i>
										<i class="bi-instagram"></i>
									</a>
									<a href="#" class="social-icon si-small text-white bg-email3" title="Email">
												...
												<div id="comment-1" class="comment-wrap">
													...
													<div class="comment-content">
														...
														<div class="comment-author">Gunther David<span><a href="#" title="Permalink to this comment">April 24, 2012 at 10:46 am</a></span>
															<small class="comment-ratings text-muted mt-2"><i class="bi-star-fill"></i><i class="bi-star-fill"></i><i class="bi-star-fill"></i><i class="bi-star-fill"></i><i class="bi-star-fill"></i> </small></div>
											...
											<li class="comment byuser comment-author-_smcl_admin even thread-odd thread-alt depth-1" id="li-comment-2">
												...
												<div id="comment-2" class="comment-wrap">
													...
													<div class="comment-content">
														...
														<div class="comment-author"><a href='https://themeforest.net/user/semicolonweb' rel='external nofollow' class='url'>John Doe</a><span><a href="#" title="Permalink to this comment">April 25, 2012 at 1:03 am</a></span><small class="comment-ratings text-muted mt-2"><i class="bi-star-fill"></i><i class="bi-star-fill"></i><i class="bi-star-fill"></i><i class="bi-star-fill"></i><i class="bi-star-fill-half2"></i> </small></div>
										...
										<div id="respond">
											...
											<form class="row" action="#" method="post" id="commentform">
												...
												<div class="col-md-4 form-group">
													<label class="text-transform-none ls-0 fw-normal" for="author">Name</label>
													<input type="text" name="author" id="author" value="" size="22" tabindex="1" class="form-control form-control-pill">
												</div>

												<div class="col-md-4 form-group">
													<label class="text-transform-none ls-0 fw-normal" for="email">Email</label>
													<input type="text" name="email" id="email" value="" size="22" tabindex="2" class="form-control form-control-pill">
												</div>

												<div class="col-md-4 form-group">
													<label class="text-transform-none ls-0 fw-normal" for="rating">Rating</label>
												...
												<div class="col-12 form-group">
													<label class="text-transform-none ls-0 fw-normal" for="comment">Comment</label>
