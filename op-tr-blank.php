...
<body class="stretched side-push-panel">
	...
	<div id="wrapper">
		...
		<section id="slider" class="slider-element">
			...
			<div class="section m-0 border-0 overflow-hidden" style="padding: 120px 0;">
					...
					<div class="emphasis-title">
						...
						<h1>
							<span class="text-rotater nocolor" data-separator="|" data-rotate="fadeIn" data-speed="6000">
								<span class="t-rotate fw-bold font-body opm-medium-word">canvas.|different.|onepage.|design.</span>
							</span>
						</h1>
					</div>

					<a href="#" class="button button-border button-circle fw-normal" data-scrollto="#section-works" data-easing="easeInOutExpo" data-speed="1250" data-offset="70">View Our Works</a>
