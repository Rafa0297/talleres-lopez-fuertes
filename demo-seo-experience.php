...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>SEO Experience - SEO Demo | Canvas</title>
...
<body class="stretched">
	...
	<div id="wrapper">
				...
				<div class="container">
					<div class="header-row">
						...
						<div class="header-misc">
							...
							<a href="demo-seo-optimizations.php" class="button button-rounded ms-3 d-none d-sm-block">Get Started</a>
		...
		<section class="page-title page-title-parallax parallax scroll-detect page-title-center dark include-header include-topbar">
			<img src="demos/seo/images/services/experience-title.jpg" class="parallax-bg">
				...
				<div class="page-title-row">
					...
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">SEO Experience</li>
						</ol>
					</nav>
				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6">
							...
							<h2 class="display-4 fw-bold">SEO Experience.</h2>
							...
							<a href="demo-seo-optimizations.php" class="button button-rounded button-large text-transform-none ls-0">Get Started</a>
						...
						<div class="col-lg-6 mt-4 mt-lg-0">
							<img src="demos/seo/images/services/experience.svg" alt="Image">
						</div>
					</div>
					...
					<div class="row mt-4 col-mb-50 mb-0">
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box">
								...
								<div class="fbox-content">
									<h3 class="text-transform-none">Originality &amp; Quality</h3>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box">
								<div class="fbox-icon mb-4">
									<a href="#"><i class="bi-book-reader bg-primary border-0"></i></a>
								</div>
								<div class="fbox-content">
									<h3 class="text-transform-none">Readability</h3>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box">
								<div class="fbox-icon mb-4">
									<a href="#"><i class="bi-fonts bg-danger border-0"></i></a>
								</div>
								<div class="fbox-content">
									<h3 class="text-transform-none">Keyword Density</h3>
