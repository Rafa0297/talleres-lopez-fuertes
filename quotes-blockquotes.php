...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Quotes &amp; Blockquotes | Canvas</title>
			...
			<div class="container">
				<div class="page-title-row pb-5 align-items-lg-end">
					...
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Quotes &amp; Blockquotes</li>
					</ol>
					...
					<div class="row justify-content-center">
						<div class="col-lg-9">
							...
							<blockquote>
								...
								<footer class="blockquote-footer">John Doe, Google Inc.</footer>
							</blockquote>
							...
							<blockquote class="quote blockquote-reverse mb-0">
								<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Harum, maiores esse temporibus accusantium quas soluta quis sed rerum. Sapiente, culpa fugit sit est laboriosam odit.</p>
								<footer class="blockquote-footer">John Doe, Google Inc.</footer>
							</blockquote>
