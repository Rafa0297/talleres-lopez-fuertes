...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Single Causes - NonProfit Demo | Canvas</title>
...
<body class="stretched">
	...
	<div id="wrapper">
				...
				<div class="container">
					<div class="header-row justify-content-lg-between">
						...
						<div class="header-misc">
							<a href="#" class="button button-rounded button-light"><div>Donate</div></a>
						</div>
		...
		<section class="page-title dark page-title-parallax parallax scroll-detect page-title-center">
			<img src="demos/nonprofit/images/cause/grid/1.jpg" class="parallax-bg">
			<div class="container">
							...
							<div class="single-post mb-0">
								...
								<div class="entry">
									...
									<div class="entry-image mb-0">
										<a href="#"><img src="demos/nonprofit/images/cause/grid/1.jpg" alt="Blog Single"></a>
									</div><!-- .entry-image end -->

									<div class="card bg-color-light rounded-1 my-4">
										<div class="card-body py-4 px-5">
											<div class="d-flex justify-content-between">
												<div class="counter counter-inherit d-flex justify-content-between">
													<strong class="me-1 ls-0">Donated:</strong> $<span data-from="0" data-to="115700" data-refresh-interval="10" data-speed="1100" data-comma="true"></span>
												</div>
												<span><strong>Target:</strong> $210,000</span>
											</div>
											<div class="skill-progress pt-3 mb-0" data-percent="81" style="--cnvs-progress-height: 0.5rem; --cnvs-progress-trackcolor: #FFF;">
												<div class="d-flex align-items-center">
													<div class="skill-progress-bar flex-fill">
														<div class="skill-progress-percent bg-color"></div>
													</div>

													<div class="badge bg-white text-dark ms-4">
														<div class="counter counter-inherit counter-instant"><span data-from="0" data-to="81" data-refresh-interval="10" data-speed="1100" data-comma="true">00</span>%</div>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="entry-content mt-0">
										...
										<p><img src="demos/nonprofit/images/cause/grid/3.jpg" alt="Image" class="alignright" width="360">Integer posuere erat a ante venenatis dapibus posuere velit aliquet. Cras mattis consectetur purus sit amet fermentum. Donec id elit non mi porta gravida at eget metus.</p>
								...
								<!-- Comments
								============================================= -->
								<div id="comments" class="border-0">
									...
									<div id="respond">
										...
										<form class="row" action="#" method="post" id="commentform">
											...
											<div class="col-12 form-group">
												<button name="submit" type="submit" id="submit-button" tabindex="5" value="Submit" class="button button-rounded button-border text-transform-none ls-0 fw-normal border-color m-0">Submit Comment</button>
											</div>
										</form>
			...
			<div class="container">
				...
				<div class="footer-widgets-wrap dark" style="background: radial-gradient(rgba(0,45,64,.5), rgba(0,45,64,.1), rgba(0,45,64,.5)), url('demos/nonprofit/images/others/footer.jpg') repeat center center / cover;  padding: 150px 0">
					<div class="mx-auto text-center" style="max-width: 700px;">
						...
						<a href="#" class="button button-rounded button-xlarge button-white bg-white button-light text-dark shadow text-transform-none ls-0 ms-0 mt-5">Donate Now</a>
					</div>
				</div>
