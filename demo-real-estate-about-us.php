...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>About Us - Real Estate | Canvas</title>
...
<body class="stretched side-push-panel">
	...
	<div id="wrapper">
		...
		<section class="page-title page-title-parallax dark page-title-center include-header include-topbar parallax scroll-detect">
			<img src="demos/real-estate/images/about-us/page-title.jpg" class="parallax-bg">
			<div class="container">
			...
			<div class="content-wrap mb-0 pb-0">
				...
				<div class="container">
					...
					<div class="row g-5 mb-6">
						<div class="col-md-4">
							<div class="card">
								<img class="card-img-top" src="demos/real-estate/images/hero/3.jpg" alt="Card image cap">
						...
						<div class="col-md-4">
							<div class="card">
								<img class="card-img-top" src="demos/real-estate/images/about-us/2.jpg" alt="Card image cap">
								<div class="card-body p-4">
						...
						<div class="col-md-4">
							<div class="card">
								<img class="card-img-top" src="demos/real-estate/images/items/6.jpg" alt="Card image cap">
								<div class="card-body p-4">
					...
					<div class="container">
						<div class="row mw-100">
							...
							<div class="col-md-6 ms-auto">
								<img src="demos/real-estate/images/about-us/3.jpg" alt="Image">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row col-mb-50 mb-0">
						...
						<div class="col-lg-6 col-12">
							...
							<div class="team team-list row align-items-center g-4">
								...
								<div class="col-sm-6">
									<div class="team-desc">
										<div class="team-title"><h4>Weir Doe</h4><span>Property Consultant</span></div>
						...
						<div class="col-lg-6 col-12">
							...
							<div class="team team-list row align-items-center g-4">
								...
								<div class="col-sm-6">
									<div class="team-desc">
										<div class="team-title"><h4>Nix Maxwell</h4><span>Director / License</span></div>
										<div class="team-content mt-4">
						...
						<div class="col-lg-6 col-12">
							...
							<div class="team team-list row align-items-center g-4">
								<div class="col-sm-6">
									<div class="team-image">
										<img src="images/team/2.jpg" alt="John Doe" class="rounded-6">
									</div>
								</div>
								<div class="col-sm-6">
									<div class="team-desc">
										<div class="team-title"><h4>Piff Jenkins</h4><span>Senior Property Manager</span></div>
										<div class="team-content mt-4">
						...
						<div class="col-lg-6 col-12">
							...
							<div class="team team-list row align-items-center g-4">
								<div class="col-sm-6">
									<div class="team-image">
										<img src="images/team/8.jpg" alt="Nix Maxwell" class="rounded-6">
									</div>
								</div>
								<div class="col-sm-6">
									<div class="team-desc">
										<div class="team-title"><h4>Pelican Steve</h4><span>Office Administrator</span></div>
										<div class="team-content mt-4">
				...
				<div class="section mb-0" style="background-color: #fef6f3">
					...
					<div class="container">
						...
						<ul class="clients-grid row  grid-border mb-0">
							<li class="col-4 col-md-2 col-padding" style="padding: 20px;"><a href="#" class="op-09"><img src="demos/real-estate/images/builders/1.png" alt="Clients"></a></li>
							<li class="col-4 col-md-2 col-padding" style="padding: 20px;"><a href="#" class="op-09"><img src="demos/real-estate/images/builders/2.png" alt="Clients"></a></li>
							<li class="col-4 col-md-2 col-padding" style="padding: 20px;"><a href="#" class="op-09"><img src="demos/real-estate/images/builders/3.png" alt="Clients"></a></li>
							<li class="col-4 col-md-2 col-padding" style="padding: 20px;"><a href="#" class="op-09"><img src="demos/real-estate/images/builders/4.png" alt="Clients"></a></li>
							<li class="col-4 col-md-2 col-padding" style="padding: 20px;"><a href="#" class="op-09"><img src="demos/real-estate/images/builders/1.png" alt="Clients"></a></li>
							<li class="col-4 col-md-2 col-padding" style="padding: 20px;"><a href="#" class="op-09"><img src="demos/real-estate/images/builders/2.png" alt="Clients"></a></li>
							<li class="col-4 col-md-2 col-padding" style="padding: 20px;"><a href="#" class="op-09"><img src="demos/real-estate/images/builders/3.png" alt="Clients"></a></li>
							<li class="col-4 col-md-2 col-padding" style="padding: 20px;"><a href="#" class="op-09"><img src="demos/real-estate/images/builders/4.png" alt="Clients"></a></li>
