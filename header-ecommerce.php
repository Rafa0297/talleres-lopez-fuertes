...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Header - eCommerce | Canvas</title>
...
<body class="stretched">
	...
	<div id="wrapper">
			...
			<div class="container">
				...
				<div class="row justify-content-between">
					<div class="col-12 col-md-auto">
						...
						<div class="top-links on-click">
							<ul class="top-links-container">
								...
								<li class="top-links-item"><a href="contact.php">Shipping</a></li>
								<li class="top-links-item"><a href="index.php">Offers</a></li>
								<li class="top-links-item"><a href="login-register.php">Returns</a>
					...
					<div class="col-12 col-md-auto">
						...
						<div class="top-links">
							<ul class="top-links-container">
								<li class="top-links-item"><a href="index.php"><i class="fa-solid fa-phone me-2"></i>+1-800-4349</a>
								<li class="top-links-item"><a href="index.php">USD</a>
									<ul class="top-links-sub-menu">
										<li class="top-links-item"><a href="about.php">EUR</a></li>
										<li class="top-links-item"><a href="faqs.php">INR</a></li>
										<li class="top-links-item"><a href="contact.php">GBP</a></li>
										<li class="top-links-item"><a href="sitemap.php">THB</a></li>
									</ul>
								</li>
								<li class="top-links-item"><a href="index.php">EN</a>
									<ul class="top-links-sub-menu">
										<li class="top-links-item"><a href="about.php">ES</a></li>
										<li class="top-links-item"><a href="faqs.php">DE</a></li>
										<li class="top-links-item"><a href="sitemap.php">TH</a></li>
									</ul>
								</li>
							</ul>
						</div>
		...
		<header id="header" class="bg-light">
			<div class="container">
				<div class="header-row flex-column flex-lg-row justify-content-between justify-content-lg-start">
					...
					<div class="header-misc ms-0">
						...
						<div id="top-cart" class="header-misc-icon d-none d-sm-block ms-3">
							<a href="#" id="top-cart-trigger"><i class="bi-bag"></i><span class="top-cart-number">5</span></a>
					...
					<div class="header-shop-search mx-auto col" style="max-width: 650px;">
						<form action="" class="mb-0">
							<div class="input-group">
								<input type="text" class="form-control rounded-pill border-3 px-4" aria-label="Text input with dropdown button" style="border-top-right-radius: 0 !important; border-bottom-right-radius: 0 !important;" placeholder="Search Products..">
								<button class="btn btn-dark rounded-pill border-width-3" type="button" style="border-top-left-radius: 0 !important; border-bottom-left-radius: 0 !important; margin-left: -3px;"><i class="uil uil-search"></i></button>
							</div>
						</form>
					</div>
			...
			<div id="header-wrap" class="border-top border-f5">
				<div class="container">
					<div class="header-row">
						...
						<!-- Primary Navigation
						============================================= -->
						<nav class="primary-menu order-lg-first order-last">

							<ul class="menu-container">
								<li class="menu-item">
									<a class="menu-link bg-dark text-light p-3 px-4" href="index.php"><div>Categories <i class="bi-list ms-2 me-0"></i></div></a>
						...
						<nav class="primary-menu with-arrows ms-lg-4 order-lg-first order-last">
							...
							<ul class="menu-container">
								<li class="menu-item">
									<a class="menu-link p-3" href="index.php"><div>All</div></a>
								</li>
								<li class="menu-item">
									<a class="menu-link p-3" href="index.php"><div>Men</div></a>
								</li>
								<li class="menu-item">
									<a class="menu-link p-3" href="index.php"><div>Women</div></a>
								</li>
								<li class="menu-item">
									<a class="menu-link p-3" href="index.php"><div>Kids</div></a>
								</li>
								<li class="menu-item">
									<a class="menu-link p-3" href="index.php"><div>Beauty</div></a>
								</li>
							</ul>

						</nav><!-- #primary-menu end -->

						<a href="#" class="btn btn-sm btn-dark rounded-pill px-4 py-2 ms-auto">Browse Offers</a>
