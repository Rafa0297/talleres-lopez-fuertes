...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>One Page Canvas Slider Fade | Canvas</title>
...
<body class="stretched">
	...
	<div id="wrapper">
		...
		<section id="slider" class="slider-element slider-parallax swiper_wrapper min-vh-100 include-header" data-loop="true" data-speed="1000" data-effect="fade">
				...
				<div class="swiper swiper-parent">
					<div class="swiper-wrapper">
						<div class="swiper-slide dark">
							...
							<div class="swiper-slide-bg" style="background-image: url('one-page/images/page/slider-1.jpg');"></div>
						</div>
						<div class="swiper-slide dark">
							<div class="container">
								<div class="slider-caption slider-caption-center">
						...
						<div class="swiper-slide dark">
							...
							<div class="swiper-slide-bg" style="background-image: url('one-page/images/page/slider-2.jpg'); background-position: center top;"></div>
						</div>
					</div>
