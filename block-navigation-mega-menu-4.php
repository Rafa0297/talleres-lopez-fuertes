												...
												<div class="mega-menu-column col-lg-8 py-4 py-lg-5">
													<div class="row">
														...
														<div class="col-xl-4 hover-opacity">
															...
															<div class="row pt-3">
																<div class="mb-5 col-12">
																	<a href="forms.php" class="feature-box mx-0">
													...
													<div class="posts-sm row pt-3">
															...
															<div class="grid-inner row align-items-center g-0">
																<div class="col-auto">
																	<div class="entry-image">
																		<a href="demo-blog.php"><img src="demos/news/images/posts/travel/small/1.jpg" alt="Image"></a>
																	</div>
																</div>
																<div class="col ps-3">
																	<div class="entry-title">
																		<h4 class="fw-medium"><a class="text-dark" href="demo-blog.php">Rules not to Follow about Travel</a></h4>
																	</div>
																	<div class="entry-meta">
																		<ul>
																			<li><i class="bi-person text-smaller text-dark position-relative" style="top: -1px"></i><a href="demo-blog.php">Jim Séchen</a></li>
																		</ul>
																	</div>
																</div>
															</div>
														...
														<div class="entry col-12">
															<div class="grid-inner row align-items-center g-0">
																<div class="col-auto">
																	<div class="entry-image">
																		<a href="demo-blog.php"><img src="demos/news/images/posts/travel/small/2.jpg" alt="Image"></a>
																	</div>
																</div>
																<div class="col ps-3">
																	<div class="entry-title">
																		<h4 class="fw-medium"><a class="text-dark" href="demo-blog.php">Can You Pass The Travel Test?</a></h4>
																	</div>
																	<div class="entry-meta">
																		<ul>
																			<li><i class="bi-person text-smaller text-dark position-relative" style="top: -1px"></i><a href="demo-blog.php">Alex Doe</a></li>
																		</ul>
																	</div>
																</div>
															</div>
														...
														<div class="entry col-12">
															<div class="grid-inner row align-items-center g-0">
																<div class="col-auto">
																	<div class="entry-image">
																		<a href="demo-blog.php"><img src="demos/news/images/posts/travel/small/4.jpg" alt="Image"></a>
																	</div>
																</div>
																<div class="col ps-3">
																	<div class="entry-title">
																		<h4 class="fw-medium"><a class="text-dark" href="demo-blog.php">Cheaper/Faster Travel than You Ever Imagined</a></h4>
																	</div>
																	<div class="entry-meta">
																		<ul>
																			<li><i class="bi-person text-smaller text-dark position-relative" style="top: -1px"></i><a href="demo-blog.php">Joss Sticks</a></li>
																		</ul>
																	</div>
																</div>
															</div>
