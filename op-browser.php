...
<body class="stretched side-push-panel" data-loader="4" data-loader-color="#666">
	...
	<div id="wrapper">
		...
		<!-- Header
		============================================= -->
		<header id="header" class="transparent-header dark header-size-custom" data-sticky-shrink="false" data-sticky-class="not-dark" data-sticky-offset="100">
			<div id="header-wrap">
				<div class="container">
		...
		<section id="slider" class="slider-element include-header h-auto">
			...
			<div class="section dark m-0 border-0 pb-0 overflow-hidden">
				...
				<div class="container">
					...
					<div class="emphasis-title border-bottom-0 mb-4 text-center">
						<h1 class="text-transform-none fw-light">Create a Website for the Next Web.</h1>
					</div>

					<div class="w-100 mb-5 text-center">
						<a href="#" class="button button-circle button-3d button-amber fw-normal border-bottom-0" data-class="up-md:button-large">Start Tour</a>
						<a href="#" class="button button-circle button-3d button-green fw-normal border-bottom-0 pulse infinite animated" data-class="up-md:button-large">Register</a>
					</div>
					...
					<div class="position-relative" data-height-xl="415" data-height-lg="342" data-height-md="262" data-height-sm="160" data-height-xs="102">
						<img src="one-page/images/page/chrome.png" style="position: absolute; top: 0; left: 0;" data-animate="fadeInUp" alt="Chrome">
