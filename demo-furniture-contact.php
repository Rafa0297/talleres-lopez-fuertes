...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Contact - Furniture | Canvas</title>
					...
					<div class="header-row justify-content-lg-between">
						...
						<nav class="primary-menu with-arrows order-lg-1 order-last px-0">
							...
							<ul class="menu-container">
								...
								<li class="menu-item current"><a class="menu-link" href="demo-furniture-contact.php">
									<div>Contact</div>
								</a></li>
							</ul>
			...
			<div class="content-wrap py-0">
				...
				<div class="section bg-transparent my-0 py-0">
					<div class="container-fluid">
						...
						<!-- 1. Section Map -->
						<div class="row align-items-center custom-bg" style="--custom-bg: var(--cnvs-themecolor)">
							<!-- Map -->
							...
							<div class="col-md-6 p-5 p-lg-6">
								...
								<div class="row col-mb-50">
									...
									<div class="col-12 col-lg-12">
										...
										<a href="https://twitter.com/__semicolon" target="_blank" class="social-icon si-small rounded-circle text-white bg-x-twitter">
											<i class="fa-brands fa-x-twitter"></i>
											<i class="fa-brands fa-x-twitter"></i>
										</a>
										<a href="https://youtube.com/c/SemiColonweb/videos" target="_blank" class="social-icon si-small rounded-circle text-white bg-youtube">
				...
				<!-- 6. Section Instagram
				============================================= -->
				<div class="section custom-bg my-0 py-1" style="--custom-bg: var(--cnvs-themecolor);">
