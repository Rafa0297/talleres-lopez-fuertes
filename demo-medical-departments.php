					...
					<div class="header-row">
						...
						<nav class="primary-menu style-3 menu-spacing-margin">
							...
							<ul class="menu-container">
								...
								<li class="menu-item current"><a class="menu-link" href="demo-medical-departments.php"><div>Departments</div></a></li>
								...
								<li class="menu-item"><a class="menu-link" href="demo-medical-blog.php"><div>Blog</div></a></li>
			...
			<div class="content-wrap">
				<div class="container">
					...
					<ul class="nav canvas-tabs tabs nav-tabs mb-3" id="canvas-tab" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" data-bs-toggle="pill" role="tab" href="#tab-1"><i class="icon-medical-i-cardiology"></i> Health Care</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" data-bs-toggle="pill" role="tab" href="#tab-2"><i class="icon-medical-i-surgery"></i> Outpatient Surgery</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" data-bs-toggle="pill" role="tab" href="#tab-3"><i class="icon-medical-i-dental"></i> Dentist</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" data-bs-toggle="pill" role="tab" href="#tab-4"><i class="icon-medical-ophthalmology"></i> Ophthalmology Clinic</a>
						</li>
					</ul>
					...
					<div id="canvas-TabContent" class="tab-content">
						<div class="tab-pane show active" id="tab-1" role="tabpanel" aria-labelledby="canvas-tab-1" tabindex="0">
							...
							<div class="row">
								<div class="col-lg-4">
									<h4 class="ms-4">Treatements</h4>
									<ul class="price-table ms-4 mb-0">
										<li>
									...
									<a href="#" class="more-link ms-4 mb-4">View Full Services→</a>
								</div>
								<div class="col-lg-4">
									<h4 class="ms-4">Therapists</h4>
									<ul class="price-table ms-4 mb-0">
										<li>
											<span>Tummy Tuck</span>
								...
								<div class="col-lg-4">
									<img src="demos/medical/images/section-bg.jpg" alt="Image">
								</div>
							</div>
						</div>
						<div class="tab-pane" id="tab-2" role="tabpanel" aria-labelledby="canvas-tab-2" tabindex="0">
							...
							<div class="row col-mb-50 mb-0">
								<div class="col-lg-6">
									...
									<div class="team team-list row align-items-center">
										<div class="team-image col-sm-6">
											<img src="demos/medical/images/doctors/1.jpg" alt="John Doe">
										</div>
								...
								<div class="col-lg-6">
									<div class="team team-list row align-items-center">
										<div class="team-image col-sm-6">
											<img src="demos/medical/images/doctors/4.jpg" alt="Nix Maxwell">
										</div>
										<div class="team-desc col-sm-6">
						...
						<div class="tab-pane" id="tab-3" role="tabpanel" aria-labelledby="canvas-tab-3" tabindex="0">
							<div class="row col-mb-50">
								<div class="col-lg-7">
									<div class="masonry-thumbs row row-cols-4 grid-container" data-big="4" data-lightbox="gallery">
										<a class="grid-item" href="demos/medical/images/gallery/1.jpg" data-lightbox="gallery-item"><img src="demos/medical/images/gallery/thumbs/1.jpg" alt="Gallery Thumb 1"></a>
										<a class="grid-item" href="demos/medical/images/gallery/2.jpg" data-lightbox="gallery-item"><img src="demos/medical/images/gallery/thumbs/2.jpg" alt="Gallery Thumb 2"></a>
										<a class="grid-item" href="demos/medical/images/gallery/3.jpg" data-lightbox="gallery-item"><img src="demos/medical/images/gallery/thumbs/3.jpg" alt="Gallery Thumb 3"></a>
										<a class="grid-item" href="demos/medical/images/gallery/4.jpg" data-lightbox="gallery-item"><img src="demos/medical/images/gallery/thumbs/4.jpg" alt="Gallery Thumb 4"></a>
										<a class="grid-item" href="demos/medical/images/gallery/5.jpg" data-lightbox="gallery-item"><img src="demos/medical/images/gallery/thumbs/5.jpg" alt="Gallery Thumb 5"></a>
										<a class="grid-item" href="demos/medical/images/gallery/6.jpg" data-lightbox="gallery-item"><img src="demos/medical/images/gallery/thumbs/6.jpg" alt="Gallery Thumb 6"></a>
										<a class="grid-item" href="demos/medical/images/gallery/7.jpg" data-lightbox="gallery-item"><img src="demos/medical/images/gallery/thumbs/7.jpg" alt="Gallery Thumb 7"></a>
										<a class="grid-item" href="demos/medical/images/gallery/9.jpg" data-lightbox="gallery-item"><img src="demos/medical/images/gallery/thumbs/9.jpg" alt="Gallery Thumb 9"></a>
										<a class="grid-item" href="demos/medical/images/gallery/10.jpg" data-lightbox="gallery-item"><img src="demos/medical/images/gallery/thumbs/10.jpg" alt="Gallery Thumb 10"></a>
										<a class="grid-item" href="demos/medical/images/gallery/11.jpg" data-lightbox="gallery-item"><img src="demos/medical/images/gallery/thumbs/11.jpg" alt="Gallery Thumb 11"></a>
										<a class="grid-item" href="demos/medical/images/gallery/12.jpg" data-lightbox="gallery-item"><img src="demos/medical/images/gallery/thumbs/12.jpg" alt="Gallery Thumb 12"></a>
										<a class="grid-item" href="demos/medical/images/gallery/13.jpg" data-lightbox="gallery-item"><img src="demos/medical/images/gallery/thumbs/13.jpg" alt="Gallery Thumb 13"></a>
										<a class="grid-item" href="demos/medical/images/gallery/14.jpg" data-lightbox="gallery-item"><img src="demos/medical/images/gallery/thumbs/14.jpg" alt="Gallery Thumb 14"></a>
									</div>
								</div>
								<div class="col-lg-5">
						...
						<div class="tab-pane" id="tab-4" role="tabpanel" aria-labelledby="canvas-tab-4" tabindex="0">
							<div class="row">
								...
								<div class="col-md-4">
									...
									<a href="#" class="more-link ms-4">View Full Services→</a>
								</div>
							</div>
						</div>
