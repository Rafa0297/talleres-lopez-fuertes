...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Style Boxes | Canvas</title>
			...
			<div class="container">
				<div class="page-title-row pb-5 align-items-lg-end">
					...
					<div class="page-title-content">
						<h1>Style Boxes</h1>
						<span>Alert your Customers</span>
					...
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Style Boxes</li>
					</ol>
					...
					<div class="row justify-content-center">
						<div class="col-lg-9">
							...
							<div class="style-msg2 style-msg-light" style="background-color: #444;">
								<div class="msgtitle"><i class="bi-newspaper"></i>Just a Custom Color Option:</div>
								<div class="sb-msg">
									<ul>
										<li>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sequi, adipisci.</li>
										<li>Placeat, et hic pariatur fugiat autem earum facere necessitatibus fuga.</li>
							...
							<div class="alert alert-warning">
							  <i class="bi-exclamation-diamond-fill"></i><strong>Warning!</strong> Better check yourself, you're not looking too good.
							</div>
							...
							<h3>Bootstrap Alerts - Bordered</h3>

							<div class="alert bg-transparent text-success border-success">
							  <i class="bi-boxes"></i><strong>Well done!</strong> You successfully read this important alert message.
							</div>
							<div class="alert bg-transparent text-info border-info">
							  <i class="bi-hand-index"></i><strong>Heads up!</strong> This alert needs your attention, but it's not super important.
							</div>
							<div class="alert bg-transparent text-warning border-warning">
							  <i class="bi-exclamation-diamond-fill"></i><strong>Warning!</strong> Better check yourself, you're not looking too good.
							</div>
