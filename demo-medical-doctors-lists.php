					...
					<div class="header-row">
						...
						<nav class="primary-menu style-3 menu-spacing-margin">
							...
							<ul class="menu-container">
								...
								<li class="menu-item current"><a class="menu-link" href="demo-medical-doctors.php"><div>Doctors</div></a>
							...
							<div class="team team-list row align-items-center">
								...
								<div class="team-desc col-md">
									...
									<div class="team-content">
										<p>Carbon emissions reductions giving, legitimize amplify non-partisan Aga Khan. Policy dialogue assessment free-speech cornerstone disruptor empower.</p>
									</div>
						...
						<div class="col-12">
							<div class="team team-list row align-items-center">
								...
								<div class="team-desc col-md">
									...
									<a href="#" class="social-icon rounded-circle si-small text-white bg-instagram">
