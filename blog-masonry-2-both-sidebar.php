...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Blog - Masonry 2 Columns Both Sidebar | Canvas</title>
						...
						<main class="postcontent col-lg-6">
							...
							<div id="posts" class="post-grid row grid-container gutter-30">
								...
								<div class="entry col-sm-6 col-12">
									<div class="grid-inner">
										<div class="entry-image">
											<div class="masonry-thumbs grid-container row row-cols-5" data-big="3" data-lightbox="gallery">
								...
								<div class="entry col-sm-6 col-12">
									<div class="grid-inner">
										...
										<div class="entry-meta">
											<ul>
												<li><i class="uil uil-schedule"></i> 3rd Apr 2021</li>
												<li><a href="blog-single.php#comments"><i class="uil uil-comments-alt"></i> 21</a></li>
												<li><a href="#"><i class="uil uil-images"></i></a></li>
											</ul>
										</div>
