...
<body class="stretched">
	...
	<div id="wrapper">
					...
					<div class="header-row">
						...
						<div class="header-misc ms-lg-auto">
							...
							<form class="input-group m-0 border-bottom me-4 search-form">
								...
								<a href="#" class="input-group-text border-0 bg-transparent pe-0"><i class="uil uil-search"></i></a>
							</form>
		...
		<!-- Hero Section
		============================================= -->
		<section id="slider" class="slider-element include-header block-slider-1 swiper_wrapper overflow-visible min-vh-100" data-loop="true">
			<div class="swiper swiper-parent">
				<div class="swiper-wrapper">
					<div class="swiper-slide dark">
						...
						<div class="swiper-slide-bg" style="background-image: url('images/blocks/preview/slider-1/1.jpg');"></div>
					</div>
					...
					<div class="swiper-slide dark">
						...
						<div class="swiper-slide-bg" style="background-image: url('images/blocks/preview/slider-1/2.jpg');"></div>
					</div>
					...
					<div class="swiper-slide dark">
						...
						<div class="swiper-slide-bg" style="background-image: linear-gradient(rgba(0,0,0,.3), rgba(0,0,0,.5)), url('images/blocks/preview/slider-1/3.jpg');"></div>
					</div>
				</div>
			...
			<div class="d-flex flex-row position-absolute z-10" style="top: auto; bottom: 40px; left: 40px;">
				<a href="#" class="social-icon mx-1 bg-dark si-small h-bg-facebook" data-animate="bounceInLeft">
					<i class="fa-brands fa-facebook-f"></i>
					<i class="fa-brands fa-facebook-f"></i>
				</a>

				<a href="#" class="social-icon mx-1 bg-dark si-small h-bg-instagram" data-animate="bounceInLeft" data-delay="100">
					<i class="bi-instagram"></i>
					<i class="bi-instagram"></i>
				</a>

				<a href="#" class="social-icon mx-1 bg-dark si-small h-bg-x-twitter" data-animate="bounceInLeft" data-delay="200">
