...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Rates - Coworking | Canvas</title>
					...
					<div class="header-row">
						...
						<nav class="primary-menu">
							...
							<ul class="menu-container">
								...
								<li class="menu-item current"><a class="menu-link" href="demo-coworking-price.php"><div>Rates</div></a></li>
			...
			<div class="content-wrap pb-0">
				...
				<div class="container mb-4">
					...
					<div class="row justify-content-center text-center">
						<div class="col-md-6">
							<h2 class="display-4 text-dark fw-semibold ls--2"><span>Free</span> Trail for 1 Day in Our Workspace.</h2>
							<p class="text-dark">Progressively syndicate user-centric schemas without front-end synergy. Monotonectally envisioneer.</p>
							<a href="demo-coworking-single.php" class="button button-rounded button-large m-0 text-center fw-medium text-transform-none ls-0 fw-normal">Book your Free Trail Now</a>
						</div>
					</div>
				</div>
				...
				<div class="section">
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-md-11 mt-5 offset-md-1 mt-6">
