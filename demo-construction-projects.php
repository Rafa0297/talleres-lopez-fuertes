		...
		<section id="content">
			<div class="content-wrap">
				<div class="container">
					...
					<h2 class="text-center ls-1 mb-5">Some of Our Esteemed Projects:</h2>
				...
				<a href="#" class="button button-3d border-bottom-0 button-full text-center fw-light font-primary mt-5 footer-stick" style="font-size: 26px;">
					<div class="container">
