			...
			<div class="row justify-content-center bg-white align-items-center" style="min-height: 380px;">
				...
				<div class="col-md-7 bg-white p-4">
					<div class="heading-block border-bottom-0 mb-3">
						<h3 class="font-secondary text-transform-none ">Join Our Newsletter &amp; Get <span class="text-danger">40%</span> Off your First Order</h3>
				...
				<div class="container">
					<div class="header-row justify-content-lg-between">
						...
						<div id="logo" class="me-lg-4">
							<a href="demo-shop.php">
								<img class="logo-default" srcset="demos/shop/images/logo.png, demos/shop/images/logo@2x.png 2x" src="demos/shop/images/logo@2x.png" alt="Canvas Logo">
							</a>
						</div><!-- #logo end -->
												...
												<ul class="sub-menu-container mega-menu-column border-start-0 col-lg-3">
													<li class="menu-item mega-menu-title"><a class="menu-link" href="#"><div>Footwear</div></a>
														<ul class="sub-menu-container">
															...
															<li class="menu-item"><a class="menu-link" href="#"><div>Show all <i class="uil uil-angle-right-b"></i></div></a></li>
														</ul>
													</li>
								...
								<div class="product-image">
									...
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											...
											<a href="demos/shop/ajax/shop-item.php" class="btn btn-dark" data-lightbox="ajax"><i class="bi-eye"></i></a>
										</div>
								...
								<div class="product-image">
									...
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="demos/shop/ajax/shop-item-no-stock.php" class="btn btn-dark" data-lightbox="ajax">Quick View</a>
										</div>
										<div class="bg-overlay-bg bg-transparent"></div>
									</div>
								</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-6 offset-1 mb-6 d-flex flex-column align-self-center">
								...
								<div class="mt-3">
									<a href="#" class="button bg-appstore inline-block button-small button-rounded button-desc fw-normal ls-1"><i class="fa-brands fa-apple"></i><div><span>Download Canvas Shop</span>App Store</div></a>
									<a href="#" class="button inline-block button-small button-rounded button-desc button-light text-dark fw-normal ls-1 bg-white border"><i class="fa-brands fa-google-play"></i><div><span>Download Canvas Shop</span>Google Play</div></a>
								</div>
							</div>
							...
							<div class="widget">
								...
								<div class="widget subscribe-widget mt-2">
									...
									<form id="widget-subscribe-form" action="include/subscribe.php" method="post" class="mt-1 mb-0 d-flex">
										<input type="email" id="widget-subscribe-form-email" name="widget-subscribe-form-email" class="form-control form-control required email rounded-0" placeholder="Enter your Email Address">

										<button class="button text-transform-none fw-normal ms-1 my-0" type="submit">Subscribe Now</button>
									</form>
								</div>
