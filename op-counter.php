...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>One Page with Hero Counter | Canvas</title>
	...
	<div id="wrapper">
		...
		<section id="slider" class="slider-element slider-parallax min-vh-100 include-header">
			<div class="slider-inner">
				...
				<div class="vertical-middle text-center position-absolute slider-element-fade">
					<div class="container">
						<div class="counter text-center opm-large-counter"><span data-from="1500" data-to="2021" data-refresh-interval="100" data-speed="5000"></span></div>
					</div>
				</div>
				...
				<div class="vertical-middle text-center position-absolute slider-element-fade">
					<div class="container">
						<div class="emphasis-title mb-0">
							<h1 class="text-uppercase fw-semibold" style="font-size: 72px; letter-spacing: 15px;">New Age: Agency</h1>
							<p class="lead mb-0">Your One Stop Solution Center for all Your Design &amp; Branding Needs.</p>
						</div>
					</div>
				</div>
