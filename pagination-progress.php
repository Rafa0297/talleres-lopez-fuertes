...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Paginations &amp; Progress Bars | Canvas</title>
			...
			<div class="container">
				<div class="page-title-row pb-5 align-items-lg-end">
					...
					<div class="page-title-content">
						<h1>Paginations &amp; Progress Bars</h1>
					...
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Paginations &amp; Progress Bars</li>
					</ol>
				...
				<div class="container">
					...
					<div class="row justify-content-center">
						<div class="col-lg-9">
							...
							<ul class="pagination pagination-circle pagination-3d pagination-sm">
							  <li class="page-item disabled"><a class="page-link" href="#" aria-label="Previous"> <span aria-hidden="true">&laquo;</span></a></li>
							  <li class="page-item active"><a class="page-link" href="#">1</a></li>
							  <li class="page-item"><a class="page-link" href="#">2</a></li>
							  <li class="page-item"><a class="page-link" href="#">3</a></li>
							...
							<h3>Paginations - Bootstrap Colors</h3>

							<ul class="pagination pagination-circle pagination-primary">
							  <li class="page-item disabled"><a class="page-link" href="#" aria-label="Previous"> <span aria-hidden="true">&laquo;</span></a></li>
							  <li class="page-item active"><a class="page-link" href="#">1</a></li>
							  <li class="page-item"><a class="page-link" href="#">2</a></li>
							  <li class="page-item"><a class="page-link" href="#">3</a></li>
							...
							<ul class="pagination pagination-circle pagination-3d pagination-success">
							  <li class="page-item disabled"><a class="page-link" href="#" aria-label="Previous"> <span aria-hidden="true">&laquo;</span></a></li>
							  <li class="page-item active"><a class="page-link" href="#">1</a></li>
							  <li class="page-item"><a class="page-link" href="#">2</a></li>
							  <li class="page-item"><a class="page-link" href="#">3</a></li>
							...
							<ul class="pagination pagination-rounded pagination-3d pagination-info">
							  <li class="page-item disabled"><a class="page-link" href="#" aria-label="Previous"> <span aria-hidden="true">&laquo;</span></a></li>
							  <li class="page-item active"><a class="page-link" href="#">1</a></li>
							  <li class="page-item"><a class="page-link" href="#">2</a></li>
							  <li class="page-item"><a class="page-link" href="#">3</a></li>
							...
							<h3>Paginations - Transparent Inside</h3>

							<ul class="pagination pagination-inside-transparent pagination-lg">
							...
							<div class="line"></div>
							<h3>Paginations - Transparent Pill</h3>
							...
							<ul class="pagination pagination-inside-transparent pagination-pill pagination-sm">
							  <li class="page-item"><a class="page-link" href="#" tabindex="-1" aria-disabled="true">Previous</a></li>
							  <li class="page-item"><a class="page-link" href="#">1</a></li>
							  <li class="page-item active"><a class="page-link" href="#">2</a></li>
							  <li class="page-item"><a class="page-link" href="#">3</a></li>
							...
							<div class="line"></div>
							<h3>Paginations - Transparent Buttons</h3>

							<ul class="pagination pagination-rounded pagination-inside-transparent pagination-button pagination-lg">
							  <li class="page-item"><a class="page-link" href="#" tabindex="-1" aria-disabled="true">Previous</a></li>
							  <li class="page-item"><a class="page-link" href="#">1</a></li>
							  <li class="page-item active"><a class="page-link" href="#">2</a></li>
							  <li class="page-item"><a class="page-link" href="#">3</a></li>
							...
							<h3>Paginations - Transparent Text</h3>

							<ul class="pagination pagination-inside-transparent pagination-lg">
							  <li class="page-item disabled"><a class="page-link text-muted" href="#" tabindex="-1" aria-disabled="true">Previous</a></li>
							  <li class="page-item disabled"><a class="page-link" href="#">1 <span class="px-1">OF</span> 3</a></li>
							  <li class="page-item"><a class="page-link" href="#">Next</a></li>
							</ul>
							...
							<div class="progress mb-2">
							  <div class="progress-bar bg-warning" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 60%">
								<span class="visually-hidden">60% Complete (warning)</span>
							  </div>
							</div>
							<div class="progress mb-2">
							...
							<div class="progress mb-2">
							  <div class="progress-bar progress-bar-striped bg-info" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: 20%">
								<span class="visually-hidden">20% Complete</span>
							  </div>
							</div>
							<div class="progress mb-2">
							...
							<div class="progress mb-2">
							  <div class="progress-bar progress-bar-striped bg-danger" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 80%">
								<span class="visually-hidden">80% Complete (danger)</span>
							  </div>
							</div>
							...
							<div class="progress">
							  <div class="progress-bar bg-success" style="width: 35%">
								<span class="visually-hidden">35% Complete (success)</span>
							  </div>
							  <div class="progress-bar bg-warning" style="width: 20%">
								<span class="visually-hidden">20% Complete (warning)</span>
							  </div>
							  <div class="progress-bar bg-danger" style="width: 10%">
								<span class="visually-hidden">10% Complete (danger)</span>
							  </div>
							</div>
