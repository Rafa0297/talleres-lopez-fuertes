...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Holiday - One Page Module | Canvas</title>
...
<body class="stretched">
	...
	<div id="wrapper">
		...
		<section id="slider" class="slider-element slider-parallax min-vh-100 dark include-header">
			<div class="slider-inner" style="background: url('one-page/images/page/5.jpg') bottom center no-repeat; background-size: cover;">

				<div class="vertical-middle">
					<div class="container">

						<div class="emphasis-title mb-0">
							<h1 class="fw-bold text-uppercase ls-3 mb-4" style="font-family: 'Montserrat', sans-serif;">Start <span class="text-lowercase" style="font-family: 'Playfair Display'; font-style: italic; color: #FFF;">With</span> <br><span class="text-rotater nocolor" data-separator="|" data-rotate="fadeInLeft" data-speed="4000">
								<span class="t-rotate">Canvas.|Different.|OnePage.|Digital.|Flexibility.|Features.</span>
							</span></h1>
							<div class="inline-block"><a id="play-hero-video" href="https://vimeo.com/117770305" class="big-video-button small-video-button pulse animated infinite" data-lightbox="iframe"><i class="uil uil-play"></i></a><span style="font-size:20px; margin-left:15px;">Play Video</span></div>
						</div>
