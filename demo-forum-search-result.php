...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Search Result - Forums / Community | Canvas</title>
				...
				<div class="page-title-row">
					...
					<div class="page-title-content w-100">
						...
						<div class="input-group input-group-lg mt-2 mb-4 mw-sm mx-auto my-4">
							<input class="form-control rounded-start border-0 fw-semibold" type="search" placeholder="Search Your Topics.." aria-label="Search" value="Navigation">
							<button class="btn border-0 bg-white rounded-end h-bg-alt" type="submit"><i class="uil uil-search"></i></button>
						</div>

						<div>
							<a href="demo-forum-single.php" class="button button-large bg-alt py-2 rounded-1 fw-medium text-transform-none ls-0 ms-0">Browse All Topics</a>
							<a href="#" class="button button-large bg-alt py-2 rounded-1 fw-medium text-transform-none ls-0 ms-0 ms-sm-1">Create A New Topic</a>
						</div>
					</div>
							...
							<li>
								<ul class="topic list-unstyled row mx-0 justify-content-between align-items-center border-top-0">
									<li class="entry mb-0 col-12">
										<h3 class="mb-0"><a href="#">Package Generator – Approx time for a file</a></h3>
								...
								<ul class="topic odd list-unstyled row mx-0 justify-content-between align-items-center">
									<li class="entry mb-0 col-12">
										<h3 class="mb-0"><a href="#">Open sub-menu touching menu-item name, instead of sub-menu-trigger only (mobile)</a></h3>
										<div class="entry-meta mt-1">
											<ul>
