...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Yoga - One Page Module | Canvas</title>
...
<body class="stretched side-push-panel">
	...
	<div id="wrapper">
		...
		<!-- Slider
		============================================= -->
		<section id="slider" class="slider-element slider-parallax min-vh-100 include-header" style="background: #FFF url('one-page/images/page/yoga/slider-bg.png') no-repeat right top / auto 100%;">
					...
					<div class="row align-items-center mt-4 h-100">
						<div class="col-md-6 order-2 order-md-1 my-5 my-md-0 text-center text-md-start">
							<div class="heading-block border-bottom-0 mb-4">
								<h5 class="text-uppercase ls-4 text-black-50 fw-light mb-2" data-animate="fadeInUp" data-delay="100">Health &amp; Meditation</h5>
								<h2 class="fw-bold text-transform-none" data-animate="fadeInUp" data-delay="200" style="font-size: 48px; letter-spacing: -1px;">Yoga is the perfect opportunity to be curious about who you are.</h2>
							</div>
							<p class="mb-5 lead" data-animate="fadeInUp" data-delay="400" style="line-height: 1.7;">Monotonectally pursue intuitive catalysts for change for extensible materials. Intrinsicly fabricate principle-centered web-readiness with virtual.</p>
							<a href="#" data-scrollto="#section-about" data-offset="70"  data-animate="fadeInUp" data-delay="600" class="button m-0 button-circle button-large text-white" style="background-color: #E25B45;">Get Started <i class="bi-arrow-right"></i></a>
						</div>

						<div class="col-md-6 order-1 order-md-2">
							<img src="one-page/images/page/yoga/yoga.svg" alt="Yoga Image"  data-animate="fadeInUp slow" data-delay="600">
						</div>
