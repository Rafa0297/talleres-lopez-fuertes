...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Digital Analysis - SEO Demo | Canvas</title>
...
<body class="stretched">
	...
	<div id="wrapper">
		...
		<section class="page-title page-title-parallax parallax scroll-detect page-title-center dark include-header include-topbar">
			<img src="demos/seo/images/services/analysis-title.jpg" class="parallax-bg">
			...
			<div class="container">
				<div class="page-title-row">
					...
					<div class="page-title-content">
						<div class="badge rounded-pill border border-light text-light">Analysis</div>
					...
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">Digital Analysis</li>
						</ol>
					</nav>
				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6">
							...
							<h2 class="display-4 fw-bold">Digital Analysis.</h2>
						...
						<div class="col-lg-6 mt-4 mt-lg-0">
							<img src="demos/seo/images/services/analysis.svg" alt="Image">
						</div>
					</div>
					...
					<div class="row mt-4 col-mb-50 mb-0">
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box">
								...
								<div class="fbox-content">
									<h3 class="text-transform-none">Google Analytics</h3>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box">
								<div class="fbox-icon mb-4">
									<a href="#"><i class="bi-file-earmark-richtext bg-dark border-0"></i></a>
								</div>
								<div class="fbox-content">
									<h3 class="text-transform-none">Page Analytics</h3>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box">
								<div class="fbox-icon mb-4">
									<a href="#"><i class="bi-box-arrow-in-right bg-info border-0"></i></a>
								</div>
								<div class="fbox-content">
									<h3 class="text-transform-none">Page Speed</h3>
									<p>Looks beautiful &amp; ultra-sharp on Retina Screen Displays. Retina Icons, Fonts &amp; all others graphics are optimized.</p>
								</div>
							</div>
						</div>
