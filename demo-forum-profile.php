...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Profile - Forums / Community | Canvas</title>
					...
					<div class="page-menu-row">
						...
						<nav class="page-menu-nav">
							<ul class="page-menu-container">
								<li class="page-menu-item current"><a href="#"><div>Profile</div></a></li>
								<li class="page-menu-item"><a href="#"><div>Topics Started</div></a></li>
								<li class="page-menu-item"><a href="#"><div>Replies Created</div></a></li>
								<li class="page-menu-item"><a href="demo-forum-edit.php"><div>Edit</div></a></li>
							</ul>
						</nav>
