...
<head>
	...
	<meta name="description" content="Create Furniture Store &amp; Rental Websites with Canvas Template. Get Canvas to build powerful websites easily with the Highly Customizable &amp; Best Selling Bootstrap Template, today.">
	...
	<!-- Niche Demos -->
	<link rel="stylesheet" href="demos/furniture/furniture.css">
				...
				<div class="container">
					<div class="header-row justify-content-lg-between">
						...
						<div id="logo" class="mx-auto col-auto flex-column order-2">
							<a href="demo-furniture.php">
								<img class="logo-default" srcset="demos/furniture/images/logo.png, demos/furniture/images/logo@2x.png 2x" src="demos/furniture/images/logo@2x.png" alt="Canvas Logo">
							</a>
						</div><!-- #logo end -->
						...
						<div class="primary-menu-trigger">
							<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 256 256"><defs><style>.a,.c{fill:none;}.b{fill:var(--cnvs-themecolor);opacity:0.2;}.c,.d{stroke:var(--cnvs-themecolor);}.c{stroke-miterlimit:10;stroke-width:14px;}.d{stroke-linecap:round;stroke-linejoin:round;stroke-width:13px;}</style></defs><rect class="a" width="24" height="24"><circle class="b" cx="96" cy="96" r="96" transform="translate(32 32)"><circle class="c" cx="96" cy="96" r="96" transform="translate(32 32)"><line class="d" x2="85" transform="translate(86 127)"><line class="d" x2="85" transform="translate(86 97)"><line class="d" x2="85" transform="translate(86 159)"></svg>
							<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="var(--cnvs-themecolor)" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><circle cx="128" cy="128" r="96" opacity="0.2"></circle><circle cx="128" cy="128" r="96" fill="none" stroke="var(--cnvs-themecolor)" stroke-miterlimit="10" stroke-width="16"></circle><line x1="160" y1="96" x2="96" y2="160" fill="none" stroke="var(--cnvs-themecolor)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line><line x1="160" y1="160" x2="96" y2="96" fill="none" stroke="var(--cnvs-themecolor)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line></svg>
						</div>
						...
						<nav class="primary-menu with-arrows order-lg-1 order-last px-0">
							...
							<ul class="menu-container">
								<li class="menu-item current">
									<a class="menu-link" href="demo-furniture.php">
										<div>Home</div>
									</a>
									<ul class="sub-menu-container">
										<li class="menu-item">
											<a class="menu-link" href="demo-furniture.php"><div>Home Page 1</div></a>
										</li>
										<li class="menu-item">
											<a class="menu-link" href="demo-furniture-2.php"><div>Home Page 2</div></a>
										</li>
									</ul>
								</li>
								<li class="menu-item mega-menu mega-menu-full">
									<a href="demo-furniture-products.php" class="menu-link"><div>Shop</div></a>
										...
										<div class="container">
											<div class="row">
												<ul class="sub-menu-container mega-menu-column col-lg-auto">
													<li class="menu-item">
														<a class="menu-link" href="demo-furniture-products.php"><div>Sofa</div></a>

														<!-- Menu Sub DropDown
														============================================= -->
														<ul class="sub-menu-container mega-menu-dropdown">
															<li class="menu-item">
																<a class="menu-link" href="demo-furniture-products.php"><div>Sofa Set</div></a>
															</li>
															<li class="menu-item">
																<a class="menu-link" href="demo-furniture-products.php"><div>Single Seater</div></a>
															</li>
															<li class="menu-item">
																<a class="menu-link" href="demo-furniture-products.php"><div>Recliner</div></a>
															</li>
															<li class="menu-item">
																<a class="menu-link" href="demo-furniture-products.php"><div>Sofa Cum Bed</div></a>
															</li>
															<li class="menu-item">
																<a class="menu-link" href="demo-furniture-products.php"><div>BeanBag</div></a>
															</li>
														</ul>
													</li>
												</ul>
												<ul class="sub-menu-container mega-menu-column col-lg-auto">
													<li class="menu-item">
														<a class="menu-link" href="demo-furniture-products.php"><div>Chairs</div></a>
													</li>
												</ul>
												<ul class="sub-menu-container mega-menu-column col-lg-auto">
													<li class="menu-item">
														<a class="menu-link" href="demo-furniture-products.php"><div>Beds</div></a>
													</li>
												</ul>
												<ul class="sub-menu-container mega-menu-column col-lg-auto">
													<li class="menu-item">
														<a class="menu-link" href="demo-furniture-products.php"><div>Wardrobe</div></a>
													</li>
												</ul>
												<ul class="sub-menu-container mega-menu-column col-lg-auto">
													<li class="menu-item">
														<a class="menu-link" href="demo-furniture-products.php"><div>Tables</div></a>
													</li>
												</ul>
												<ul class="sub-menu-container mega-menu-column col-lg-auto">
													<li class="menu-item">
														<a class="menu-link" href="demo-furniture-products.php"><div>More</div></a>
														<ul class="sub-menu-container mega-menu-dropdown">
															<li class="menu-item">
																<a class="menu-link" href="demo-furniture-products.php"><div>Kids Room</div></a>
															</li>
															<li class="menu-item">
																<a class="menu-link" href="demo-furniture-products.php"><div>Mattress</div></a>
															</li>
															<li class="menu-item">
																<a class="menu-link" href="demo-furniture-products.php"><div>Lighting</div></a>
															</li>
															<li class="menu-item">
																<a class="menu-link" href="demo-furniture-products.php"><div>Pillows</div></a>
															</li>
															<li class="menu-item">
																<a class="menu-link" href="demo-furniture-products.php"><div>FlowerPot</div></a>
															</li>
														</ul>
													</li>
												</ul>
												<ul class="sub-menu-container mega-menu-column bg-color-light col-lg-auto">
													<li class="menu-item">
														<a class="menu-link" href="demo-furniture-single.php"><div><i class="bi-link-45deg"></i>Single Page</div></a>
													</li>
												</ul>
											</div>
										</div>
								...
								<li class="menu-item">
									<a class="menu-link" href="demo-furniture-about.php">
										<div>About Us</div>
									</a>
								</li>
								<li class="menu-item"><a class="menu-link" href="demo-furniture-contact.php">
									<div>Contact</div>
								</a></li>
							</ul>
			...
			<div class="swiper swiper-parent">
				<div class="swiper-wrapper">
						...
						<div class="container">
							<div class="position-absolute pos-y-end mb-3 row w-100 col-mb-30">
								<div class="col-md-auto col-10 ts">
									<a href="demo-furniture-single.php" class="card d-flex flex-row" data-animate="fadeInLeft">
										<img src="demos/furniture/images/hero-2/1/1.jpg" width="100" height="100" alt="Image" class="rounded-start">
										<div class="card-body px-4">
											<h4 class="mb-2 text-white fw-medium">Light Brown Dining Sofa</h4>
											<h4 class="mb-0 h6 text-white fw-normal font-body d-flex">$149.99 <i class="bi-arrow-right ms-auto"></i></h4>
										</div>
									</a>
								</div>

								<div class="col-md-auto col-10 ts">
									<a href="demo-furniture-single.php" class="card d-flex flex-row" data-animate="fadeInLeft" data-delay="200">
										<img src="demos/furniture/images/hero-2/1/3.jpg" width="100" height="100" alt="Image" class="rounded-start">
										<div class="card-body px-4">
											<h4 class="mb-2 text-white fw-medium">Sofa Side Table</h4>
											<h4 class="mb-0 h6 text-white fw-normal font-body d-flex">$31.49 <i class="bi-arrow-right ms-auto"></i></h4>
										</div>
									</a>
								</div>

								<div class="col-md-auto col-10 ts">
									<a href="demo-furniture-single.php" class="card d-flex flex-row" data-animate="fadeInLeft" data-delay="400">
										<img src="demos/furniture/images/hero-2/1/2.jpg" width="100" height="100" alt="Image" class="rounded-start">
										<div class="card-body px-4">
											<h4 class="mb-2 text-white fw-medium">Blue Pillow for Sofa</h4>
											<h4 class="mb-0 h6 text-white fw-normal font-body d-flex">$11.49 <i class="bi-arrow-right ms-auto"></i></h4>
										</div>
									</a>
								</div>
							</div>
						</div>
						<div class="swiper-slide-bg" style="background-image: linear-gradient(to bottom, transparent, rgba(25, 53, 50, .9)), url('demos/furniture/images/hero-2/1/slide.jpg');"></div>
					</div>
					...
					<div class="swiper-slide">
						<div class="container">
							<div class="position-absolute pos-y-end mb-3 row justify-content-lg-end w-100 col-mb-30">
								<div class="col-lg-auto col-md-8 col-10">
									<a href="demo-furniture-single.php" class="card d-flex flex-row" data-animate="fadeInLeft">
										<img src="demos/furniture/images/hero-2/2/1.jpg" width="100" height="100" alt="Image" class="rounded-start">
										<div class="card-body px-4">
								...
								<div class="col-lg-auto col-md-8 col-10">
									<a href="demo-furniture-single.php" class="card d-flex flex-row" data-animate="fadeInLeft" data-delay="400">
										<img src="demos/furniture/images/hero-2/2/2.jpg" width="100" height="100" alt="Image" class="rounded-start">
										<div class="card-body px-4">
						...
						<div class="swiper-slide-bg" style="background-image: linear-gradient(to bottom, transparent, rgba(25, 53, 50, .9)), url('demos/furniture/images/hero-2/2/slide.jpg');"></div>
					</div>
					...
					<div class="swiper-slide dark">
						...
						<div class="video-wrap no-placeholder">
							<video id="slide-video" poster="images/videos/deskwork.jpg" preload="auto" loop autoplay muted playsinline>
								<source src='demos/furniture/images/hero-2/3/slide_vdo.mp4' type='video/mp4'>
							</video>
		...
		<section id="content">
			<div class="content-wrap py-0">
				...
				<div class="section bg-color-light mt-0">
					<div class="container text-center mw-md mt-5 mb-5">
						...
						<div class="row col-mb-50 mb-0 mt-5 justify-content-center">
							<div class="col-sm-6 col-lg-4">
								<div class="feature-box fbox-center fbox-dark fbox-plain">
									<div class="fbox-icon">
										<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="var(--cnvs-themecolor)" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><path d="M130.24636,223.97423a96.01036,96.01036,0,0,0,83.92-53.60107l-.00178-.00094-54.28632-33.38846a7.99993,7.99993,0,0,0-3.12236-1.114l-22.81867-3.07595a8,8,0,0,0-8.37592,4.67178l-13.69878,30.73831a8,8,0,0,0,1.433,8.68736l18.79995,20.33464a8,8,0,0,1,1.98022,6.9502l-3.8294,19.79638Z" opacity="0.2"></path><path d="M64.95216,55.60635,56.00794,76.75607a8,8,0,0,0-.12321,5.92293l11.49086,30.66819a8,8,0,0,0,5.81037,5.01448l5.423,1.16555,8.32721-19.76833a8,8,0,0,1,7.37259-4.89437h21.34538a8,8,0,0,0,3.86737-.9969l12.24176-6.76034a8.00033,8.00033,0,0,0,1.49868-1.06968l26.91087-24.33754a8,8,0,0,0,1.6191-9.83314l-9.33366-16.7184.00122-.00463A96.18805,96.18805,0,0,0,64.95081,55.60478Z" opacity="0.2"></path><circle cx="128" cy="128" r="96" fill="none" stroke="var(--cnvs-themecolor)" stroke-linecap="round" stroke-linejoin="round" stroke-width="10"></circle><path d="M214.16458,170.37222l-54.28632-33.38846a7.99993,7.99993,0,0,0-3.12236-1.114l-22.81867-3.07595a8,8,0,0,0-8.37592,4.67178l-13.69878,30.73831a8,8,0,0,0,1.433,8.68736l18.79995,20.33464a8,8,0,0,1,1.98022,6.9502l-3.8294,19.79638" fill="none" stroke="var(--cnvs-themecolor)" stroke-linecap="round" stroke-linejoin="round" stroke-width="10"></path><path d="M64.95216,55.60635,56.00794,76.75607a8,8,0,0,0-.12321,5.92293l11.49086,30.66819a8,8,0,0,0,5.81037,5.01448l21.42993,4.60592a8,8,0,0,1,5.5197,4.3358l3.80564,7.862a8,8,0,0,0,7.20075,4.51442h13.43256" fill="none" stroke="var(--cnvs-themecolor)" stroke-linecap="round" stroke-linejoin="round" stroke-width="10"></path><path d="M152.45823,35.14852l9.33366,16.7184a8,8,0,0,1-1.6191,9.83314L133.26192,86.0376a8.00033,8.00033,0,0,1-1.49868,1.06968l-12.24176,6.76034a8,8,0,0,1-3.86737.9969H94.30873a8,8,0,0,0-7.37259,4.89437l-8.32721,19.76833" fill="none" stroke="var(--cnvs-themecolor)" stroke-linecap="round" stroke-linejoin="round" stroke-width="10"></path></svg>
									</div>
									<div class="fbox-content">
										<h2 class="text-transform-none fw-medium h4 mb-4">Woldwide Brand</h2>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="feature-box fbox-center fbox-dark fbox-plain">
									<div class="fbox-icon">
										<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="var(--cnvs-themecolor)" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><path d="M56,56v55.09613c0,39.70052,31.75464,72.60753,71.45407,72.90185A72.00008,72.00008,0,0,0,200,112V56a8,8,0,0,0-8-8H64A8,8,0,0,0,56,56Z" opacity="0.2"></path><path d="M56,56v55.09613c0,39.70052,31.75464,72.60753,71.45407,72.90185A72.00008,72.00008,0,0,0,200,112V56a8,8,0,0,0-8-8H64A8,8,0,0,0,56,56Z" fill="none" stroke="var(--cnvs-themecolor)" stroke-linecap="round" stroke-linejoin="round" stroke-width="10"></path><line x1="96" y1="224" x2="160" y2="224" fill="none" stroke="var(--cnvs-themecolor)" stroke-linecap="round" stroke-linejoin="round" stroke-width="10"></line><line x1="128" y1="184" x2="128" y2="224" fill="none" stroke="var(--cnvs-themecolor)" stroke-linecap="round" stroke-linejoin="round" stroke-width="10"></line><path d="M198.21561,128H208a32,32,0,0,0,32-32V80a8,8,0,0,0-8-8H200" fill="none" stroke="var(--cnvs-themecolor)" stroke-linecap="round" stroke-linejoin="round" stroke-width="10"></path><path d="M57.964,128H47.87289a32,32,0,0,1-32-32V80a8,8,0,0,1,8-8h32" fill="none" stroke="var(--cnvs-themecolor)" stroke-linecap="round" stroke-linejoin="round" stroke-width="10"></path></svg>
									</div>
									<div class="fbox-content">
										<h2 class="text-transform-none fw-medium h4 mb-4">Award Winner</h2>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="feature-box fbox-center fbox-dark fbox-plain">
									<div class="fbox-icon">
										<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="var(--cnvs-themecolor)" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><circle cx="128" cy="128" r="96" opacity="0.2"></circle><circle cx="128" cy="128" r="96" fill="none" stroke="var(--cnvs-themecolor)" stroke-miterlimit="10" stroke-width="10"></circle><path d="M169.57812,151.99627a48.02731,48.02731,0,0,1-83.15624.00073" fill="none" stroke="var(--cnvs-themecolor)" stroke-linecap="round" stroke-linejoin="round" stroke-width="10"></path><circle cx="92" cy="108" r="12"></circle><circle cx="164" cy="108" r="12"></circle></svg>
									</div>
									<div class="fbox-content">
										<h2 class="text-transform-none fw-medium h4 mb-4">Happily Service</h2>
						...
						<div class="row justify-content-center text-center">
							<div class="col-lg-9">
								<div class="row justify-content-center align-items-center text-center mx-auto">
									<div class="col op-05"><img src="demos/furniture/images/sponsors/amazon.svg" alt="" width="100"></div>
									<div class="col op-05"><img src="demos/furniture/images/sponsors/cnn.svg" alt="" width="100"></div>
									<div class="col op-05"><img src="demos/furniture/images/sponsors/google.svg" alt="" width="100"></div>
									<div class="col op-05"><img src="demos/furniture/images/sponsors/linkedin.svg" alt="" width="100"></div>
								</div>
								<div class="row justify-content-center align-items-center mx-auto text-center mt-3">
									<div class="col op-05"><img src="demos/furniture/images/sponsors/netflix.svg" alt="" width="100"></div>
									<div class="col op-05"><img src="demos/furniture/images/sponsors/jetblue.svg" alt="" width="100"></div>
									<div class="col op-05"><img src="demos/furniture/images/sponsors/github.svg" alt="" width="100"></div>
								</div>
							</div>
						</div>
				...
				<div class="container-fluid">
					...
					<div class="text-center mt-6 mb-5">
						...
						<a href="demo-furniture-products.php" class="button button-small button-border m-0 button-dark border-width-1 border-default px-4 h-bg-color"><i class="bi-grid"></i> View All</a>
					</div>

					<!-- Categories -->
					<div class="row item-categories gutter-20">
						<div class="col-lg-4 col-md-6">
							<a href="demo-furniture-products.php" class="d-block h-op-09 op-ts" style="background: url('demos/furniture/images/categories/sofas.jpg') no-repeat center center; background-size: cover; height: 340px;">
								<h5 class="text-uppercase ls-1 bg-white mb-0">Sofa</h5>
							</a>
						</div>
						<div class="col-lg-4 col-md-6">
							<a href="demo-furniture-products.php" class="d-block h-op-09 op-ts" style="background: url('demos/furniture/images/categories/tables.jpg') no-repeat center center; background-size: cover; height: 340px;">
								<h5 class="text-uppercase ls-1 bg-white mb-0">Tables</h5>
							</a>
						</div>

						<div class="col-lg-4 col-md-6">
							<a href="demo-furniture-products.php" class="d-block h-op-09 op-ts" style="background: url('demos/furniture/images/categories/chairs.jpg') no-repeat center center; background-size: cover; height: 340px;">
								<h5 class="text-uppercase ls-1 bg-white mb-0">Chairs</h5>
							</a>
						</div>
						<div class="col-lg-4 col-md-6">
							<a href="demo-furniture-products.php" class="d-block h-op-09 op-ts" style="background: url('demos/furniture/images/categories/lights.jpg') no-repeat center center; background-size: cover; height: 340px;">
								<h5 class="text-uppercase ls-1 bg-white mb-0">Lights</h5>
							</a>
						</div>
						<div class="col-lg-4 col-md-6">
							<a href="demo-furniture-products.php" class="d-block h-op-09 op-ts" style="background: url('demos/furniture/images/categories/wardrobes.jpg') no-repeat center center; background-size: cover; height: 340px;">
								<h5 class="text-uppercase ls-1 bg-white mb-0">Wardrobes</h5>
							</a>
						</div>
						<div class="col-lg-4 col-md-6">
							<a href="demo-furniture-products.php" class="d-block h-op-09 op-ts" style="background: url('demos/furniture/images/categories/beds.jpg') no-repeat center center; background-size: cover; height: 340px;">
								<h5 class="text-uppercase ls-1 bg-white mb-0">Beds</h5>
							</a>
						</div>
					</div>
					...
					<div class="container">
						...
						<div id="shop" class="shop row gutter-30 col-mb-30 mt-3">
							...
							<div class="col-xl-3 col-lg-6">
								...
								<a href="demo-furniture-products.php" class="button button-border py-1 text-transform-none ls-0 fw-normal button-dark border-width-1 border-color h-bg-color">New Arrivals</a>
								<a href="demo-furniture-products.php" class="button button-border py-1 text-transform-none ls-0 fw-normal button-dark border-width-1 border-color h-bg-color">Popular</a>
							</div>
							...
							<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
								<div class="grid-inner">
									<div class="product-image">
										<a href="demo-forum-single.php"><img src="demos/furniture/images/shop/2.jpg" alt="Light Grey Sofa"></a>
										<a href="demo-forum-single.php"><img src="demos/furniture/images/shop/2-1.jpg" alt="Light Grey Sofa"></a>
										<div class="bg-overlay">
											<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
												<a href="#" class="btn btn-light me-2"><i class="uil uil-shopping-cart"></i></a>
												<a href="demos/furniture/ajax/quick-view.php" class="btn btn-light" data-lightbox="ajax"><i class="bi-eye"></i></a>
											</div>
										</div>
									</div>
									<div class="product-desc">
										<div class="product-title mb-0"><h4 class="mb-0"><a class="fw-medium" href="demo-forum-single.php">Light Grey Sofa</a></h4></div>
							...
							<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
								<div class="grid-inner">
									<div class="product-image">
										<a href="demo-forum-single.php"><img src="demos/furniture/images/shop/3.jpg" alt="Celling Lights"></a>
										<a href="demo-forum-single.php"><img src="demos/furniture/images/shop/3-1.jpg" alt="Celling Lights"></a>
										<div class="bg-overlay">
											<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
												<a href="#" class="btn btn-light me-2"><i class="uil uil-shopping-cart"></i></a>
												<a href="demos/furniture/ajax/quick-view.php" class="btn btn-light" data-lightbox="ajax"><i class="bi-eye"></i></a>
									...
									<div class="product-desc">
										<div class="product-title mb-0"><h4 class="mb-0"><a class="fw-medium" href="demo-forum-single.php">Celling Lights</a></h4></div>
							...
							<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
								<div class="grid-inner">
									<div class="product-image">
										<a href="demo-forum-single.php"><img src="demos/furniture/images/shop/4-1.jpg" alt="High Stand Chair"></a>
										<a href="demo-forum-single.php"><img src="demos/furniture/images/shop/4.jpg" alt="High Stand Chair"></a>
										<div class="bg-overlay">
											<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
												<a href="#" class="btn btn-light me-2"><i class="uil uil-shopping-cart"></i></a>
												<a href="demos/furniture/ajax/quick-view.php" class="btn btn-light" data-lightbox="ajax"><i class="bi-eye"></i></a>
									...
									<div class="product-desc">
										<div class="product-title mb-0"><h4 class="mb-0"><a class="fw-medium" href="demo-forum-single.php">High Stand Chair</a></h4></div>
							...
							<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
								<div class="grid-inner">
									<div class="product-image">
										<a href="demo-forum-single.php"><img src="demos/furniture/images/shop/5.jpg" alt="Dining Sofa with Tea-table"></a>
										<a href="demo-forum-single.php"><img src="demos/furniture/images/shop/5-1.jpg" alt="Dining Sofa with Tea-table"></a>
										<div class="bg-overlay">
											<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
												<a href="#" class="btn btn-light me-2"><i class="uil uil-shopping-cart"></i></a>
												<a href="demos/furniture/ajax/quick-view.php" class="btn btn-light" data-lightbox="ajax"><i class="bi-eye"></i></a>
									...
									<div class="product-desc">
										<div class="product-title mb-0"><h4 class="mb-0"><a class="fw-medium" href="demo-forum-single.php">Dining Sofa with Tea-table</a></h4></div>
							...
							<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
								<div class="grid-inner">
									<div class="product-image">
										<a href="demo-forum-single.php"><img src="demos/furniture/images/shop/6.jpg" alt="Bathroom Cloths Shelves"></a>
										<div class="bg-overlay">
											<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
												<a href="#" class="btn btn-light me-2"><i class="uil uil-shopping-cart"></i></a>
												<a href="demos/furniture/ajax/quick-view.php" class="btn btn-light" data-lightbox="ajax"><i class="bi-eye"></i></a>
									...
									<div class="product-desc">
										<div class="product-title mb-0"><h4 class="mb-0"><a class="fw-medium" href="demo-forum-single.php">Bathroom Cloths Shelves</a></h4></div>
							...
							<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
								<div class="grid-inner">
									<div class="product-image">
										<a href="demo-forum-single.php"><img src="demos/furniture/images/shop/7.jpg" alt="Golden Lamp for Room"></a>
										<div class="bg-overlay">
											<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
												<a href="#" class="btn btn-light me-2"><i class="uil uil-shopping-cart"></i></a>
												<a href="demos/furniture/ajax/quick-view.php" class="btn btn-light" data-lightbox="ajax"><i class="bi-eye"></i></a>
									...
									<div class="product-desc">
										<div class="product-title mb-0"><h4 class="mb-0"><a class="fw-medium" href="demo-forum-single.php">Golden Lamp for Room</a></h4></div>
							...
							<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
								<div class="grid-inner">
									<div class="product-image">
										<a href="demo-forum-single.php"><img src="demos/furniture/images/shop/8.jpg" alt="White Cuddle Chair with Cusions"></a><a href="demo-forum-single.php"><img src="demos/furniture/images/shop/8-1.jpg" alt="White Cuddle Chair with Cusions"></a>
										<div class="bg-overlay">
											<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
												<a href="#" class="btn btn-light me-2"><i class="uil uil-shopping-cart"></i></a>
												<a href="demos/furniture/ajax/quick-view.php" class="btn btn-light" data-lightbox="ajax"><i class="bi-eye"></i></a>
									...
									<div class="product-desc">
										<div class="product-title mb-0"><h4 class="mb-0"><a class="fw-medium" href="demo-forum-single.php">White Cuddle Chair with Cusions</a></h4></div>
				...
				<div class="container-fluid">
					...
					<div class="row align-items-lg-center col-mb-30">
						...
						<div class="col-xl-4 col-lg-6 px-lg-5 py-5">
							...
							<a href="#" class="button button-border m-0 button-dark border-width-1 border-default h-bg-color">Discover Now <i class="bi-arrow-right"></i></a>
						</div>
					</div>
						...
						<div class="row col-mb-50">
							...
							<div class="col-md-4">
								<div class="feature-box fbox-center fbox-dark fbox-plain">
									...
									<div class="fbox-content">
										<h2 class="text-transform-none fw-medium h4 mb-4">Original & Excellent Quality</h2>
				...
				<!-- 6. Section Instagram
				============================================= -->
				<div class="section custom-bg my-0 py-0" style="--custom-bg: var(--cnvs-themecolor);">
					<div class="row align-items-center no-gutters">
						...
						<div class="col-lg-4 py-5 order-lg-2">
							<div class="text-center dark p-5">
								...
								<a href="https://instagram.com/semicolonweb" target="_blank" class="button button-large button-border text-transform-none ls-0 fw-normal button-light button-white border-width-1 m-0" style="border-color: rgba(255,255,255,0.25)">@semicolonweb</a>
							</div>
						</div>
					...
					<div class="row col-mb-30">
						...
						<div class="col-lg-2 col-md-3 col-6">
							<div class="widget widget_links widget-li-noicon">
								...
								<h4 class="ls-0 text-transform-none">Social</h4>

								<ul class="list-unstyled iconlist ms-0">
									<li><a href="https://facebook.com/semicolonweb" target="_blank"><i class="fa-brands fa-facebook-f"></i> Facebook</a></li>
									<li><a href="https://instagram.com/semicolonweb" target="_blank"><i class="bi-instagram"></i> Instagram</a></li>
									<li><a href="https://twitter.com/__semicolon" target="_blank"><i class="fa-brands fa-x-twitter"></i> Twitter</a></li>
									<li><a href="https://youtube.com/c/SemiColonweb/videos" target="_blank"><i class="fa-brands fa-youtube"></i> YouTube</a></li>
									<li><a href="https://wa.me/00112233344"><i class="fa-brands fa-whatsapp"></i> WhatsApp</a></li>
								</ul>
						...
						<div class="col-lg-2 col-md-3 col-6">
							<div class="widget widget_links widget-li-noicon">
								...
								<h4 class="ls-0 text-transform-none">Support</h4>

								<ul class="list-unstyled iconlist ms-0">
									<li><a href="demo-furniture.php">Home</a></li>
									<li><a href="demo-furniture-about.php">About</a></li>
									<li><a href="demo-furniture-contact.php">Contact</a></li>
								</ul>
						...
						<div class="col-lg-2 col-md-3 col-6">
							<div class="widget widget_links widget-li-noicon">
								...
								<h4 class="ls-0 text-transform-none">Trending</h4>

								<ul class="list-unstyled iconlist ms-0">
									<li><a href="demo-furniture-products.php">Shop</a></li>
									<li><a href="demo-forum-single.php">Single</a></li>
									<li><a href="demo-furniture-about.php">Who are we</a></li>
								</ul>
						...
						<div class="col-lg-2 col-md-3 col-6">
							<div class="widget widget_links widget-li-noicon">
								...
								<h4 class="ls-0 text-transform-none">Get to Know us</h4>

								<ul class="list-unstyled iconlist ms-0">
									<li><a href="intro.php#section-niche">Niche Demos</a></li>
									<li><a href="intro.php#section-multipage">Home Pages</a></li>
									<li><a href="intro.php#section-onepage">One Pages</a></li>
								</ul>
			...
			<div id="copyrights" class="py-3 bg-color-light">
				<div class="container">
					...
					<div class="d-flex justify-content-between op-04">
						<span>&copy; 2023 All Rights Reserved by Canvas Inc.</span>
