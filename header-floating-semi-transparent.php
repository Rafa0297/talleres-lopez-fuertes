...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Header - Floating Semi Transparent | Canvas</title>
...
<body class="stretched">
	...
	<div id="wrapper">
		...
		<!-- Header
		============================================= -->
		<header id="header" class="transparent-header floating-header header-size-md no-sticky" style="--cnvs-header-floating-bg: rgba(var(--cnvs-invert-contrast-rgb), 0.85);">
			<div id="header-wrap" data-class="up-lg:position-fixed">
				<div class="container" style="border-radius: 1.75rem;">
					<div class="header-row">
						...
						<div class="header-misc">
							<a href="#" class="button button-border border-default rounded-pill"><i class="fa-solid fa-user d-block d-md-none m-0"></i><span class="d-none d-md-block">Login</span></a>
							<a href="#" class="button button-3d rounded-pill button-black"><i class="fa-solid fa-phone d-block d-md-none m-0"></i><span class="d-none d-md-block">Talk to us</span></a>
						</div>
						...
						<nav class="primary-menu mx-lg-auto">
							...
							<ul class="menu-container">
								...
								<li class="menu-item">
									<a class="menu-link" href="#"><div>Pricing</div></a>
								</li>
								<li class="menu-item">
