...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>About - Freelancer | Canvas</title>
					...
					<div class="header-row">
						...
						<nav class="primary-menu">
							...
							<ul class="menu-container">
								<li class="menu-item current"><a class="menu-link" href="demo-freelancer-about.php"><div>About me</div></a></li>
			...
			<div class="content-wrap pb-0">
				...
				<div class="section text-center mb-0">
					<div class="mw-xs mx-auto ">
						...
						<div class="row justify-content-center align-items-center text-center mt-4 col-mb-30">
							<div class="col-md-4 col-6"><img src="demos/freelancer/images/clients/amazon.svg" alt="Clients"></div>
							<div class="col-md-4 col-6"><img src="demos/freelancer/images/clients/netflix.svg" alt="Clients"></div>
							<div class="col-md-4 col-6"><img src="demos/freelancer/images/clients/google.svg" alt="Clients"></div>
							<div class="col-md-4 col-6"><img src="demos/freelancer/images/clients/paypal.svg" alt="Clients"></div>
							<div class="col-md-4 col-6"><img src="demos/freelancer/images/clients/skype.svg" alt="Clients"></div>
							<div class="col-md-4 col-6"><img src="demos/freelancer/images/clients/ps.svg" alt="Clients"></div>
							<div class="col-md-4 col-6"><img src="demos/freelancer/images/clients/slack.svg" alt="Clients"></div>
							<div class="col-md-4 col-6"><img src="demos/freelancer/images/clients/applemusic.svg" alt="Clients"></div>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="col-md-4">
							<div class="widget">
								...
								<div>
									...
									<a href="#" class="social-icon si-small text-white bg-delicious">
										<i class="fa-brands fa-delicious"></i>
										<i class="fa-brands fa-delicious"></i>
									</a>
									<a href="#" class="social-icon si-small text-white bg-paypal">
										<i class="fa-brands fa-paypal"></i>
										<i class="fa-brands fa-paypal"></i>
									</a>
									<a href="#" class="social-icon si-small text-white bg-waze">
