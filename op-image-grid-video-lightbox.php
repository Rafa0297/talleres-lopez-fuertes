...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>One Page Image Grid Video Lightbox | Canvas</title>
...
<body class="stretched side-push-panel">
	...
	<div id="wrapper">
		...
		<!-- Header
		============================================= -->
		<header id="header" class="full-header transparent-header border-full-header dark header-size-custom" data-sticky-shrink="false" data-sticky-class="not-dark" data-sticky-offset="full" data-sticky-offset-negative="auto">
			<div id="header-wrap">
				<div class="container">
		...
		<section id="slider" class="slider-element slider-parallax min-vh-100 dark include-header">
			<div class="slider-inner">
				...
				<div class="row text-center dark w-100 h-100 mx-0 position-absolute">

					<div class="col-md-6 h-100 max-vh-50 max-vh-md-none p-0 dark" style="background-image: url('images/parallax/home/2.jpg'); background-size: cover;">
						<div class="vertical-middle">
							<div>
								<div class="inline-block"><a id="play-hero-video" href="https://vimeo.com/117770305" class="big-video-button mb-0 mb-md-5 slider-element-fade" data-lightbox="iframe"><i class="uil uil-play"></i></a></div>
								<div class="emphasis-title mx-auto d-none d-md-block slider-element-fade" style="max-width: 450px;">
									<h1 class="fw-bold font-body ls-1" style="font-size: 34px;">We are a Creative &amp; Smart Media Agency.</h1>
								</div>
								<div class="clear"></div>
								<a href="#" class="button button-border button-light button-circle d-none d-md-inline-block slider-element-fade" data-scrollto="#section-works" data-easing="easeInOutExpo" data-speed="1250" data-offset="70">View our Works</a>
							</div>
						</div>
					...
					<div class="col-md-6 h-100 max-vh-50 max-vh-md-none p-0 dark" style="background-image: url('images/parallax/home/7.jpg'); background-size: cover;">
						<div class="vertical-middle">
							<div>
								<div class="inline-block"><a id="play-hero-video" href="https://vimeo.com/117770305" class="big-video-button mb-0 mb-md-5 slider-element-fade" data-lightbox="iframe"><i class="uil uil-play"></i></a></div>
								<div class="emphasis-title mx-auto d-none d-md-block slider-element-fade" style="max-width: 450px;">
									<h1 class="fw-bold font-body ls-1" style="font-size: 34px;">Experts in Quality &amp; Innovative Branding.</h1>
								</div>
								<div class="clear"></div>
								<a href="#" class="button button-border button-light button-circle d-none d-md-inline-block slider-element-fade" data-scrollto="#template-contactform" data-easing="easeInOutExpo" data-speed="1250" data-offset="100">Get a Quote</a>
							</div>
						</div>
						<div class="video-wrap">
							<div class="video-overlay" style="background-color: rgba(0,0,0,0.7);"></div>
