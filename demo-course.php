...
<head>
	...
	<meta name="description" content="Create Courses &amp; e-Learning Websites with Canvas Template. Get Canvas to build powerful websites easily with the Highly Customizable &amp; Best Selling Bootstrap Template, today.">

	<!-- Font Imports -->
	<link rel="preconnect" href="https://fonts.googleapis.com">
	<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Istok+Web:wght@400;700&display=swap" rel="stylesheet">
	...
	<div id="wrapper">
					...
					<div class="col-12 col-md-auto px-0">
						...
						<div class="top-links">
							<ul class="top-links-container">
								...
								<li class="top-links-item d-none d-sm-inline-block"><a href="#"><i class="bi-download"></i> Download App</a></li>
							</ul>
						</div><!-- .top-links end -->
		...
		<header id="header" class="header-size-sm" data-sticky-shrink="false">
			...
			<div id="header-wrap" class="bg-light">
				<div class="container">
					<div class="header-row flex-row-reverse flex-lg-row justify-content-between" data-class="down-lg:py-3">
						...
						<nav class="primary-menu with-arrows">
							...
							<ul class="menu-container">
								<li class="menu-item"><a class="menu-link" href="#" class="ps-0"><div><i class="bi-grid"></i>All Categories</div></a>
									<ul class="sub-menu-container">
										<li class="menu-item"><a class="menu-link" href="#"><div><i class="bi-person"></i>Teacher Training</div></a>
											<ul class="sub-menu-container">
										...
										<li class="menu-item"><a class="menu-link" href="#"><div><i class="bi-bar-chart"></i>Business</div></a>
											<ul class="sub-menu-container">
										...
										<li class="menu-item"><a class="menu-link" href="#"><div><i class="bi-code"></i>Development</div></a>
											<ul class="sub-menu-container">
										...
										<li class="menu-item"><a class="menu-link" href="#"><div><i class="bi-phone"></i>IT & Software</div></a>
											<ul class="sub-menu-container">
										...
										<li class="menu-item"><a class="menu-link" href="#"><div><i class="bi-music-note-beamed"></i>Music</div></a>
											<ul class="sub-menu-container">
										...
										<li class="menu-item"><a class="menu-link" href="#"><div><i class="bi-controller"></i>Lifestyle</div></a>
											<ul class="sub-menu-container">
										...
										<li class="menu-item"><a class="menu-link" href="#"><div><i class="bi-globe"></i>Language</div></a>
											<ul class="sub-menu-container">
										...
										<li class="menu-item"><a class="menu-link" href="#"><div><i class="bi-lungs"></i>Health &amp; Fitness</div></a>
											<ul class="sub-menu-container">
										...
										<li class="menu-item"><a class="menu-link" href="#"><div><i class="bi-crop"></i>Design</div></a>
											<ul class="sub-menu-container">
										...
										<li class="menu-item"><a class="menu-link" href="#"><div><i class="fa-solid fa-burger"></i>Food</div></a>
											<ul class="sub-menu-container">
		...
		<section id="slider" class="slider-element min-vh-75">
			<div class="slider-inner">
				...
				<div class="vertical-middle">
					<div class="container text-center">
						<div class="row justify-content-center">
							<div class="col-md-7">
								<div class="slider-title mb-5 dark">
									<h2 class="text-white text-rotater mb-2" data-separator="," data-rotate="fadeIn" data-speed="3500">Learn More About <span class="t-rotate text-white d-inline-block">Development,Photography,Teacher Training,Business,Lifestyle,Language,Health,Fitness,Music</span>.</h2>
									<p class="lead mb-0 text-uppercase ls-2" style="color: #CCC; font-size: 110%">What Do You Want To Learn?</p>
								</div>
								<div class="clear"></div>
				...
				<div class="video-wrap no-placeholder">
					<video id="slide-video" poster="demos/course/images/video/poster.jpg" preload="auto" loop autoplay muted playsinline>
		...
		<section id="content">
			<div class="content-wrap" style="overflow: visible;">
					...
					<div class="row course-categories mb-4">
						<div class="col-lg-2 col-sm-3 col-6 mt-4">
							<div class="card hover-effect">
								<img class="card-img" src="demos/course/images/categories/music.jpg" alt="Card image">
								<a href="#" class="card-img-overlay rounded p-0" style="background-color: rgba(251,51,100,0.8);">
									<span><i class="bi-music-note-beamed"></i>Music</span>
								</a>
							</div>
						</div>
						...
						<div class="col-lg-2 col-sm-3 col-6 mt-4">
							<div class="card hover-effect">
								<img class="card-img" src="demos/course/images/categories/development.jpg" alt="Card image">
								<a href="#" class="card-img-overlay rounded p-0" style="background-color: rgba(29,74,103,0.8);">
									<span><i class="bi-code"></i>Development</span>
								</a>
							</div>
						</div>
						...
						<div class="col-lg-2 col-sm-3 col-6 mt-4">
							<div class="card hover-effect">
								<img class="card-img" src="demos/course/images/categories/teacher.jpg" alt="Card image">
								<a href="#" class="card-img-overlay rounded p-0" style="background-color: rgba(50,71,66,0.8);">
									<span><i class="bi-person"></i>Teacher</span>
								</a>
							</div>
						</div>
						...
						<div class="col-lg-2 col-sm-3 col-6 mt-4">
							<div class="card hover-effect">
								<img class="card-img" src="demos/course/images/categories/food.jpg" alt="Card image">
								<a href="#" class="card-img-overlay rounded p-0" style="background-color: rgba(70,58,69,0.8);">
									<span><i class="fa-solid fa-burger"></i>Food</span>
								</a>
							</div>
						</div>
						...
						<div class="col-lg-2 col-sm-3 col-6 mt-4">
							<div class="card hover-effect">
								<img class="card-img" src="demos/course/images/categories/business.jpg" alt="Card image">
								<a href="#" class="card-img-overlay rounded p-0" style="background-color: rgba(252,108,52,0.8);">
									<span><i class="bi-bar-chart"></i>Business</span>
								</a>
							</div>
						</div>
						...
						<div class="col-lg-2 col-sm-3 col-6 mt-4">
							<div class="card hover-effect">
								<img class="card-img" src="demos/course/images/categories/health.jpg" alt="Card image">
								<a href="#" class="card-img-overlay rounded p-0" style="background-color: rgba(158,108,87,0.8);">
									<span><i class="bi-activity"></i>Health Fitness</span>
								</a>
							</div>
						</div>
						...
						<div class="col-lg-2 col-sm-3 col-6 mt-4">
							<div class="card hover-effect">
								<img class="card-img" src="demos/course/images/categories/lifestyle.jpg" alt="Card image">
								<a href="#" class="card-img-overlay rounded p-0" style="background-color: rgba(164,108,119,0.85);">
									<span><i class="bi-controller"></i>Lifestyle</span>
								</a>
							</div>
						</div>
						...
						<div class="col-lg-2 col-sm-3 col-6 mt-4">
							<div class="card hover-effect">
								<img class="card-img" src="demos/course/images/categories/language.jpg" alt="Card image">
								<a href="#" class="card-img-overlay rounded p-0" style="background-color: rgba(80,167,159,0.8);">
									<span><i class="bi-globe"></i>Language</span>
								</a>
							</div>
						</div>
						...
						<div class="col-lg-2 col-sm-3 col-6 mt-4">
							<div class="card hover-effect">
								<img class="card-img" src="demos/course/images/categories/paint.jpg" alt="Card image">
								<a href="#" class="card-img-overlay rounded p-0" style="background-color: rgba(23,116,234,0.8);">
									<span><i class="bi-brush"></i>Paint</span>
								</a>
							</div>
						</div>
						...
						<div class="col-lg-2 col-sm-3 col-6 mt-4">
							<div class="card hover-effect">
								<img class="card-img" src="demos/course/images/categories/photography.jpg" alt="Card image">
								<a href="#" class="card-img-overlay rounded p-0" style="background-color: rgba(108,156,148,0.85);">
									<span><i class="bi-camera"></i>Photography</span>
								</a>
							</div>
						</div>
						...
						<div class="col-lg-2 col-sm-3 col-6 mt-4">
							<div class="card hover-effect">
								<img class="card-img" src="demos/course/images/categories/marketing.jpg" alt="Card image">
								<a href="#" class="card-img-overlay rounded p-0" style="background-color: rgba(227,141,66,0.8);">
									<span><i class="bi-share"></i>Digital Marketing</span>
								</a>
							</div>
						</div>
						...
						<div class="col-lg-2 col-sm-3 col-6 mt-4">
							<div class="card hover-effect">
								<img class="card-img" src="demos/course/images/categories/academics.jpg" alt="Card image">
								<a href="#" class="card-img-overlay rounded p-0" style="background-color: rgba(39,103,240,0.8);">
									<span><i class="bi-book"></i>Academics</span>
								</a>
							</div>
						</div>
				...
				<div class="section mt-6 parallax" style="padding: 80px 0 60px;">
					<div class="parallax-bg" style="background: url('demos/course/images/icon-pattern.jpg') repeat;"></div>

					<!-- Wave Shape Divider
					============================================= -->
					<div class="wave-top" style="position: absolute; top: 0; left: 0; width: 100%; background-image: url('demos/course/images/wave-3.svg'); height: 12px; z-index: 2; background-repeat: repeat-x;"></div>
						...
						<div class="row mt-2">
							...
							<div class="col-md-4 mb-5">
								<div class="card course-card hover-effect border-0">
									<a href="#"><img class="card-img-top" src="demos/course/images/courses/1.jpg" alt="Card image cap"></a>
									<div class="card-body">
										<h4 class="card-title fw-bold mb-2"><a href="#">Spanish Language Learning For Absolute Beginners</a></h4>
										<p class="mb-2 card-title-sub text-uppercase fw-normal ls-1"><a href="#" class="text-black-50">Language</a></p>
										<div class="rating-stars mb-2"><i class="bi-star-fill"></i><i class="bi-star-fill"></i><i class="bi-star-fill"></i><i class="bi-star-fill"></i><i class="bi-star-half"></i> <span>4.7</span></div>
									...
									<div class="card-footer py-3 d-flex justify-content-between align-items-center bg-white text-muted">
										...
										<a href="#" class="text-dark position-relative"><i class="bi-person"></i> <span class="author-number">1</span></a>
									</div>
								</div>
							</div>
							...
							<div class="col-md-4 mb-5">
								<div class="card course-card hover-effect border-0">
									<a href="#"><img class="card-img-top" src="demos/course/images/courses/2.jpg" alt="Card image cap"></a>
									<div class="card-body">
										<h4 class="card-title fw-bold mb-2"><a href="#">Music Theory for Electronic Producers - The Complete Course!</a></h4>
										<p class="mb-2 card-title-sub text-uppercase fw-normal ls-1"><a href="#" class="text-black-50">Music</a></p>
										<div class="rating-stars mb-2"><i class="bi-star-fill"></i><i class="bi-star-fill"></i><i class="bi-star-fill"></i><i class="bi-star-fill"></i><i class="bi-star-fill"></i> <span>4.9</span></div>
										<p class="card-text text-black-50 mb-1">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
									</div>
									<div class="card-footer py-3 d-flex justify-content-between align-items-center bg-white text-muted">
							...
							<div class="col-md-4 mb-5">
								<div class="card course-card hover-effect border-0">
									<a href="#"><img class="card-img-top" src="demos/course/images/courses/3.jpg" alt="Card image cap"></a>
									<div class="card-body">
										<h4 class="card-title fw-bold mb-2"><a href="#">Ultimate Photoshop Training: From Beginner to Pro</a></h4>
										<p class="mb-2 card-title-sub text-uppercase fw-normal ls-1"><a href="#" class="text-black-50">Design Tools</a></p>
										<div class="rating-stars mb-2"><i class="bi-star-fill"></i><i class="bi-star-fill"></i><i class="bi-star-fill"></i><i class="bi-star-fill"></i><i class="bi-star-fill-half"></i> <span>4.4</span></div>
										<p class="card-text text-black-50 mb-1">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
									</div>
									<div class="card-footer py-3 d-flex justify-content-between align-items-center bg-white text-muted">
										<div class="badge alert-warning">Free</div>
							...
							<div class="col-md-4 mb-5">
								<div class="card course-card hover-effect border-0">
									<a href="#"><img class="card-img-top" src="demos/course/images/courses/4.jpg" alt="Card image cap"></a>
									<div class="card-body">
										<h4 class="card-title fw-bold mb-2"><a href="#">Blockchain Advanced Level: Uses Beyond Bitcoin 2021</a></h4>
										<p class="mb-2 card-title-sub text-uppercase fw-normal ls-1"><a href="#" class="text-black-50">Business</a></p>
										<div class="rating-stars mb-2"><i class="bi-star-fill"></i><i class="bi-star-fill"></i><i class="bi-star-fill"></i><i class="bi-star-fill-half"></i><i class="bi-star"></i> <span>3.7</span></div>
										<p class="card-text text-black-50 mb-1">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
									</div>
									<div class="card-footer py-3 d-flex justify-content-between align-items-center bg-white text-muted">
										<div class="badge alert-primary">$19.99</div>
							...
							<div class="col-md-4 mb-5">
								<div class="card course-card hover-effect border-0">
									<a href="#"><img class="card-img-top" src="demos/course/images/courses/5.jpg" alt="Card image cap"></a>
									<div class="card-body">
										<h4 class="card-title fw-bold mb-2"><a href="#">Cognitive Behavioural Therapy (CBT) Practitioner Certificate</a></h4>
										<p class="mb-2 card-title-sub text-uppercase fw-normal ls-1"><a href="#" class="text-black-50">Health & Fitness</a></p>
										<div class="rating-stars mb-2"><i class="bi-star-fill"></i><i class="bi-star-fill"></i><i class="bi-star-fill"></i><i class="bi-star-fill"></i><i class="bi-star"></i> <span>4.1</span></div>
										<p class="card-text text-black-50 mb-1">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
									</div>
									<div class="card-footer py-3 d-flex justify-content-between align-items-center bg-white text-muted">
							...
							<div class="col-md-4 mb-5">
								<div class="card course-card hover-effect border-0">
									<a href="#"><img class="card-img-top" src="demos/course/images/courses/6.jpg" alt="Card image cap"></a>
									<div class="card-body">
										<h4 class="card-title fw-bold mb-2"><a href="#">Masterclass: Start Your Food Business 7 courses in 1</a></h4>
										<p class="mb-2 card-title-sub text-uppercase fw-normal ls-1"><a href="#" class="text-black-50">Food Recipes</a></p>
										<div class="rating-stars mb-2"><i class="bi-star-fill"></i><i class="bi-star-fill"></i><i class="bi-star-fill"></i><i class="bi-star-fill"></i><i class="bi-star-fill-half"></i> <span>4.4</span></div>
										<p class="card-text text-black-50 mb-1">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
									</div>
									<div class="card-footer py-3 d-flex justify-content-between align-items-center bg-white text-muted">
						...
						<div class="row">
							...
							<div class="col-lg-3 col-sm-6 mb-4">
								<div class="feature-box hover-effect shadow-sm fbox-center fbox-bg fbox-light fbox-lg fbox-effect">
									<div class="fbox-icon">
										<i><img src="demos/course/images/instructor/1.jpg" class="border-0 bg-transparent shadow-sm" style="z-index: 2;" alt="Image"></i>
									</div>
									<div class="fbox-content">
										<h3 class="mb-4 text-transform-none ls-0"><a href="#" class="text-dark">Dylan Meringue</a><br><small class="subtitle text-transform-none color">Digital Marketing</small></h3>
							...
							<div class="col-lg-3 col-sm-6 mb-4">
								<div class="feature-box hover-effect shadow-sm fbox-center fbox-bg fbox-light fbox-lg fbox-effect">
									<div class="fbox-icon">
										<i><img src="demos/course/images/instructor/2.jpg" class="border-0 bg-transparent shadow-sm" style="z-index: 2;" alt="Image"></i>
									</div>
									<div class="fbox-content">
										<h3 class="mb-4 text-transform-none ls-0"><a href="#" class="text-dark">Alan Fresco</a><br><small class="subtitle text-transform-none color">Health &amp; Fitness</small></h3>
							...
							<div class="col-lg-3 col-sm-6 mb-4">
								<div class="feature-box hover-effect shadow-sm fbox-center fbox-bg fbox-light fbox-lg fbox-effect">
									<div class="fbox-icon">
										<i><img src="demos/course/images/instructor/3.jpg" class="border-0 bg-transparent shadow-sm" style="z-index: 2;" alt="Image"></i>
									</div>
									<div class="fbox-content">
										<h3 class="mb-4 text-transform-none ls-0"><a href="#" class="text-dark">Gunther Beard</a><br><small class="subtitle text-transform-none color">Photography</small></h3>
							...
							<div class="col-lg-3 col-sm-6 mb-4">
								<div class="feature-box hover-effect shadow-sm fbox-center fbox-bg fbox-light fbox-lg fbox-effect">
									<div class="fbox-icon">
										<i><img src="demos/course/images/instructor/4.jpg" class="border-0 bg-transparent shadow-sm" style="z-index: 2;" alt="Image"></i>
									</div>
									<div class="fbox-content">
										<h3 class="mb-4 text-transform-none ls-0"><a href="#" class="text-dark">Desmond Eagle</a><br><small class="subtitle text-transform-none color">Lifestyle</small></h3>
								...
								<div class="row dark g-4">
									...
									<div class="col-md-6">
										<div class="feature-box media-box">
											<div class="fbox-icon">
												<a href="#">
													<i class="bi-book rounded-0 bg-transparent text-start"></i>
												</a>
											</div>
											<div class="fbox-content">
									...
									<div class="col-md-6">
										<div class="feature-box media-box">
											<div class="fbox-icon">
												<a href="#">
													<i class="bi-pencil-square rounded-0 bg-transparent text-start"></i>
												</a>
											</div>
											<div class="fbox-content">
									...
									<div class="col-md-6">
										<div class="feature-box media-box">
											<div class="fbox-icon">
												<a href="#">
													<i class="bi-person rounded-0 bg-transparent text-start"></i>
												</a>
											</div>
											<div class="fbox-content">
									...
									<div class="col-md-6">
										<div class="feature-box media-box">
											<div class="fbox-icon">
												<a href="#">
													<i class="bi-globe rounded-0 bg-transparent text-start"></i>
												</a>
											</div>
											<div class="fbox-content">
							...
							<div class="col-lg-4">
								...
								<div class="card shadow" data-animate="shake" style="opacity: 1 !important">
									<div class="card-body">
										...
										<div class="badge bg-color registration-badge shadow-sm">FREE</div>
										<h3 class="card-title ls-1 mt-4 fw-bold">Get Your Free Online Courses!</h3>
										<h6 class="card-subtitle mb-4 fw-normal text-uppercase ls-2 text-black-50">Free Registration here.</h6>
										...
										<div class="form-widget">
											...
											<form class="row mb-0" id="template-contactform" name="template-contactform" action="include/form.php" method="post">
												...
												<div class="col-12 form-group">
													<input type="text" id="template-contactform-name" name="template-contactform-name" value="" class="form-control border-form-control required" placeholder="Your Full Name:">
												</div>
												<div class="col-12 form-group">
													<input type="email" id="template-contactform-email" name="template-contactform-email" value="" class="required email form-control border-form-control" placeholder="Your Email Address:">
												</div>

												<div class="col-12 form-group">
													<input type="text" id="template-contactform-phone" name="template-contactform-phone" value="" class="form-control border-form-control required" placeholder="Your Phone Number:">
												</div>

												<div class="col-12 form-group">
													<button class="button button-rounded w-100 button-large bg-color text-white text-transform-none ls-0 mx-0" type="submit" id="template-contactform-submit" name="template-contactform-submit" value="submit">Apply It Now</button>
													<br>
													<small class="d-block mt-3 text-muted text-smaller">We'll do our best to get back to you within 6-8 working hours.</small>
												</div>
				...
				<div class="footer-widgets-wrap">
					...
					<div class="row">
						<div class="col-6 col-md"  style="background: url('images/world-map.png') no-repeat center center; background-size: 100%;">
							...
							<a href="#"><i class="bi-envelope me-2"></i>info@canvas.com</a>
						</div>
						<div class="col-6 col-md">
							<h4 class="text-uppercase ls-2 fw-normal">Best Courses</h4>
						...
						<div class="col-6 col-md col-sm mt-4 mt-md-0 mt-lg-0 mt-xl-0">
							<h4 class="text-uppercase ls-2 fw-normal">Support</h4>
							<ul class="list-unstyled mb-0">
								<li><h5 class="mb-2 fw-normal"><a href="#">My Account</a></h5></li>
								<li><h5 class="mb-2 fw-normal"><a href="#">Become an Instructor</a></h5></li>
								<li><h5 class="mb-2 fw-normal"><a href="#">Free Courses</a></h5></li>
								<li><h5 class="mb-2 fw-normal"><a href="#">Mobile Apps</a></h5></li>
								<li><h5 class="mb-2 fw-normal"><a href="#">Contact Us</a></h5></li>
							</ul>
						</div>
						<div class="col-6 col-md mt-4 mt-md-0 mt-lg-0 mt-xl-0">
							<h4 class="text-uppercase ls-2 fw-normal">Worldwide</h4>
