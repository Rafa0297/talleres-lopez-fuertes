...
<head>
	...
	<link href="https://fonts.googleapis.com/css2?family=Source+Sans+Pro:wght@300;400;600;700&family=Roboto:wght@300;400;700&family=Kristi&display=swap" rel="stylesheet">
	...
	<!-- Document Title
	============================================= -->
	<title>One Page with Common Height Content Sections Alternate | Canvas</title>
...
<div class="body-overlay"></div>
	...
	<div id="wrapper">
		...
		<!-- Slider
		============================================= -->
		<section id="slider" class="slider-element slider-parallax min-vh-100 include-header bg-contrast-100">
			<div class="slider-inner">

				<div class="row align-items-center w-100 h-100 position-md-absolute position-lg-relative m-0">
					<div class="col-lg-7 col-md-6 text-center p-0 h-100 min-vh-50 order-md-last">
						<div class="fslider h-100 position-absolute" data-speed="2000" data-pause="4000" data-animation="fade" data-arrows="false" data-pagi="false">
							<div class="flexslider">
								<div class="slider-wrap">
									<div class="slide" style="background: url('one-page/images/section/1.png') center center; background-size: cover;"></div>
									<div class="slide" style="background: url('one-page/images/section/2.png') center center; background-size: cover;"></div>
									<div class="slide" style="background: url('one-page/images/section/3.png') center center; background-size: cover;"></div>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="vertical-middle subscribe-widget" data-loader="button">
							<div class="col-padding">
								<div class="heading-block border-bottom-0 mb-4">
									<h1 style="line-height: 1.4;font-size: 24px;">Subscribe to the Best Feed</h1>
								</div>
								<div class="widget-subscribe-form-result"></div>
								<form id="slider-subscribe-form" action="include/subscribe.php" method="post" class="row mb-0">
									<div class="col-6 mb-3">
										<input type="text" class="form-control border-form-control not-dark required" name="widget-subscribe-form-fname" placeholder="First Name">
									</div>
									<div class="col-6 mb-3">
										<input type="text" class="form-control border-form-control not-dark required" name="widget-subscribe-form-lname" placeholder="Last Name">
									</div>
									<div class="w-100"></div>
									<div class="col-12 mb-3">
										<input type="email" class="form-control border-form-control not-dark required" name="widget-subscribe-form-email" placeholder="Enter Email Address">
									</div>
									<div class="col-12">
										<button type="submit" class="button button-dark button-circle button-border ms-0 mt-4" value="submit">Subscribe Me</button>
									</div>
								</form>
							</div>
						</div>
