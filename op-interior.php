...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Interior - One Page Canvas Slider | Canvas</title>
	...
	<div id="wrapper">
		...
		<div id="side-panel" class="dark">
			...
			<div class="side-panel-wrap">
				...
				<div class="widget quick-contact-widget">
					...
					<div class="d-flex flex-wrap" style="--cnvs-socialicon-gap-y:5px;">
						...
						<a href="#" class="social-icon si-small text-white bg-pinterest" title="Pinterest">
							<i class="fa-brands fa-pinterest-p"></i>
							<i class="fa-brands fa-pinterest-p"></i>
						</a>
						<a href="#" class="social-icon si-small text-white bg-forrst" title="Forrst">
							<i class="fa-solid fa-tree"></i>
							<i class="fa-solid fa-tree"></i>
						</a>
						<a href="#" class="social-icon si-small text-white bg-linkedin" title="LinkedIn">
							<i class="fa-brands fa-linkedin"></i>
							<i class="fa-brands fa-linkedin"></i>
						</a>
						<a href="#" class="social-icon si-small text-white bg-google" title="Google Plus">
		...
		<section id="slider" class="slider-element revslider-wrap include-header">
			...
			<nav class="custom-hero-nav">
				<ul class="one-page-menu mb-0" data-easing="easeInOutExpo" data-speed="1300" data-offset="60">
			...
			<div id="welcome_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="news-content-Goodnews-Header" data-source="gallery" style="background:#FFF;padding:0px;">
				...
				<div id="welcome" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.5">
					<ul>	<!-- SLIDE  -->
						<li class="dark" data-index="rs-209" data-transition="slidingoverlayup" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-rotate="0"  data-saveperformance="off"  data-title="Fitness" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
							<!-- MAIN IMAGE -->
							<img src="include/rs-plugin/demos/assets/images/dummy.png"  alt="Image"  data-lazyload="one-page/images/page/interior/1.jpg" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="4" class="rev-slidebg" data-no-retina>
							<!-- LAYERS -->

							<div id="rrzb_209" class="rev_row_zone rev_row_zone_bottom" style="z-index: 7; width: auto; right: 0px; left: auto;">
								<!-- LAYER NR. 1 -->
								...
								<div class="tp-caption  "
									 ...
									 data-x="['right','right','right','right']" data-hoffset="['0','0','100','100']"
						 ...
						 data-verticalalign="top"
									...
									style="z-index: 8; width: 100%;background-color:#FFF;">
								<!-- LAYER NR. 3 -->
								<div class="tp-caption text-uppercase  tp-resizeme"
									...
									style="z-index: 10; white-space: normal; font-size: 15px; line-height: 15px; font-weight: 600; color: #c5a477; letter-spacing: 3px; display: inline-block;font-family:source Sans Pro;">Bedroom / 2132 sqft.</div>
						 ...
						 href="https://themeforest.net/item/canvas-the-multipurpose-html5-template/9228123?ref=SemiColonWeb&license=regular&open_purchase_for_item_id=9228123&purchasable=source" target="_self"			 id="slide-209-layer-4"
									...
									style="z-index: 11; white-space: normal; font-size: 45px; line-height: 54px; font-weight: 400; color: #2d3032; letter-spacing: 0px; display: inline-block;font-family:Playfair Display;cursor:pointer;text-decoration: none;">Luxury 4BHK Gallaxy Apartment</a>
								...
								<div class="tp-caption   tp-resizeme"
									...
									style="z-index: 12; white-space: normal; font-size: 16px; line-height: 22px; font-weight: 400; color: rgba(45,48,50,0.75); letter-spacing: 0px; display: inline-block;font-family:source Sans Pro;">4 Bedrooms / 3 Bathrooms / 2 Balcony / 1 Kitchen</div>
									</div>
								</div>
							</div>
						</li>

						<li class="dark" data-index="rs-210" data-transition="slidingoverlayup" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-rotate="0"  data-saveperformance="off"  data-title="Fitness" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
							<!-- MAIN IMAGE -->
							<img src="include/rs-plugin/demos/assets/images/dummy.png"  alt="Image"  data-lazyload="one-page/images/page/interior/2.jpg" data-bgposition="bottom center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="4" class="rev-slidebg" data-no-retina>
							<!-- LAYERS -->

							<div id="rrzb_210" class="rev_row_zone rev_row_zone_bottom" style="z-index: 7; width: auto; right: 0px; left: auto;">
								<!-- LAYER NR. 1 -->
								<div class="tp-caption  "
						 ...
						 data-verticalalign="top"
								...
								<div class="tp-caption text-uppercase  tp-resizeme"
									...
									style="z-index: 10; white-space: normal; font-size: 15px; line-height: 15px; font-weight: 600; color: #c5a477; letter-spacing: 3px; display: inline-block;font-family:source Sans Pro;">Bathrooms</div>
						 ...
						 href="https://themeforest.net/item/canvas-the-multipurpose-html5-template/9228123?ref=SemiColonWeb&license=regular&open_purchase_for_item_id=9228123&purchasable=source" target="_self"			 id="slide-210-layer-4"
									...
									style="z-index: 11; white-space: normal; font-size: 45px; line-height: 54px; font-weight: 400; color: #2d3032; letter-spacing: 0px; display: inline-block;font-family:Playfair Display;cursor:pointer;text-decoration: none;">Beautiful 3BHK Gallaxy</a>
						...
						<li class="dark" data-index="rs-211" data-transition="slidingoverlayup" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-rotate="0"  data-saveperformance="off"  data-title="Fitness" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
							<!-- MAIN IMAGE -->
							<img src="include/rs-plugin/demos/assets/images/dummy.png"  alt="Image"  data-lazyload="one-page/images/page/interior/3.jpg" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="4" class="rev-slidebg" data-no-retina>
							<!-- LAYERS -->

							<div id="rrzb_211" class="rev_row_zone rev_row_zone_bottom" style="z-index: 7; width: auto; right: 0px; left: auto;">
								<!-- LAYER NR. 1 -->
								<div class="tp-caption  "
						 ...
						 data-verticalalign="top"
								...
								<div class="tp-caption text-uppercase  tp-resizeme"
									...
									style="z-index: 10; white-space: normal; font-size: 15px; line-height: 15px; font-weight: 600; color: #c5a477; letter-spacing: 3px; display: inline-block;font-family:source Sans Pro;">Kitchen</div>
						 ...
						 href="https://themeforest.net/item/canvas-the-multipurpose-html5-template/9228123?ref=SemiColonWeb&license=regular&open_purchase_for_item_id=9228123&purchasable=source" target="_self"			 id="slide-211-layer-4"
									...
									style="z-index: 11; white-space: normal; font-size: 45px; line-height: 54px; font-weight: 400; color: #2d3032; letter-spacing: 0px; display: inline-block;font-family:Playfair Display;cursor:pointer;text-decoration: none;">White and Gold Beautiful Open Kitchen Design</a>
								...
								<div class="tp-caption   tp-resizeme"
									...
									style="z-index: 12; white-space: normal; font-size: 16px; line-height: 22px; font-weight: 400; color: rgba(45,48,50,0.75); letter-spacing: 0px; display: inline-block;font-family:source Sans Pro;">2 Bedrooms / 1 Bathrooms / 1 Balcony / 1 Kitchen</div>
									</div>
								</div>
							</div>
						</li>
		...
		<section id="content">
			<div class="content-wrap py-0">
				...
				<div id="section-works" class="page-section pt-0">
					...
					<div class="section m-0">
						<div class="container">
							<div class="mx-auto text-center" style="max-width: 900px;">
								<h2 class="mb-0 fw-light ls-1">We create &amp; craft projects that ooze creativity in every aspect. We try to create a benchmark in everything we do. Take a moment to browse through some of our recent completed work.</h2>
							</div>
						</div>
					</div>
						...
						<article class="portfolio-item col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="grid-inner">
								<div class="portfolio-image">
									...
									<div class="bg-overlay">
										<div class="bg-overlay-content flex-column" data-hover-animate="fadeIn">
											<div class="portfolio-desc p-0 text-center" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutDownSmall" data-hover-speed="350">
					...
					<div class="mt-5 text-center"><a href="#" class="button button-border button-circle fw-semibold">View More Projects</a></div>
				...
				<div id="section-services" class="page-section pt-0">
					...
					<div class="section m-0">
						<div class="container">
							<div class="mx-auto text-center" style="max-width: 900px;">
								<h2 class="mb-0 fw-light ls-1">We enjoy working on the Services &amp; Products we provide as much as you need them. This help us in delivering your Goals easily. Browse through the wide range of services we provide.</h2>
							</div>
						</div>
					</div>
					...
					<div class="section dark m-0">
						<div class="mx-auto text-center" style="max-width: 900px;">
							<h2 class="mb-0 fw-light ls-1">Like Our Services? Get an <a href="#" data-scrollto="#template-contactform" data-offset="140" data-easing="easeInOutExpo" data-speed="1250" class="button button-border button-circle button-light button-large my-0" style="position: relative; top: -3px;">Instant Quote</a></h2>
						</div>
					</div>
					...
					<div class="section parallax scroll-detect m-0 dark" style="padding: 150px 0;">
						...
						<div class="container">
							...
							<div class="row justify-content-end">
								<div class="col-md-7">
									<div class="fslider testimonial testimonial-full text-center bg-transparent border-0 shadow-none p-0" data-arrows="false">
										<div class="flexslider">
											<div class="slider-wrap">
												<div class="slide">
													<p class="mb-4 fs-4 fw-light ls-1">Similique fugit repellendus expedita excepturi iure perferendis provident quia eaque vero numquam?</p>
													<h4 class="h5 mb-0 fw-medium">Steve Jobs</h4>
													<small class="text-muted">Apple Inc.</small>
												</div>
												<div class="slide">
													<p class="mb-4 fs-4 fw-light ls-1">Natus voluptatum enim quod necessitatibus quis expedita harum provident eos obcaecati id culpa corporis molestias.</p>
													<h4 class="h5 mb-0 fw-medium">Collis Ta'eed</h4>
													<small class="text-muted">Envato Inc.</small>
												</div>
												<div class="slide">
													<p class="mb-4 fs-4 fw-light ls-1">Incidunt deleniti blanditiis quas aperiam recusandae consequatur ullam quibusdam cum libero illo rerum!</p>
				...
				<div id="section-blog" class="page-section">
									...
									<div class="grid-inner row align-items-center">
										...
										<div class="col-lg-6 mt-3 mt-lg-0">
											...
											<div class="entry-content">
												<a href="#" class="more-link">Read more <i class="uil uil-angle-right-b"></i></a>
											</div>
										</div>
									</div>
								</div>
					...
					<div class="container mt-6">
						...
						<div id="oc-clients" class="owl-carousel mt-5 image-carousel carousel-widget" data-margin="80" data-loop="true" data-nav="false" data-autoplay="5000" data-pagi="false" data-items-xs="2" data-items-sm="3" data-items-md="4" data-items-lg="5" data-items-xl="6">
							...
							<div class="form-widget">
								...
								<form class="row mb-0" id="template-contactform" name="template-contactform" action="include/form.php" method="post">
									...
									<div class="col-md-6 mb-4">
										<input type="text" id="template-contactform-name" name="template-contactform-name" value="" class="form-control border-form-control required" placeholder="Name">
									</div>
									<div class="col-md-6 mb-4">
										<input type="email" id="template-contactform-email" name="template-contactform-email" value="" class="required email form-control border-form-control" placeholder="Email Address">
									</div>

									<div class="w-100"></div>

									<div class="col-md-4 mb-4">
										<input type="text" id="template-contactform-phone" name="template-contactform-phone" value="" class="form-control border-form-control" placeholder="Phone">
									</div>

									<div class="col-md-8 mb-4">
										<input type="text" id="template-contactform-subject" name="subject" value="" class="required form-control border-form-control" placeholder="Subject">
									</div>

									<div class="w-100"></div>

									<div class="col-12 mb-4">
										<textarea class="required form-control border-form-control" id="template-contactform-message" name="template-contactform-message" rows="7" cols="30" placeholder="Your Message"></textarea>
									</div>

									<div class="col-12 text-center mb-4">
										<button class="button button-border button-circle fw-medium ms-0 mt-4" type="submit" id="template-contactform-submit" name="template-contactform-submit" value="submit">Send Message</button>
										<br>
										<small class="d-block mt-3 text-muted">We'll do our best to get back to you within 6-8 working hours.</small>
									</div>
						...
						<div class="col-lg-4">
							...
							<div class="widget subscribe-widget" data-loader="button">
								...
								<form id="widget-subscribe-form" action="include/subscribe.php" method="post" class="mb-0">
									...
									<button class="button button-border button-circle button-light mt-4" type="submit">Subscribe Now</button>
								</form>
							</div>
						...
						<div class="col-lg-4">
							...
							<div class="widget">
								...
								<div class="d-flex justify-content-center mt-4">
									...
									<a href="#" class="social-icon si-small bg-transparent h-bg-x-twitter" title="Twitter">
										<i class="fa-brands fa-x-twitter"></i>
										<i class="fa-brands fa-x-twitter"></i>
									</a>
