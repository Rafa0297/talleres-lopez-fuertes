...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Single - Furniture | Canvas</title>
			...
			<div class="content-wrap py-0 overflow-visible">
								...
								<div class="row">
									...
									<div class="col-md-6 product-desc p-lg-5 px-4 py-0 mt-5 mt-md-0 content-sticky">
										...
										<form class="cart mb-0 d-flex align-items-center" method="post" enctype='multipart/form-data'>
											...
											<button type="submit" class="add-to-cart button button-large fw-medium color button-light bg-white px-lg-4 add-to-cart m-0 mb-3"><i style="position: relative; top: -2px;"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="var(--cnvs-themecolor)" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><path d="M62.54543,144H188.10132a16,16,0,0,0,15.74192-13.13783L216,64H48Z" opacity="0.2"></path><path d="M184,184H69.81818L41.92162,30.56892A8,8,0,0,0,34.05066,24H16" fill="none" stroke="var(--cnvs-themecolor)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></path><circle cx="80" cy="204" r="20" fill="none" stroke="var(--cnvs-themecolor)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></circle><circle cx="184" cy="204" r="20" fill="none" stroke="var(--cnvs-themecolor)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></circle><path d="M62.54543,144H188.10132a16,16,0,0,0,15.74192-13.13783L216,64H48" fill="none" stroke="var(--cnvs-themecolor)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></path></svg></i> Add to cart</button>
				...
				<div class="section bg-transparent my-0 py-5">
					<div class="mw-sm mx-auto text-center px-4 px-md-0">
						...
						<a href="https://www.youtube.com/watch?v=lWb_427hIl0" data-lightbox="iframe" class="d-flex flex-column justify-content-center align-items-center mb-2  h-scale-sm transform-ts rounded-xxxl" style="background: url('demos/furniture/images/video-poster.jpg') no-repeat center center / cover; min-height: 450px">
