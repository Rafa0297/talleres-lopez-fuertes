...
<head>
	...
	<meta name="description" content="Create Modern Blogs, Magazine &amp; Infinite Scroll Websites with Canvas Template. Get Canvas to build powerful websites easily with the Highly Customizable &amp; Best Selling Bootstrap Template, today.">
				...
				<div class="container-fluid">
					<div class="header-row">
						...
						<div class="primary-menu-trigger">
							<button class="cnvs-hamburger not-dark" type="button" title="Open Mobile Menu">
			...
			<div class="content-wrap pt-lg-0 pt-xl-0 pb-0">
				...
				<div class="container">
					...
					<div class="text-center d-none">
						<a href="demo-modern-blog-2.php" class="load-next-posts"></a>
					</div>
