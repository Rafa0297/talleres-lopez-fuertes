...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Menu - Style 8 | Canvas</title>
					...
					<div class="header-row justify-content-between flex-row-reverse flex-lg-row">
						...
						<nav class="primary-menu sub-title">
							...
							<ul class="menu-container">
								<li class="menu-item">
									<a class="menu-link" href="index.php"><div>Home</div><span>Lets Start</span></a>
								...
								<li class="menu-item mega-menu">
									<a class="menu-link" href="#"><div>Shortcodes</div><span>Super Flexibility</span></a>
									<div class="mega-menu-content">
										<div class="container">
											<div class="row">
												<ul class="sub-menu-container mega-menu-column col">
