...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>One Page Teaser | Canvas</title>
...
.top-teaser .emphasis-title .highlight:hover { background-color: var(--cnvs-themecolor); }
</style>
...
<body class="stretched side-push-panel">
	...
	<div id="wrapper">
		...
		<!-- Header
		============================================= -->
		<header id="header" class="full-header border-full-header header-size-custom" data-sticky-shrink="false">
			<div id="header-wrap">
				<div class="container">
		...
		<div class="section top-teaser bg-transparent m-0 border-0 overflow-hidden" style="padding: 90px 0;">

			<div class="container">

				<div class="emphasis-title">
					<h1 class="ls-1 text-lowercase">We design Awesome <a href="#" class="highlight font-body fw-medium" data-scrollto="#section-works" data-easing="easeInOutExpo" data-speed="1250" data-offset="70">UI Elements</a><br>for Brand &amp; Media Agencies.</h1>
				</div>
		...
		<!-- Slider
		============================================= -->
		<section id="slider" class="slider-element swiper_wrapper min-vh-75" data-effect="fade" data-autoplay="5000" data-loop="true" data-speed="1000">
					...
					<div class="swiper-slide dark">
						<div class="container">
							<div class="slider-caption slider-caption-center">
								<h2 class="ls-0" data-animate="fadeInUp">A Different Canvas.</h2>
							</div>
						</div>
						<div class="swiper-slide-bg" style="background: #348F50; background: -webkit-linear-gradient(to left, #348F50 , #56B4D3); background: linear-gradient(to left, #348F50 , #56B4D3);"></div>
					</div>
					<div class="swiper-slide dark">
						<div class="container">
							<div class="slider-caption slider-caption-center">
								<h2 class="ls-0" data-animate="fadeInUp">Beautifully Flexible.</h2>
							</div>
						</div>
						<div class="swiper-slide-bg" style="background: #403B4A; background: -webkit-linear-gradient(to left, #403B4A , #E7E9BB); background: linear-gradient(to left, #403B4A , #E7E9BB);"></div>
					</div>
					<div class="swiper-slide dark">
						<div class="container">
							<div class="slider-caption slider-caption-center">
								<h2 class="ls-0" data-animate="fadeInUp">Great Performance.</h2>
							</div>
						</div>
						<div class="swiper-slide-bg" style="background: #403A3E; background: -webkit-linear-gradient(to left, #403A3E , #BE5869); background: linear-gradient(to left, #403A3E , #BE5869);"></div>
					</div>
				</div>
				<div class="slider-arrow-left" class="bg-transparent"><i class="uil uil-angle-left-b"></i></div>
				<div class="slider-arrow-right" class="bg-transparent"><i class="uil uil-angle-right-b"></i></div>
			</div>
