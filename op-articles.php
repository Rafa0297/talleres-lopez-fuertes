...
<head>
	...
	<link href="https://fonts.googleapis.com/css2?family=Source+Sans+Pro:wght@300;400;600;700&family=Roboto:wght@300;400;500;700&family=Playfair+Display&display=swap" rel="stylesheet">
	...
	<!-- Document Title
	============================================= -->
	<title>Articles - One Page Canvas Slider | Canvas</title>
					...
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide">
							<div class="row justify-content-center align-items-center g-0 h-100">
								...
								<div class="col-md-6 h-100" data-animate="fadeInLeft fast" style="background: url('demos/recipes/images/about/2.jpg') center center /cover; min-height: 360px;">
									<div class="d-flex align-items-center">
										<div class="slider-arrow-left slider-arrows"><i class="uil uil-angle-left-b"></i></div>
										<div class="slider-arrow-right slider-arrows"><i class="uil uil-angle-right-b"></i></div>
									</div>
								</div>
								...
								<div class="col-md-6 mt-5 mt-md-0">
									<div class="px-5">
										<div class="heading-block border-bottom-0 mb-4">
											<h5 class="mb-2 fw-normal text-black-50 text-uppercase ls-3" data-animate="fadeInUp">02 February 2021</h5>
											<h2 class="fw-bold ls-0 text-transform-none font-secondary" data-animate="fadeInUp">A Complete Recipes for Vegan People.</h2>
										</div>

										<p data-animate="fadeInUp">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Assumenda, animi. Nihil repellendus nemo praesentium eos illo assumenda, velit similique repellat.</p>

										<div class="mb-4 d-flex align-items-center" data-animate="fadeInUp">
											<a href="#" class="button button-large button-circle button-dark text-transform-none"><i class="bi-cart"></i> Add to Cart</a>
											<div class="rating-stars ms-4"><i class="bi-star-fill text-warning"></i><i class="bi-star-fill text-warning"></i><i class="bi-star-fill text-warning"></i><i class="bi-star-fill text-warning"></i><i class="bi-star-half text-warning"></i></div>
											<h5 class="mb-0 ms-4 fw-normal">by: <a href="#" class="fw-semibold">Samuel Serif</a></h5>
										</div>
									</div>
									...
									<div class="ms-5 mt-4" data-animate="fadeInUp">
										<div id="oc-images" class="owl-carousel image-carousel carousel-widget" data-margin="20"  data-autowidth="true" data-nav="true" data-pagi="false" data-items-xs="2" data-items-sm="3" data-items-lg="4" data-items-xl="4">
											<a href="#"><img src="demos/articles/images/articles/1/4.png" alt="Image 1"></a>
											<a href="#"><img src="demos/articles/images/articles/1/2.png" alt="Image 2"></a>
											<a href="#"><img src="demos/articles/images/articles/1/3.png" alt="Image 3"></a>
											<a href="#"><img src="demos/articles/images/articles/1/5.png" alt="Image 4"></a>
											<a href="#"><img src="demos/articles/images/articles/2/2.png" alt="Image 4"></a>
											<a href="#"><img src="demos/articles/images/articles/2/1.png" alt="Image 4"></a>
										</div>
									</div>
								</div>
							</div>
							<div class="swiper-slide-bg" style="background: linear-gradient(to right, rgba(255,255,255,0.75), rgba(255,255,255,1)), url('demos/recipes/images/about/2.jpg') center center /cover;"></div>
						</div>
						...
						<div class="swiper-slide">
							<div class="row justify-content-center align-items-center g-0 h-100">
								...
								<div class="col-md-6 h-100" data-animate="fadeInLeft fast" style="background: url('demos/nonprofit/images/slider/1.jpg') center center /cover; min-height: 360px;">
									<div class="d-flex align-items-center">
										<div class="slider-arrow-left slider-arrows"><i class="uil uil-angle-left-b"></i></div>
										<div class="slider-arrow-right slider-arrows"><i class="uil uil-angle-right-b"></i></div>
									</div>
								...
								<div class="col-md-6">
									<div class="px-5">
										<div class="heading-block border-bottom-0 mb-4">
											<h5 class="mb-2 fw-normal text-black-50 text-uppercase ls-3" data-animate="fadeInUp">02 February 2021</h5>
											<h2 class="fw-bold ls-0 text-transform-none font-secondary" data-animate="fadeInUp">A Complete Recipes for Veagn People.</h2>
										</div>
							...
							<div class="swiper-slide-bg" style="background: linear-gradient(to right, rgba(255,255,255,0.7), rgba(255,255,255,1)), url('demos/nonprofit/images/slider/1.jpg') center center /cover;"></div>
						</div>
					</div>
				</div>
