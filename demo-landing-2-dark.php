...
<head>
	...
	<meta name="description" content="Create Landing &amp; SAAS Websites with Canvas Template. Get Canvas to build powerful websites easily with the Highly Customizable &amp; Best Selling Bootstrap Template, today.">
	...
	<!-- Niche Demos -->
	<link rel="stylesheet" href="demos/landing-2/landing-2.css">
	...
	<!-- Document Title
	============================================= -->
	<title>Dark Demo Landing 2 | Canvas</title>
...
<body class="stretched dark">
	...
	<div id="wrapper">
		...
		<div class="position-absolute vh-100 w-100 top-0 start-0 overflow-hidden z-0">
			<img src="demos/landing-2/images/hero-bg.svg" alt="" class="hero-bg">
		</div>
				...
				<div class="container">
					<div class="header-row">
						...
						<div id="logo" class="me-lg-5">
							<a href="#" ><img src="demos/landing-2/images/logo.svg" alt="Canvas Logo" class="py-3"></a>
						</div><!-- #logo end -->
						...
						<div class="header-misc">
							...
							<!-- Top Search
							============================================= -->
							<a href="#" class="button button-dark button-black rounded-pill">Create a Project <i class="bi-arrow-right me-0 ms-1"></i></a>
						...
						<nav class="primary-menu me-lg-auto">
							...
							<ul class="menu-container">
								...
								<li class="menu-item"><a class="menu-link" href="index.php"><div>Help &amp; Supports</div></a></li>
							</ul>
		...
		<section id="content" class="bg-transparent">
			<div class="content-wrap overflow-visible pb-0">
							...
							<div class="row col-mb-50">
								<div class="col-lg-5">
                                    ...
                                    <div class="d-flex align-items-center mt-5">
                                        <img src="demos/landing-2/images/avatar.svg" alt="User" width="54">
                                        <div class="ms-3">
                                ...
                                <div class="col-lg-7">
                                    <img src="demos/landing-2/images/browser.jpg" alt="Image" class="shadow-lg rounded-6" width="720">
                                    <img src="demos/landing-2/images/hero-iphone.png" alt="Image" width="150" class="position-absolute mt-5 d-block d-lg-none" style="right: 0; bottom: 0;">
                                </div>
							</div>
						</div>
					</div>
						...
						<div class="section-sticky">
							<div class="container">
								<div class="row justify-content-end">
									<div class="col-md-7">
										<div class="position-relative">
											<img src="demos/landing-2/images/browser.jpg" alt="Image" class="position-relative op-0">
                                            <img src="demos/landing-2/images/hero-iphone-2.png" alt="Image" width="220" class="parallax position-absolute mb-5" style="right: 0; bottom: -50px; opacity: 0;" data-200-start="transform: translate(0px, 0px); opacity: 0;" data-top-bottom="transform: translate(-260px, -60px); opacity: 1;">
                                            <img src="demos/landing-2/images/hero-iphone.png" alt="Image" width="220" class="parallax position-absolute mb-5" style="right: 0; bottom: -60px;" data-0="transform: translate(0px, 0px) scale(1); bottom: -60px;" data-top-bottom="transform: translate(-60px, 60px) scale(1.3); bottom: 63px;">
										</div>
									</div>
								</div>
							</div>
				...
				<div class="container py-6 mw-md mt-5">
						...
						<div class="row gutter-custom justify-content-center" style="--custom-gutter: 80px;">
							<div class="col-sm-6">
								<div class="card border-0">
									<img src="demos/landing-2/images/services/3.jpg" alt="card img" class="rounded-5 mb-3">
									<div class="card-body">
										...
										<a href="#" class="button button-small button-dark button-border border-color h-bg-color h-text-dark rounded-pill m-0">Learn More <i class="bi-arrow-right me-0 ms-1"></i></a>
									</div>
								</div>
							</div>
							...
							<div class="col-sm-6">
								<div class="card border-0">
									<img src="demos/landing-2/images/services/2.jpg" alt="card img" class="rounded-5 mb-3">
									<div class="card-body">
							...
							<div class="col-sm-6">
								<div class="card border-0">
									<img src="demos/landing-2/images/services/1.jpg" alt="card img" class="rounded-5 mb-3">
									<div class="card-body">
							...
							<div class="col-sm-6">
								<div class="card border-0">
									<img src="demos/landing-2/images/services/4.jpg" alt="card img" class="rounded-5 mb-3">
									<div class="card-body">
				...
				<div class="section sticky-top p-0 mb-0 overflow-visible">
					<div class="row g-0">
						<div class="col-md-6 position-sticky m-0 vh-40 min-vh-md-100 top-0 z-1 overflow-hidden">
							<!-- Sticky Image Target -->
							<div id="list-example" class="w-100 h-100" style="background: url('demos/landing-2/images/sticky-section/video-poster.jpg') no-repeat center center / cover;">
								<!-- List Item 1 -->
								<div class="list-group-item active" id="list-item-1-target">
									<div class="video-wrap no-placeholder">
										<video id="slide-video" poster="demos/landing-2/images/sticky-section/video-poster.jpg" preload="auto" loop autoplay muted playsinline>
											<source src='demos/landing-2/images/sticky-section/video.mp4' type='video/mp4'>
										</video>
									</div>
								</div>
									...
									<div class="fslider position-absolute h-100 w-100 top-0 start-0" data-loop="true" data-pause="5000" data-animation="fade">
										<div class="flexslider h-100">
											<div class="slider-wrap">
												<div class="slide" style="background: url('demos/landing-2/images/sticky-section/2-1.jpg') center right; background-size: cover; height: 100% !important;"></div>
												<div class="slide" style="background: url('demos/landing-2/images/sticky-section/2-2.jpg') center right; background-size: cover; height: 100% !important;"></div>
											</div>
										</div>
									</div>
								...
								<!-- List Item 3 -->
								<div class="list-group-item" id="list-item-3-target" style="background-image: url('demos/landing-2/images/sticky-section/3.jpg');">
									<a href="demos/landing-2/images/sticky-section/3.jpg" data-lightbox="image" class="bi-image icon-stacked transform-ts bg-white h-bg-light rounded-circle text-dark h1 text-center shadow m-0"></a>
								</div>

								<!-- List Item 4 -->
								<div class="list-group-item" id="list-item-4-target" style="background-image: url('demos/landing-2/images/sticky-section/1.jpg');">
					...
					<div class="container py-5">
						...
						<div class="row justify-content-center gy-5" style="--bs-gutter-x: 60px">
							<div class="col-xl-5 col-lg-6">
								<div class="card border-0 bg-color rounded-6 pt-0">
									<div class="card-body text-center p-5 pt-0">
										<i class="bi-person h2 m-0 bg-black rounded-circle icon-stacked text-center" style="transform: translateY(-32px);"></i>
										<h2 class="text-transform-none fw-bold fs-2 mb-0 text-dark">Standard</h2>
										<p class="text-dark">For individuals and small projects.</p>
										<div class="bg-black p-2 d-flex justify-content-center align-items-center rounded text-start">
										...
										<div class="small op-07 mt-2 text-dark">Or $110 per year</div>
										<div class="text-start my-5 d-flex flex-column justify-content-center align-items-center text-start">
											<div>
												<h4 class="mb-3 h6 fw-medium text-dark"><i class="bi-check-circle-fill me-2"></i> Use free 30 Days with pay</h4>
												<h4 class="mb-3 h6 fw-medium text-dark"><i class="bi-check-circle-fill me-2"></i> Use it from anywhere</h4>
												<h4 class="mb-3 h6 fw-medium text-dark"><i class="bi-check-circle-fill me-2"></i> All devices except mobile</h4>
												<h4 class="h6 fw-medium text-dark"><i class="bi-check-circle-fill me-2"></i> For individual person only</h4>
											</div>
										</div>
										<a href="#" class="button button-xlarge button-black button-dark px-5 py-3 w-100 rounded-pill m-0">Start your 30-Day Free Trial</a>
										<div class="small op-06 mt-2 text-black-50">No Credit-Card required upto 30days</div>
									</div>
								</div>
							</div>
							...
							<div class="col-xl-5 col-lg-6">
								<div class="card border-0 rounded-6 pt-0" style="background: linear-gradient( to bottom left, rgba(255, 224, 54, .3), rgba(216, 220, 232, .5) 70% );">
									<div class="card-body text-center p-5 pt-0">
										...
										<div class="bg-white bg-opacity-10 p-3 d-flex justify-content-center align-items-center rounded text-start">
										...
										<div class="text-start my-5 py-3 d-flex flex-column justify-content-center align-items-center text-start">
											<div>
												...
												<h4 class="mb-3 h6 fw-medium"><i class="bi-check-circle-fill me-2"></i> For all latest devices</h4>
												<h4 class="mb-3 h6 fw-medium"><i class="bi-check-circle-fill me-2"></i> Unlimited users excess</h4>
												<h4 class="h6 fw-medium"><i class="bi-check-circle-fill me-2"></i> Priority support available</h4>
											</div>
										</div>
										<a href="#" class="button button-xlarge button-dark bg-black px-5 py-3 w-100 rounded-pill h-op-09 m-0">Contact Us</a>
							...
							<div class="col-lg-9 mt-6">
								...
								<div class="px-6 py-5 rounded" style="background: linear-gradient( to bottom left, rgba(255, 224, 54, .15), rgba(216, 220, 232, .3) 70% );">
				...
				<div class="section  bg-opacity-10 py-0 mt-4">
					<div class="position-absolute top-0 end-0 w-100 h-100" style="background: url('demos/landing-2/images/section-bg.svg') no-repeat right 70%; background-size: 100%;"></div>
					<div class="container">
								...
								<div class="d-flex mt-4">
									<div class="d-flex flex-column me-2">
										<a href="#" class="button button-xlarge rounded-pill button-dark d-flex align-items-center justify-content-center py-3 bg-dark h-op-09 m-0 mb-3">
											...
											<img src="demos/landing-2/images/appstore.svg" alt="Store Logo" width="45" height="45">
											<div class="d-flex flex-column ms-3">
												<small class="fw-normal text-smaller lh-1 mb-2 op-06">Get it on the</small>
												<span class="h5 mb-0 fw-semibold lh-1">Apple Store</span>
											</div>
										</a>
										<a href="#" class="button button-xlarge rounded-pill button-dark d-flex align-items-center justify-content-center py-3 bg-dark h-op-09 m-0">
											<img src="demos/landing-2/images/playstore.svg" alt="Store Logo" width="45" height="45">
											<div class="d-flex flex-column ms-3">
												<small class="fw-normal text-smaller lh-1 mb-2 op-06">Get it on the</small>
												<span class="h5 mb-0 fw-semibold lh-1">Google Store</span>
											</div>
										</a>
									</div>
									<img src="demos/landing-2/images/qr.svg" alt="Image" height="170" class="bg-white border p-2 ms-4">
								</div>
							</div>

							<div class="col-lg-6 col-md-8 mt-6 mt-sm-0">
								<div class="d-flex align-items-end">
									<img src="demos/landing-2/images/phone-2-half.png" class="fast" alt="Image" style="width: 300px;">
									<img src="demos/landing-2/images/phone-1-half.png" class="fast" alt="Image" style="width: 370px; transform: translateX(-100px);">
								</div>
							</div>
				...
				<div class="section bg-transparent my-0">
					<div class="container text-center">
						<h2 class="display-4 font-secondary position-relative">
							...
							Enjoy the Canvas now
						</h2>
						<p class="mw-xs mx-auto text-white-50">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Excepturi molestiae sequi placeat facilis quis recusandae nisi nesciunt illo fuga in.</p>
					...
					<div class="row col-mb-50">
						...
						<div class="col-md-4">
							<div class="widget">
								...
								<img src="demos/landing-2/images/logo.svg" alt="Image" class="footer-logo" height="60">
						...
						<div class="col-md-2">
							<div class="widget">
								...
								<p class="mb-0 mt-4 mt-md-5 text-smaller op-06">Copyrights &copy; 2023 All Rights Reserved by Canvas Inc.</p>
