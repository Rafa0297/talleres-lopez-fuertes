...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Rates - Movers Demo | Canvas</title>
...
<body class="stretched">
	...
	<div id="wrapper">
					...
					<div class="header-row justify-content-between flex-row-reverse flex-lg-row">
						...
						<nav class="primary-menu with-arrows">
							...
							<ul class="menu-container">
								...
								<li class="menu-item current"><a class="menu-link" href="demo-movers-rates.php"><div>Rates</div></a>
									<ul class="sub-menu-container" data-class="up-lg:not-dark">
										<li class="menu-item"><a class="menu-link" href="#"><div><i class="bi-house"></i>Home Moving</div></a></li>
										<li class="menu-item"><a class="menu-link" href="#"><div><i class="bi-building"></i>Office Moving</div></a></li>
										<li class="menu-item"><a class="menu-link" href="#"><div><i class="bi-globe"></i>International Moving</div></a></li>
										<li class="menu-item"><a class="menu-link" href="#"><div><i class="fa-solid fa-paw"></i>Pet Shifting</div></a></li>
										<li class="menu-item"><a class="menu-link" href="#"><div><i class="bi-car-front"></i>Car Shifting</div></a></li>
										<li class="menu-item"><a class="menu-link" href="#"><div><i class="bi-truck"></i>Hire Truck</div></a></li>
									</ul>
								</li>
		...
		<!-- Page Title
		============================================= -->
		<section class="page-title bg-color dark py-6" style="border-bottom: 1px solid rgba(255, 255, 255, .1);">
			<div class="container">
