...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>One Page HTML5 Video Grid | Canvas</title>
...
<body class="stretched side-push-panel">
	...
	<div id="wrapper">
		...
		<!-- Header
		============================================= -->
		<header id="header" class="full-header transparent-header dark header-size-custom" data-sticky-shrink="false" data-sticky-class="not-dark">
			<div id="header-wrap">
				<div class="container">
		...
		<section id="slider" class="slider-element slider-parallax min-vh-100 include-header">
			<div class="slider-inner">
				...
				<div class="row text-center dark w-100 h-100 mx-0 position-absolute align-self-stretch">

					<div class="col-6 p-0 dark videoplay-on-hover">
						<div class="vertical-middle text-center slider-element-fade">
							<h2 class="mb-0 ls-1 font-body">different.</h2>
						</div>
						<div class="video-wrap no-placeholder">
	                        <video id="slide-video" poster="one-page/images/videos/1.jpg" preload="auto" loop muted playsinline>
					...
					<div class="col-6 p-0 dark videoplay-on-hover">
						<div class="vertical-middle text-center slider-element-fade">
							<h2 class="mb-0 ls-1 font-body">extensible.</h2>
						</div>
						<div class="video-wrap no-placeholder">
	                        <video id="slide-video" poster="one-page/images/videos/3.jpg" preload="auto" loop muted playsinline>
	                            <source src='one-page/images/videos/3.webm' type='video/webm'>
	                            <source src='one-page/images/videos/3.mp4' type='video/mp4'>
	                        </video>
					...
					<div class="col-6 p-0 dark videoplay-on-hover">
						<div class="vertical-middle text-center slider-element-fade">
							<h2 class="mb-0 ls-1 font-body">flexible.</h2>
						</div>
						<div class="video-wrap no-placeholder">
	                        <video id="slide-video" poster="images/videos/explore-poster.jpg" preload="auto" loop muted playsinline>
					...
					<div class="col-6 p-0 dark videoplay-on-hover">
						<div class="vertical-middle text-center slider-element-fade">
							<h2 class="mb-0 ls-1 font-body">powerful.</h2>
						</div>
						<div class="video-wrap no-placeholder">
