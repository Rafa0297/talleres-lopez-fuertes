...
<head>
	...
	<link href="https://fonts.googleapis.com/css2?family=Source+Sans+Pro:wght@300;400;600;700&family=Roboto:wght@300;400;700&family=Playfair+Display:wght@400&display=swap" rel="stylesheet">
	...
	<!-- Document Title
	============================================= -->
	<title>One Page Subscription Sections | Canvas</title>
...
<div class="body-overlay"></div>
	...
	<div id="wrapper">
		...
		<!-- Header
		============================================= -->
		<header id="header" class="full-header transparent-header header-size-custom" data-sticky-shrink="false" data-sticky-offset="full">
			<div id="header-wrap">
				<div class="container">
		...
		<section id="slider" class="slider-element slider-parallax min-vh-100 include-header">
			<div class="slider-inner">
				...
				<div class="row align-items-stretch position-relative position-md-absolute position-lg-relative w-100 h-100 m-0">
					<div class="col-xl-5 col-md-6" style="background-color: #FFF;">
						<div class="vertical-middle subscribe-widget" data-loader="button">
							<div class="col-padding">
								<div class="heading-block border-bottom-0 ms-4">
									<h1 class="text-transform-none fw-normal" style="line-height: 1.4;font-size: 48px; font-family: 'Playfair Display', serif; font-weight: 400;">Type and Subscribe</h1>
									<span style="font-size:16px; top-margin: 20px;" class="fw-light">Deals, Coupon Codes &amp; Insider Tips to get the Best out of our Products &amp; Services.</span>
								</div>
					...
					<div class="col-xl-7 col-md-6 text-center p-0 min-vh-50" style="background: url('one-page/images/page/op-subscription.jpg') center center no-repeat; background-size: cover; z-index: -1">
							...
							<div class="emphasis-title mb-0">
								<h1>
									<span class="text-rotater nocolor" data-separator="|" data-rotate="fadeIn" data-speed="6000">
										<span class="t-rotate fw-bold font-body opm-medium-word">canvas.|different.|creative.|digital.|vision.</span>
									</span>
								</h1>
							</div>
