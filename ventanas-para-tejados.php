    ...
    <section id="carpinteria-aluminio" class="py-5">
      <div class="container">
        ...
        <div class="text-center mb-5">
          <h2 class="fw-bold text-uppercase" style="color:#003b6f;">Ventanas para Tejados</h2>
          <p class="lead text-muted mx-auto" style="max-width: 700px; text-align: justify">
            Las ventanas para tejados son una solución práctica y elegante para aprovechar al máximo los espacios
            abuhardillados y techos inclinados. Estas ventanas permiten la entrada de luz natural, mejoran la
            ventilación y ofrecen vistas panorámicas, creando ambientes acogedores y funcionales en cualquier estancia.
            Disponibles en diversos estilos y materiales, las ventanas para tejados se adaptan a las necesidades
            estéticas
            y funcionales de cada hogar.
          </p>
        </div>
        ...
        <div class="row align-items-center g-5">
          <!-- Imagen principal -->
          <div class="col-lg-6">
            <img src="demos/construction/images/products/ventanas-para-tejados/1.jpg" alt="Carpintería de Aluminio"
              class="img-fluid rounded shadow-sm w-100">
          </div>

          <!-- Descripción -->
          <div class="col-lg-6">
            <h3 class="fw-semibold mb-3">Luz, Ventilación y Control Térmico en su Cubierta</h3>
            <p>
              Nuestras <strong>ventanas para tejados</strong> transforman su espacio bajo cubierta,
              aportando <strong>luz natural</strong> y permitiendo una <strong>ventilación eficiente</strong> que ayuda
              a
              regular la temperatura y la calidad del aire. Diseñadas para una instalación
              perfecta en diferentes tipos de cubiertas, garantizan <strong>estanqueidad y durabilidad</strong>.
              Disponibles con diversos sistemas de apertura y acristalamientos.
            </p>
            <ul class="list-unstyled">
              <li><i class="fa-solid fa-check text-danger me-2"></i> Máximo aprovechamiento de la luz cenital</li>
              <li><i class="fa-solid fa-check text-danger me-2"></i> Apertura para ventilación natural y evacuación de
                calor</li>
              <li><i class="fa-solid fa-check text-danger me-2"></i> Opciones manuales, eléctricas o solares con control
                remoto</li>
            </ul>
          </div>
        ...
        <div class="row align-items-center g-5">
          <!-- Descripción -->
          <div class="col-lg-6">
            <p style="text-align: justify;">Las ventanas para tejados iluminan los interiores, ventilan los espacios de
              los lofts y brindan vistas al exterior. Por otro lado, instalar ventanas en el techo requiere menos mano
              de obra que construir buhardillas.
              <br><br>
              Al elegir las ventanas del techo, hay que tener en cuenta la funcionalidad, la eficiencia energética, la
              seguridad de uso y la resistencia a los robos.
              <br><br>
              Los residentes encuentran todos estos aspectos muy importantes. Todos quieren sentirse seguros y cómodos
              en casa.Las ventanas de techo que ofrece Talleres Lopez Fuertes están fabricadas con excelente calidad,
              alta durabilidad y eficiencia energética.
            </p>

          </div>
          <!-- Imagen secundaria -->
          <div class="col-lg-6">
            <img src="demos/construction/images/products/ventanas-para-tejados/2.jpg" alt="Carpintería de Aluminio"
              class="img-fluid rounded shadow-sm w-100">
          </div>
        ...
        <div style="margin-top: 30px;" class="container">
          ...
          <div id="portfolio" class="portfolio row gutter-20">
            ...
            <article class="portfolio-item col-12 col-sm-6 col-md-4 pf-media pf-icons">
              <div class="grid-inner">
                <div class="portfolio-image">
                  <img src="demos/construction/images/products/ventanas-para-tejados/3.png" alt="The Atmosphere">
                  <div class="bg-overlay">
                    <div class="bg-overlay-content dark" data-hover-animate="fadeIn">
                      <a href="demos/construction/images/products/ventanas-para-tejados/3.png"
            ...
            <article class="portfolio-item col-12 col-sm-6 col-md-4 pf-illustrations">
              <div class="grid-inner">
                <div class="portfolio-image">
                  <img src="demos/construction/images/products/ventanas-para-tejados/4.jpg" alt="Wavelength Structure">
                  <div class="bg-overlay">
                    <div class="bg-overlay-content dark" data-hover-animate="fadeIn">
                      <a href="demos/construction/images/products/ventanas-para-tejados/4.jpg"
                        class="overlay-trigger-icon bg-light text-dark" data-hover-animate="zoomIn"
                        data-hover-animate-out="zoomOut" data-hover-speed="350"><i class="uil uil-search-plus"></i></a>
                    </div>
                    <div class="bg-overlay-bg dark" data-hover-animate="fadeIn"></div>
            ...
            <article class="portfolio-item col-12 col-sm-6 col-md-4 pf-graphics pf-uielements">
              <div class="grid-inner">
                <div class="portfolio-image">
                  <img src="demos/construction/images/products/ventanas-para-tejados/5.jpg" alt="Greenhouse Garden">
                  <div class="bg-overlay">
                    <div class="bg-overlay-content dark" data-hover-animate="fadeIn">
                      <a href="demos/construction/images/products/ventanas-para-tejados/5.jpg"
                        class="overlay-trigger-icon bg-light text-dark" data-hover-animate="zoomIn"
                        data-hover-animate-out="zoomOut" data-hover-speed="350"><i class="uil uil-search-plus"></i></a>
                    </div>
                    <div class="bg-overlay-bg dark" data-hover-animate="fadeIn"></div>
