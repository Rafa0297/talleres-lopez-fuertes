...
<head>
	...
	<meta name="description" content="Create Server Hosting, VPS Cloud, Domains &amp; Reselling Websites with Canvas Template. Get Canvas to build powerful websites easily with the Highly Customizable &amp; Best Selling Bootstrap Template, today.">
	...
	<div id="wrapper">
				...
				<div class="container">
					<div class="header-row">
						...
						<div class="header-misc">
							<a href="#" class="button bg-contrast-1000 text-contrast-100 h-bg-dark h-text-light button-rounded">Sign Up</a>
						</div>
		...
		<section id="content">
			<div class="content-wrap py-0">
				...
				<!-- Pricing Section
				============================================= -->
				<div class="section bg-angle mt-0" style="background: #F9F9F9 url('demos/hosting/images/pattern-dark.png') repeat center center;">
					<div class="container">
						...
						<div class="col-md-3 col-6 mt-5 mt-sm-0">
							...
							<div class="widget">
								...
								<ul class="list-unstyled iconlist">
									...
									<li><i class="fa-brands fa-x-twitter"></i><a href="https://twitter.com/__semicolon" target="_blank"> Twitter</a></li>
	...
	<script>
		jQuery(document).ready( function() {
			...
			function calculatePrice( cpu, ram, storage ) {
				...
				jQuery('.cpu-value').php(pricingCPU);
				jQuery('.ram-value').php(pricingRAM);
				jQuery('.storage-value').php(pricingStorage);
				jQuery('.cpu-price').php('$'+pricingCPU * 10);
				jQuery('.ram-price').php('$'+pricingRAM * 8);
				jQuery('.storage-price').php('$'+pricingStorage * 0.5);
