...
<body class="stretched" data-loader-html="<div id='css3-spinner-svg-pulse-wrapper'><svg id='css3-spinner-svg-pulse' version='1.2' height='210' width='550' xmlns='https://www.w3.org/2000/svg' viewport='0 0 60 60' xmlns:xlink='https://www.w3.org/1999/xlink'><path id='css3-spinner-pulse' stroke='#DE6262' fill='none' stroke-width='2' stroke-linejoin='round' d='M0,90L250,90Q257,60 262,87T267,95 270,88 273,92t6,35 7,-60T290,127 297,107s2,-11 10,-10 1,1 8,-10T319,95c6,4 8,-6 10,-17s2,10 9,11h210'></svg></div>">
	...
	<div id="wrapper">
					...
					<div class="header-row">
						...
						<nav class="primary-menu style-3 menu-spacing-margin">
							...
							<ul class="menu-container">
								...
								<li class="menu-item current"><a class="menu-link" href="demo-medical-appointment.php"><div>Appointment</div></a></li>
		...
		<!-- Page Title
		============================================= -->
		<section class="page-title page-title-parallax parallax scroll-detect" style="padding: 100px 0;">
			<img src="demos/medical/images/appointment/page-title-bg.jpg" class="parallax-bg">
			<div class="container">
		...
		<section id="content">
			<div class="content-wrap">
				...
				<div class="section mb-0 parallax scroll-detect">
					<img src="demos/medical/images/appointment/bg.jpg" class="parallax-bg">
					<div class="container">
						<div class="row">
							<div class="col-lg-5">
								<div class="d-none d-lg-block" style="position: relative;" data-height-xl="413" >
									<img src="demos/medical/images/appointment/doctor1.png" alt="Image" style="position: absolute; bottom: -82px;">
								</div>
							</div>
							...
							<div class="form-widget col-lg-7">
								...
								<form class="row mb-0" id="template-medical-form" name="template-medical-form" action="include/form.php" method="post">
									...
									<div class="col-12 form-group text-end">
										<button class="button button-rounded m-0" type="submit" value="submit">Confirm Booking</button>
									</div>
								</form>
		...
		<!-- Footer
		============================================= -->
		<footer id="footer" class="bg-constrast-100" style="border-top: 2px solid rgba(var(--cnvs-contrast-rgb),0.06);">
