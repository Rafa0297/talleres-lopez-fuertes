...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>One Page HTML5 Video with Form | Canvas</title>
...
<body class="stretched side-push-panel">
	...
	<div id="wrapper">
		...
		<!-- Header
		============================================= -->
		<header id="header" class="full-header transparent-header dark header-size-custom" data-sticky-shrink="false" data-sticky-class="not-dark" data-sticky-offset="full" data-sticky-offset-negative="auto">
			<div id="header-wrap">
				<div class="container">
			...
			<div class="slider-inner">
				...
				<div class="vertical-middle slider-element-fade">
					<div class="container text-center py-5">
						<div class="inline-block pulse animated infinite dark"><a id="play-hero-video" href="#" class="big-video-button mb-5"><i class="uil uil-play"></i><i class="uil uil-pause"></i></a></div>
						<div id="hide-on-play" class="card mx-auto" style="background-color:#FFF;border-color: #eee;max-width:400px;">
							<div class="card-body" style="padding: 30px;">
								<div class="heading-block border-bottom-0 mb-4">
									<h1 style="font-size: 20px;">Start your Free Trial</h1>
									<span style="font-size: 15px;" class="fw-light text-capitalize ls-1 mt-0 d-none d-md-block">Get Started within 5 Minutes.</span>
								</div>
								<form action="#" class="row mb-3">
									<input class="d-none" type="text" name="ignore-username">
									<input class="d-none" type="password" name="ignore-password">
									<div class="col-12 mb-3">
										<input type="text" id="template-op-form-email" name="template-op-form-username" value="" class="form-control text-center" placeholder="Choose a Username">
									</div>
									<div class="col-12 mb-3">
										<input type="password" id="template-op-form-password" name="template-op-form-password" value="" class="form-control text-center" placeholder="Choose a Password">
									</div>
									<div class="col-12">
										<button type="submit" class="fw-normal text-capitalize button button-border button-circle m-0" value="submit">Register Now</button>
									</div>
								</form>
							</div>
						</div>
				...
				<div class="video-wrap no-placeholder">
					<video id="hero-video" poster="one-page/images/videos/1.jpg" preload="auto" loop muted playsinline>
						<source src='one-page/images/videos/1.webm' type='video/webm'>
						<source src='one-page/images/videos/1.mp4' type='video/mp4'>
					</video>
	...
	<script>
		jQuery('#play-hero-video').on('click', function(e){
			e.preventDefault();
