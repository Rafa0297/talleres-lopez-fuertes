...
<head>
	...
	<meta name="description" content="Create CV, Resume &amp; Curriculum Vitae Websites with Canvas Template. Get Canvas to build powerful websites easily with the Highly Customizable &amp; Best Selling Bootstrap Template, today.">
			...
			<div id="header-wrap">
				<div class="container">
					<div class="header-row">
						...
						============================================= -->
						<div id="logo">
							<a href="demo-resume.php" class="font-secondary ls-3" style="line-height: 90px;">canvas</a>
						</div><!-- #logo end -->
				...
				<div class="container">
					<div class="slider-caption dark slider-caption-right">
						<div>
							...
							<a class="font-primary border-0 ls-1 mt-4 inline-block more-link text-white dark d-none d-sm-inline-block" data-animate="fadeIn" data-delay="800" data-scrollto="#section-works" data-offset="0" href="#"><u>My Works</u> &rarr;</a>
						</div>
					</div>
				</div>
								...
								<div class="row">
									<div class="col-md-6">
										<ul class="niche-demos-lists mb-0 lists-1">
											<li class="mt-0"><a href="demo-restaurant.php"><img src="images/intro/niche/restaurant.jpg" alt="Image">Restaurant Demo</a></li>
											<li><a href="demo-photography.php"><img src="images/intro/niche/photography.jpg" alt="Image">Photography</a></li>
											<li><a href="demo-medical.php"><img src="images/intro/niche/medical.jpg" alt="Image">Medical</a></li>
											<li><a href="demo-spa.php"><img src="images/intro/niche/spa.jpg" alt="Image">Spa</a></li>
											<li><a href="demo-cafe.php"><img src="images/intro/niche/new/cafe.jpg" alt="Image">Coffee</a></li>
											<li><a href="demo-interior-design.php"><img src="images/intro/niche/interior-design.jpg" alt="Image">Interior Design</a></li>
											<li><a href="demo-barber.php"><img src="images/intro/niche/barber.jpg" alt="Image">Barber</a></li>
										</ul>
									</div>
									<div class="col-md-6">
										<ul class="niche-demos-lists mb-0 lists-2">
											<li><a href="demo-travel.php"><img src="images/intro/niche/travel.jpg" alt="Image">Travel</a></li>
											<li><a href="demo-media-agency.php"><img src="images/intro/niche/media-agency.jpg" alt="Image">Media Agency</a></li>
											<li><a href="demo-construction.php"><img src="images/intro/niche/construction.jpg" alt="Image">Construction</a></li>
											<li><a href="demo-writer.php"><img src="images/intro/niche/writer.jpg" alt="Image">Writer</a></li>
											<li><a href="demo-real-estate.php"><img src="images/intro/niche/real-estate/1.jpg" alt="Image">Real Estate</a></li>
											<li><a href="demo-business.php"><img src="images/intro/niche/business.jpg" alt="Image">Business</a></li>
											<li><a href="demo-app-landing.php"><img src="images/intro/niche/app-landing.jpg" alt="Image">App Landing</a></li>
										</ul>
									</div>
								</div>
			...
			<div class="container">
				...
				<div class="footer-widgets-wrap" style="padding: 80px 0">
					...
					<div class="row col-mb-50">
						<div class="col-lg-3">
							<div class="footer-logo"><span class="fw-normal color ls-1" style="font-size: 22px; ">SemiColonWeb.</span><br><small class="ls-3 text-uppercase" style="color: rgba(255,255,255,0.2);">&copy; 2023 Reserved.</small></div>
						</div>
	...
	<script>
		window.addEventListener('scroll', function() {
			var pixs = window.scrollY,
				opacity = pixs / 650,
				element = document.querySelector( '.blurred-img' ),
			...
			if( ( elementHeight + elementNextHeight + 50 ) > pixs ) {
				element.classList.add('blurred-image-visible');
				element.style.opacity = opacity;
			} else {
				element.classList.remove('blurred-image-visible');
			}
		});
	</script>
