					...
					<div class="header-row justify-content-lg-between">
						...
						<nav class="primary-menu with-arrows">
							...
							<ul class="menu-container">
								...
								<li class="menu-item mega-menu"><a class="menu-link" href="demo-store-products.php"><div>Men</div></a>
						...
						<div class="swiper-slide dark">
							<div class="container">
								<div class="slider-caption">
									...
									<div>
										<a href="demo-store-products.php" data-animate="fadeInUp" data-delay="200" class="button button-large button-white button-light">Shop Men</a>
										<a href="demo-store-products.php" data-animate="fadeInUp" data-delay="200" class="button button-large button-white button-light">Shop Women</a>
									</div>
								</div>
							</div>
						...
						<div class="col-md-4 mb-5">
							<div class="card cat-card rounded-0 border-0 dark">
								...
								<div class="d-flex align-items-start flex-column card-img-overlay p-4">
									...
									<a href="demo-store-products.php" class="button button button-white button-light ms-0">Shop Now</a>
								</div>
							</div>
						</div>
						<div class="col-md-4 mb-5">
							...
							<div class="row">
								...
								<div class="col-lg-4 col-md-6 mb-4">
									<div class="product">
										<div class="product-image position-relative">
											<div class="fslider" data-pagi="false" data-speed="400" data-pause="200000">
												<div class="flexslider">
													<div class="slider-wrap">
														<div class="slide">
															<a href="demo-store-product-single.php"><img src="demos/store/images/product/3-1.jpg" alt="Morning Dew"></a>
														</div>
														<div class="slide">
															<a href="demo-store-product-single.php"><img src="demos/store/images/product/3-2.jpg" alt="Morning Dew"></a>
														</div>
														<div class="slide">
															<a href="demo-store-product-single.php"><img src="demos/store/images/product/3-3.jpg" alt="Morning Dew"></a>
														</div>
														<div class="slide">
															<a href="demo-store-product-single.php"><img src="demos/store/images/product/3-4.jpg" alt="Morning Dew"></a>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="product-desc">
											<div class="product-title">
												<h3><a href="demo-store-product-single.php">Men Black Sweatshirt</a></h3>
										...
										<div class="product-image position-relative">
											<div class="fslider" data-pagi="false" data-speed="400" data-pause="200000">
												<div class="flexslider">
													<div class="slider-wrap">
														<div class="slide">
															<a href="demo-store-product-single.php"><img src="demos/store/images/product/4-1.jpg" alt="Morning Dew"></a>
														</div>
														<div class="slide">
															<a href="demo-store-product-single.php"><img src="demos/store/images/product/4-2.jpg" alt="Morning Dew"></a>
														</div>
													</div>
												</div>
											</div>
								...
								<div class="col-lg-4 col-md-6 mb-4">
									<div class="product">
										<div class="product-image position-relative">
											<div class="fslider" data-pagi="false" data-speed="400" data-pause="200000">
												<div class="flexslider">
													<div class="slider-wrap">
														<div class="slide">
															<a href="demo-store-product-single.php"><img src="demos/store/images/product/5-1.jpg" alt="Morning Dew"></a>
														</div>
														<div class="slide">
															<a href="demo-store-product-single.php"><img src="demos/store/images/product/5-2.jpg" alt="Morning Dew"></a>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="product-desc">
											<div class="product-title">
												<h3><a href="demo-store-product-single.php">Women Sports Pant</a></h3>
								...
								<div class="col-lg-4 col-md-6 mb-4">
									<div class="product">
										<div class="product-image position-relative">
											<div class="fslider" data-pagi="false" data-speed="400" data-pause="200000">
												<div class="flexslider">
													<div class="slider-wrap">
														<div class="slide">
															<a href="demo-store-product-single.php"><img src="demos/store/images/product/6-1.jpg" alt="Morning Dew"></a>
														</div>
														<div class="slide">
															<a href="demo-store-product-single.php"><img src="demos/store/images/product/6-2.jpg" alt="Morning Dew"></a>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="product-desc">
											<div class="product-title">
												<h3><a href="demo-store-product-single.php">Men White Escaper SL Running Sports Shoes</a></h3>
								...
								<div class="col-lg-4 col-md-6 mb-4">
									<div class="product">
												...
												<div class="flexslider">
													<div class="slider-wrap">
														<div class="slide" data-thumb="demos/store/images/product/7-1.jpg">
															<a href="demo-store-product-single.php"><img src="demos/store/images/product/7-1.jpg" alt="Morning Dew"></a>
														</div>
														<div class="slide" data-thumb="demos/store/images/product/7-2.jpg">
															<a href="demo-store-product-single.php"><img src="demos/store/images/product/7-2.jpg" alt="Morning Dew"></a>
														</div>
														<div class="slide" data-thumb="demos/store/images/product/7-3.jpg">
															<a href="demo-store-product-single.php"><img src="demos/store/images/product/7-3.jpg" alt="Morning Dew"></a>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="product-desc">
											<div class="product-title">
												<h3><a href="demo-store-product-single.php">The Cotton Weave Shirtdress</a></h3>
								...
								<div class="col-lg-4 col-md-6 mb-4">
									<div class="product">
										<div class="product-image">
											<a href="demo-store-product-single.php"><img src="demos/store/images/product/8-1.jpg" alt="Morning Dew"></a>
											<a href="demo-store-product-single.php"><img src="demos/store/images/product/8-2.jpg" alt="Morning Dew"></a>
											<a href="#" class="cart-btn button button-white button-light"><i class="uil uil-plus"></i>Add to Cart</a>
										</div>
										<div class="product-desc">
											<div class="product-title">
										...
										<div class="product-image">
											<div class="fslider" data-pagi="false" data-speed="400" data-pause="200000">
												<div class="flexslider">
													<div class="slider-wrap">
														<div class="slide">
															<a href="demo-store-product-single.php"><img src="demos/store/images/product/9-1.jpg" alt="Morning Dew"></a>
														</div>
														<div class="slide">
															<a href="demo-store-product-single.php"><img src="demos/store/images/product/9-2.jpg" alt="Morning Dew"></a>
														</div>
														<div class="slide">
															<a href="demo-store-product-single.php"><img src="demos/store/images/product/9-3.jpg" alt="Morning Dew"></a>
														</div>
													</div>
												</div>
											</div>
				...
				<div class="container-fluid mt-5">
					<div class="row">
						...
						<div class="col-md-6 mb-5">
							...
							<p class="mb-3"><i class="bi-geo-alt-fill"></i> <strong>Headquarters: </strong><a href="#" class="text-black-50 under btn-link"> 795 Folsom Ave, Suite 600 San Francisco, CA 94107</a></p>
