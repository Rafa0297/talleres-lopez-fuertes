...
<body class="stretched side-push-panel">
						...
						<div class="row align-items-center">
							<div class="col-md-6 text-center text-md-start">
								<div class="emphasis-title mb-0">
									<span class="text-uppercase d-block text-black-50" style="letter-spacing:10px; font-size: 18px">Smart Watch</span>
									<h2 class="mt-2 fw-semibold font-secondary" style="font-size: 64px; color: #E25B45; line-height: 1.3; letter-spacing: -2px;"><u>Canvas Watch New colors to style your spring</u></h2>
									<h2 class="fw-bold mt-4">$200</h2>
									<a href="#" data-animate="fadeInUp" data-delay="600" class="button button-circle button-white button-light button-large text-white mt-4 text-transform-none ls-0" style="background-color: #E25B45">View Details</a>
								</div>
							</div>
							...
							<div class="col-md-6">
								...
								<div id="oc-watch-bg" style="background: #E25B45; width: 360px; height: 360px; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); opacity: 1; border-radius: 50%;"></div>
							</div>
						</div>
	...
	<script>
		jQuery(window).on( 'load', function() {
			var owlWatch = jQuery('#oc-watch'),
				owlWatchbg = jQuery('.bgchanger');
