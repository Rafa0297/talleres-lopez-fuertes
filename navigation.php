				...
				<div class="container">
					...
					<div class="row justify-content-center">
						<div class="col-lg-9">
							...
							<ul class="nav nav-pills">
								<li class="nav-item"><a class="nav-link" href="#">Clickable link</a></li>
								<li class="nav-item"><a class="nav-link" href="#">Clickable link</a></li>
								<li class="nav-item"><a class="nav-link" class="disabled" href="#">Disabled link</a></li>
							</ul>

							<div class="line"></div>

							<h4>Using Dopdowns</h4>

							<ul class="nav nav-tabs">
								<li class="nav-item"><a class="nav-link" class="active" href="#">Home</a></li>
							...
							<nav class="navbar navbar-expand-lg navbar-light bg-light">
								<div class="container-fluid">
									...
									<div class="collapse navbar-collapse" id="navbarSupportedContent">
										...
										<form class="row gx-3 align-items-center my-2 my-lg-0">
											<div class="col">
							...
							<div class="pos-f-t">
								<div class="collapse" id="navbarToggleExternalContent4">
									<div class="bg-dark p-4">
										<h4 class="text-white mb-2">Collapsed content</h4>
