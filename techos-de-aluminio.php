    ...
    <section id="carpinteria-aluminio" class="py-5">
      <div class="container">
        ...
        <div class="text-center mb-5">
          <h2 class="fw-bold text-uppercase" style="color:#003b6f;">Techos de Aluminio</h2>
          <p class="lead text-muted mx-auto" style="max-width: 700px; text-align: justify">
            Los techos de aluminio son una solución moderna y versátil para crear espacios exteriores protegidos y
            funcionales. Ideales para terrazas, patios o jardines, estos techos ofrecen resistencia a la intemperie,
            durabilidad y un diseño elegante que se adapta a cualquier estilo arquitectónico.
          </p>
        </div>
        ...
        <div class="row align-items-center g-5">
          <!-- Imagen principal -->
          <div class="col-lg-6">
            <img src="demos/construction/images/products/techos-de-aluminio/1.jpg" alt="Carpintería de Aluminio"
              class="img-fluid rounded shadow-sm w-100">
          </div>

          <!-- Descripción -->
          <div class="col-lg-6">
            <h3 class="fw-semibold mb-3">Resistencia, estética y protección</h3>
            <p>
              Los techos de aluminio ofrecen una solución duradera y moderna para interiores y exteriores.
              Su diseño ligero y resistente a la humedad, el sol y la corrosión los convierte en la opción ideal
              para terrazas, porches, cocinas y baños, aportando un acabado elegante y funcional.
            </p>
            <ul class="list-unstyled">
              <li><i class="fa-solid fa-check text-danger me-2"></i> Alta resistencia a la humedad y la corrosión</li>
              <li><i class="fa-solid fa-check text-danger me-2"></i> Fácil mantenimiento y larga durabilidad</li>
              <li><i class="fa-solid fa-check text-danger me-2"></i> Diseño moderno y adaptable a cualquier espacio</li>
            </ul>
          </div>
        ...
        <div class="row align-items-center g-5">
          <!-- Descripción -->
          <div class="col-lg-6">
            <p style="text-align: justify;">Los techos de aluminio son extremadamente duraderos y resistentes, son
              adecuados para entornos con un diseño moderno y se utilizan en espacios con grandes elementos
              acristalados. El aluminio es resistente al fuego y también a las grandes diferencias de temperatura.
              <br><br>
              El soporte apenas es necesario, siempre y cuando esté hecho con un sistema de buena calidad y por un
              fabricante bien establecido. No hay restricciones para los colores, utilizados para tales marcos.
            </p>

          </div>
          <!-- Imagen secundaria -->
          <div class="col-lg-6">
            <img src="demos/construction/images/products/techos-de-aluminio/2.jpg" alt="Carpintería de Aluminio"
              class="img-fluid rounded shadow-sm w-100">
          </div>
        ...
        <div style="margin-top: 30px;" class="container">
          ...
          <div id="portfolio" class="portfolio row gutter-20">
            ...
            <article class="portfolio-item col-12 col-sm-6 col-md-4 pf-media pf-icons">
              <div class="grid-inner">
                <div class="portfolio-image">
                  <img src="demos/construction/images/products/techos-de-aluminio/3.jpg" alt="The Atmosphere">
                  <div class="bg-overlay">
                    <div class="bg-overlay-content dark" data-hover-animate="fadeIn">
                      <a href="demos/construction/images/products/techos-de-aluminio/3.jpg"
            ...
            <article class="portfolio-item col-12 col-sm-6 col-md-4 pf-illustrations">
              <div class="grid-inner">
                <div class="portfolio-image">
                  <img src="demos/construction/images/products/techos-de-aluminio/4.jpg" alt="Wavelength Structure">
                  <div class="bg-overlay">
                    <div class="bg-overlay-content dark" data-hover-animate="fadeIn">
                      <a href="demos/construction/images/products/techos-de-aluminio/4.jpg"
                        class="overlay-trigger-icon bg-light text-dark" data-hover-animate="zoomIn"
                        data-hover-animate-out="zoomOut" data-hover-speed="350"><i class="uil uil-search-plus"></i></a>
                    </div>
                    <div class="bg-overlay-bg dark" data-hover-animate="fadeIn"></div>
            ...
            <article class="portfolio-item col-12 col-sm-6 col-md-4 pf-graphics pf-uielements">
              <div class="grid-inner">
                <div class="portfolio-image">
                  <img src="demos/construction/images/products/techos-de-aluminio/5.jpg" alt="Greenhouse Garden">
                  <div class="bg-overlay">
                    <div class="bg-overlay-content dark" data-hover-animate="fadeIn">
                      <a href="demos/construction/images/products/techos-de-aluminio/5.jpg"
                        class="overlay-trigger-icon bg-light text-dark" data-hover-animate="zoomIn"
                        data-hover-animate-out="zoomOut" data-hover-speed="350"><i class="uil uil-search-plus"></i></a>
                    </div>
                    <div class="bg-overlay-bg dark" data-hover-animate="fadeIn"></div>
