...
<head>
	...
	<meta name="description" content="Create SEO Services &amp; Lead Generation Management Websites with Canvas Template. Get Canvas to build powerful websites easily with the Highly Customizable &amp; Best Selling Bootstrap Template, today.">
...
<body class="stretched">
	...
	<div id="wrapper">
					...
					<div class="col-12 col-md-auto">
						...
						<div class="top-links">
							<ul class="top-links-container">
								<li class="top-links-item"><a href="demo-seo.php">Home</a></li>
								<li class="top-links-item"><a href="demo-seo-faqs.php">FAQs</a></li>
								<li class="top-links-item"><a href="demo-seo-contact.php">Contact</a></li>
					...
					<div class="header-row">
						...
						<nav class="primary-menu with-arrows">
							...
							<ul class="menu-container">
								<li class="menu-item"><a class="menu-link" href="demo-seo.php"><div>Home</div></a></li>
								<li class="menu-item current"><a class="menu-link" href="demo-seo-about.php"><div>What We Do</div></a></li>
								<li class="menu-item mega-menu"><div class="menu-link"><div>Services</div></div>
									<div class="mega-menu-content mega-menu-style-2 px-0">
										<div class="container">
											<div class="row">
												<a href="demo-seo-optimizations.php" class="mega-menu-column sub-menu-container col-lg-4 border-bottom h-bg-light py-4">
												...
												<a href="demo-seo-social.php" class="mega-menu-column sub-menu-container col-lg-4 border-bottom h-bg-light py-4">
													<div class="feature-box">
														<div class="fbox-icon mb-2">
												...
												<a href="demo-seo-adwords.php" class="mega-menu-column sub-menu-container col-lg-4 border-bottom h-bg-light py-4">
													<div class="feature-box">
														<div class="fbox-icon mb-2">
												...
												<a href="demo-seo-experience.php" class="mega-menu-column sub-menu-container col-lg-4 border-bottom h-bg-light py-4">
													<div class="feature-box">
														<div class="fbox-icon mb-2">
												...
												<a href="demo-seo-analysis.php" class="mega-menu-column sub-menu-container col-lg-4 border-bottom h-bg-light py-4">
													<div class="feature-box">
														<div class="fbox-icon mb-2">
												...
												<a href="demo-seo-content-marketing.php" class="mega-menu-column sub-menu-container col-lg-4 border-bottom h-bg-light py-4">
													<div class="feature-box">
														<div class="fbox-icon mb-2">
												...
												<div class="mega-menu-column sub-menu-container col-12 p-0">
													<a href="#" class="button button-rounded button-large text-transform-none ls-0 w-100 text-center m-0 rounded-0 py-3 button-light ">View All <i class="bi-arrow-right"></i></a>
												</div>
											</div>
										</div>
									</div>
								</li>
								<li class="menu-item"><a class="menu-link" href="demo-seo-faqs.php"><div>FAQs</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-seo-contact.php"><div>Contact</div></a></li>
							</ul>
		...
		<section class="page-title page-title-parallax parallax scroll-detect page-title-center dark include-header include-topbar" style="padding-bottom: 140px;">
			<img src="demos/seo/images/about-title.jpg" class="parallax-bg">
			...
			<div class="container position-relative">
				<div class="page-title-row">
					...
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="demo-seo.php">Home</a></li>
			...
			<div class="content-wrap py-0 overflow-visible">
						...
						<div class="row align-items-center">
							<div class="col-md-6">
								<div class="heading-block border-bottom-0 mb-0">
									...
									<h3 class="text-transform-none ls-0 mb-3">See how our Business Grows Month by Month</h3>
									<p>Dynamically provide access to resource-leveling mindshare vis-a-vis bricks-and-clicks ideas authoritatively.</p>
									<a href="#" class="button button-rounded text-capitalize m-0 ls-0">Get Started</a>
								</div>
							</div>
							<div class="col-md-6">
					...
					<div class="container">
						<div class="row col-mb-30 align-content-stretch">
							...
							<div class="col-lg-4 col-md-6 d-flex">
								<a href="demo-seo-experience.php" class="card h-shadow h-translate-y-sm all-ts">
									<div class="card-body p-5">
										<div class="feature-box flex-column">
											...
											<div class="fbox-content">
												<h3 class="text-transform-none ls-0 text-larger">SEO optimization</h3>
							...
							<div class="col-lg-4 col-md-6 d-flex">
								<a href="demo-seo-social.php" class="card h-shadow h-translate-y-sm all-ts">
									<div class="card-body p-5">
										<div class="feature-box flex-column">
											<div class="fbox-image mb-5 text-center">
											...
											<div class="fbox-content">
												<h3 class="text-transform-none ls-0 text-larger">Social Media Marketing</h3>
												<p class="text-smaller">Objectively fashion highly efficient testing off proced through sustainable channels.</p>
											</div>
											<ul class="iconlist ms-3 mt-4 mb-0">
												<li class="mb-2 text-muted"><i class="fa-solid fa-check text-smaller color"></i> Facebook Advertising</li>
												<li class="mb-2 text-muted"><i class="fa-solid fa-check text-smaller color"></i> Instagram Advertising</li>
												<li class="mb-2 text-muted"><i class="fa-solid fa-check text-smaller color"></i> Twitter Advertising</li>
												<li class="mb-2 text-muted"><i class="fa-solid fa-check text-smaller color"></i> Pinterest Advertising</li>
												<li class="text-muted"><i class="fa-solid fa-check text-smaller color"></i> Sales Banner</li>
											</ul>
										</div>
									</div>
								</a>
							...
							<div class="col-lg-4 col-md-6 d-flex">
								<a href="demo-seo-adwords.php" class="card h-shadow h-translate-y-sm all-ts">
									<div class="card-body p-5">
										<div class="feature-box flex-column">
											<div class="fbox-image mb-5 text-center">
											...
											<div class="fbox-content">
												<h3 class="text-transform-none ls-0 text-larger">Adwords Campaign</h3>
												<p class="text-smaller">Objectively fashion highly efficient testing off proced through sustainable channels.</p>
											</div>
											<ul class="iconlist ms-3 mt-4 mb-0">
												<li class="mb-2 text-muted"><i class="fa-solid fa-check text-smaller color"></i> Google Search</li>
												<li class="mb-2 text-muted"><i class="fa-solid fa-check text-smaller color"></i> Google Shopping</li>
												<li class="mb-2 text-muted"><i class="fa-solid fa-check text-smaller color"></i> App Campaign</li>
												<li class="mb-2 text-muted"><i class="fa-solid fa-check text-smaller color"></i> Video Advertising</li>
												<li class="mb-2 text-muted"><i class="fa-solid fa-check text-smaller color"></i> Mobile Advertising</li>
												<li class="text-muted"><i class="fa-solid fa-check text-smaller color"></i> Display Advertising</li>
											</ul>
										</div>
									</div>
								</a>
							...
							<div class="col-lg-4 col-md-6 d-flex">
								<a href="demo-seo-analysis.php" class="card h-shadow h-translate-y-sm all-ts">
									<div class="card-body p-5">
										<div class="feature-box flex-column">
											<div class="fbox-image mb-5 text-center">
											...
											<ul class="iconlist ms-3 mt-4 mb-0">
												<li class="mb-2 text-muted"><i class="fa-solid fa-check text-smaller color"></i> Google Analytics</li>
												<li class="mb-2 text-muted"><i class="fa-solid fa-check text-smaller color"></i> Page Analytics</li>
												<li class="text-muted"><i class="fa-solid fa-check text-smaller color"></i> Page Speed</li>
											</ul>
										</div>
									</div>
								</a>
								...
								<a href="demo-seo-experience.php" class="card h-shadow h-translate-y-sm all-ts">
									<div class="card-body p-5">
										<div class="feature-box flex-column">
											...
											<ul class="iconlist ms-3 mt-4 mb-0">
												<li class="mb-2 text-muted"><i class="fa-solid fa-check text-smaller color"></i> Orginality</li>
												<li class="mb-2 text-muted"><i class="fa-solid fa-check text-smaller color"></i> Quality</li>
												<li class="mb-2 text-muted"><i class="fa-solid fa-check text-smaller color"></i> Readability</li>
												<li class="mb-2 text-muted"><i class="fa-solid fa-check text-smaller color"></i> Keyword Density</li>
												<li class="text-muted"><i class="fa-solid fa-check text-smaller color"></i> Grammer &amp; Spelling</li>
											</ul>
										</div>
									</div>
								</a>
							...
							<div class="col-lg-4 col-md-6 d-flex">
								<a href="demo-seo-content-marketing.php" class="card h-shadow h-translate-y-sm all-ts">
									<div class="card-body p-5">
										<div class="feature-box flex-column">
											<div class="fbox-image mb-5 text-center">
											...
											<ul class="iconlist ms-3 mt-4 mb-0">
												<li class="mb-2 text-muted"><i class="fa-solid fa-check text-smaller color"></i> Increase Profits</li>
												<li class="mb-2 text-muted"><i class="fa-solid fa-check text-smaller color"></i> Create a Story</li>
												<li class="text-muted"><i class="fa-solid fa-check text-smaller color"></i> Create a Dialogue</li>
											</ul>
										</div>
									</div>
								</a>
				...
				<div class="section mt-0" style="background: url('demos/seo/images/sections/3.jpg') no-repeat top center; background-size: cover; padding: 0 0 70px;">
					<div class="container">
						...
						<div id="oc-testi" class="owl-carousel testimonials-carousel carousel-widget" data-margin="0" data-pagi="true" data-loop="true" data-center="true" data-autoplay="5000" data-items-sm="1" data-items-md="2" data-items-xl="3">
				...
				<div class="section mt-5" style="padding: 100px 0; overflow: visible; background: url('demos/seo/images/sections/3.jpg') no-repeat top center; background-size: cover;">
					<div class="container">
						<div class="heading-block border-bottom-0 text-center">
							...
							<a href="demo-seo-contact.php" class="button button-large button-rounded text-transform-none ms-0 ls-0 mt-4">Contact Us Now</a>
						</div>
					</div>
				</div>
			</div>
