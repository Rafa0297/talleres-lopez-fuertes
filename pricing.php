	...
	<div id="wrapper">
			...
			<div class="container">
				<div class="page-title-row pb-5 align-items-lg-end">
					...
					<div class="page-title-content">
						<h1>Pricing</h1>
						<span>Start selling your Subscription Plans effectively</span>
		...
		<section id="content">
			<div class="content-wrap">
							...
							<div class="grid-inner">
								<div class="card rounded-6 overflow-hidden">
									<div class="card-body p-5">
										<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="#578316" viewBox="0 0 256 256"><path d="M63.81,192.19c-47.89-79.81,16-159.62,151.64-151.64C223.43,176.23,143.62,240.08,63.81,192.19Z" opacity="0.2"></path><path d="M223.45,40.07a8,8,0,0,0-7.52-7.52C139.8,28.08,78.82,51,52.82,94a87.09,87.09,0,0,0-12.76,49c.57,15.92,5.21,32,13.79,47.85l-19.51,19.5a8,8,0,0,0,11.32,11.32l19.5-19.51C81,210.73,97.09,215.37,113,215.94q1.67.06,3.33.06A86.93,86.93,0,0,0,162,203.18C205,177.18,227.93,116.21,223.45,40.07ZM153.75,189.5c-22.75,13.78-49.68,14-76.71.77l88.63-88.62a8,8,0,0,0-11.32-11.32L65.73,179c-13.19-27-13-54,.77-76.71,22.09-36.47,74.6-56.44,141.31-54.06C210.2,114.89,190.22,167.41,153.75,189.5Z"></path></svg>

										<h3 class="fs-6 fw-semibold text-uppercase mb-0 mt-4">Personal</h3>
										<h4 class="display-5 fw-bold my-3">$49</h4>

										<p class="fw-light">Best for Individual Explorers who wants all the Features at an Affordable Price.</p>
										<a href="#" class="button button-border button-rounded button-large h-bg-dark mx-0 fw-bold d-block">Get Started</a>

										<h5 class="fs-6 fw-bold mt-4 mb-3 pt-1">What's Included:</h5>
										<ul class="iconlist iconlist-sm fw-medium text-muted mb-0">
											<li><i class="bi-check-circle-fill text-success"></i><span>220+ Block Templates</span></li>
											<li><i class="bi-check-circle-fill text-success"></i><span>Ultimate Form Processor</span></li>
											<li><i class="bi-check-circle-fill text-success"></i><span>100+ Home Demos</span></li>
											<li><i class="bi-check-circle-fill text-success"></i><span>1500+ UI Elements</span></li>
										</ul>
									</div>
								</div>
							</div>
				...
				<div class="section bg-contrast-200">
					<div class="container">

						<div class="row g-4">
							<div class="col-lg-4">
								<div class="card rounded-6 overflow-hidden border-0 shadow-sm">
									<div class="card-body p-5">
										<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="#578316" viewBox="0 0 256 256"><path d="M63.81,192.19c-47.89-79.81,16-159.62,151.64-151.64C223.43,176.23,143.62,240.08,63.81,192.19Z" opacity="0.2"></path><path d="M223.45,40.07a8,8,0,0,0-7.52-7.52C139.8,28.08,78.82,51,52.82,94a87.09,87.09,0,0,0-12.76,49c.57,15.92,5.21,32,13.79,47.85l-19.51,19.5a8,8,0,0,0,11.32,11.32l19.5-19.51C81,210.73,97.09,215.37,113,215.94q1.67.06,3.33.06A86.93,86.93,0,0,0,162,203.18C205,177.18,227.93,116.21,223.45,40.07ZM153.75,189.5c-22.75,13.78-49.68,14-76.71.77l88.63-88.62a8,8,0,0,0-11.32-11.32L65.73,179c-13.19-27-13-54,.77-76.71,22.09-36.47,74.6-56.44,141.31-54.06C210.2,114.89,190.22,167.41,153.75,189.5Z"></path></svg>
				...
				<div class="container">
					...
					<div class="row pricing col-mb-30 mb-4">
						<div class="col-md-6 col-lg-4">
							...
							<div class="pricing-box pricing-simple px-5 py-4 bg-light text-center text-md-start">
								...
								<div class="pricing-features">
									<ul class="iconlist" style="--cnvs-iconlist-color: var(--bs-dark);">
										<li><i class="bi-check-lg"></i> <span><strong>Full</strong> Access</span></li>
										<li><i class="bi-check-lg"></i> <span><strong>100</strong> User Accounts</span></li>
										<li><i class="bi-check-lg"></i> <span><strong>1 Year</strong> License</span></li>
										<li><i class="bi-check-lg"></i> <span><strong>24/7</strong> Support</span></li>
									</ul>
								</div>
						...
						<div class="col-md-6 col-lg-4">
							...
							<div class="pricing-box pricing-simple px-5 py-4 bg-light text-center text-md-start">
								...
								<div class="pricing-features">
									<ul class="iconlist" style="--cnvs-iconlist-color: var(--bs-dark);">
										<li><i class="bi-check-lg"></i> <span><strong>Premium</strong> Plugins</span></li>
										<li><i class="bi-check-lg"></i> <span><strong>SEO</strong> Features</span></li>
										<li><i class="bi-check-lg"></i> <span><strong>Full</strong> Access</span></li>
										<li><i class="bi-check-lg"></i> <span><strong>100</strong> User Accounts</span></li>
										<li><i class="bi-check-lg"></i> <span><strong>1 Year</strong> License</span></li>
										<li><i class="bi-check-lg"></i> <span><strong>24/7</strong> Support</span></li>
						...
						<div class="col-md-6 col-lg-4">
							...
							<div class="pricing-box pricing-simple px-5 py-4 bg-light text-center text-md-start">
								...
								<div class="pricing-features">
									<ul class="iconlist" style="--cnvs-iconlist-color: var(--bs-dark);">
										<li><i class="bi-check-lg"></i> <span><strong>55+</strong> Niche Demos</span></li>
										<li><i class="bi-check-lg"></i> <span><strong>Drag-n-Drop</strong> Builder</span></li>
										<li><i class="bi-check-lg"></i> <span><strong>Premium</strong> Plugins</span></li>
										<li><i class="bi-check-lg"></i> <span><strong>SEO</strong> Features</span></li>
										<li><i class="bi-check-lg"></i> <span><strong>Full</strong> Access</span></li>
										<li><i class="bi-check-lg"></i> <span><strong>100</strong> User Accounts</span></li>
					...
					<div class="row pricing col-mb-30 mb-4">
						<div class="col-md-6 col-lg-4">
							...
							<div class="pricing-box pricing-simple p-5 bg-light border-top border-primary text-center">
								...
								<div class="pricing-price">
									<span class="price-unit">&euro;</span>0
								</div>
								<div class="pricing-action">
									<a href="#" class="btn btn-primary btn-lg">Get Started</a>
								</div>
						...
						<div class="col-md-6 col-lg-4">
							...
							<div class="pricing-box pricing-simple p-5 bg-light border-top border-danger text-center">
								...
								<div class="pricing-price">
									<span class="price-unit">&euro;</span>19
								</div>
								<div class="pricing-action">
									<a href="#" class="btn btn-danger btn-lg">Get Started</a>
								</div>
						...
						<div class="col-md-6 col-lg-4">
							...
							<div class="pricing-box pricing-simple p-5 bg-light border-top border-success text-center">
								...
								<div class="pricing-price">
									<span class="price-unit">&euro;</span>49
								</div>
								<div class="pricing-action">
									<a href="#" class="btn btn-success btn-lg">Get Started</a>
								</div>
					...
					<div class="fancy-title title-border title-center mt-6">
						<h3>3 Columns - Simple with Color Accents</h3>
					</div>

					<div class="row pricing col-mb-30 mb-4">
						<div class="col-md-6 col-lg-4">

							<div class="pricing-box pricing-simple p-5 bg-primary dark text-center">
								<div class="pricing-title">
									<span>Try Now</span>
									<h3>Personal</h3>
								</div>
						...
						<div class="col-md-6 col-lg-4">
							...
							<div class="pricing-box pricing-simple p-5 bg-danger dark text-center">
								<div class="pricing-title">
						...
						<div class="col-md-6 col-lg-4">
							...
							<div class="pricing-box pricing-simple p-5 bg-success dark text-center">
								<div class="pricing-title">
									<span>Full Featured</span>
									<h3>Enterprise</h3>
								</div>
						...
						<div class="col-md-6 col-lg-3">
							...
							<div class="pricing-box text-center">
								...
								<div class="pricing-action px-4">
									<a href="#" class="btn btn-danger w-100 btn-lg">Sign Up</a>
								</div>
							</div>
							...
							<div class="pricing-box pricing-highlight text-center">
								...
								<div class="pricing-features">
									<ul>
										...
										<li><i class="bi-star-fill"></i>
										<i class="bi-star-fill"></i>
										<i class="bi-star-fill"></i>
										<i class="bi-star-fill"></i>
										<i class="bi-star-fill"></i></li>
									</ul>
								</div>
								<div class="pricing-action px-4">
									<a href="#" class="btn btn-danger w-100 btn-lg bg-color border-color">Sign Up</a>
								</div>
							</div>
					...
					<div class="row pricing col-mb-30 mb-4 g-0">
						...
						<div class="col-sm-6 col-md-4 col-lg-1-5">
							<div class="pricing-box pricing-minimal text-center">
								...
								<div class="pricing-price">
									<span class="price-unit">&euro;</span>0<span class="price-tenure">/mo</span>
								</div>
								<div class="pricing-action px-4">
									<a href="#" class="btn btn-danger w-100">Get Started</a>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6 col-md-4 col-lg-1-5">
							<div class="pricing-box pricing-minimal pricing-highlight text-center">
								...
								<div class="pricing-action px-4">
									<a href="#" class="btn btn-danger w-100 bg-color border-color btn-lg">Start Trial</a>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6 col-md-4 col-lg-1-5">
							<div class="pricing-box pricing-minimal text-center">
								...
								<div class="pricing-action px-4">
									<a href="#" class="btn btn-danger w-100">Start Trial</a>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6 col-md-4 col-lg-1-5">
							<div class="pricing-box pricing-minimal text-center">
								...
								<div class="pricing-price">
									<span class="price-unit">&euro;</span>39<span class="price-tenure">/mo</span>
								</div>
								<div class="pricing-action px-4">
									<a href="#" class="btn btn-danger w-100">Start Trial</a>
								</div>
						...
						<div class="pricing-tenure-switcher row align-items-center justify-content-center mb-4" data-container="#pricing-switch">
							...
							<!-- <div class="col-auto">
								<div class="btn-group" role="group" aria-label="Basic radio toggle button group">
									<input type="radio" class="btn-check" name="switch-toggle-radio" id="switch-toggle-radio1" autocomplete="off" checked value="monthly">
									<label class="btn btn-outline-primary" for="switch-toggle-radio1">Monthly</label>

									<input type="radio" class="btn-check" name="switch-toggle-radio" id="switch-toggle-radio2" autocomplete="off" value="annually">
									<label class="btn btn-outline-primary" for="switch-toggle-radio2">Annually</label>
								</div>
							</div> -->
							<!-- <div class="col-auto">
								<select name="pricing-switcher-select" id="pricing-switcher-select">
						...
						<div id="pricing-switch" class="row pricing col-mb-50 mb-0">
							...
							<div class="col-md-4">
								...
								<div class="pricing-box pricing-simple p-5 bg-light border-top border-danger text-center">
									...
									<div class="pricing-price">
										<div class="pts-content pts-content-false"><span class="price-unit">&euro;</span>19</div>
										<div class="pts-content pts-content-true"><span class="price-unit">&euro;</span>149</div>
									</div>
									<div class="pricing-action">
										<a href="#" class="btn btn-danger btn-lg">Get Started</a>
									</div>
							...
							<div class="col-md-4">
								...
								<div class="pricing-box pricing-simple p-5 bg-light border-top border-success text-center">
									...
									<div class="pricing-price">
										<div class="pts-content pts-content-false"><span class="price-unit">&euro;</span>49</div>
										<div class="pts-content pts-content-true"><span class="price-unit">&euro;</span>399</div>
									</div>
									<div class="pricing-action">
										<a href="#" class="btn btn-success btn-lg">Get Started</a>
									</div>
					...
					<div class="pricing">
						<div class="pricing-box pricing-extended row align-items-stretch mb-5 mx-0">
							<div class="pricing-desc col-lg-9 p-4">
								<div class="pricing-title">
									<h3 class="fw-medium ls-0">How many Themes can you Download today?</h3>
								</div>
								<div class="pricing-features pb-0">
									<ul class="row gy-1">
										<li class="col-md-6"><i class="bi-pc-display me-2"></i> Ultra Responsive Layouts</li>
										<li class="col-md-6"><i class="bi-eye me-2"></i> Retina Ready Designs</li>
										<li class="col-md-6"><i class="bi-box me-2"></i> Advanced Admin Panel</li>
										<li class="col-md-6"><i class="bi-magic me-2"></i> Tons of Customization Options</li>
										<li class="col-md-6"><i class="bi-fonts me-2"></i> Support for Custom Fonts</li>
										<li class="col-md-6"><i class="bi-window-stack me-2"></i> Premium Sliders Included</li>
										<li class="col-md-6"><i class="bi-file-earmark-richtext me-2"></i> Photoshop Source Files Included</li>
										<li class="col-md-6"><i class="fa-regular fa-life-ring me-2"></i> 24x7 Priority Email Support</li>
									</ul>
								</div>
							</div>
							...
							<div class="pricing-action-area col-lg d-flex flex-column justify-content-center">
								...
								<div class="pricing-action">
									<a href="#" class="button button-3d button-large w-100 m-0">Get Started</a>
								</div>
							</div>
						</div>
					</div>
					...
					<table class="table table-hover table-comparison mb-0">
					  ...
					  <tbody>
						...
						<tr>
						  <td>SSH Access</td>
						  <td><i class="bi-x-lg text-danger"></i></td>
						  <td><i class="bi-x-lg text-danger"></i></td>
					...
					<div class="mt-6 text-center">
						<a href="pricing-table.php" class="btn btn-secondary btn-lg">Fancy Pricing Tables</a>
					</div>
