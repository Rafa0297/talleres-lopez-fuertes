...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Adwords - SEO Demo | Canvas</title>
...
<body class="stretched">
	...
	<div id="wrapper">
				...
				<div class="container">
					<div class="header-row">
						...
						<div class="header-misc">
							...
							<a href="demo-seo.php" class="button button-rounded ms-3 d-none d-sm-block">Get Started</a>
						...
						<nav class="primary-menu with-arrows">
							...
							<ul class="menu-container">
								...
								<li class="menu-item"><a class="menu-link" href="demo-seo-about.php"><div>What We Do</div></a></li>
								<li class="menu-item mega-menu current"><div class="menu-link"><div>Services</div></div>
										...
										<div class="container">
											<div class="row">
												...
												<div class="mega-menu-column sub-menu-container col-12 p-0">
													<a href="demo-seo-about.php" class="button button-rounded button-large text-transform-none ls-0 w-100 text-center m-0 rounded-0 py-3 button-light ">View All <i class="bi-arrow-right"></i></a>
												</div>
											</div>
										</div>
									</div>
		...
		<section class="page-title page-title-parallax parallax scroll-detect page-title-center dark include-header include-topbar">
			<img src="demos/seo/images/services/adwords-title.jpg" class="parallax-bg">
			...
			<div class="container">
				<div class="page-title-row">
					...
					<div class="page-title-content">
						<div class="badge rounded-pill border border-light text-light">Adwords</div>
					...
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="demo-seo-about.php">Services</a></li>
							<li class="breadcrumb-item active" aria-current="page">Adwords Campaign</li>
						</ol>
					</nav>
			...
			<div class="content-wrap pb-0">
				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6">
							<div class="badge rounded-pill badge-default">Adwords</div>
							<h2 class="display-4 fw-bold">Adwords Campaign.</h2>
							...
							<a href="demo-seo-contact.php" class="button button-rounded button-large button-light text-dark bg-white border text-transform-none ls-0">Contact Us</a>
						</div>
						<div class="col-lg-6 mt-4 mt-lg-0">
							<img src="demos/seo/images/services/adwords.svg" alt="Image">
						</div>
					</div>
					...
					<div class="heading-block border-bottom-0 text-center">
						...
						<h3 class="text-transform-none ls-0">What We Provide:</h3>
					</div>
					<div class="clear"></div>
					<div class="row mt-4 col-mb-50 mb-0">
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box">
								<div class="fbox-icon mb-4">
									<a href="#"><i class="fa-brands fa-google text-white bg-google"></i></a>
								</div>
								<div class="fbox-content">
									<h3 class="text-transform-none">Google Search</h3>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box">
								<div class="fbox-icon mb-4">
									<a href="#"><i class="uil uil-shopping-cart text-white bg-google"></i></a>
								</div>
								<div class="fbox-content">
									<h3 class="text-transform-none">Google Shopping</h3>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box">
								<div class="fbox-icon mb-4">
									<a href="#"><i class="fa-brands fa-app-store text-white bg-appstore"></i></a>
								</div>
								<div class="fbox-content">
									<h3 class="text-transform-none">App Campaign</h3>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box">
								<div class="fbox-icon mb-4">
									<a href="#"><i class="bi-camera-video text-white bg-youtube"></i></a>
								</div>
								<div class="fbox-content">
									<h3 class="text-transform-none">Video Advertising</h3>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box">
								<div class="fbox-icon mb-4">
									<a href="#"><i class="bi-phone text-white bg-instagram"></i></a>
								</div>
								<div class="fbox-content">
									<h3 class="text-transform-none">Mobile Advertising</h3>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box">
								<div class="fbox-icon mb-4">
									<a href="#"><i class="bi-bullseye text-white bg-android"></i></a>
								</div>
								<div class="fbox-content">
									<h3 class="text-transform-none">Display Advertising</h3>
				...
				<div class="section mb-0">
					<div class="container">
						<div class="heading-block border-bottom-0 text-center">
							...
							<h3 class="text-transform-none ls-0">Other Causes</h3>
						</div>
				...
				<!-- Form Section
				============================================= -->
				<div class="section mt-0" style="background: url('demos/seo/images/sections/1.jpg') no-repeat center center; background-size: cover; padding: 100px 0;">
					<div class="container">
