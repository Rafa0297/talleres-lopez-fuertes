...
<body class="stretched">
	...
	<div id="wrapper">
		...
		<!-- Slider
		============================================= -->
		<section id="slider" class="slider-element min-vh-100 include-header" style="background: url('one-page/images/page/apartment.jpg') no-repeat center right; background-size: cover;">
					...
					<div class="container py-5">
						<div class="row">
							<div class="col-lg-4">
								...
								<h2 class="ls-0 fw-bold text-uppercase" style="font-size: 26px;">Your House is not an Asset,<br>It's a Liability.</h2>
								<h3 class="fw-light" style="font-size: 20px;">Everyone wants a piece of land. It’s the only sure investment. It can never depreciate like a car or washing machine. Land will only double its value in ten years.</h3>
								<a href="#" class="button button-circle button-border button-dark button-black button-large text-end m-0" data-scrollto="#section-about" data-offset="60">Let's Go Inside<i class="bi-arrow-down"></i></a>
							</div>
						</div>
					</div>
				</div>
