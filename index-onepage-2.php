...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Home - One Page Layout 2 | Canvas</title>
					...
					<div class="page-menu-row">
						...
						<nav class="page-menu-nav one-page-menu">
							<ul class="page-menu-container">
								<li class="page-menu-item"><a href="#" data-href="#header"><div>Start</div></a></li>
								...
								<li class="page-menu-item"><a href="#" data-href="#section-team"><div>Team</div></a></li>
								...
								<li class="page-menu-item"><a href="blog.php"><div>Blog</div></a></li>
		...
		<section id="content">
			<div class="content-wrap">
				...
				<section id="section-about" class="page-section">
					...
					<div class="section dark parallax scroll-detect mb-0 py-6">
						<img src="images/parallax/1.jpg" class="parallax-bg">
						<div class="container">

							<div class="row col-mb-30">
								<div class="col-sm-6 col-lg-3 text-center" data-animate="bounceIn">
									<i class="i-plain i-xlarge mx-auto mb-2 bi-code"></i>
									<div class="counter counter-lined"><span data-from="100" data-to="846" data-refresh-interval="50" data-speed="2000"></span>K+</div>
									<h5>Lines of Codes</h5>
								</div>

								<div class="col-sm-6 col-lg-3 text-center" data-animate="bounceIn" data-delay="200">
									<i class="i-plain i-xlarge mx-auto mb-2 bi-magic"></i>
								...
								<div class="col-sm-6 col-lg-3 text-center" data-animate="bounceIn" data-delay="400">
									<i class="i-plain i-xlarge mx-auto mb-2 bi-file-earmark-text"></i>
								...
								<div class="col-sm-6 col-lg-3 text-center" data-animate="bounceIn" data-delay="600">
									<i class="i-plain i-xlarge mx-auto mb-2 bi-clock"></i>
								...
								<div class="team team-list row align-items-center">
									...
									<div class="team-desc col-sm-6">
										...
										<div class="d-flex mt-4">
											...
											<a href="#" class="social-icon rounded-circle si-small text-white bg-x-twitter">
						...
						<div class="row pricing col-mb-30 mb-4">
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-5 py-4 bg-light text-center text-md-start">
									...
									<div class="pricing-features">
										<ul class="iconlist">
											<li><i class="fa-solid fa-check text-smaller"></i> <span><strong>Full</strong> Access</span></li>
											<li><i class="fa-solid fa-check text-smaller"></i> <span><strong>100</strong> User Accounts</span></li>
											<li><i class="fa-solid fa-check text-smaller"></i> <span><strong>1 Year</strong> License</span></li>
											<li><i class="fa-solid fa-check text-smaller"></i> <span><strong>24/7</strong> Support</span></li>
										</ul>
									</div>
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-5 py-4 bg-light text-center text-md-start">
									...
									<div class="pricing-features">
										<ul class="iconlist">
											<li><i class="fa-solid fa-check text-smaller"></i> <span><strong>Premium</strong> Plugins</span></li>
											<li><i class="fa-solid fa-check text-smaller"></i> <span><strong>SEO</strong> Features</span></li>
											<li><i class="fa-solid fa-check text-smaller"></i> <span><strong>Full</strong> Access</span></li>
											<li><i class="fa-solid fa-check text-smaller"></i> <span><strong>100</strong> User Accounts</span></li>
											<li><i class="fa-solid fa-check text-smaller"></i> <span><strong>1 Year</strong> License</span></li>
											<li><i class="fa-solid fa-check text-smaller"></i> <span><strong>24/7</strong> Support</span></li>
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-5 py-4 bg-light text-center text-md-start">
									...
									<div class="pricing-features">
										<ul class="iconlist">
											<li><i class="fa-solid fa-check text-smaller"></i> <span><strong>55+</strong> Niche Demos</span></li>
											<li><i class="fa-solid fa-check text-smaller"></i> <span><strong>Drag-n-Drop</strong> Builder</span></li>
											<li><i class="fa-solid fa-check text-smaller"></i> <span><strong>Premium</strong> Plugins</span></li>
											<li><i class="fa-solid fa-check text-smaller"></i> <span><strong>SEO</strong> Features</span></li>
											<li><i class="fa-solid fa-check text-smaller"></i> <span><strong>Full</strong> Access</span></li>
											<li><i class="fa-solid fa-check text-smaller"></i> <span><strong>100</strong> User Accounts</span></li>
					...
					<div class="container">
						...
						<div class="row">
							<div class="col-md-6 offset-md-6">
								...
								<div class="fslider testimonial testimonial-full bg-transparent text-center border-0 shadow-none p-0" data-arrows="false">
									<div class="flexslider">
										<div class="slider-wrap">
											<div class="slide">
												<p class="mb-4 fs-5 fw-light font-secondary ls-1">Similique fugit repellendus expedita excepturi iure perferendis provident quia eaque vero numquam?</p>
												<h4 class="fs-6 mb-0 fw-medium">Steve Jobs</h4>
												<small class="text-muted">Apple Inc.</small>
											</div>
											<div class="slide">
												<p class="mb-4 fs-5 fw-light font-secondary ls-1">Natus voluptatum enim quod necessitatibus quis expedita harum provident eos obcaecati id culpa corporis molestias.</p>
												<h4 class="fs-6 mb-0 fw-medium">Collis Ta'eed</h4>
												<small class="text-muted">Envato Inc.</small>
											</div>
											<div class="slide">
												<p class="mb-4 fs-5 fw-light font-secondary ls-1">Incidunt deleniti blanditiis quas aperiam recusandae consequatur ullam quibusdam cum libero illo rerum!</p>
