...
<body class="stretched" data-loader="11" data-loader-color="#543456">
	...
	<div id="wrapper">
		...
		<section id="slider" class="slider-element slider-parallax min-vh-100 dark include-header">
			<div class="slider-inner" style="background-image: url('one-page/images/page/op-register.jpg');">

				<div class="vertical-middle slider-element-fade">
					<div class="container py-5">
						<div style="max-width: 700px;">
							<div class="heading-block border-bottom-0">
								<h1 style="font-size: 36px;" class="text-transform-none font-body">Responsive Design Conference.<br>Get Cozy with the Best in the Business.</h1>
								<span style="font-size: 18px;" class="fw-light text-transform-none ls-1 mt-4">Get Early Bird Discount of upto <strong>50%</strong> OFF on more than 3 Attendees.</span>
							</div>
							<div class="mb-5 d-block py-3 fs-6" style="border-top:1px solid rgba(255,255,255,0.2); border-bottom:1px solid rgba(255,255,255,0.2); max-width: 400px;">
								<i class="bi-clock i-plain my-0"></i> <div id="countdown-ex4" class="countdown countdown-inline" data-year="2024" style="margin-top: 7px;"></div>
							</div>
							<a href="#" class="button button-green button-3d m-0">Get Early Bird Access</a>
						</div>
					</div>
				</div>
