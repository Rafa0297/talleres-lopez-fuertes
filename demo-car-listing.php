...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Listing - Car Demo | Canvas</title>
	...
	<div id="side-panel">
		...
		<div class="side-panel-wrap">
			...
			<div class="widget">
				...
				<a href="demo-car.php"><img src="demos/car/images/logo@2x.png" alt="Canvas Logo" height="50"></a>
						...
						<form action="#" method="post" class="mb-0">
							<div class="row">
								...
								<div class="col-md-4 col-sm-6 col-12 mt-4 mt-md-0">
									...
									<select class="selectpicker customjs" title="Select Brand"  data-size="10" data-live-search="true" multiple data-live-search="true" style="width:100%;">
