...
<head>
	...
	<meta name="description" content="Create Music Streaming &amp; Subscription Websites with Canvas Template. Get Canvas to build powerful websites easily with the Highly Customizable &amp; Best Selling Bootstrap Template, today.">
...
<body class="stretched bg-color2" data-loader="4" data-loader-color="theme">
			...
			<div id="header-wrap">
				<div class="container">
					<div class="header-row">
						...
						============================================= -->
						<div id="logo">
							<a href="demo-music.php">
								<img class="logo-default" srcset="demos/music/images/logo.png, demos/music/images/logo@2x.png 2x" src="demos/music/images/logo@2x.png" alt="Canvas Logo">
								<img class="logo-dark" srcset="demos/music/images/logo-dark.png, demos/music/images/logo-dark@2x.png 2x" src="demos/music/images/logo-dark@2x.png" alt="Canvas Logo">
							</a>
						</div><!-- #logo end -->
		...
		<section id="content" class="bg-color2">
			<div class="content-wrap py-0" style="overflow: visible;">
				<div class="container" style="z-index: 7;">
					...
					<div id="top-charts" class="portfolio row dark gutter-20 desc-sm">
	...
	<script>
		...
		function changeAudio( sourceUrl, posterUrl, trackTitle, trackSinger, playAudio = true ) {
			...
			jQuery('.mejs__layers').php('').php('<div class="mejs-track-artwork"><img src="'+ posterUrl +'" alt="Track Poster"></div><div class="mejs-track-details"><h3>'+ trackTitle +'<br><span>'+ trackSinger +'</span></h3></div>');
