...
<head>
	...
	<link rel="stylesheet" href="css/components/bs-filestyle.css"><!-- Bootstrap File Upload CSS -->
	...
	<link rel="stylesheet" href="css/components/bs-rating.css"><!-- Star Rating CSS -->
	...
	<div id="wrapper">
		...
		<section id="content">
			<div class="content-wrap bg-light">
										...
										<form class="mb-0" id="template-contactform" name="template-contactform" action="include/form.php" method="post" enctype="multipart/form-data">
											...
											<div class="row g-4">
												...
												<div class="col-12">
													...
													<input type="text" id="template-contactform-name" name="template-contactform-name" value="" class="form-control required" placeholder="Enter your Full Name">
												</div>
												...
												<div class="col-12">
													...
													<select id="template-contactform-multiple-select" name="template-contactform-multiple-select[]" class="selectpicker w-100" multiple>
												...
												<div class="col-12">
													...
													<div class="form-group mb-0">
														<div class="input-group text-start">
															<div class="input-group-text" data-target=".datetimepicker1" data-toggle="datetimepicker"><i class="uil uil-schedule"></i></div>
												...
												<div class="col-12">
													<label for="template-contactform-age" class="mb-3">Select Your Age:</label>
												...
												<div class="col-12">
													...
													<div class="btn-group w-100" role="group">
														...
														<label for="template-contactform-platform-mobile" class="btn btn-outline-secondary flex-fill fw-semibold ls-0 text-transform-none">Mobile
														</label>
														...
														<label for="template-contactform-platform-web" class="btn btn-outline-secondary flex-fill fw-semibold ls-0 text-transform-none">Web
														</label>
														...
														<label for="template-contactform-platform-others" class="btn btn-outline-secondary flex-fill fw-semibold ls-0 text-transform-none"> Others
														</label>
													</div>
												</div>
												...
												<div class="col-12">
													...
													<ul class="nav btn-group">
														<li class="btn-group">
															<a class="btn btn-outline-secondary px-4 active" data-bs-toggle="pill" href="#offers-tab-1" role="tab">No</a>
														</li>
														<li class="btn-group">
															<a class="btn btn-outline-secondary px-4" data-bs-toggle="pill" href="#offers-tab-2" role="tab">Yes</a>
														</li>
													</ul>
												...
												<div class="col-12">
													...
													<div class="btn-group nav"  role="group">
														<a href="#know-us-tab-1" class="btn btn-outline-secondary flex-fill active" data-bs-toggle="tab">
															<input type="radio" class="btn-check" name="template-contactform-know-us" id="template-contactform-know-us-google" value="Google">Google
														</a>
														<a href="#know-us-tab-2" class="btn btn-outline-secondary flex-fill" data-bs-toggle="tab">
															<input type="radio" class="btn-check" name="template-contactform-know-us" id="template-contactform-know-us-social" value="Social">Social Sites
														</a>
														<a href="#know-us-tab-3" class="btn btn-outline-secondary flex-fill" data-bs-toggle="tab">
															<input type="radio" class="btn-check" name="template-contactform-know-us" id="template-contactform-know-us-friends" value="Friends">Friends
														</a>
														<a href="#know-us-tab-4" class="btn btn-outline-secondary flex-fill" data-bs-toggle="tab">
															<input type="radio" class="btn-check" name="template-contactform-know-us" id="template-contactform-know-us-others" value="others">Others
														</a>
													</div>
												...
												<div class="col-12">
													...
													<div class="d-flex align-items-center">
														...
														<label class="media-body text-muted ms-3" for="template-contactform-default-switch">
													    	<span class="d-block text-dark mb-1 text-transform-none ls-0">Default Switch</span>
													    	<span class="d-block text-transform-none ls-0 fw-normal">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</span>
													    </label>
												    </div>
												    ...
												    <div class="d-flex align-items-center">
														...
														<label class="media-body text-muted ms-3" for="template-contactform-checked-switch">
													        <span class="d-block text-dark mb-1 text-transform-none ls-0">Checked Switch</span>
													        <span class="d-block text-transform-none ls-0 fw-normal">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quas, aut?</span>
													    </label>
												    </div>
												</div>
												...
												<div class="col-12">
													...
													<select class="selectpicker w-100" multiple data-live-search="true" data-size="12" data-max-options="3" title="Choose max 3 of the following..." name="template-contactform-livesearch[]">
												...
												<div class="col-12">
													...
													<select id="template-contactform-select-splitter" size="1" class="form-select selectsplitter" name="template-contactform-select-splitter">
												...
												<div class="col-12">
													<button type="submit" name="template-contactform-submit" class="btn btn-secondary w-100 btn-lg">Send</button>
												</div>
				...
				<div class="section bg-contrast-0 mb-0 p-0">
