...
<body class="stretched dark side-push-panel">
	...
	<div id="wrapper">
		...
		<!-- Header
		============================================= -->
		<header id="header" class="full-header transparent-header border-full-header header-size-custom" data-sticky-shrink="false" data-sticky-offset="full" data-sticky-offset-negative="auto">
			<div id="header-wrap">
				<div class="container">
		...
		<!-- Slider
		============================================= -->
		<section id="slider" class="slider-element slider-parallax vh-100 include-header">
			<div class="slider-inner">

				<div class="vh-100 dark section p-0 m-0 border-0 overflow-hidden">

					<div class="vertical-middle container text-center">
						<div>
					...
					<div class="video-wrap no-placeholder">
	                    <video id="slide-video" poster="one-page/images/videos/1.jpg" preload="auto" loop muted autoplay playsinline>
