...
<body class="stretched dark">
						...
						<div class="col-md-2">
							<div class="w-100 canvas-custom-scroll position-sticky top-0" data-height="100vh">
								<div class="logo text-center">
									<a href="#"><img src="images/logo-dark@2x.png" alt=".." height="120"></a>
								</div>
	...
	<script>
		document.addEventListener("DOMContentLoaded", function() {
			var scrollPanels = document.querySelectorAll( '.canvas-custom-scroll' );

			scrollPanels.forEach( function(element) {

				var panelHeight = element.getAttribute('data-height') || "250px";
				var panelWidth = element.getAttribute('data-width') || "auto";
				var panelAutohide = element.getAttribute('data-autohide') || "true";
		...
		function updateClock (){
			...
			jQuery('#date-today').php( weekday[currentTime.getDay()] + ', ' + month[currentTime.getMonth()] + ' ' + currentTime.getDate() );
			jQuery("#time-today").php(currentTimeString);
		}
