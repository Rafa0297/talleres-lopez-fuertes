		...
		<section id="slider" class="slider-element slider-parallax min-vh-100 include-header">
			<div class="slider-inner">
				...
				<div class="row position-absolute position-lg-relative w-100 h-100 m-0 align-items-stretch">
						...
						<div class="vertical-middle subscribe-widget" data-loader="button">
							<div class="col-padding">
								...
								<form id="slider-subscribe-form" action="include/subscribe.php" method="post" class="row mb-0">
									...
									<div class="col-12">
										<button type="submit" class="button button-light button-circle button-border ms-0 mt-4" value="submit">Subscribe Me</button>
									</div>
								</form>
							</div>
						</div>
					...
					<div class="col-lg-7 col-md-6 text-center p-0 min-vh-50" style="background: url('one-page/images/page/main.jpg') center center no-repeat; background-size: cover;">
						<div class="fslider h-100 position-absolute" data-speed="2000" data-pause="4000" data-animation="fade" data-arrows="false" data-pagi="false" style="background-color: #333;">
							<div class="flexslider">
								<div class="slider-wrap">
									<div class="slide" style="background: url('demos/media-agency/images/1.jpg') center right; background-size: cover;"></div>
									<div class="slide" style="background: url('demos/media-agency/images/2.jpg') center right; background-size: cover;"></div>
								</div>
							</div>
						</div>
