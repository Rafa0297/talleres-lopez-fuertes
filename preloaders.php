			...
			<div class="container">
				<div class="page-title-row pb-5 align-items-lg-end">
					...
					<div class="page-title-content">
						<h1>Preloaders</h1>
						<span>The way to Load the Page</span>
					...
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Preloaders</li>
					</ol>
		...
		<section id="content">
			<div class="content-wrap">
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-3 col-md-4 col-6" style="height:12.5rem;">
						...
						<div class="col-lg-3 col-md-4 col-6" style="height:12.5rem;">
							<div class="css3-spinner" style="--cnvs-loader-color:var(--cnvs-themecolor);">
								<div class="css3-spinner-cube1"></div>
								<div class="css3-spinner-cube2"></div>
							</div>
						</div>
						<div class="col-lg-3 col-md-4 col-6" style="height:12.5rem;">
							<div class="css3-spinner" style="--cnvs-loader-color:var(--cnvs-themecolor);">
						...
						<div class="col-lg-3 col-md-4 col-6" style="height:12.5rem;">
							<div class="css3-spinner" style="--cnvs-loader-color:var(--cnvs-themecolor);">
								<div class="css3-spinner-zig-zag">
									<div></div>
									<div></div>
								</div>
							</div>
