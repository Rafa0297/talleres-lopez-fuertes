...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Services - Real Estate | Canvas</title>
...
<body class="stretched side-push-panel">
	...
	<div id="wrapper">
		...
		<!-- Page Title
		============================================= -->
		<section class="page-title page-title-parallax parallax scroll-detect dark page-title-center include-header include-topbar" style="padding: 110px 0;">
			<img src="demos/real-estate/images/about-us/1.jpg" class="parallax-bg">
			<div class="container">
		...
		<section id="content">
			<div class="content-wrap">
				<div class="container">
					...
					<div class="row col-mb-50 mb-0">
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box fbox-plain">
								<div class="fbox-icon">
									<a href="#"><i class="icon-realestate-chair"></i></a>
								</div>
								<div class="fbox-content">
									<h3 class="fw-normal">Furnished Rooms</h3>
									<p>Canvas provides support for Native HTML5 Videos that can be added to a Full Width Background.</p>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box fbox-plain">
								<div class="fbox-icon">
									<a href="#"><i class="icon-realestate-calendar"></i></a>
								</div>
								<div class="fbox-content">
									<h3 class="fw-normal">On-Time Delivery</h3>
									<p>Display your Content attractively using Parallax Sections that have unlimited customizable areas.</p>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box fbox-plain">
								<div class="fbox-icon">
									<a href="#"><i class="icon-realestate-document"></i></a>
								</div>
								<div class="fbox-content">
									<h3 class="fw-normal">100% Genuine</h3>
									<p>You have complete easy control on each &amp; every element that provides endless customization possibilities.</p>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box fbox-plain">
								<div class="fbox-icon">
									<a href="#"><i class="icon-realestate-map"></i></a>
								</div>
								<div class="fbox-content">
									<h3 class="fw-normal">Good Locations</h3>
									<p>Canvas provides support for Native HTML5 Videos that can be added to a Full Width Background.</p>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box fbox-plain">
								<div class="fbox-icon">
									<a href="#"><i class="icon-realestate-plan"></i></a>
								</div>
								<div class="fbox-content">
									<h3 class="fw-normal">Well Planed Sites</h3>
									<p>Display your Content attractively using Parallax Sections that have unlimited customizable areas.</p>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box fbox-plain">
								...
								<div class="fbox-content">
									<h3 class="fw-normal">Offers &amp; Discounts</h3>
									<p>You have complete easy control on each &amp; every element that provides endless customization possibilities.</p>
								</div>
							</div>
						</div>
				...
				<div class="container">
					<div class="section text-center m-0" style="background-color: #fef6f3; padding:80px 0 ">
