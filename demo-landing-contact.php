...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Contact - Landing Demo | Canvas</title>
						...
						<div class="row justify-content-between col-mb-50">
							<div class="col-lg-5">
								<div class="text-nowrap dotted-bg dotted-bg-dark">
									<h2 class="text-transform-none mb-3 display-3 fw-bold">We're truly Yours</h2>
									<p class="fw-normal text-black-50">Recusandae ducimus, sequi, sapiente possimus optio impedit <br> efficient services. Completely promote.</p>
								</div>
								...
								<div class="d-flex mt-4">
									<a href="#" class="social-icon text-light bg-facebook" title="Facebook">
										<i class="fa-brands fa-facebook-f"></i>
										<i class="fa-brands fa-facebook-f"></i>
									</a>

									<a href="#" class="social-icon text-light bg-instagram" title="Instagram">
										<i class="bi-instagram"></i>
										<i class="bi-instagram"></i>
									</a>

									<a href="#" class="social-icon text-light bg-x-twitter" title="Twitter">
										<i class="fa-brands fa-x-twitter"></i>
										<i class="fa-brands fa-x-twitter"></i>
									</a>

									<a href="#" class="social-icon text-light bg-appstore" title="Apple">
										<i class="fa-brands fa-apple"></i>
										<i class="fa-brands fa-apple"></i>
									</a>

									<a href="#" class="social-icon text-light bg-android" title="Android">
							...
							<div class="col-lg-7">
								<img src="demos/landing/images/contact.jpg" alt="Office Image">
							</div>
						</div>
					</div>
				</div>
