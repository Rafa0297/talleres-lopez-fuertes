	...
	<div id="wrapper">
		...
		<section id="slider" class="slider-element slider-parallax min-vh-100 include-header">
			<div class="slider-inner">
						...
						<div class="row align-items-center col-mb-50">
							...
							<div class="col-lg-5 text-center text-lg-start">
								<div class="heading-block border-bottom-0 mb-4">
									<h1 class="text-capitalize">Your Business Growth.<br>Shows our Commitment.</h1>
								</div>
								<p class="lead mb-4">We make sure that your Business Model makes the most out of Modern Day Technologies. We prove our case wih your Business Results.</p>
								<a href="#" class="button button-black text-end ms-0">Give Us a Chance <i class="uil uil-angle-right-b"></i></a>
							</div>
				...
				<a href="#" data-scrollto="#section-about" data-easing="easeInOutExpo" data-speed="1250" data-offset="70" class="one-page-arrow d-none d-lg-block"><i class="bi-chevron-down infinite animated fadeInDown"></i></a>
