...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Developer - One Page Module | Canvas</title>
...
<body class="stretched">
	...
	<div id="wrapper">
		...
		<!-- Slider
		============================================= -->
		<section id="slider" class="slider-element include-header" style="background: #F9F9F9 url('one-page/images/page/developer.svg') no-repeat 103% -3px / auto 75%; padding: 100px 0 180px">
				...
				<div class="row mt-0 mt-md-5">
					<div class="col-lg-6 my-5 my-md-0">
						<div class="heading-block border-bottom-0 mb-4">
							<h5 class="text-uppercase ls-4 text-black-50 fw-light mb-2" data-animate="fadeInUp" data-delay="100">Developer</h5>
							<h2 class="fw-bold text-transform-none font-secondary" data-animate="fadeInUp" data-delay="200" style="font-size: 58px; line-height: 1.15; letter-spacing: -1px; color: #084678">We Deliver Best Website For You.</h2>
						</div>
						<p class="mb-5 lead" data-animate="fadeInUp" data-delay="400" style="line-height: 1.7;">Monotonectally pursue intuitive catalysts for change for extensible materials.</p>
						<a href="#" data-scrollto="#section-about" data-offset="70"  data-animate="fadeInUp" data-delay="600" class="button m-0 button-circle button-large text-white" style="background-color: #084678;">Get Started <i class="bi-arrow-right"></i></a>
					</div>
		...
		<section id="content">
			...
			<div class="content-wrap py-0" style="overflow: visible">
				...
				<div class="section-negetive mx-auto" style="max-width: 1000px; transform: translateY(-200px);">
					<div class="card-block-wrap g-0 row align-items-stretch bg-white" style="border-radius: 20px; box-shadow: 0 10px 80px rgba(14,72,119, 0.2)">
						<div class="col-md-6 card-block" style="padding: 80px 70px;">
							<h5 class="ls-3 text-uppercase fw-normal text-black-50 mb-3">Purpose</h5>
							<h3 class="display-4 fw-bold font-secondary" style="color: #084678">Business</h3>
							<p class="text-black-50 mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatum sunt, iure voluptatem repellat ab veniam facere iusto quae quia delectus!</p>
							<a href="#" class="button m-0 button-circle button-large text-white" style="background-color: #084678;">Get Started</a>
						</div>
						<div class="line d-block d-md-none m-0"></div>
						<div class="col-md-6 card-block border-left" style="padding: 80px 70px;">
							<h5 class="ls-3 text-uppercase fw-normal text-black-50 mb-3">Purpose</h5>
							<h3 class="display-4 fw-bold font-secondary">Personal</h3>
							<p class="text-black-50 mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatum sunt, iure voluptatem repellat ab veniam facere iusto quae quia delectus!</p>
							<a href="#" class="button m-0 button-dark bg-black button-large button-circle">Get Started</a>
						</div>
					</div>
				</div>
