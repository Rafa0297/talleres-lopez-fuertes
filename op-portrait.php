...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Portrait - One Page Canvas Slider | Canvas</title>
					...
					<div class="swiper-wrapper h-auto">
						...
						<div class="swiper-slide bg-white">
							<div class="row justify-content-center align-items-stretch h-100">
								<div class="col-md-6 order-md-last min-vh-50" data-animate="fadeInRight">
									<div class="video-wrap no-placeholder">
										<video id="slide-video" poster="one-page/images/page/portrait/video-poster.jpg" preload="auto" loop autoplay muted playsinline>
								...
								<div class="col-md-6">
									<div class="row flex-row h-100">
										<div class="col-12 d-flex align-items-center px-3 px-xl-5">
											<div class="slider-desc p-5">
												<h5 class="text-uppercase ls-3 fw-normal text-black-50" data-animate="fadeIn" data-delay="100">Model 2021</h5>
												<h2 class="display-3 fw-bold font-secondary" data-animate="fadeIn" data-delay="200">Montana Yao</h2>
												<p class="lead mb-0 d-block d-md-none d-lg-block font-secondary" data-animate="fadeIn" data-delay="300">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Assumenda praesentium eius, similique reprehenderit ab voluptatibus eaque. Nobis maxime recusandae aliquid, id impedit aperiam dolore quas, illo eum quam.</p>
											</div>
										</div>

										<div class="col-12 d-flex align-items-end">
											<div class="row">
												<div class="col-6 h-100" data-animate="fadeInLeft" data-delay="400" style="background: url('one-page/images/page/portrait/slide1-sm.jpg') center center /cover; min-height: 250px">
												</div>
												<div class="col-6 px-4 d-flex align-items-start flex-column" data-animate="fadeIn" data-delay="600">
													<p class="mb-auto">Dynamically incentivize 2.0 materials via integrated products. Efficiently facilitate cross functional convergence before client-based e-business. Authoritatively provide access to compelling leadership.</p>
													<div class="slider-nav d-flex justify-content-between w-100 my-3">
														<div class="slider-arrows d-flex align-items-center">
						...
						<div class="swiper-slide bg-light">
							<div class="row justify-content-center align-items-stretch h-100">
								<div class="col-md-6 order-md-last min-vh-50" data-animate="fadeInRight" style="background: url('one-page/images/page/portrait/slide1.jpg') top center /cover; min-height: 360px">
								</div>
								<div class="col-md-6">
									<div class="row flex-row h-100">
										<div class="col-12 d-flex align-items-center px-3 px-xl-5">
											<div class="slider-desc p-5">
												<h5 class="text-uppercase ls-3 fw-normal text-black-50"  data-animate="fadeIn" data-delay="100">Model 2021</h5>
												<h2 class="display-3 fw-bold font-secondary" data-animate="fadeIn" data-delay="200">Pelician Steve</h2>
												<p class="lead mb-0 d-block d-md-none d-lg-block font-secondary" data-animate="fadeIn" data-delay="300">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Assumenda praesentium eius, similique reprehenderit ab voluptatibus eaque. Nobis maxime recusandae aliquid, id impedit aperiam dolore quas, illo eum quam.</p>
											</div>
										</div>
										...
										<div class="col-12 d-flex align-items-end">
											<div class="row">
												<div class="col-6 h-100" data-animate="fadeInLeft" data-delay="400" style="background: url('one-page/images/page/portrait/slide1-sm.jpg') top center /cover; min-height: 250px">
												</div>
												<div class="col-6 px-4 d-flex align-items-start flex-column" data-animate="fadeIn" data-delay="600">
													<p class="mb-auto">Dynamically incentivize 2.0 materials via integrated products. Efficiently facilitate cross functional convergence before client-based e-business. Authoritatively provide access to compelling leadership.</p>
													<div class="slider-nav d-flex justify-content-between w-100 mb-3">
														<div class="slider-arrows d-flex align-items-center">
															<div class="slider-arrow-left"><i class="bi-arrow-left"></i></div>
															<div class="slider-arrow-right"><i class="bi-arrow-right"></i></div>
														</div>
