				...
				<div class="container">
					<div class="header-row">
						...
						<div class="header-misc">
							<a href="demo-forum-signin.php" class="button button-border border-default px-4 rounded-1 fw-medium text-transform-none ls-0 m-0 px-3 h-op-09">Sign In</a>
						</div>
						...
						<nav class="primary-menu">
							...
							<ul class="menu-container pe-0 pe-md-3">
								...
								<li class="menu-item current"><a class="menu-link" href="demo-forum-search-result.php"><div>Search Page</div></a></li>
							</ul>
			...
			<div class="container">
				<div class="row h-100">
					<div class="col-lg-6 d-flex align-self-center flex-column pt-5 pb-0 py-lg-6 mb-0 my-lg-4">
						...
						<p class="mb-3">Your One-Stop Center for Help.</p>
						<div class="input-group input-group-lg mt-2 mb-4">
							...
							<button class="btn border-0 bg-white rounded-end h-bg-alt" type="submit"><i class="uil uil-search"></i></button>
						</div>
						<div>
							<a href="demo-forum-single.php" class="button button-large bg-alt py-2 rounded-1 fw-medium text-transform-none ls-0 ms-0"><i class="bi-file-earmark-richtext"></i> Browse All Topics</a>
							<a href="demo-forum-signin.php" class="button button-large bg-alt py-2 rounded-1 fw-medium text-transform-none ls-0 ms-0 ms-sm-1"><i class="bi-file-earmark-plus"></i> Create a Post</a>
						</div>
					</div>
							...
							<li>
								<ul class="topic list-unstyled row mx-0 justify-content-between align-items-center">
									<li class="entry mb-0 col-sm-10">
										<h3 class="mb-0"><a href="demo-forum-single.php">Package Generator – Approx time for a file</a></h3>
								...
								<ul class="topic odd list-unstyled row mx-0 justify-content-between align-items-center">
									<li class="entry mb-0 col-sm-10">
										<h3 class="mb-0"><a href="demo-forum-single.php">Open sub-menu touching menu-item name, instead of sub-menu-trigger only (mobile)</a></h3>
										<div class="entry-meta mt-1">
											<ul>
								...
								<ul class="topic list-unstyled row mx-0 justify-content-between align-items-center">
									<li class="entry mb-0 col-sm-10">
										<h3 class="mb-0"><a href="demo-forum-single.php">Portfolio Overlay Slide fadein fadeout</a></h3>
										<div class="entry-meta mt-1">
											<ul>
