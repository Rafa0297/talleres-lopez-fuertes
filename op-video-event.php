			...
			<div class="slider-inner">
				...
				<div class="vertical-middle slider-element-fade">
					<div class="container text-center">
						<div class="inline-block pulse animated infinite"><a id="play-hero-video" href="#" class="big-video-button mb-5"><i class="uil uil-play"></i><i class="uil uil-pause"></i></a></div>
						<div class="emphasis-title mx-auto" style="max-width: 700px;">
							<h1 class="fw-bold font-body ls-1" style="font-size: 44px;">We are a Creative Media Agency with a Flare for Perfection.</h1>
						</div>
