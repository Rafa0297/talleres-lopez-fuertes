...
<div class="body-overlay"></div>
	...
	<div id="wrapper">
		...
		<!-- Header
		============================================= -->
		<header id="header" class="full-header transparent-header border-full-header header-size-custom" data-sticky-shrink="false" data-sticky-offset="full" data-sticky-offset-negative="300">
			<div id="header-wrap">
				<div class="container">
		...
		<section id="slider" class="slider-element slider-parallax min-vh-100 include-header">
			<div class="slider-inner" style="background-image: url('one-page/images/page/iphone-slider.png'); background-color: #FFF;">

				<div class="vertical-middle slider-element-fade">
					<div class="container text-start py-5">
						<div class="emphasis-title mb-4">
							<h1 class="text-uppercase fw-semibold" style="font-size: 56px; letter-spacing: 8px;">A New Canvas.<br>A New Beginning.</h1>
							<p class="lead mt-4 mb-0" style="max-width:700px; line-height: 1.7;">One Stop Solution Center for all Your Design &amp; Branding<br> Needs. Start with a <strong>Canvas</strong> &amp; explore Unlimited Possibilities.</p>
						</div>
						<a href="#" class="button button-dark button-circle button-large fw-light ms-0" data-scrollto="#section-works" data-easing="easeInOutExpo" data-speed="1250" data-offset="70"><i class="fa-brands fa-apple"></i>App Store</a>
						<a href="#" class="button button-dark button-circle button-large fw-light" data-scrollto="#section-works" data-easing="easeInOutExpo" data-speed="1250" data-offset="70"><i class="fa-brands fa-google-play"></i>Google Play</a>
					</div>
				</div>
