...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Content Marketing - SEO Demo | Canvas</title>
...
<body class="stretched">
	...
	<div id="wrapper">
		...
		<section class="page-title page-title-parallax parallax scroll-detect page-title-center dark include-header include-topbar">
			<img src="demos/seo/images/services/content_marketing-title.jpg" class="parallax-bg">
			...
			<div class="container">
				<div class="page-title-row">
					...
					<div class="page-title-content">
						<div class="badge rounded-pill border border-light text-light">Marketing</div>
				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6">
							...
							<h2 class="display-4 fw-bold">Content Marketing.</h2>
							...
							<a href="demo-seo-about.php" class="button button-rounded button-large text-transform-none ls-0">Get Started</a>
					...
					<div class="row mt-4 col-mb-50 mb-0">
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box">
								<div class="fbox-icon mb-4">
									<a href="#"><i class="bi-currency-dollar text-white bg-google"></i></a>
								</div>
								<div class="fbox-content">
									<h3 class="text-transform-none">Increase Profits</h3>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box">
								<div class="fbox-icon mb-4">
									<a href="#"><i class="bi-chat bg-dark"></i></a>
								</div>
								<div class="fbox-content">
									<h3 class="text-transform-none">Create a Story</h3>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box">
								<div class="fbox-icon mb-4">
									<a href="#"><i class="bi-quote bg-info"></i></a>
								</div>
								<div class="fbox-content">
									<h3 class="text-transform-none">Create a Dialogue</h3>
									<p>Looks beautiful &amp; ultra-sharp on Retina Screen Displays. Retina Icons, Fonts &amp; all others graphics are optimized.</p>
								</div>
							</div>
						</div>
