...
<head>
	...
	<meta name="description" content="Create Freelancer &amp; Portfolio Websites with Canvas Template. Get Canvas to build powerful websites easily with the Highly Customizable &amp; Best Selling Bootstrap Template, today.">
					...
					<div class="header-row">
						...
						<nav class="primary-menu">
							...
							<ul class="menu-container">
								<li class="menu-item"><a class="menu-link" href="demo-freelancer-about.php"><div>About me</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-freelancer-works.php"><div>Works</div></a></li>
				...
				<div class="vertical-middle slider-element-fade">
					<div class="container text-center py-5">
						...
						<div class="mx-auto"  style="max-width: 600px">
							...
							<a href="demo-freelancer-works.php" class="button button-dark button-hero h-translatey-3 tf-ts button-reveal overflow-visible bg-dark text-end"><span>View our Works</span><i class="bi-arrow-right"></i></a>
							<a href="#" data-scrollto="#footer" data-easing="easeInOutExpo" data-speed="1250" data-offset="70" class="button button-large button-light text-dark bg-transparent m-0"><i class="bi-arrow-down-circle fw-bold"></i> <u>Contact Me</u></a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="section mb-0 pt-3 pb-0" style="background-color: #F4F4F4; margin-top: 150px; overflow: visible;">
					...
					<div class="container">
						<div class="row justify-content-center text-center mt-5">
							<div class="col-lg-6">
								<div>
									<h3 class="fw-bolder h1 mb-4">Graphics Designer & Frontend Developer, Based in <span class="gradient-text gradient-horizon">Berlin, Germany. Since 2009.</span></h3>
				...
				<div class="section m-0">
					<div class="container">
						<div class="row align-items-end justify-content-between mb-5">
							...
							<div class="col-auto">
								<a href="demo-freelancer-works.php" class="button button-dark button-border rounded-pill">View All Works <i class="bi-arrow-right"></i></a>
							</div>
						</div>

						<div class="row justify-content-center col-mb-50">
							<div class="col-lg-6 h-translatey-3 tf-ts">
								<a href="demo-store.php" class="portfolio-item" target="_blank">
							...
							<div class="col-lg-6 h-translatey-3 tf-ts">
								<a href="demo-yoga.php" class="portfolio-item" target="_blank">
									<div class="portfolio-image">
							...
							<div class="col-lg-6 h-translatey-3 tf-ts">
								<a href="demo-hostel.php" class="portfolio-item" target="_blank">
									<div class="portfolio-image">
							...
							<div class="col-lg-6 h-translatey-3 tf-ts">
								<a href="demo-conference.php" class="portfolio-item" target="_blank">
									<div class="portfolio-image">
					...
					<div class="row justify-content-between">
						...
						<div class="col-md-4">
							<div class="widget">
								...
								<a href="mailto:noreply@canvas.com" class="h4 text-dark mt-5 mb-4 d-block"><u>noreply@canvas.com</u> <i class="bi-arrow-right position-relative ms-2" style="top: 3px"></i></a>
								<div>
									<a href="http://facebook.com/semicolonweb" class="social-icon si-small text-light bg-facebook" target="_blank">
										<i class="fa-brands fa-facebook-f"></i>
										<i class="fa-brands fa-facebook-f"></i>
									</a>
									<a href="http://instagram.com/semicolonweb" class="social-icon si-small text-light bg-instagram" target="_blank">
										<i class="bi-instagram"></i>
										<i class="bi-instagram"></i>
									</a>
									<a href="http://youtube.com/semicolonweb" class="social-icon si-small text-light bg-youtube" target="_blank">
