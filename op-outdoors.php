...
<head>
	...
	<link href="https://fonts.googleapis.com/css2?family=Source+Sans+Pro:wght@300;400;600;700&family=Roboto:wght@300;400;500;700&family=Playfair+Display:ital,wght@0,400;0,700;0,900;1,400;1,700&display=swap" rel="stylesheet">
...
<body class="stretched dark">
	...
	<div id="wrapper">
		...
		<!-- Header
		============================================= -->
		<header id="header" class="full-header transparent-header dark header-size-custom" data-sticky-shrink="false" data-sticky-offset="full" data-sticky-offset-negative="auto">
			<div id="header-wrap">
				<div class="container">
			...
			<div class="slider-inner">
				...
				<div class="swiper swiper-parent">
					<div class="swiper-wrapper">
						<div class="swiper-slide dark">
							<div class="swiper-slide-bg" style="background-image: url('one-page/images/page/outdoor.jpg'); background-position: center bottom;"></div>
						</div>
						<div class="swiper-slide dark">
							<div class="swiper-slide-bg" style="background-image: url('one-page/images/page/outdoor-2.jpg'); background-position: center bottom;"></div>
						</div>
						<div class="swiper-slide dark">
							<div class="swiper-slide-bg" style="background-image: url('one-page/images/page/outdoor-3.jpg'); background-position: center bottom;"></div>
						</div>
					</div>
				</div>
				...
				<div class="vertical-middle">
					<div class="container text-center">
						<h2 class="fw-bold mb-0" style="font-family: 'Playfair Display';">A Beautiful Travel</h2>
						<p class="ls-1 fw-light">Adventure is worthwhile</p>
						<a href="https://www.youtube.com/watch?v=P3Huse9K6Xs" class="play-icon" data-lightbox="iframe"><i class="fa-brands fa-google-play"></i></a>
					</div>
				</div>
