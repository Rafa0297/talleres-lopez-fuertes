...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Builders - Real Estate | Canvas</title>
...
<body class="stretched side-push-panel">
	...
	<div id="wrapper">
		...
		<!-- Page Title
		============================================= -->
		<section class="page-title page-title-parallax parallax scroll-detect dark page-title-center include-header include-topbar" style="padding: 140px 0;">
			<img src="demos/real-estate/images/builders/page-title.jpg" class="parallax-bg">
			<div class="container">
