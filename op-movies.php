...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Movies - One Page Canvas Slider | Canvas</title>
...
<body class="stretched">
	...
	<div id="wrapper">
		...
		<!-- Slider
		============================================= -->
		<section id="slider" class="slider-element min-vh-100 include-header" style="background: url('one-page/images/page/movies/wall.jpg') no-repeat center center / cover;">
			<div class="slider-inner">
				<div class="vertical-middle">
					<div class="movies-wrap">
						<div id="oc-movies" class="owl-carousel image-carousel carousel-widget" data-stage-padding="100" data-nav="false" data-pagi="true" data-items-xs="1" data-items-sm="2" data-items-md="2" data-items-lg="3" data-items-xl="4">

							<!-- Poster 1 -->
							<div class="card movie-card">
								<img src="one-page/images/page/movies/1.jpg" alt="Movie Poster Image">
								<div class="card-img-overlay p-3 dark d-flex align-items-end flex-column">
									<div class="mt-auto w-100">
										<div class="rating-stars mb-1"><i class="bi-star-fill text-warning"></i><i class="bi-star-fill text-warning"></i><i class="bi-star-fill text-warning"></i><i class="bi-star-fill text-warning"></i><i class="bi-star-half text-warning"></i></div>
										<h3 class="card-title mb-2">Avengers: Endgame</h3>
										<p class="card-text mb-3"><strong>Directors:</strong> <a href="#">Anthony Russo</a>, <a href="#">Joe Russo</a><br><strong>Starring:</strong> <a href="#">Robert Downey Jr.</a>, <a href="#">Chris Evans</a>, <a href="#">Mark Ruffalo</a></p>
										<a href="#" class="btn btn-sm"><i class="bi-arrow-right"></i></a>
									</div>
								</div>
							</div>
							...
							<!-- Poster 2 -->
							<div class="card movie-card">
								<img src="one-page/images/page/movies/2.jpg" alt="Movie Poster Image">
								<div class="card-img-overlay p-3 dark d-flex align-items-end flex-column">
									<div class="mt-auto w-100">
										<div class="rating-stars mb-1"><i class="bi-star-fill text-warning"></i><i class="bi-star-fill text-warning"></i><i class="bi-star-fill text-warning"></i><i class="bi-star-fill text-warning"></i><i class="bi-star text-warning"></i></div>
										<h3 class="card-title mb-2">Spider-Man</h3>
										<p class="card-text mb-3"><strong>Directors:</strong> <a href="#">Marc Webb</a><br><strong>Starring:</strong> <a href="#">Andrew Garfield</a>, <a href="#">Emma Stone</a>, <a href="#">Jamie Foxx</a></p>
										<a href="#" class="btn btn-sm"><i class="bi-arrow-right"></i></a>
									</div>
								</div>
							</div>
							...
							<!-- Poster 3 -->
							<div class="card movie-card">
								<img src="one-page/images/page/movies/3.jpg" alt="Movie Poster Image">
								<div class="card-img-overlay p-3 dark d-flex align-items-end flex-column">
									<div class="mt-auto w-100">
										<div class="rating-stars mb-1"><i class="bi-star-fill text-warning"></i><i class="bi-star-fill text-warning"></i><i class="bi-star-fill text-warning"></i><i class="bi-star-fill text-warning"></i><i class="bi-star-half text-warning"></i></div>
										<h3 class="card-title mb-2">Captain America</h3>
										<p class="card-text mb-3"><strong>Directors:</strong> <a href="#">Anthony Russo</a>, Joe Russo<br><strong>Starring:</strong> <a href="#">Chris Evans</a>, <a href="#">Robert Downey Jr.</a>, Scarlett Johansson</p>
										<a href="#" class="btn btn-sm"><i class="bi-arrow-right"></i></a>
									</div>
								</div>
							</div>
							...
							<!-- Poster 4 -->
							<div class="card movie-card">
								<img src="one-page/images/page/movies/4.jpg" alt="Movie Poster Image">
								<div class="card-img-overlay p-3 dark d-flex align-items-end flex-column">
									<div class="mt-auto w-100">
										<div class="rating-stars mb-1"><i class="bi-star-fill text-warning"></i><i class="bi-star-fill text-warning"></i><i class="bi-star-fill text-warning"></i><i class="bi-star-fill text-warning"></i><i class="bi-star-fill text-warning"></i></div>
										<h3 class="card-title mb-2">Iron Man</h3>
										<p class="card-text mb-3"><strong>Directors:</strong> <a href="#">Jon Favreau</a><br><strong>Starring:</strong> <a href="#">Robert Downey Jr.</a>, <a href="#">Gwyneth Paltrow</a>, <a href="#">Terrence Howard</a></p>
										<a href="#" class="btn btn-sm"><i class="bi-arrow-right"></i></a>
									</div>
								</div>
							</div>
							...
							<!-- Poster 5 -->
							<div class="card movie-card">
								<img src="one-page/images/page/movies/5.jpg" alt="Movie Poster Image">
								<div class="card-img-overlay p-3 dark d-flex align-items-end flex-column">
									<div class="mt-auto w-100">
										<div class="rating-stars mb-1"><i class="bi-star-fill text-warning"></i><i class="bi-star-fill text-warning"></i><i class="bi-star-fill text-warning"></i><i class="bi-star-fill text-warning"></i><i class="bi-star-half text-warning"></i></div>
										<h3 class="card-title mb-2">Thor: Ragnarok</h3>
										<p class="card-text mb-3"><strong>Directors:</strong> <a href="#">Taika Waititi</a><br><strong>Starring:</strong> <a href="#">Chris Hemsworth</a>, <a href="#">Tom Hiddleston</a>, Cate Blanchett</p>
										<a href="#" class="btn btn-sm"><i class="bi-arrow-right"></i></a>
									</div>
								</div>
							</div>
							...
							<!-- Poster 6 -->
							<div class="card movie-card">
								<img src="one-page/images/page/movies/6.jpg" alt="Movie Poster Image">
								<div class="card-img-overlay p-3 dark d-flex align-items-end flex-column">
									<div class="mt-auto w-100">
										<div class="rating-stars mb-1"><i class="bi-star-fill text-warning"></i><i class="bi-star-fill text-warning"></i><i class="bi-star-fill text-warning"></i><i class="bi-star-fill text-warning"></i><i class="bi-star-half text-warning"></i></div>
										<h3 class="card-title mb-2">Captain Marvel</h3>
										<p class="card-text mb-3"><strong>Directors:</strong> <a href="#">Anna Boden</a>, <a href="#">Ryan Fleck</a><br><strong>Starring:</strong> <a href="#">Brie Larson</a>, <a href="#">Samuel L. Jackson</a>, Ben Mendelsohn</p>
										<a href="#" class="btn btn-sm"><i class="bi-arrow-right"></i></a>
									</div>
								</div>
							</div>
							...
							<!-- Poster 7 -->
							<div class="card movie-card">
								<img src="one-page/images/page/movies/7.jpg" alt="Movie Poster Image">
								<div class="card-img-overlay p-3 dark d-flex align-items-end flex-column">
									<div class="mt-auto w-100">
										<div class="rating-stars mb-1"><i class="bi-star-fill text-warning"></i><i class="bi-star-fill text-warning"></i><i class="bi-star-fill text-warning"></i><i class="bi-star-fill text-warning"></i><i class="bi-star-half text-warning"></i></div>
										<h3 class="card-title mb-2">Hulk: The Incredible</h3>
										<p class="card-text mb-3"><strong>Directors:</strong> <a href="#">Louis Leterrier</a><br><strong>Starring:</strong> <a href="#">Edward Norton</a>, <a href="#">Liv Tyler</a>, Tim Roth</p>
										<a href="#" class="btn btn-sm"><i class="bi-arrow-right"></i></a>
									</div>
								</div>
							</div>
				...
				<img class="wall-man d-none d-md-block" src="one-page/images/page/movies/wall-man.png" alt="Man">
