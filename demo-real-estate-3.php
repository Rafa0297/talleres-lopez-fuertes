...
<body class="stretched side-push-panel">
	...
	<div id="wrapper">
		...
		<!-- Slider
		============================================= -->
		<section id="slider" class="slider-element min-vh-60 min-vh-md-100 include-header include-topbar" style="background: url(demos/real-estate/images/hero/2.jpg) top right no-repeat; background-size: cover;">
					...
					<div class="container py-5 py-md-4">
						<div class="tabs advanced-real-estate-tabs m-0" style="max-width: 500px;">
							...
							<ul class="nav canvas-tabs nav-tabs" id="canvas-tab" role="tablist">
								<li class="nav-item ms-0"><a class="nav-link active" data-bs-toggle="pill" role="tab" href="#tab-buy">Buy</a></li>
								<li class="nav-item ms-0"><a class="nav-link" data-bs-toggle="pill" role="tab"  href="#tab-rent">Rent</a></li>
							</ul>

							<div id="canvas-TabContent" class="tab-content">
								<div class="tab-pane show active" id="tab-buy" role="tabpanel" aria-labelledby="canvas-tab-buy" tabindex="0">
									<form action="#" method="post" class="mb-0">
										<div class="row g-4">
											<div class="col-md-6 col-12">
												<label>Choose Locations</label>
												<select class="selectpicker" multiple data-live-search="true" data-size="6" style="width:100%;">
											...
											<div class="col-md-6 col-12">
												...
												<select class="selectpicker" data-size="6" style="width:100%; line-height: 30px;">
											...
											<div class="col-6">
												<label>Beds</label>
												<select class="selectpicker" multiple data-size="6" data-placeholder="Any" style="width:100%; line-height: 30px;">
											...
											<div class="col-md-12">
												<button class="button button-3d button-rounded w-100 m-0" style="margin-top: 35px !important;">Search Properties</button>
											</div>
										</div>
									</form>
								</div>

								<div class="tab-pane" id="tab-rent" role="tabpanel" aria-labelledby="canvas-tab-rent" tabindex="0">
									<form action="#" method="post" class="mb-0">
										<div class="row g-4">
											<div class="col-md-6 col-12">
												<label>Rental Locations</label>
												<select class="selectpicker" multiple data-live-search="true" data-size="6" style="width:100%;">
													<optgroup label="Alaskan/Hawaiian Time Zone">
														<option value="AK">Alaska</option>
														<option value="HI">Hawaii</option>
											...
											<div class="col-md-12">
												<button class="button button-3d button-rounded w-100 m-0" style="margin-top: 35px !important;">Search Rentals</button>
											</div>
										</div>
									</form>
								</div>
			...
			<div class="content-wrap">
				<div class="container">
					...
					<div style="position: relative;">
						...
						<a href="#" class="button button-small button-rounded button-border button-border-thin fw-medium m-0" style="position: absolute; top: 7px; right: 0;">Check All</a>

						<div class="real-estate owl-carousel image-carousel carousel-widget mb-6" data-margin="10" data-nav="true" data-loop="true" data-pagi="false" data-items-xs="1" data-items-sm="1" data-items-md="2" data-items-lg="3" data-items-xl="3">
									...
									<div class="real-estate-item-desc">
										...
										<div class="real-estate-item-features fw-medium font-primary">
											<div class="row g-0">
												...
												<div class="col-lg-4 p-0">Pool: <span class="text-success"><i class="fa-solid fa-square-check"></i></span></div>
												<div class="col-lg-4 p-0">Internet: <span class="text-success"><i class="fa-solid fa-square-check"></i></span></div>
												<div class="col-lg-4 p-0">Cleaning: <span class="text-danger"><i class="bi-dash-square-fill"></i></span></div>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="real-estate-item-desc">
										...
										<div class="real-estate-item-features fw-medium">
											<div class="row g-0">
												...
												<div class="col-lg-4 p-0">Pool: <span class="text-success"><i class="fa-solid fa-square-check"></i></span></div>
												<div class="col-lg-4 p-0">Internet: <span class="text-success"><i class="fa-solid fa-square-check"></i></span></div>
												<div class="col-lg-4 p-0">Cleaning: <span class="text-success"><i class="fa-solid fa-square-check"></i></span></div>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="col-padding">
							<div class="quick-contact-widget form-widget dark">
								...
								<form id="quick-contact-form" name="quick-contact-form" action="include/form.php" method="post" class="quick-contact-form mb-0">
									...
									<button type="submit" id="quick-contact-form-submit" name="quick-contact-form-submit" class="button button-small button-rounded button-white text-dark h-text-light m-0" value="submit">Send Email</button>
					...
					<div class="row col-mb-50">
						<div class="col-md-8">
							...
							<div class="mb-0">
								...
								<ul id="realestate-tabs" class="nav canvas-alt-tabs tabs-alt tabs-tb tabs nav-tabs nav-fill mb-3" id="canvas-tab-tb"
									role="tablist" style="--bs-nav-link-font-weight: 500;">
									<li class="nav-item" role="presentation">
										<button class="nav-link active" id="canvas-realestate-tab-1-tab" data-bs-toggle="pill"
											data-bs-target="#realestate-tab-1" type="button" role="tab" aria-controls="canvas-realestate-tab-1"
											aria-selected="true">Why Us?</button>
									</li>
									<li class="nav-item" role="presentation">
										<button class="nav-link" id="canvas-realestate-tab-2-tab" data-bs-toggle="pill"
											data-bs-target="#realestate-tab-2" type="button" role="tab" aria-controls="canvas-realestate-tab-2"
											aria-selected="false">Properties</button>
									</li>
									<li class="nav-item" role="presentation">
										<button class="nav-link" id="canvas-realestate-tab-3-tab" data-bs-toggle="pill"
											data-bs-target="#realestate-tab-3" type="button" role="tab" aria-controls="canvas-realestate-tab-3"
											aria-selected="false">Legal</button>
									</li>
								</ul>

								<div id="canvas-tab-tb-content" class="tab-content">
									<div class="tab-pane fade show active" id="realestate-tab-1" role="tabpanel"
										aria-labelledby="canvas-realestate-tab-1-tab" tabindex="0">
										...
										<div class="row col-mb-30">
											<div class="col-sm-6 col-lg-3 text-center">
												<div class="counter ls-1 fw-semibold" style="color: #D2D2D2;"><span data-from="100" data-to="964"
														data-refresh-interval="50" data-speed="2000"></span></div>
												<h5>Floors Built</h5>
											</div>

											<div class="col-sm-6 col-lg-3 text-center">
												<div class="counter ls-1 fw-semibold" style="color: #D2D2D2;"><span data-from="100" data-to="8514"
														data-refresh-interval="50" data-speed="2500"></span></div>
												<h5>Employees</h5>
											</div>

											<div class="col-sm-6 col-lg-3 text-center">
												<div class="counter ls-1 fw-semibold" style="color: #D2D2D2;"><span data-from="100" data-to="458"
														data-refresh-interval="50" data-speed="3500"></span></div>
												<h5>Happy Clients</h5>
											</div>

											<div class="col-sm-6 col-lg-3 text-center">
												<div class="counter ls-1 fw-semibold" style="color: #D2D2D2;"><span data-from="14" data-to="159"
														data-refresh-interval="15" data-speed="2700"></span></div>
												<h5>Cities Served</h5>
											</div>
										</div>
									</div>
									<div class="tab-pane fade" id="realestate-tab-2" role="tabpanel" aria-labelledby="canvas-realestate-tab-2-tab"
										tabindex="0">
									...
									<div class="tab-pane fade" id="realestate-tab-3" role="tabpanel" aria-labelledby="canvas-realestate-tab-3-tab"
										tabindex="0">
										...
										<div class="row col-mb-30">
											<div class="col-md-7">
												<p>Morbi tincidunt, dui sit amet facilisis feugiat, odio metus gravida ante, ut pharetra massa metus
													...
													eros molestie lectus, ut tempus eros massa ut dolor.</p>
												<div class="row col-mb-30">
													<div class="col-md-6">
														<address>
											...
											<div class="col-md-5">
												<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3151.925819998654!2d144.9613620758663!3d-37.81520647197522!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6ad642b4758afc1d%3A0x3119cc820fdfc62e!2sEnvato!5e0!3m2!1sen!2sin!4v1683119849609!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
											</div>
										</div>
						...
						<div class="col-md-4">
							...
							<h4 class="text-center">Top Builders</h4>

							<ul class="clients-grid grid-border row row-cols-2 mb-0">
								<li class="col-3 col-md-6 col-padding" style="padding: 20px;"><a href="#" class="op-09"><img src="demos/real-estate/images/builders/1.png" alt="Clients"></a></li>
								<li class="col-3 col-md-6 col-padding" style="padding: 20px;"><a href="#" class="op-09"><img src="demos/real-estate/images/builders/2.png" alt="Clients"></a></li>
								<li class="col-3 col-md-6 col-padding" style="padding: 20px;"><a href="#" class="op-09"><img src="demos/real-estate/images/builders/3.png" alt="Clients"></a></li>
								<li class="col-3 col-md-6 col-padding" style="padding: 20px;"><a href="#" class="op-09"><img src="demos/real-estate/images/builders/4.png" alt="Clients"></a></li>
							</ul>
