...
<head>
	...
	<meta name="description" content="Create Clothing Store, eCommerce &amp; Shop Websites with Canvas Template. Get Canvas to build powerful websites easily with the Highly Customizable &amp; Best Selling Bootstrap Template, today.">
...
<body class="stretched modal-subscribe-bottom">
	...
	<div id="wrapper">
					...
					<div class="header-row justify-content-lg-between">
									...
									<div class="top-cart-items">
										<div class="top-cart-item">
											<div class="top-cart-item-image">
												<a href="demo-store-product-single.php"><img src="demos/shop/images/items/featured/5.jpg" alt="Blue Shoulder Bag"></a>
											</div>
						...
						<nav class="primary-menu with-arrows">
							...
							<ul class="menu-container">
								<li class="menu-item"><a class="menu-link" href="demo-store.php"><div>Home</div></a></li>
								<li class="menu-item mega-menu current"><a class="menu-link" href="demo-store-products.php"><div>Men</div></a>
								...
								<li class="menu-item"><a class="menu-link" href="demo-store-products.php"><div>Women</div></a></li>
								...
								<li class="menu-item"><a class="menu-link" href="demo-store-contact.php"><div>Contact</div></a></li>
							</ul>
		...
		<section class="page-title page-title-parallax parallax scroll-detect dark page-title-center include-header bg-overlay-mask" style="padding: 170px 0 100px;">
			<img src="demos/store/images/men/page-title.jpg" class="parallax-bg">
			<div class="container">
				<div class="page-title-row">

					<div class="page-title-content">
						<h1 class="text-uppercase">Men's Collections</h1>
					...
					<div class="row">
						<div class="col-md-2 sticky-sidebar-wrap">
							<ul class="list-unstyled items-nav sticky-sidebar shop-filter" data-container="#shop">
								...
								<li class="no-divider"><a href="#" class="text-dark fw-semibold" data-filter=".sf-new">New Arrivals</a></li>
								<li><hr></li>
							...
							<div>
								<h5 class="ls-0 text-muted">Select Price:</h5>
							...
							<div id="shop" class="row shop grid-container" data-layout="fitRows">
									...
									<div class="product">
											...
											<div class="fslider" data-pagi="false" data-speed="400" data-pause="200000">
												<div class="flexslider">
													<div class="slider-wrap">
														<div class="slide">
															<a href="demo-store-product-single.php"><img src="demos/store/images/product/1-1.jpg" alt="Black Shoe"></a>
														</div>
														<div class="slide">
															<a href="demo-store-product-single.php"><img src="demos/store/images/product/1-2.jpg" alt="Black Shoe"></a>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="product-desc">
											<div class="product-title">
												<h3><a href="demo-store-product-single.php">Black Sports Shoe</a></h3>
								...
								<div class="col-lg-4 col-md-6 mb-4 sf-shoes sf-sportswear">
									<div class="product">
										<div class="product-image position-relative">
											<div class="fslider" data-pagi="false" data-speed="400" data-pause="200000">
												<div class="flexslider">
													<div class="slider-wrap">
														<div class="slide">
															<a href="demo-store-product-single.php"><img src="demos/store/images/product/2-1.jpg" alt="Sports Shoe"></a>
														</div>
														<div class="slide">
															<a href="demo-store-product-single.php"><img src="demos/store/images/product/2-2.jpg" alt="Sports Shoe"></a>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="product-desc">
											<div class="product-title">
												<h3><a href="demo-store-product-single.php">Sports Shoe</a></h3>
												<span><a href="#">Nike</a></span>
											</div>
								...
								<div class="col-lg-4 col-md-6 mb-4 sf-jackets sf-new">
									<div class="product">
										<div class="product-image position-relative">
											<div class="fslider" data-pagi="false" data-speed="400" data-pause="200000">
												<div class="flexslider">
													<div class="slider-wrap">
														<div class="slide">
															<a href="demo-store-product-single.php"><img src="demos/store/images/product/3-1.jpg" alt="Jackets"></a>
														</div>
														<div class="slide">
															<a href="demo-store-product-single.php"><img src="demos/store/images/product/3-2.jpg" alt="Jackets"></a>
														</div>
														<div class="slide">
															<a href="demo-store-product-single.php"><img src="demos/store/images/product/3-3.jpg" alt="Jackets"></a>
														</div>
														<div class="slide">
															<a href="demo-store-product-single.php"><img src="demos/store/images/product/3-4.jpg" alt="Jackets"></a>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="product-desc">
											<div class="product-title">
												<h3><a href="demo-store-product-single.php">Men Black Jackets</a></h3>
								...
								<div class="col-lg-4 col-md-6 mb-4 sf-t-shirts sf-new">
									<div class="product">
										<div class="product-image position-relative">
											<div class="fslider" data-pagi="false" data-speed="400" data-pause="200000">
												<div class="flexslider">
													<div class="slider-wrap">
														<div class="slide">
															<a href="demo-store-product-single.php"><img src="demos/store/images/product/4-1.jpg" alt="T-shirt"></a>
														</div>
														<div class="slide">
															<a href="demo-store-product-single.php"><img src="demos/store/images/product/4-2.jpg" alt="T-shirt"></a>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="product-desc">
											<div class="product-title">
												<h3><a href="demo-store-product-single.php">Roundneck T-shirt</a></h3>
								...
								<div class="col-lg-4 col-md-6 mb-4 sf-t-shirts">
									<div class="product">
										<div class="product-image position-relative">
											<div class="fslider" data-pagi="false" data-speed="400" data-pause="200000">
												<div class="flexslider">
													<div class="slider-wrap">
														<div class="slide">
															<a href="demo-store-product-single.php"><img src="demos/store/images/men/items/2.jpg" alt="T-Shirts"></a>
														</div>
														<div class="slide">
															<a href="demo-store-product-single.php"><img src="demos/store/images/men/items/2-1.jpg" alt="T-Shirts"></a>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="product-desc">
											<div class="product-title">
												<h3><a href="demo-store-product-single.php">Grey T-Shirt</a></h3>
												<span><a href="#">T-Shirt</a></span>
											</div>
								...
								<div class="col-lg-4 col-md-6 mb-4 sf-shoes sf-sportswear sf-new">
									<div class="product">
										<div class="product-image position-relative">
											<div class="fslider" data-pagi="false" data-speed="400" data-pause="200000">
												<div class="flexslider">
													<div class="slider-wrap">
														<div class="slide">
															<a href="demo-store-product-single.php"><img src="demos/store/images/product/6-1.jpg" alt="Shoes"></a>
														</div>
														<div class="slide">
															<a href="demo-store-product-single.php"><img src="demos/store/images/product/6-2.jpg" alt="Shoes"></a>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="product-desc">
											<div class="product-title">
												<h3><a href="demo-store-product-single.php">Men White Escaper Sports Shoes</a></h3>
								...
								<div class="col-lg-4 col-md-6 mb-4 sf-watches">
									<div class="product">
										<div class="product-image position-relative">
											<div class="fslider" data-arrows="true" data-pagi="false" data-speed="400" data-pause="6000" data-thumbs="true">
												<div class="flexslider">
													<div class="slider-wrap">
														<div class="slide" data-thumb="demos/store/images/men/items/1.jpg">
															<a href="demo-store-product-single.php"><img src="demos/store/images/men/items/1.jpg" alt="Watch"></a>
														</div>
														<div class="slide" data-thumb="demos/store/images/men/items/1-1.jpg">
															<a href="demo-store-product-single.php"><img src="demos/store/images/men/items/1-1.jpg" alt="Watch"></a>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="product-desc">
											<div class="product-title">
												<h3><a href="demo-store-product-single.php">Rounded Watch</a></h3>
								...
								<div class="col-lg-4 col-md-6 mb-4 sf-jeans sf-new">
									<div class="product">
										<div class="product-image">
											<a href="demo-store-product-single.php"><img src="demos/store/images/product/8-1.jpg" alt="Jeans"></a>
											<a href="demo-store-product-single.php"><img src="demos/store/images/product/8-2.jpg" alt="Jeans"></a>
											<a href="#" class="cart-btn button button-white button-light"><i class="uil uil-plus"></i>Add to Cart</a>
										</div>
										<div class="product-desc">
											<div class="product-title">
												<h3><a href="demo-store-product-single.php">Navi Blue Jeans</a></h3>
								...
								<div class="col-lg-4 col-md-6 mb-4 sf-shorts sf-sportswear">
									<div class="product">
										<div class="product-image">
											<a href="demo-store-product-single.php"><img src="demos/store/images/men/items/6.jpg" alt="Shorts"></a>
											<a href="demo-store-product-single.php"><img src="demos/store/images/men/items/6-1.jpg" alt="Shorts"></a>
											<a href="#" class="cart-btn button button-white button-light"><i class="uil uil-plus"></i>Add to Cart</a>
										</div>
										<div class="product-desc">
											<div class="product-title">
												<h3><a href="demo-store-product-single.php">Jogging Shorts</a></h3>
								...
								<div class="col-lg-4 col-md-6 mb-4 sf-sweaters">
									<div class="product">
										<div class="product-image">
											<a href="demo-store-product-single.php"><img src="demos/store/images/men/items/3.jpg" alt="Sweaters"></a>
											<a href="demo-store-product-single.php"><img src="demos/store/images/men/items/3.jpg" alt="Sweaters"></a>
											<a href="#" class="cart-btn button button-white button-light"><i class="uil uil-plus"></i>Add to Cart</a>
										</div>
										<div class="product-desc">
											<div class="product-title">
												<h3><a href="demo-store-product-single.php">Woolen Sweaters</a></h3>
									...
									<div class="product">
										<div class="product-image">
											<div class="fslider" data-arrows="false" data-pagi="false" data-speed="400" data-pause="6000" data-thumbs="true">
												<div class="flexslider">
													<div class="slider-wrap">
														<div class="slide" data-thumb="demos/store/images/men/items/4.jpg">
															<a href="demo-store-product-single.php"><img src="demos/store/images/men/items/4.jpg" alt="Trouser"></a>
														</div>
														<div class="slide" data-thumb="demos/store/images/men/items/4-1.jpg">
															<a href="demo-store-product-single.php"><img src="demos/store/images/men/items/4-1.jpg" alt="Trouser"></a>
														</div>
														<div class="slide" data-thumb="demos/store/images/men/items/4-2.jpg">
															<a href="demo-store-product-single.php"><img src="demos/store/images/men/items/4-2.jpg" alt="Trouser"></a>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="product-desc">
											<div class="product-title">
												<h3><a href="demo-store-product-single.php">Light Blue Trouser</a></h3>
									...
									<div class="product">
										<div class="product-image">
											<div class="fslider" data-arrows="false" data-pagi="false" data-speed="400" data-pause="6000" data-thumbs="true">
												<div class="flexslider">
													<div class="slider-wrap">
														<div class="slide" data-thumb="demos/store/images/men/items/5.jpg">
															<a href="demo-store-product-single.php"><img src="demos/store/images/men/items/5.jpg" alt="Shorts"></a>
														</div>
														<div class="slide" data-thumb="demos/store/images/men/items/5-1.jpg">
															<a href="demo-store-product-single.php"><img src="demos/store/images/men/items/5-1.jpg" alt="Shorts"></a>
														</div>
														<div class="slide" data-thumb="demos/store/images/men/items/5-2.jpg">
															<a href="demo-store-product-single.php"><img src="demos/store/images/men/items/5-2.jpg" alt="Shorts"></a>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="product-desc">
											<div class="product-title">
												<h3><a href="demo-store-product-single.php">Shorts - Pack of 3</a></h3>
												<span><a href="#">Shorts</a></span>
											</div>
	...
	<script>
		...
		jQuery(window).on( 'load', function(){
			...
			jQuery('.shop-filter a').click(function(){
				jQuery('.shop-filter li').removeClass('activeFilter');
