...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Mega Menu Tab | Canvas</title>
					...
					<div class="header-row">
						...
						<nav class="primary-menu with-arrows">
							...
							<ul class="menu-container">
								...
								<li class="mega-menu menu-item"><a class="menu-link" href="#"><div>Shop Categories</div></a>
											...
											<div class="row">
												<ul class="mega-menu-column border-start-0 p-0 sub-menu-container col-lg-12">
													<div id="tab-shop" class="nav d-flex justify-content-center" role="tablist">
														<a class="nav-link d-inline-block active" href="#mega-menu-tab-men" data-bs-toggle="tab">Men</a>
														<a class="nav-link d-inline-block" href="#mega-menu-tab-women" data-bs-toggle="tab">Women</a>
														<a class="nav-link d-inline-block" href="#mega-menu-tab-accessories" data-bs-toggle="tab">Accessories</a>
													</div>
												</ul>
												<div class="mega-menu-column col-lg-12 tab-content">
													...
													<div class="tab-pane fade" id="mega-menu-tab-women">
														<div class="row">
															<ul class="mega-menu-column sub-menu-container border-start-0 col-lg-3">
																<li class="mega-menu-title menu-item"><a class="menu-link" href="#"><div>Footwear</div></a>
																	<ul class="sub-menu-container">
															...
															<ul class="mega-menu-column sub-menu-container col-lg-3 border-start-0">
																<li class="card p-0 bg-transparent border-0 my-3 my-lg-0 me-3">
																	<img class="card-img-top" src="demos/store/images/cat/workout.jpg" alt="image cap">
																	<a href="#" class="btn btn-link text-start fw-medium ps-0 bg-transparent"><u>Editor's Pick</u></a>
																</li>
															</ul>
														</div>
													</div>
													<div class="tab-pane fade py-4 py-lg-0" id="mega-menu-tab-accessories">
														<div class="row col-mb-30 mx-0">
															<div class="col-6 col-lg-3">
																<div class="product">
																	<div class="product-image">
																		<a href="#"><img src="demos/store/images/product/4-1.jpg" alt="Blue Round-Neck Tshirt"></a>
																		<a href="#"><img src="demos/store/images/product/4-2.jpg" alt="Blue Round-Neck Tshirt"></a>
																		...
																		<div class="bg-overlay">
																			...
																			<div class="bg-overlay-bg dark op-07"></div>
																		</div>
																	</div>
																</div>
															</div>
															<div class="col-6 col-lg-3">
																<div class="product">
																	<div class="product-image">
																		<a href="#"><img src="demos/store/images/product/5-1.jpg" alt="Blue Round-Neck Tshirt"></a>
																		<a href="#"><img src="demos/store/images/product/5-2.jpg" alt="Blue Round-Neck Tshirt"></a>
																		<div class="bg-overlay">
																			<div class="bg-overlay-content align-items-center justify-content-center flex-column dark">
																				<h4 class="mb-0">Product Title</h4>
															...
															<div class="col-6 col-lg-3">
																<div class="product">
																	<div class="product-image">
																		<a href="#"><img src="demos/store/images/product/9-1.jpg" alt="Blue Round-Neck Tshirt"></a>
																		<a href="#"><img src="demos/store/images/product/9-2.jpg" alt="Blue Round-Neck Tshirt"></a>
															...
															<div class="col-6 col-lg-3">
																<div class="product">
																	<div class="product-image">
																		<a href="#"><img src="demos/store/images/product/2-2.jpg" alt="Blue Round-Neck Tshirt"></a>
																		<a href="#"><img src="demos/store/images/product/2-1.jpg" alt="Blue Round-Neck Tshirt"></a>
																		<div class="sale-flash badge bg-success p-2">Sale</div>
																		<div class="bg-overlay">
																			<div class="bg-overlay-content align-items-center justify-content-center flex-column dark">
																				<h4 class="mb-0">Product Title</h4>
					...
					<div class="page-menu-row">
						...
						<nav class="page-menu-nav">
							<ul class="page-menu-container">
								...
								<li class="page-menu-item current"><a href="mega-menu-tab.php"><div>With Tab</div></a></li>
				...
				<div class="page-title-row">
					...
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">Mega Menu Tab</li>
						</ol>
					</nav>
