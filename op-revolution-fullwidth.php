...
<head>
	...
	<style>.tp-caption { white-space: nowrap; }</style>

	<!-- Document Title
	============================================= -->
	<title>One Page Revolution Slider Full Width | Canvas</title>
...
<body class="stretched">
	...
	<div id="wrapper">
		...
		<!-- Header
		============================================= -->
		<header id="header" class="full-header transparent-header dark header-size-custom" data-sticky-shrink="false" data-sticky-class="not-dark" data-sticky-offset="full" data-sticky-offset-negative="200">
			<div id="header-wrap">
				<div class="container">
		...
		<section id="slider" class="slider-element slider-parallax revslider-wrap min-vh-0 include-header">
			<div class="slider-inner">
				...
				#################################
				-->
				<div id="rev_slider_op-fw_wrapper" class="rev_slider_wrapper fullwidth-container"  style="padding:0px;">
						<!-- START REVOLUTION SLIDER 5.1.4 fullwidth mode -->
						<div id="rev_slider_op-fw" class="rev_slider fullwidthbanner" style="display:none;" data-version="5.1.4">
						<ul>    <!-- SLIDE  -->
							<li class="dark" data-transition="fade" data-slotamount="1" data-masterspeed="1500" data-thumb="images/slider/rev/ken-1-thumb.jpg" data-delay="10000"  data-saveperformance="off" data-title="Responsive Design">
								...
								<!-- LAYER NR. 2 -->
								<div class="tp-caption fw-semibold text-center ltl tp-resizeme"
								...
								data-height="none"
								data-endeasing="Power4.easeIn" style="z-index: 3;">different.</div>

								<div class="tp-caption text-center ltl tp-resizeme"
								data-x="center" data-hoffset="0"
								...
								data-endeasing="Power4.easeIn" style="z-index: 3; line-height: 32px">
									<p class="lead">We are a Creative Media Agency with a Flare for Perfection.</p>
								</div>
								...
								data-endelementdelay="0.1"
								data-endspeed="1000"
								data-endeasing="Power4.easeIn" style="z-index: 3;"><a href="#" class="button button-border button-light button-circle m-0"><span>View our Works</span> <i class="uil uil-angle-right-b"></i></a></div>
							...
							<li data-transition="slideup" data-slotamount="1" data-masterspeed="1500" data-thumb="images/slider/rev/ken-2-thumb.jpg" data-delay="10000"  data-saveperformance="off"  data-title="Unlimited Possibilities">
								...
								data-width="['800','800','560','360']"
								data-height="none"
								data-endeasing="Power4.easeIn" style="z-index: 3;">creative.</div>
								...
								data-endelementdelay="0.1"
								data-endspeed="1000"
								data-endeasing="Power4.easeIn" style="z-index: 3;"><a href="#" class="button button-border button-circle fw-medium m-0"><span>Check Out</span> <i class="uil uil-angle-right-b"></i></a></div>
	...
	<script>
		...
		tpj(document).ready(function() {
			if(tpj("#rev_slider_op-fw").revolution == undefined){
				revslider_showDoubleJqueryError("#rev_slider_op-fw");
			}else{
				revapi32 = tpj("#rev_slider_op-fw").show().revolution({
					sliderType:"standard",
					...
					responsiveLevels:[1140,992,768,420],
					visibilityLevels:[1140,992,768,420],
					gridwidth:[1140,992,768,420],
			...
			revapi32.on("revolution.slide.onchange",function (e,data) {
