					...
					<div class="header-row justify-content-lg-between">
						...
						<nav class="primary-menu with-arrows me-lg-auto">
							...
							<ul class="menu-container align-self-start">
								...
								<li class="menu-item current"><a class="menu-link" href="demo-nonprofit.php"><div>Home</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-nonprofit-about.php"><div>About</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-nonprofit-causes.php"><div>Causes</div></a>
			...
			<div class="content-wrap py-0" style="overflow: visible">
					...
					<div class="slider-feature w-100">
						<div class="row justify-content-center">
							<div class="col-md-3 px-1">
								<a href="demo-nonprofit-about.php" class="card text-center border-start-0 border-end-0 border-top-0 border-bottom border-bottom shadow py-3 rounded-0 fw-semibold text-uppercase ls-1">
									<div class="card-body">
							...
							<div class="col-md-3 px-1">
								<a href="demo-nonprofit-causes.php" class="card text-center border-start-0 border-end-0 border-top-0 border-bottom border-bottom shadow py-3 rounded-0 fw-semibold text-uppercase ls-1">
									<div class="card-body">
							...
							<div class="col-md-3 px-1">
								<a href="demo-nonprofit.php" class="card text-center border-start-0 border-end-0 border-top-0 border-bottom border-bottom shadow py-3 rounded-0 fw-semibold text-uppercase ls-1">
									<div class="card-body">
				...
				<div class="container">
					<div class="w-100 position-relative">
						<div class="donor-img d-flex align-items-center rounded parallax scroll-detect mx-auto shadow-sm w-100" style="height: 500px;">
					...
					<div class="owl-carousel owl-carousel-full image-carousel carousel-widget mt-4 charity-card" data-stage-padding="20" data-margin="10" data-center="true" data-loop="true" data-nav="true" data-autoplay="500000" data-speed="400" data-pagi="true" data-items-xs="1" data-items-sm="2" data-items-md="2" data-items-lg="3" data-items-xl="4">
						...
						<div class="oc-item text-start">
							...
							<div class="oc-desc d-flex flex-column justify-content-center shadow-lg">
								...
								<a href="demo-nonprofit-causes-single.php" class="button button-rounded button-border text-transform-none ls-0 fw-medium m-0 d-flex align-self-start">Donate Now</a>
							</div>
						</div>
				...
				<div class="section bg-transparent" style="padding: 80px 0">
					<div class="container">
						<div class="row justify-content-center">
							...
							<h5 class="fw-normal text-black-50 mb-0 text-center">If you want to work with for nonprofit? <a href="demo-nonprofit.php"><u>Send your Details</u></a>.</h5>
						</div>
					</div>
				</div>
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-4 px-4 mb-5 mb-md-0">
								...
								<a href="#" class="mb-1 d-block"><i class="bi-envelope position-relative" style="top: 1px;"></i> no.reply@canvas.com</a>
