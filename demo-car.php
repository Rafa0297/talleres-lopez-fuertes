						...
						<div class="container">
							<div class="slider-caption top-left">
								<div>
									...
									<a href="demo-car-dealers.php" class="button button-rounded button-border button-white button-light text-transform-none">View Details</a>
								</div>
							</div>
						</div>
		...
		<section id="content">
			...
			<div class="content-wrap pb-0" style="padding-top: 1px">
				...
				<div class="row m-0 dark" data-height-xs="500" data-height-sm="500" data-height-md="350" data-height-lg="350" data-height-xl="350">
					<a href="demo-car-dealers.php" class="col-md-4 image_fade border-right" style="background: url('demos/car/images/categories/1.jpg') no-repeat center center / cover;">
					...
					<a href="demo-car-accessories.php" class="col-md-4 image_fade p-0 border-right" style="background: url('demos/car/images/categories/2.jpg') no-repeat center center / cover;">
						<div class="bg-overlay">
							<div class="bg-overlay-content text-overlay-mask dark align-items-end justify-content-start">
								<div class="portfolio-desc py-0">
					...
					<a href="demo-car-contact.php" class="col-md-4 image_fade p-0" style="background: url('demos/car/images/categories/3.jpg') no-repeat center center / cover;">
						<div class="bg-overlay">
							<div class="bg-overlay-content text-overlay-mask dark align-items-end justify-content-start">
								<div class="portfolio-desc py-0">
									<h3>Our Stores</h3>
				...
				<div class="container">
					...
					<div class="row mt-5 mb-5">
						...
						<div class="col-lg-4 col-md-6 mt-5 mb-4">
							...
							<div class="clear"></div>
							<a href="demo-car-dealers.php" class="button button-rounded button-black button-dark ms-0 mt-4">Know More</a>
				...
				<div class="section m-0" style="background: #FFF url('demos/car/images/footer-bg.jpg') center bottom no-repeat; background-size: cover; height: 770px">
					<div class="mx-auto dark center" style="max-width: 570px">
						...
						<a href="demo-car-contact.php" class="text-uppercase fw-bold ls-2 text-white" style="font-size: 12px; border-bottom: 1px solid #FFF">Request a Quote</a> &rarr;
					</div>
				</div>
			</div>
		</section><!-- #content end -->
