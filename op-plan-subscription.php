...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Plan Subscription - One Page Canvas Slider | Canvas</title>
	...
	<style>
		...
		#op-plan-subscription-from button,
		#op-plan-subscription-from input { border-radius: 6px; }
		...
		.price-block:hover,
		.price-block.checked { background-color: #F8F9FA; }


		.op-plan-subscription-from-processing .form-process {
			display: block;
			top: 0;
			left: 0;
			cursor: default;
...
<body class="stretched">
		...
		<section id="slider" class="slider-element include-header">
			...
			<div class="row align-items-stretch g-0 min-vh-100">
				<div class="col-lg-6 col-md-7 order-md-last">
					<div class="vertical-middle px-lg-5 form-widget" data-loader="button">
						<div class="p-5">
							<h3 class="mb-3"><i class="bi-check-circle-fill me-1 position-relative" style="top:2px"></i>Choose your plan.</h3>
							<div class="form-result"></div>
							<form class="mb-0" id="op-plan-subscription-from" name="op-plan-subscription-from" action="include/form.php" method="post" enctype="multipart/form-data">
								...
								<div class="row">
									<div class="col-12 form-group mb-5">
										<div class="g-0 price-block-wrap row align-items-stretch">
											<label for="op-plan-subscription-from-free" class="col-sm-6 price-block text-center mb-0 p-5">
												<input type="radio" name="op-plan-subscription-from-plan" class="required mb-3" id="op-plan-subscription-from-free" autocomplete="off" value="Free">
												<h2 class="h1 fw-bold color mb-3">Free</h2>
												<h6 class="ls-2 text-uppercase text-black-50 fw-normal mb-0">30 Days Free Trail</h6>
											</label>
											<div class="col-12 line d-block d-sm-none m-0"></div>
											<label for="op-plan-subscription-from-pro" class="col-sm-6 price-block text-center mb-0 p-5">
												<input type="radio" name="op-plan-subscription-from-plan" class="required mb-3" id="op-plan-subscription-from-pro" autocomplete="off" value="Pro">
												<h2 class="h1 fw-bold mb-3">$19<span class="price-tenure">/mo</span></h2>
												<h6 class="ls-2 text-uppercase text-black-50 fw-normal mb-0">Unlimited Use <i class="bi-info-circle-circle position-relative" data-bs-toggle="tooltip" title="Globally transform turnkey portals with prospective opportunities. Quickly engage efficient information through market-driven portals. Efficiently." style="top:1px"></i></h6>
											</label>
										</div>
									</div>
									<div class="col-md-6 form-group">
										<label for="op-plan-subscription-from-name">Full Name<small class="text-danger">*</small></label>
										<input type="text" id="op-plan-subscription-from-name" name="op-plan-subscription-from-name" value="" class="form-control required" placeholder="Enter your Full Name">
									</div>
									<div class="col-md-6 form-group">
										<label for="op-plan-subscription-from-contact">Contact Number<small class="text-danger">*</small></label>
										<input type="text" name="op-plan-subscription-from-contact" id="op-plan-subscription-from-contact" class="form-control required" value="" placeholder="Enter your contact Number">
									</div>
									<div class="col-12 form-group">
										<label for="op-plan-subscription-from-email">Email Address<small class="text-danger">*</small></label>
										<input type="email" name="op-plan-subscription-from-email" id="op-plan-subscription-from-email" class="form-control required" value="" placeholder="Enter your Your Email Address..">
									</div>
									<div class="col-12 d-none">
										<input type="text" id="op-plan-subscription-from-botcheck" name="op-plan-subscription-from-botcheck" value="">
									</div>
									<div class="col-12 mt-4 d-flex justify-content-between align-items-center">
										<button type="submit" name="op-plan-subscription-from-submit" class="button m-0 button-large button-rounded">Subscribe Now</button>
										<a href="#"><u>Already Subscribed?</u></a>
									</div>

									<input type="hidden" name="prefix" value="op-plan-subscription-from-">
									<input type="hidden" name="subject" value="New Subscription Request">
									<input type="hidden" name="html_title" value="Subscription Details">
								</div>
				...
				<div class="col-lg-6 col-md-5 dark" style="background: linear-gradient(rgba(0,0,0,.3), rgba(0,0,0,.7)), url('one-page/images/page/subscription.jpg') center center no-repeat; background-size: cover;">
					<div class="d-flex justify-content-center align-items-center h-100 p-5">
						<ul class="iconlist mb-0">
							<li><h4 class="mb-2"><i class="bi-check-circle-fill"></i>First Month Free.</h4></li>
							<li><h4 class="mb-2"><i class="bi-check-circle-fill"></i>You won't be charged until after your Free Month.</h4></li>
							<li><h4 class="mb-2"><i class="bi-check-circle-fill"></i>We'll remind you three days before your trial ends.</h4></li>
							<li><h4 class="mb-2"><i class="bi-check-circle-fill"></i>Watch on your Laptop, TV, Phone &amp; Tablet.</h4></li>
							<li><h4 class="mb-2"><i class="bi-check-circle-fill"></i>No commitments, Cancel at any Time.</h4></li>
						</ul>
					</div>
	...
	<script>
		jQuery(document).ready( function(){
			jQuery('.price-block input:radio').on( 'change', function(){
