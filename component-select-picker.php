...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Select Picker | Canvas</title>
			...
			<div class="container">
				<div class="page-title-row pb-5 align-items-lg-end">
					...
					<div class="page-title-content">
						<h1>Select Picker</h1>
						<span>Styled Select Pickers bringing Additional Functionality to Normal Select Boxes.</span>
					...
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Select Picker</li>
					</ol>
						...
						<div class="row g-4">
							...
							<div class="col-lg-6">
								<div class="white-section">
									...
									<br>
									<pre class="border-0 mb-0">&#x3C;select class=&#x22;selectpicker&#x22;&#x3E;
&#x3C;option&#x3E;Mustard&#x3C;/option&#x3E;
&#x3C;option&#x3E;Ketchup&#x3C;/option&#x3E;
&#x3C;option&#x3E;Relish&#x3C;/option&#x3E;
&#x3C;/select&#x3E;
							...
							<div class="col-lg-6">
								<div class="white-section">
									...
									<br>
									<pre class="border-0 mb-0">&#x3C;select class=&#x22;selectpicker&#x22; multiple&#x3E;
&#x3C;option&#x3E;Mustard&#x3C;/option&#x3E;
&#x3C;option&#x3E;Ketchup&#x3C;/option&#x3E;
&#x3C;option&#x3E;Relish&#x3C;/option&#x3E;
&#x3C;/select&#x3E;
								...
								<div class="white-section">
									<div class="row">
										<div class="col-lg-6">
											...
											<select class="selectpicker" multiple title="Choose Multiple...">
												<option>Mustard</option>
												<option>Ketchup</option>
												<option>Relish</option>
											</select>
										...
										<label>Single PlaceHolder:</label>
											<select class="selectpicker" title="Choose Multiple...">
												<option>Mustard</option>
												<option>Ketchup</option>
												<option>Relish</option>
											</select>
							...
							<div class="col-lg-6">
								<div class="white-section">
									...
									<select class="selectpicker">
										<option data-content="<span class='badge bg-success'>Mustard</span>">Mustard</option>
										<option data-content="<span class='badge bg-warning text-dark'>Ketchup</span>">Ketchup</option>
										<option data-content="<span class='badge bg-danger'>Relish</span>">Relish</option>
									</select>
								</div>
							</div>
							...
							<div class="col-lg-12">
								<div class="white-section">
									...
									<select class="selectpicker" data-style="btn-info" data-width="19%">
										<option>Mustard</option>
										<option>Ketchup</option>
										<option>Relish</option>
										<option>Onions</option>
									...
									<select class="selectpicker" data-style="btn-warning" data-width="19%">
										<option>Mustard</option>
										<option>Ketchup</option>
										<option>Relish</option>
										<option>Onions</option>
									...
									<select class="selectpicker" data-style="btn-success" data-width="19%">
										<option>Mustard</option>
										<option>Ketchup</option>
										<option>Relish</option>
										<option>Onions</option>
									...
									<select class="selectpicker" data-style="btn-danger" data-width="19%">
										<option>Mustard</option>
										<option>Ketchup</option>
										<option>Relish</option>
										<option>Onions</option>
