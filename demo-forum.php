...
<head>
	...
	<meta name="description" content="Create Forums, Link-Sharing &amp; Discussions Websites with Canvas Template. Get Canvas to build powerful websites easily with the Highly Customizable &amp; Best Selling Bootstrap Template, today.">
	...
	<!-- Document Title
	============================================= -->
	<title>Forums / Community | Canvas</title>
					...
					<form class="row mb-0" action="#" method="post" enctype="multipart/form-data">
						...
						<div class="col-12 form-group mb-1">
							<div class="form-check form-check-inline">
								...
								<label class="form-check-label text-transform-none ls-0 mb-0 fw-semibold" for="inlineCheckbox1">Set as a Private Reply</label>
							</div>
						</div>
						<div class="clear"></div>
						<div class="col-12 form-group">
							<div class="form-check form-check-inline">
								...
								<label class="form-check-label text-transform-none ls-0 mb-0 fw-semibold" for="inlineCheckbox2">Email me when Someone Replies</label>
							</div>
						</div>
						<div class="col-12">
							<button type="submit" name="submit" class="button button-large bg-alt border border-width-2 rounded-1 fw-medium text-transform-none ls-0 ms-0">Submit Now</button>

							<button type="button" data-bs-dismiss="modal" aria-label="Close" class="button button-large button-border border-default h-bg-danger rounded-1 fw-medium text-transform-none ls-0 ms-0">Cancel</button>
						</div>
					</form>
				</div>
			</div>
			...
			<div id="header-wrap">
				<div class="container">
					<div class="header-row">
						...
						============================================= -->
						<div id="logo">
							<a href="demo-forum.php">
								<img class="logo-default" srcset="demos/forum/images/canvasforum.png, demos/forum/images/canvasforum@2x.png 2x" src="demos/forum/images/canvasforum@2x.png" alt="Canvas Logo">
							</a>
						</div><!-- #logo end -->
						...
						<div class="header-misc ms-0">
							...
							<div class="header-misc-icon profile-image">
								...
								<div class="dropdown-menu dropdown-menu-end py-0 m-0" aria-labelledby="profilelink">
									<a class="dropdown-item" href="demo-forum-edit.php"><i class="bi-pencil-square me-2"></i>Edit Profile</a>
									<a class="dropdown-item" href="demo-forum-single.php"><i class="bi-text-left me-2"></i>Your Topics</a>
									<a class="dropdown-item" href="demo-forum-signout.php"><i class="bi-box-arrow-right me-2"></i>Sign Out</a>
								</div>
							</div>
						...
						<nav class="primary-menu">
							...
							<ul class="menu-container">
								<li class="menu-item current"><a class="menu-link" href="demo-forum.php"><div>Home</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-forum-single.php"><div>Topic Page</div></a></li>
								<li class="menu-item"><a class="menu-link" href="#" data-bs-toggle="modal" data-bs-target="#modal-signin"><div>Create</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-forum-profile.php"><div>Profile</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-forum-search-result.php"><div>Search Page</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-forum-signin.php"><div>Sign In Page</div></a></li>
							</ul>

						</nav><!-- #primary-menu end -->

						<form class="top-search-form bg-alt dark" action="search.php" method="get">
									...
									<div class="row col-mb-30">
										<div class="col-md-6">
											<div class="widget widget_links">
												...
												<ul>
													<li><a href="demo-forum-single.php">Package Generator – Approx time for a file</a></li>
													<li><a href="demo-forum-single.php">Open sub-menu touching menu-item name</a></li>
													<li><a href="demo-forum-single.php">Portfolio Overlay Slide fadein fadeout</a></li>
													<li><a href="demo-forum-single.php">Show menu .dropdown-menu down only</a></li>
													<li><a href="demo-forum-single.php">Couldnt Generate Package Snippet</a></li>
												</ul>
											</div>
										</div>
										...
										<div class="col-md-6">
											<div class="widget widget_links">
												...
												<ul>
													<li><a href="demo-forum-single.php">How to Install</a></li>
													<li><a href="demo-forum-single.php">How to setup Niche Demos</a></li>
													<li><a href="demo-forum-single.php">Header Layouts and Styles</a></li>
													<li><a href="demo-forum-single.php">Setup Forms</a></li>
													<li><a href="demo-forum-single.php">Setup RTL</a></li>
												</ul>
											</div>
										</div>
									</div>
			...
			<div class="container">
				<div class="row h-100">
					<div class="col-lg-6 d-flex align-self-center flex-column pt-5 pb-0 py-lg-6 mb-0 my-lg-4">
						...
						<div>
							<a href="#" data-bs-toggle="modal" data-bs-target="#modal-signin" class="button button-large border border-width-2 bg-alt py-2 rounded-1 fw-medium text-transform-none ls-0 ms-0 ms-sm-1 h-op-09"><i class="bi-file-earmark-plus"></i>Create A New Topic</a>
							<a href="demo-forum-single.php" class="button button-large button-border rounded-1 fw-medium text-transform-none h-bg-alt ls-0 ms-0"><i class="bi-text-left"></i>Browse All Topics</a>
						</div>
					</div>
							...
							<li>
								<ul class="topic list-unstyled row mx-0 justify-content-between align-items-center">
									<li class="entry mb-0 col-sm-10">
										<h3 class="mb-0"><a class="link-dark" href="demo-forum-single.php">Jump In Content When Using Include-Header Class</a></h3>
								...
								<ul class="topic odd list-unstyled row mx-0 justify-content-between align-items-center">
									<li class="entry mb-0 col-sm-10">
										<h3 class="mb-0"><a class="link-dark" href="demo-forum-single.php">Open sub-menu touching menu-item name, instead of sub-menu-trigger only (mobile)</a></h3>
										<div class="entry-meta mt-1">
											<ul>
								...
								<ul class="topic list-unstyled row mx-0 justify-content-between align-items-center">
									<li class="entry mb-0 col-sm-10">
										<h3 class="mb-0"><a class="link-dark" href="demo-forum-single.php">Portfolio Overlay Slide fadein fadeout</a></h3>
										<div class="entry-meta mt-1">
											<ul>
						...
						<div class="col-lg-6">
							<div class="row justify-content-center col-mb-30 gutter-50 text-center">
								<div class="col-md-3 col-4">
									<img src="demos/forum/images/users/1.jpg" alt="Memebers" width="80" class="rounded-circle mb-2">
									<h5 class="fw-medium">Jim Séchen</h5>
								</div>
								<div class="col-md-3 col-4">
									<img src="demos/forum/images/users/2.jpg" alt="Memebers" width="80" class="rounded-circle mb-2">
									<h5 class="fw-medium">Alan Fresco</h5>
								</div>
								<div class="col-md-3 col-4">
									<img src="demos/forum/images/users/3.jpg" alt="Memebers" width="80" class="rounded-circle mb-2">
									<h5 class="fw-medium">Fig Nelson</h5>
								</div>
								<div class="col-md-3 col-4">
									<img src="demos/forum/images/users/4.jpg" alt="Memebers" width="80" class="rounded-circle mb-2">
									<h5 class="fw-medium">Pelican Steve</h5>
								</div>
								<div class="col-md-3 col-4">
									<img src="demos/forum/images/users/5.jpg" alt="Memebers" width="80" class="rounded-circle mb-2">
									<h5 class="fw-medium">Pelican Steve</h5>
								</div>
								<div class="col-md-3 col-4">
									<img src="demos/forum/images/users/6.jpg" alt="Memebers" width="80" class="rounded-circle mb-2">
									<h5 class="fw-medium">Russell Sprout</h5>
								</div>
								<div class="col-md-3 col-4">
									<img src="demos/forum/images/users/7.jpg" alt="Memebers" width="80" class="rounded-circle mb-2">
									<h5 class="fw-medium">Sir Cumference</h5>
								</div>
								<div class="col-md-3 col-4">
									<img src="demos/forum/images/users/8.jpg" alt="Memebers" width="80" class="rounded-circle mb-2">
									<h5 class="fw-medium">Theodore Handle</h5>
								</div>
							</div>
						</div>
					</div>
	...
	<script>
		jQuery(document).ready( function(){
			jQuery('input[type="file"]').change(function(e){
				...
				jQuery('.custom-file-label').php(fileName);
			});
