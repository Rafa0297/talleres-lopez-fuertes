...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>One Page with Pricing Box | Canvas</title>
	...
	.pricing-extended .pricing-title h3 {
		font-size: 26px;
		margin-bottom: 20px;
	}
...
<body class="stretched" data-loader="11" data-loader-color="#543456">
	...
	<div id="wrapper">
		...
		<section id="slider" class="slider-element slider-parallax min-vh-100 include-header">
			<div class="slider-inner" style="background-image: url('one-page/images/page/3.jpg'); background-position: top center;">
					...
					<div class="row align-items-center m-0">
						<div class="col-md-6 col-lg-5">
							<div class="col-padding">
								<div class="pricing">
									<div class="pricing-box pricing-simple p-4 bg-light text-center">
										<div class="pricing-title text-uppercase">
											<h3>Professional</h3>
										</div>
										<div class="pricing-price color">
											<span class="price-unit">&euro;</span>19
										</div>
										<div class="pricing-features">
											<p class="lead mb-0">Good for: Portfolios, blogs, brochure sites, light ecommerce</p>
										</div>
						...
						<div class="col-md-6 col-lg-7 pricing-extended bg-transparent">
							<div class="col-padding">
								<div class="pricing-desc">
									<div class="pricing-title bg-transparent border-0">
										<h3>How many Themes can you Download today?</h3>
										<p class="lead text-muted">We create &amp; craft projects that ooze creativity in every aspect. We try to create a benchmark in everything. </p>
									</div>
									<div class="pricing-features border-0">
										<div class="row">
											<ul class="col-lg-6 py-0">
												<li><i class="bi-pc-display me-2"></i> Ultra Responsive Layouts</li>
												<li><i class="bi-eye me-2"></i> Retina Ready Designs</li>
												<li><i class="bi-box me-2"></i> Advanced Admin Panel</li>
												<li><i class="bi-magic me-2"></i> Tons of Customization Options</li>
											</ul>
											<ul class="col-lg-6 py-0">
												<li><i class="bi-fonts me-2"></i> Support for Custom Fonts</li>
												<li><i class="bi-window-stack me-2"></i> Premium Sliders Included</li>
												<li><i class="bi-file-earmark-richtext me-2"></i> Photoshop Source Files Included</li>
												<li><i class="fa-regular fa-life-ring me-2"></i> 24x7 Priority Email Support</li>
											</ul>
										</div>
									</div>
								</div>
