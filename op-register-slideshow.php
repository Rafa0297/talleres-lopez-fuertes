							...
							<div class="dark col-padding">
								...
								<form action="#" class="row" style="max-width: 300px;">
									...
									<div class="col-12 form-group mb-0">
										<button type="submit" class="fw-normal text-capitalize button button-border button-light button-circle m-0" value="submit">Register Now</button>
									</div>
								</form>
