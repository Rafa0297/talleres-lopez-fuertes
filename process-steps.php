...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Process Steps | Canvas</title>
		...
		<section id="content">
			<div class="content-wrap">
				<div class="container">
					...
					<div id="processTabs">
						<ul class="nav canvas-tabs tabs nav-tabs mb-3 process-steps row col-mb-30" id="canvas-tab" role="tablist">
							<li class="col-sm-6 col-lg-3">
								<a href="#ptab1" data-bs-toggle="pill" role="tab" class="active i-style rounded-circle i-bordered i-alt mx-auto">1</a>
								<h5>Review Cart</h5>
							</li>
							<li class="col-sm-6 col-lg-3">
								<a href="#ptab2" class="i-style rounded-circle i-bordered i-alt mx-auto" id="canvas-tab-2" data-bs-toggle="pill" role="tab">2</a>
								<h5>Enter Shipping Info</h5>
							</li>
							<li class="col-sm-6 col-lg-3">
								<a href="#ptab3" class="i-style rounded-circle i-bordered i-alt mx-auto" id="canvas-tab-2" data-bs-toggle="pill" role="tab">3</a>
								<h5>Complete Payment</h5>
							</li>
							<li class="col-sm-6 col-lg-3">
								<a href="#ptab4" class="i-style rounded-circle i-bordered i-alt mx-auto" id="canvas-tab-2" data-bs-toggle="pill" role="tab">4</a>
								<h5>Order Complete</h5>
							</li>
						</ul>
						<div id="canvas-TabContent" class="tab-content">
							<div class="tab-pane show active" id="ptab1" role="tabpanel" aria-labelledby="canvas-tab-1" tabindex="0">
								...
								<div class="text-end">
									<a href="#" class="button button-3d m-0 tab-btn-next">Checkout &rArr;</a>
								</div>
							...
							<div class="tab-pane" id="ptab2" role="tabpanel" aria-labelledby="canvas-tab-2" tabindex="0">
								...
								<div class="d-flex justify-content-between">
									<a href="#" class="button button-3d m-0 tab-btn-prev">Previous</a>
									<a href="#" class="button button-3d m-0 tab-btn-next">Pay Now</a>
								</div>
							</div>
							<div class="tab-pane" id="ptab3" role="tabpanel" aria-labelledby="canvas-tab-2" tabindex="0">
								...
								<div class="d-flex justify-content-between">
									<a href="#" class="button button-3d m-0 tab-btn-prev">Previous</a>
									<a href="#" class="button button-3d m-0 tab-btn-next">Complete Order</a>
								</div>
							</div>
							<div class="tab-pane" id="ptab4" role="tabpanel" aria-labelledby="canvas-tab-2" tabindex="0">
					...
					<h3 class="text-center">Process Steps Variations</h3>
					...
					<ul class="process-steps process-3 row col-mb-30 justify-content-center mb-4">
						<li class="col-sm-6 col-lg-3">
							<a href="#" class="i-style i-bordered rounded mx-auto">1</a>
							<h5>Review Cart</h5>
						</li>
						<li class="col-sm-6 col-lg-3 active">
							<a href="#" class="i-style rounded i-alt mx-auto bg-color">2</a>
							<h5>Complete Payment</h5>
						</li>
						<li class="col-sm-6 col-lg-3">
							<a href="#" class="i-style i-bordered rounded mx-auto">3</a>
							<h5>Order Complete</h5>
						</li>
					</ul>
					...
					<ul class="process-steps row col-mb-30 justify-content-center mb-4">
						<li class="col-sm-6 col-lg-3">
							<a href="#" class="i-style rounded-circle i-alt mx-auto">1</a>
							<h5>Review Cart</h5>
						</li>
						<li class="col-sm-6 col-lg-3">
							<a href="#" class="i-style rounded-circle i-alt mx-auto">2</a>
							<h5>Enter Shipping Info</h5>
						</li>
						<li class="col-sm-6 col-lg-3 active">
							<a href="#" class="i-style rounded-circle i-alt mx-auto bg-color">3</a>
							<h5>Complete Payment</h5>
						</li>
						<li class="col-sm-6 col-lg-3">
							<a href="#" class="i-style rounded-circle i-alt mx-auto">4</a>
							<h5>Order Complete</h5>
						</li>
					</ul>
					...
					<ul class="process-steps process-5 row col-mb-30 justify-content-center mb-4">
						<li class="col-sm-6 col-lg-1-5">
							<a href="#" class="i-bordered i-style rounded-circle mx-auto bi-cart"></a>
							<h5>Review Cart</h5>
						</li>
						<li class="col-sm-6 col-lg-1-5">
							<a href="#" class="i-bordered i-style rounded-circle mx-auto bi-pencil"></a>
							<h5>Enter Shipping Info</h5>
						</li>
						<li class="col-sm-6 col-lg-1-5">
							<a href="#" class="i-bordered i-style rounded-circle mx-auto bi-cash"></a>
							<h5>Enter Billing Info</h5>
						</li>
						<li class="col-sm-6 col-lg-1-5 active">
							<a href="#" class="i-style rounded-circle i-alt mx-auto bg-color bi-hand-thumbs-up"></a>
							<h5>Complete Payment</h5>
						</li>
						<li class="col-sm-6 col-lg-1-5">
							<a href="#" class="i-bordered i-style rounded-circle mx-auto bi-check-lg"></a>
							<h5>Order Complete</h5>
						</li>
					</ul>
