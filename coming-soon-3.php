				...
				<div class="container">
					<div class="header-row">
						...
						<div class="header-misc">
							...
							<a href="#" data-bs-toggle="modal" data-bs-target="#contactFormModal" class="social-icon bg-white bg-opacity-25 border-transparent h-bg-email3">
			...
			<div class="slider-inner">
				...
				<div class="vertical-middle">
					<div class="container-fluid py-5 py-md-0">
						...
						<div id="countdown-ex1" class="countdown countdown-large coming-soon mx-auto mb-5" data-year="2024" style="max-width:700px;"></div>
				...
				<div class="video-wrap no-placeholder">
					<video poster="images/videos/explore-poster.jpg" preload muted autoplay loop playsinline>
