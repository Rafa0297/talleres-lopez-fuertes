...
<head>
	...
	<meta name="description" content="Create Law-Firm &amp; Lawyers Websites with Canvas Template. Get Canvas to build powerful websites easily with the Highly Customizable &amp; Best Selling Bootstrap Template, today.">
	...
	<!-- Niche Demos -->
	<link rel="stylesheet" href="demos/law-firm/law-firm.css">
...
<body class="stretched">
	...
	<div id="wrapper">
				...
				<div class="container">
					<div class="header-row align-items-lg-start justify-content-between py-lg-4">
						...
						<div id="logo" class="col-xl-2 col-md-3 col-6 align-items-lg-start py-4">
							<a href="demo-law-firm.php">
								<img class="logo-default" src="demos/law-firm/images/logo.svg" alt="Canvas Logo">
							</a>
						</div><!-- #logo end -->
						...
						<div class="col-auto d-none d-lg-flex py-2">
							<div class="row gx-5 large-device-menu-wrap">
								...
								<div class="col-auto large-device-menu">
									<a class="text-white op-09 h-op-1" href="#"><div>News &amp; Blogs</div></a>
						...
						<nav class="primary-menu d-block d-lg-none">
							...
							<ul class="menu-container">
								...
								<li class="menu-item"><a class="menu-link h-text-warning" href="#"><div>News &amp; Blogs</div></a></li>
		...
		<section id="slider" class="slider-element dark min-vh-md-100 min-vh-75 include-header">
			<div class="slider-inner" style="background-image: linear-gradient(to bottom, rgba(0,0,0,.5), rgba(0,0,0,.3)), url('demos/law-firm/images/hero.jpg');background-position: 50% 0;">
				<div class="container">

					<div class="vertical-middle">
						<div class="row mt-6">
							<div class="col-md-6">
								<div class="before-title text-border-right position-relative text-uppercase ls-3 text-smaller overflow-hidden mb-4 op-04 b-w-50">Team Of Law Agency</div>
		...
		<section id="content">
			<div class="content-wrap overflow-visible py-0">
					...
					<div class="row align-items-center justify-content-center mt-6 mt-lg-0 mb-4">
						<div class="col-lg-5 col-10 px-5">
							<div class="lady-justice-img position-relative">
								<img src="demos/law-firm/images/lady-justice.jpg" alt="Image" class="rounded">
							</div>
						</div>
				...
				<div id="section-contact" class="section bg-color dark mt-6" style="background-image: linear-gradient(to bottom, rgba(var(--cnvs-themecolor-rgb),.8), rgba(var(--cnvs-themecolor-rgb),1)), url('demos/law-firm/images/bg-1.jpg'); background-attachment: fixed; background-size: cover;">
								 ...
								 <div class="form-widget" data-alert-type="false">
									...
									<form class="mb-0" id="lawfirm-inline" name="lawfirm-inline" action="include/form.php" method="post" enctype="multipart/form-data">
										...
										<div class="row">
											...
											<div class="before-title text-uppercase ls-3 text-smaller mb-3 op-05">Looking for a Lawyer?</div>
					...
					<div class="container">
						<div class="row align-items-center justify-content-center gutter-50">
							...
							<div class="col-lg-5 col-10">
								<img src="demos/law-firm/images/bg-2.jpg" alt="Image">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="container">
						<div class="row justify-content-between align-items-center">
							...
							<div class="col-lg-6 col-7 mx-auto">
								<img src="demos/law-firm/images/lawyer.jpg" alt="Image">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="container mw-md mt-5 mt-lg-0">
					<div class="row g-4 align-items-end blog-cards">
						<div class="col-md-8">
							<div class="p-3 pb-4">
								<div class="before-title text-border-right position-relative text-uppercase ls-3 text-smaller overflow-hidden mb-4 op-04 b-w-50">Our Latest News</div>
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="card h-translate-y-sm transform-ts">
										<img src="demos/law-firm/images/blog/1.jpg" alt="" class="card-img-top">
										<div class="card-body p-4">
											...
											<a href="#">Read More <span class="material-symbols-outlined align-middle mb-1">trending_flat</span></a>
										</div>
									</div>
								</div>
								<div class="col-sm-6 mt-4 mt-sm-0">
									<div class="card h-translate-y-sm transform-ts">
										<img src="demos/law-firm/images/blog/2.jpg" alt="" class="card-img-top">
										<div class="card-body p-4">
							...
							<div class="row">
								<div class="col-md-12 col-sm-6">
									<div class="card h-translate-y-sm transform-ts dark mb-4">
										<img src="demos/law-firm/images/blog/3.jpg" alt="" class="card-img">
					...
					<div class="container">
						<div class="row align-items-center justify-content-center col-mb-30 mx-md mx-auto">
							...
							<div class="col-sm-12 col-md-auto">
								<a href="#" data-scrollto="#section-contact" data-easing="easeInOutExpo" data-speed="1250" data-offset="88" class="btn py-3 px-5 rounded-1 btn-dark bg-color h-op-09 m-0">Contact Us <span class="material-symbols-outlined align-middle mb-1 ms-1">trending_flat</span></a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row col-mb-50">
						<div class="col-lg-5 col-sm-6">
							...
							<div class="widget">
								...
								<h5 class="mb-3 h6"><i class="material-symbols-outlined fs-5 text-warning mb-0 align-middle me-3">call</i>+01 234 5678</h5>
								<h5 class="mb-0 h6"><i class="material-symbols-outlined fs-5 text-warning mb-0 align-middle me-3">alternate_email</i>noreply@canvas.com</h5>
						...
						<div class="col-lg-2 col-6">
							<div class="widget widget_links widget-li-noicon">
								...
								<ul>
									<li><a href="#" class="d-flex align-items-center"><i class="fa-brands fa-facebook-f h5 text-warning text-center mb-0 me-3" style="width: 1.5rem;"></i> Facebook</a></li>
									<li><a href="#" class="d-flex align-items-center"><i class="fa-brands fa-instagram h5 text-warning text-center mb-0 me-3" style="width: 1.5rem;"></i> Instagram</a></li>
									<li><a href="#" class="d-flex align-items-center"><i class="fa-brands fa-twitter h5 text-warning text-center mb-0 me-3" style="width: 1.5rem;"></i> Twitter</a></li>
									<li><a href="#" class="d-flex align-items-center"><i class="bi-envelope h5 text-warning text-center mb-0 me-3" style="width: 1.5rem;"></i> Gmail</a></li>
								</ul>
