...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Date &amp; Time Pickers | Canvas</title>
			...
			<div class="container">
				<div class="page-title-row pb-5 align-items-lg-end">
					...
					<div class="page-title-content">
						...
						<span>Variation of Date &amp; Time Pickers</span>
							...
							<div class="row g-5">
								...
								<div class="col-md-6">
									...
									<div class="input-group">
										<input type="text" value="" class="form-control text-start component-datepicker past-enabled" placeholder="MM/DD/YYYY">
										<div class="input-group-text"><i class="bi-calendar3"></i></div>
									</div>
								</div>
								<div class="col-md-6">
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										<div class="input-group text-start" data-target-input="nearest" data-target=".datetimepicker1">
											...
											<div class="input-group-text"  data-target=".datetimepicker1" data-toggle="datetimepicker"><i class="bi-clock"></i></div>
										</div>
									</div>
								</div>
								<div class="col-md-6">
					...
					<div class="row g-5">
						...
						<div class="col-lg-6">
							...
							<div class="d-flex justify-content-end">
								<div class="reportrange form-control" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc; width: 100%">
	...
	<script>
		jQuery(function() {
			...
			function cb(start, end) {
				jQuery(".reportrange span").php(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));
			}
