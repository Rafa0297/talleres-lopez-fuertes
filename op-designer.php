...
<head>
	...
	<link href="https://fonts.googleapis.com/css2?family=Source+Sans+Pro:wght@300;400;600;700&family=Roboto:wght@300;400;500;700&family=Playfair+Display:wght@400;700&display=swap" rel="stylesheet">
	...
	<!-- Document Title
	============================================= -->
	<title>Designer - One Page | Canvas</title>
		...
		<section id="slider" class="slider-element min-vh-60 min-vh-md-100 include-header">
						...
						<div class="row align-items-center justify-content-between py-5">
							...
							<div class="col-lg-5 col-md-6">
								<div class="subscribe-widget" data-loader="button" data-alert-type="inline">
									<h1 class="display-4 text-transform-none" style="letter-spacing:-1px; line-height: 1;"><div class="top-title">We're</div>
										<span class="text-rotater nocolor" style="font-family: 'Playfair Display';" data-separator="|" data-rotate="fadeIn" data-speed="1300"><span class="t-rotate fw-bold opm-large-word">Creative.|Different.|Designer.|Digital.|Vision.|Developer.</span></span>
									</h1>
									<p class="mb-5">Globally innovate principle-centered partnerships with progressive convergence. Interactively mesh best-of-breed functionalities without an expanded array of methodologies.</p>
									<div class="widget-subscribe-form-result"></div>
									<form id="slider-subscribe-form" action="include/subscribe.php" method="post" class="nomb-5">
										<div class="form-group shadow-sm border rounded">
											<label for="widget-subscribe-form-email" class="color">Enter your Email Adress:</label>
											<input type="email" id="widget-subscribe-form-email" name="widget-subscribe-form-email" class="form-control required" placeholder="user@website.com">
											<label id="widget-subscribe-form-email-error" class="error" for="widget-subscribe-form-email"></label>
										</div>
										<button href="#" class="button button-xlarge button-rounded ms-0 mt-2 shadow ls-0" type="submit">Receive Quotes</button>
										<a href="https://vimeo.com/87766904" class="text-uppercase fw-bold text-dark d-block d-lg-inline-block ms-0 ms-lg-4 mt-3 mt-lg-0" data-lightbox="iframe"><i class="bi-play me-2"></i>Play Video</a>
									</form>
								</div>
							</div>

							<div class="col-lg-6 col-md-5">
								<img src="one-page/images/page/design.svg" alt="Image">
							</div>
			...
			<div class="social-icons d-flex">
				<div class="d-flex flex-lg-column flex-row align-items-center justify-content-lg-center justify-content-end w-100">
					...
					<a href="#" class="social-icon rounded-circle si-small text-white bg-facebook" title="Facebook">
						<i class="fa-brands fa-facebook-f"></i>
						<i class="fa-brands fa-facebook-f"></i>
					</a>
					<a href="#" class="social-icon rounded-circle si-small text-white bg-x-twitter" title="Twitter">
						<i class="fa-brands fa-x-twitter"></i>
						<i class="fa-brands fa-x-twitter"></i>
					</a>
					<a href="#" class="social-icon rounded-circle si-small text-white bg-github" title="Github">
						<i class="fa-brands fa-github"></i>
						<i class="fa-brands fa-github"></i>
					</a>
					<a href="#" class="social-icon rounded-circle si-small text-white bg-pinterest" title="Pinterest">
			...
			<a href="#" data-scrollto="#section-about" data-easing="easeInOutExpo" data-speed="1250" data-offset="65" class="one-page-arrow ms-2 mt-5" style="left: 80px;"><i class="bi-arrow-down infinite animated fadeInDown"></i></a>
							...
							<div class="row align-items-stretch grid-border">
								<div class="col-lg-4 col-md-6 col-padding">
									<div class="feature-box fbox-center fbox-dark fbox-plain">
										<div class="fbox-icon">
											<a href="#"><i class="icon-et-mobile color"></i></a>
										</div>
								...
								<div class="col-lg-4 col-md-6 col-padding">
									<div class="feature-box fbox-center fbox-dark fbox-plain">
										<div class="fbox-icon">
											<a href="#"><i class="icon-et-presentation color"></i></a>
										</div>
										<div class="fbox-content fbox-content-sm">
								...
								<div class="col-lg-4 col-md-6 col-padding">
									<div class="feature-box fbox-center fbox-dark fbox-plain">
										<div class="fbox-icon">
											<a href="#"><i class="icon-et-puzzle color"></i></a>
										</div>
										<div class="fbox-content fbox-content-sm">
								...
								<div class="col-lg-4 col-md-6 col-padding">
									<div class="feature-box fbox-center fbox-dark fbox-plain">
										<div class="fbox-icon">
											<a href="#"><i class="icon-et-gears color"></i></a>
										</div>
										<div class="fbox-content fbox-content-sm">
								...
								<div class="col-lg-4 col-md-6 col-padding">
									<div class="feature-box fbox-center fbox-dark fbox-plain">
										<div class="fbox-icon">
											<a href="#"><i class="icon-et-genius color"></i></a>
										</div>
										<div class="fbox-content fbox-content-sm">
								...
								<div class="col-lg-4 col-md-6 col-padding">
									<div class="feature-box fbox-center fbox-dark fbox-plain">
										<div class="fbox-icon">
											<a href="#"><i class="icon-et-hotairballoon color"></i></a>
										</div>
										<div class="fbox-content fbox-content-sm">
