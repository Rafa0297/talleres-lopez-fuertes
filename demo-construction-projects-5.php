					...
					<div class="header-row justify-content-between flex-row-reverse flex-lg-row justify-content-lg-center">
						...
						<nav class="primary-menu with-arrows">
							...
							<ul class="menu-container">
								...
								<li class="menu-item current"><a class="menu-link" href="demo-construction-projects.php"><div>Projects</div></a>
									<ul class="sub-menu-container">
			...
			<div class="container">
				<div class="page-title-row">
					...
					<div class="page-title-content">
						<h1>Projects</h1>
						<span>Monuments &amp; Buildings we have worked on</span>
					</div>
		...
		<section id="content">
			<div class="content-wrap">
				<div class="container">
					...
					<h3 class="text-center ls-1 mb-4">Some of Our Esteemed Projects:</h3>

					<div id="portfolio" class="portfolio row gutter-10">
