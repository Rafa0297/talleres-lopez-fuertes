...
<body style="background: url('images/pattern.png') repeat;">
	...
	<div id="wrapper">
		...
		<section id="content">
			<div class="content-wrap">
					...
					<div class="row col-mb-50">
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box fbox-sm fbox-plain" data-animate="fadeIn" data-delay="1000">
								<div class="fbox-icon">
									<a href="#"><i class="bi-check-circle-fill"></i></a>
								</div>
								<div class="fbox-content">
									<h3>Endless Possibilities</h3>
				...
				<div class="section parallax scroll-detect dark mb-0" style="padding: 100px 0;">
							...
							<div class="col-lg-3 col-md-6">
								...
								<div class="team">
									...
									<div class="team-desc team-desc-bg">
										...
										<a href="#" class="social-icon inline-block si-small bg-light rounded-circle border-transparent h-bg-facebook">
											<i class="fa-brands fa-facebook-f"></i>
											<i class="fa-brands fa-facebook-f"></i>
										</a>
										<a href="#" class="social-icon inline-block si-small bg-light rounded-circle border-transparent h-bg-x-twitter">
											<i class="fa-brands fa-x-twitter"></i>
											<i class="fa-brands fa-x-twitter"></i>
										</a>
										<a href="#" class="social-icon inline-block si-small bg-light rounded-circle border-transparent h-bg-google">
