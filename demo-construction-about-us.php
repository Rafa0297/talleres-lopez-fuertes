					...
					<div class="header-row justify-content-between flex-row-reverse flex-lg-row justify-content-lg-center">
						...
						<nav class="primary-menu with-arrows">
							...
							<ul class="menu-container">
								...
								<li class="menu-item current"><a class="menu-link" href="demo-construction-about-us.php"><div>About Us</div></a></li>
		...
		<section id="content">
			<div class="content-wrap">
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-6">
							...
							<a href="#" class="button button-3d ms-0 mb-4">Learn More</a>
						</div>
				...
				<div class="section row p-0 align-items-stretch dark mt-5">
					<div class="col-lg-4 d-none d-md-block min-vh-50" style="background: url('demos/construction/images/services/parallax.jpg') center center repeat; background-size: cover;">
						<div>&nbsp;</div>
					</div>
					<div class="col-lg-8">
					...
					<div class="row g-5 mb-6">
						...
						<div class="col-lg-5">
							...
							<ul class="clients-grid row row-cols-2 row-cols-sm-3 grid-border">
								<li class="col-padding"><a href="#"><img src="images/clients/1.png" alt="Clients"></a></li>
								<li class="col-padding"><a href="#"><img src="images/clients/2.png" alt="Clients"></a></li>
								<li class="col-padding"><a href="#"><img src="images/clients/3.png" alt="Clients"></a></li>
								<li class="col-padding"><a href="#"><img src="images/clients/4.png" alt="Clients"></a></li>
								<li class="col-padding"><a href="#"><img src="images/clients/5.png" alt="Clients"></a></li>
								<li class="col-padding"><a href="#"><img src="images/clients/6.png" alt="Clients"></a></li>
							</ul>
						</div>
					</div>
				</div>

				<a href="demo-construction-projects.php" class="button button-3d border-bottom-0 mt-4 button-full text-center mb-5 fw-light font-primary" style="font-size: 26px;">
					<div class="container">
