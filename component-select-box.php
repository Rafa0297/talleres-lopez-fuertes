...
<body class="stretched" data-menu-breakpoint="1200">
			...
			<div class="container">
				<div class="page-title-row pb-5 align-items-lg-end">
					...
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Select Boxes</li>
					</ol>
							...
							<form action="#" method="post" class="mb-0">
								...
								<div class="mb-4">
									...
									<div style="margin-bottom: 10px;">
										<select class="select-data-array form-select mb-4" style="width:100%;"></select>
									</div>
									<div>
								...
								<div class="mb-4">
									...
									<select class="select-hide form-select mb-4" style="width:100%;">
										<option value="CT">Connecticut</option>
										<option value="DE">Delaware</option>
										<option value="FL">Florida</option>
										<option value="GA">Georgia</option>
	...
	<script>
		jQuery(document).ready( function(){
			...
			jQuery(".select-data-array-selected").select2({
			  data: data
			});

			// Enabled/Disabled
			jQuery(".select-disabled").select2();
			jQuery(".select-enable").on("click", function () {
				jQuery(".select-disabled").prop("disabled", false);
				jQuery(".select-disabled-multi").prop("disabled", false);
			});
			jQuery(".select-disable").on("click", function () {
				jQuery(".select-disabled").prop("disabled", true);
				jQuery(".select-disabled-multi").prop("disabled", true);
			});

			// Without Search
			jQuery(".select-hide").select2({
