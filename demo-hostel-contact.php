...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Contact - Hostel | Canvas</title>
	...
	<div id="wrapper">
		...
		<section id="slider" class="slider-element bg-light d-flex align-items-center text-center" style="padding: 80px 0">
			...
			<div class="container">
				...
				<span class="color text-uppercase ls-3">Get in Touch</span>
			</div>
			...
			<div class="content-wrap pb-0">
				<div class="container">
					...
					<div class="row align-items-stretch gx-0">
						...
						<div class="h-100" style="background: url('demos/hostel/images/box-img/1.jpg') no-repeat center center / cover;"></div>
						</div>
						<div class="col-lg-6">
							<div class="bg-light border border-f5 p-5">
								<h3 class="mb-2">Send us an Email</h3>
								<p class="lead">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Facere, dolores.</p>
								...
								<div class="form-widget">
									...
									<form class="mb-0" id="template-contactform" name="template-contactform" action="include/form.php" method="post">
										...
										<div class="row">
											...
											<div class="col-12 form-group">
												<button class="button button-xlarge fw-semibold bg-color text-transform-none ls-0 px-5 m-0" type="submit" id="template-contactform-submit" name="template-contactform-submit" value="submit">Send Message</button>
											</div>
										</div>
				...
				<div class="section mb-0 text-center dark parallax" style="background: url('demos/hostel/images/hero.jpg') center center / cover; padding: 170px 0;">
					<div class="container">
