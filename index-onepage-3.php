...
<body class="stretched">
	...
	<div id="wrapper">
		...
		<!-- Header
		============================================= -->
		<header id="header" class="full-header transparent-header dark no-sticky page-section">
			<div id="header-wrap">
				<div class="container">
		...
		<section id="slider" class="slider-element slider-parallax min-vh-60 min-vh-md-100 dark include-header">
			<div class="slider-inner" style="background: url('images/slider/swiper/1.jpg') center center;">
			...
			<div class="content-wrap py-0">
				...
				<section id="section-about" class="page-section section bg-transparent m-0">
					<div class="container">
						...
						<div class="heading-block mb-6 text-center">
							<h2>About Us.</h2>
				...
				<section id="section-services" class="page-section section dark m-0 border-0 overflow-hidden" style="background-color: #222;">
						...
						<div class="container">
							...
							<div class="row justify-content-center col-mb-50">
								...
								<div class="col-sm-6 col-lg-4">
									<div class="feature-box fbox-plain">
										<div class="fbox-icon">
											<a href="#"><i class="bi-droplet-half"></i></a>
										</div>
										<div class="fbox-content">
								...
								<div class="col-sm-6 col-lg-4">
									<div class="feature-box fbox-plain">
										<div class="fbox-icon">
											<a href="#"><i class="bi-textarea-t"></i></a>
										</div>
										<div class="fbox-content">
				...
				<section id="section-video" class="page-section min-vh-100 section dark p-0 m-0 border-0 d-flex overflow-hidden">
					...
					<div class="container-fluid text-center">
						<div class="slider-caption slider-caption-center">
							<i class="i-plain i-xlarge bi-gem float-none mx-auto mb-4" data-animate="fadeInDown"></i>
				...
				<section id="section-testimonials" class="page-section section parallax scroll-detect min-vh-100 m-0 d-flex dark" style="padding: 200px 0;">
