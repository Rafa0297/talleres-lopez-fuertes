...
<body class="stretched" data-menu-breakpoint="1200">
	...
	<div class="offcanvas offcanvas-top dark py-lg-5 py-4" tabindex="-1" data-bs-backdrop="true" id="offcanvasMenu" aria-labelledby="offcanvasMenuLabel">
        <button type="button" class="btn-close position-absolute top-0 end-0 p-2 rounded-0" data-bs-dismiss="offcanvas" aria-label="Close"></button>
		<div class="container">
			<div class="row g-5">
		...
		<section id="content">
			<div class="content-wrap">
				<div class="content-wrap text-center">
					...
					<a href="header-offcanvas-light.php" class="fs-4 link-dark link-opacity-75-hover"><u>Offcanvas - Light</u></a>
				</div>
			</div>
		</section><!-- #content end -->
