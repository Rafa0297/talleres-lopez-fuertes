	...
	<div id="wrapper">
					...
					<div id="rev_slider_579_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.1.4">
						<ul>   <!-- SLIDE  -->
							...
							<li class="dark" data-transition="slideup" data-slotamount="1" data-masterspeed="1000" data-thumb="images/slider/rev/main/s2-thumb.jpg"  data-fstransition="fade" data-fsmasterspeed="1000" data-fsslotamount="7" data-saveperformance="off"  data-title="Unlimited Homepages">
								...
								data-endelementdelay="0.1"
								data-endspeed="1300"
								data-endeasing="Power4.easeIn" style="z-index: 11;"><a href="#" class="button button-border button-white button-light button-large button-rounded text-end m-0"><span>Check Now</span> <i class="uil uil-angle-right-b"></i></a></div>
		...
		<section id="content">
			<div class="content-wrap">
					...
					<div class="container">
						...
						<div class="row col-mb-50">
							...
							<div class="col-sm-6 col-lg-3 text-center" data-animate="bounceIn" data-delay="400">
								<i class="i-plain i-xlarge mx-auto mb-0 bi-file-earmark-text"></i>
							...
							<div class="col-sm-6 col-lg-3 text-center" data-animate="bounceIn" data-delay="600">
								<i class="i-plain i-xlarge mx-auto mb-0 bi-clock"></i>
				...
				<a href="#" class="button button-full button-dark text-center text-end mb-6">
					<div class="container">
						We have more than 100+ predefined Portfolio Grid Layouts. <strong>See More</strong> <i class="fa-solid fa-caret-right" style="top:4px;"></i>
					</div>
				</a>
				...
				<div class="container">
					...
					<div class="row align-items-center gutter-40 col-mb-50">
						...
						<div class="col-md-7">
							...
							<a href="#" class="button button-border button-rounded button-large ms-0 mt-4">Experience More</a>
						</div>
					</div>
						...
						<div class="col-lg-4">
									...
									<div class="slider-wrap">
										<div class="slide">
											<div class="row gx-3">
												...
												<div class="col">
													<p class="mb-3 font-secondary">Similique fugit repellendus expedita excepturi iure perferendis provident quia eaque. Repellendus, vero numquam?</p>
							...
							<div class="position-relative overflow-hidden pb-4">
								...
								<ul class="iconlist mb-0">
									...
									<li><i class="bi-clock color"></i> <strong class="me-2">Saturdays:</strong> 11AM to 3PM</li>
