...
<body class="stretched" data-menu-breakpoint="1200">
	...
	<div id="wrapper">
		...
		<div class="gdpr-settings gdpr-settings-sm border border-default" data-persistent="true" style="--cnvs-gdpr-settings-spacing:2rem;--cnvs-gdpr-settings-width:40rem;">
			<div class="container-fluid">
				<div class="row align-items-center gy-4">
					<div class="col-md-12 mb-md-0 text-center text-md-start">
					...
					<div class="col-md-12">
						<div class="row">
							<div class="col-md-4">
								<button class="btn btn-success gdpr-accept w-100">Accept All</button>
							</div>

							<div class="col-md-4">
								<a href="#gdpr-preferences" class="btn btn-secondary w-100" data-lightbox="inline">Preferences</a>
							</div>

							<div class="col-md-4">
								<button class="btn btn-danger gdpr-decline w-100">Decline</button>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="mfp-hide" id="gdpr-preferences">
			<div class="block mx-auto bg-white gdpr-cookie-settings" style="max-width: 800px;">
				<div class="p-5" style="max-height: 400px; overflow-y: scroll; -webkit-overflow-scrolling: touch;">
					<h3 class="mb-3">Privacy Preferences</h3>
			...
			<div class="container">
				<div class="page-title-row pb-5 align-items-lg-end">
					...
					<div class="page-title-content">
						<h1>GDPR</h1>
						<span>Privacy Policy Preferences</span>
