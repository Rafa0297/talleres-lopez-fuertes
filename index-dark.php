		...
		<section id="content">
			<div class="content-wrap">
				...
				<div class="row align-items-stretch">
					...
					<div class="col-lg-6 text-center col-padding" style="background-color: #282828;">
						<div>
				...
				<div class="section parallax scroll-detect dark mb-0">
								...
								<div class="team">
									...
									<div class="team-desc team-desc-bg">
										...
										<div class="d-flex justify-content-center mt-4">
											<a href="#" class="social-icon si-small bg-black rounded-circle h-bg-facebook">
												<i class="fa-brands fa-facebook-f"></i>
												<i class="fa-brands fa-facebook-f"></i>
											</a>
											<a href="#" class="social-icon si-small bg-black rounded-circle h-bg-x-twitter">
												<i class="fa-brands fa-x-twitter"></i>
												<i class="fa-brands fa-x-twitter"></i>
											</a>
											<a href="#" class="social-icon si-small bg-black rounded-circle h-bg-google">
