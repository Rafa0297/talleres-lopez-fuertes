				...
				<div class="header-row flex-column flex-lg-row justify-content-center justify-content-lg-start">
					...
					<div class="header-misc mb-4 mb-lg-0 order-lg-last">
						...
						<ul class="header-extras me-0 me-lg-4">
							<li>
								<i class="i-plain bi-hand-thumbs-up m-0"></i>
								<div class="he-text">
									Original Brands
							...
							<li>
								<i class="i-plain bi-truck m-0"></i>
								<div class="he-text">
									Free Shipping
							...
							<li>
								<i class="i-plain bi-arrow-counterclockwise m-0"></i>
								<div class="he-text">
									30-Day Returns
		...
		<section id="content">
			<div class="content-wrap">
				<div class="container">
					...
					<div class="row align-items-stretch g-4 mb-5 min-vh-60">
						...
						<div class="col-xl-4">
							<div class="row g-4">
								<div class="col-sm-6 col-xl-12">
									<a href="#" class="grid-inner d-block">
										<img src="images/shop/banners/7.jpg" alt="Image" class="w-100 h-100 object-cover rounded">
									</a>
								</div>

								<div class="col-sm-6 col-xl-12">
									<a href="#" class="grid-inner d-block">
										<img src="images/shop/banners/3.jpg" alt="Image" class="w-100 h-100 object-cover rounded">
									</a>
								</div>
							</div>
						</div>
				...
				<div class="promo parallax scroll-detect promo-full my-6">
					<img src="images/parallax/home/9.jpg" class="parallax-bg">
					<div class="container">
										...
										<div class="col ps-3">
											...
											<div class="entry-meta no-separator">
												<ul>
													...
													<li><i class="bi-star-fill"></i><i class="bi-star-fill"></i><i class="bi-star-fill"></i><i class="bi-star-fill"></i><i class="bi-star"></i></li>
												</ul>
											</div>
										</div>
									</div>
				...
				<div class="si-sticky si-sticky-right d-none d-lg-block" style="z-index: 399;">
					<a href="#" class="social-icon text-white bg-facebook" data-animate="bounceInRight">
						<i class="fa-brands fa-facebook-f"></i>
						<i class="fa-brands fa-facebook-f"></i>
					</a>
					<a href="#" class="social-icon text-white bg-x-twitter" data-animate="bounceInRight" data-delay="100">
						<i class="fa-brands fa-x-twitter"></i>
						<i class="fa-brands fa-x-twitter"></i>
					</a>
					<a href="#" class="social-icon text-white bg-pinterest" data-animate="bounceInRight" data-delay="200">
						<i class="fa-brands fa-pinterest-p"></i>
						<i class="fa-brands fa-pinterest-p"></i>
					</a>
					<a href="#" class="social-icon text-white bg-instagram" data-animate="bounceInRight" data-delay="300">
						<i class="bi-instagram"></i>
						<i class="bi-instagram"></i>
					</a>
					<a href="#" class="social-icon text-white bg-google" data-animate="bounceInRight" data-delay="600">
						<i class="fa-brands fa-google"></i>
						<i class="fa-brands fa-google"></i>
					</a>
					<a href="#" class="social-icon text-white bg-rss" data-animate="bounceInRight" data-delay="700">
