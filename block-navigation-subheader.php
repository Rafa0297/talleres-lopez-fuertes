...
<body class="stretched">
	...
	<div id="wrapper">
		...
		<!-- Header
		============================================= -->
		<header id="header" data-sticky-shrink-offset="0">
			<div id="header-wrap">
				<div class="container">
		...
		<!-- <div class="container">
			<a href="#" class="d-block pb-3 link-primary"><i class="bi-arrow-left me-2"></i> Back to Portfolio</a>
		</div> -->

		<!-- Content
		============================================= -->
		<section id="content">
			<div class="content-wrap py-0 bg-dark dark">
				<div class="row justify-content-center align-items-center text-center min-vh-100">
					<h1 class="col-12 display-4 mb-0">Sub Menu<br>...</h1>
				</div>
			</div>
		</section><!-- #content end -->
