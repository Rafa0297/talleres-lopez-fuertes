						...
						<div class="col-lg-8">
							...
							<div class="row col-mb-50">
											...
											<div class="col-md-6 mt-3 mt-md-0">
												...
												<div class="entry-meta">
													<ul>
														...
														<li><a href="blog-single.php#comments"><i class="uil uil-comments-alt"></i> 21</a></li>
									...
									<div class="posts-md">
										<div class="entry row mb-5">
											...
											<div class="col-md-6 mt-3 mt-md-0">
												...
												<div class="entry-meta">
													<ul>
														<li><i class="uil uil-schedule"></i> 7th Jun 2021</li>
														<li><a href="blog-single.php#comments"><i class="uil uil-comments-alt"></i> 23</a></li>
														<li><a href="#"><i class="uil uil-camera"></i></a></li>
													</ul>
												</div>
												<div class="entry-content">
										...
										<div class="entry col-md-6">
											<div class="grid-inner row g-0">
												...
												<div class="col ps-3">
													...
													<div class="entry-meta">
														<ul>
															<li><i class="uil uil-schedule"></i> 5th Nov 2021</li>
															<li><a href="#"><i class="uil uil-comments-alt"></i> 3</a></li>
														</ul>
													</div>
												</div>
											</div>
										...
										<div class="entry col-md-6">
											<div class="grid-inner row g-0">
												...
												<div class="col ps-3">
													...
													<div class="entry-meta">
														<ul>
															<li><i class="uil uil-schedule"></i> 29th Jul 2021</li>
															<li><a href="#"><i class="uil uil-comments-alt"></i> 22</a></li>
														</ul>
													</div>
												</div>
											</div>
										...
										<div class="entry col-md-6">
											<div class="grid-inner row g-0">
												...
												<div class="col ps-3">
													...
													<div class="entry-meta">
														<ul>
															<li><i class="uil uil-schedule"></i> 12th Oct 2021</li>
															<li><a href="#"><i class="uil uil-comments-alt"></i> 47</a></li>
														</ul>
													</div>
												</div>
											</div>
										...
										<div class="entry col-md-6">
											<div class="grid-inner row g-0">
												...
												<div class="col ps-3">
													...
													<div class="entry-meta">
														<ul>
															<li><i class="uil uil-schedule"></i> 25th Mar 2021</li>
															<li><a href="#"><i class="uil uil-comments-alt"></i> 56</a></li>
														</ul>
													</div>
												</div>
											</div>
								...
								<div class="col-12">
									...
									<div class="masonry-thumbs grid-container row row-cols-6" data-big="5" data-lightbox="gallery">
									...
									<div class="row posts-md col-mb-30">
										<div class="entry col-sm-6 col-xl-4">
											<div class="grid-inner">
												...
												<div class="entry-title title-xs text-transform-none">
													<h3><a href="blog-single.php">Yum, McDonald's apologize as new China food scandal brews</a></h3>
												</div>
												<div class="entry-meta">
													<ul>
														<li><i class="uil uil-schedule"></i> 9th Sep 2021</li>
														<li><a href="blog-single.php#comments"><i class="uil uil-comments-alt"></i> 23</a></li>
													</ul>
												</div>
												<div class="entry-content">
										...
										<div class="entry col-sm-6 col-xl-4">
											<div class="grid-inner">
												...
												<div class="entry-title title-xs text-transform-none">
													<h3><a href="blog-single.php">Halliburton gets boost from rebound in North America drilling</a></h3>
												</div>
												<div class="entry-meta">
													<ul>
														<li><i class="uil uil-schedule"></i> 23rd Aug 2021</li>
														<li><a href="blog-single.php#comments"><i class="uil uil-comments-alt"></i> 33</a></li>
													</ul>
												</div>
												<div class="entry-content">
										...
										<div class="entry col-sm-6 col-xl-4">
											<div class="grid-inner">
												...
												<div class="entry-title title-xs text-transform-none">
													<h3><a href="blog-single.php">China sends spy ship off Hawaii during U.S.-led drills brews</a></h3>
												</div>
												<div class="entry-meta">
													<ul>
														<li><i class="uil uil-schedule"></i> 11th Feb 2021</li>
										...
										<div class="entry col-sm-6 col-xl-4">
											<div class="grid-inner">
												...
												<div class="entry-title title-xs text-transform-none">
													<h3><a href="blog-single.php">Wobbly stocks underpin yen and Swiss franc; dollar subdued</a></h3>
												</div>
												<div class="entry-meta">
													<ul>
														<li><i class="uil uil-schedule"></i> 17th Jan 2021</li>
														<li><a href="blog-single.php#comments"><i class="uil uil-comments-alt"></i> 50</a></li>
													</ul>
												</div>
												<div class="entry-content">
													<p>Neque nesciunt molestias soluta esse debitis. Magni impedit quae consectetur consequuntur.</p>
										...
										<div class="entry col-sm-6 col-xl-4">
											<div class="grid-inner">
												...
												<div class="entry-title title-xs text-transform-none">
													<h3><a href="blog-single.php">BlackBerry names ex-Sybase executive as chief operating officer</a></h3>
												</div>
												<div class="entry-meta">
													<ul>
										...
										<div class="entry col-sm-6 col-xl-4">
											<div class="grid-inner">
												...
												<div class="entry-title title-xs text-transform-none">
													<h3><a href="blog-single.php">Georgian prime minister fires seven ministers in first reshuffle</a></h3>
												</div>
												<div class="entry-meta">
													<ul>
														<li><i class="uil uil-schedule"></i> 10th Dec 2013</li>
														<li><a href="blog-single.php#comments"><i class="uil uil-comments-alt"></i> 13</a></li>
													</ul>
												</div>
												<div class="entry-content">
									...
									<div class="row gutter-20 col-mb-30">
										<div class="col-4">
											<div class="row align-items-center gx-2">
												...
												<div class="counter counter-inherit text-smaller col-auto"><span class="d-block fw-bold" data-from="1000" data-to="58742" data-refresh-interval="100" data-speed="3000" data-comma="true"></span><small>Likes</small></div>
											</div>
										</div>

										<div class="col-4">
											<div class="row align-items-center gx-2">
												<a href="#" class="social-icon bg-dark h-bg-x-twitter">
													<i class="fa-brands fa-x-twitter"></i>
													<i class="fa-brands fa-x-twitter"></i>
												</a>
												<div class="counter counter-inherit text-smaller col-auto"><span class="d-block fw-bold" data-from="500" data-to="9654" data-refresh-interval="50" data-speed="2500" data-comma="true"></span><small>Followers</small></div>
											</div>
										</div>

										<div class="col-4">
											<div class="row align-items-center gx-2">
												<a href="#" class="social-icon bg-dark h-bg-rss">
													<i class="fa-solid fa-rss"></i>
													<i class="fa-solid fa-rss"></i>
												</a>
												<div class="counter counter-inherit text-smaller col-auto"><span class="d-block fw-bold" data-from="200" data-to="15475" data-refresh-interval="150" data-speed="3500" data-comma="true"></span><small>Readers</small></div>
											</div>
										</div>
									</div>
								</div>
