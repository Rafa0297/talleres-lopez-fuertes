				...
				<div class="fslider h-100 position-absolute" data-speed="3000" data-pause="7500" data-animation="fade" data-arrows="false" data-pagi="false" style="background-color: #333;">
					<div class="flexslider">
						<div class="slider-wrap">
							<div class="slide" style="background: url('demos/real-estate/images/hero/3.jpg') center center; background-size: cover;"></div>
							<div class="slide" style="background: url('demos/real-estate/images/hero/4.jpg') center center; background-size: cover;"></div>
							<div class="slide" style="background: url('demos/real-estate/images/hero/5.jpg') center center; background-size: cover;"></div>
						</div>
					</div>
				</div>
				...
				<div class="vertical-middle">
					<div class="container text-center">
						<div class="emphasis-title m-0">
							...
							<span class="fw-light text-uppercase" style="font-size: 18px; letter-spacing: 10px; color: rgba(255,255,255,0.9);">A Few Clicks Away.</span>
						</div>
					</div>
				</div>
		...
		<div class="tabs advanced-real-estate-tabs">
			...
			<div class="container">
				<ul class="nav canvas-tabs tabs nav-tabs" style="--bs-nav-tabs-border-width: 0px">
					<li class="nav-item"><a class="nav-link active" href="#tab-properties" data-scrollto="#tab-properties" data-offset="133">Search Properties</a></li>
				</ul>
			</div>
						...
						<form action="#" method="post" class="mb-0">
							<div class="row g-4">
								...
								<div class="col-lg-2 col-md-6 col-6">
									<label>Beds</label>
									<select class="selectpicker w-100" multiple data-size="6" data-placeholder="Any" style="line-height: 30px;">
					...
					<div class="row col-mb-50">
						<div class="col-md-8">
							...
							<div class="mb-0">
								...
								<ul id="realestate-tabs" class="nav canvas-alt-tabs tabs-alt tabs-tb tabs nav-tabs nav-fill mb-3" id="canvas-tab-tb" role="tablist" style="--bs-nav-link-font-weight: 500;">
									<li class="nav-item" role="presentation">
										<button class="nav-link active" id="canvas-realestate-tab-1-tab" data-bs-toggle="pill" data-bs-target="#realestate-tab-1"
											type="button" role="tab" aria-controls="canvas-realestate-tab-1" aria-selected="true">Why Us?</button>
									</li>
									<li class="nav-item" role="presentation">
										<button class="nav-link" id="canvas-realestate-tab-2-tab" data-bs-toggle="pill" data-bs-target="#realestate-tab-2"
											type="button" role="tab" aria-controls="canvas-realestate-tab-2" aria-selected="false">Properties</button>
									</li>
									<li class="nav-item" role="presentation">
										<button class="nav-link" id="canvas-realestate-tab-3-tab" data-bs-toggle="pill" data-bs-target="#realestate-tab-3"
											type="button" role="tab" aria-controls="canvas-realestate-tab-3" aria-selected="false">Legal</button>
									</li>
								</ul>

								<div id="canvas-tab-tb-content" class="tab-content">
									<div class="tab-pane fade show active" id="realestate-tab-1" role="tabpanel" aria-labelledby="canvas-realestate-tab-1-tab"
										tabindex="0">
										<p>Proin elit arcu, rutrum commodo, vehicula tempus, commodo a, risus. Curabitur nec arcu. Donec sollicitudin mi sit amet mauris. Nam elementum quam ullamcorper ante. Etiam aliquet massa et lorem. Mauris dapibus lacus auctor risus. Aenean tempor ullamcorper leo. Vivamus sed magna quis ligula eleifend adipiscing. Duis orci. Aliquam sodales tortor vitae ipsum. Aliquam nulla. Duis aliquam molestie erat. Ut et mauris vel pede varius sollicitudin. Sed ut dolor nec orci tincidunt interdum. Phasellus ipsum. Nunc tristique tempus lectus.</p>
										<div class="row col-mb-30">
											<div class="col-sm-6 col-lg-3 text-center">
												<div class="counter ls-1 fw-semibold" style="color: #D2D2D2;"><span data-from="100" data-to="964" data-refresh-interval="50" data-speed="2000"></span></div>
												<h5>Floors Built</h5>
											</div>

											<div class="col-sm-6 col-lg-3 text-center">
												<div class="counter ls-1 fw-semibold" style="color: #D2D2D2;"><span data-from="100" data-to="8514" data-refresh-interval="50" data-speed="2500"></span></div>
												<h5>Employees</h5>
											</div>

											<div class="col-sm-6 col-lg-3 text-center">
												<div class="counter ls-1 fw-semibold" style="color: #D2D2D2;"><span data-from="100" data-to="458" data-refresh-interval="50" data-speed="3500"></span></div>
												<h5>Happy Clients</h5>
											</div>

											<div class="col-sm-6 col-lg-3 text-center">
												<div class="counter ls-1 fw-semibold" style="color: #D2D2D2;"><span data-from="14" data-to="159" data-refresh-interval="15" data-speed="2700"></span></div>
												<h5>Cities Served</h5>
											</div>
										</div>
									</div>
									<div class="tab-pane fade" id="realestate-tab-2" role="tabpanel" aria-labelledby="canvas-realestate-tab-2-tab" tabindex="0">
									...
									<div class="tab-pane fade" id="realestate-tab-3" role="tabpanel" aria-labelledby="canvas-realestate-tab-3-tab" tabindex="0">
