...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Careers - Construction | Canvas</title>
	...
	<div id="wrapper">
					...
					<div class="header-row justify-content-between flex-row-reverse flex-lg-row justify-content-lg-center">
						...
						<nav class="primary-menu with-arrows">
							...
							<ul class="menu-container">
								...
								<li class="menu-item current"><a class="menu-link" href="demo-construction-careers.php"><div>Careers</div></a></li>
			...
			<div class="container">
				<div class="page-title-row">
					...
					<div class="page-title-content">
						<h1>Careers</h1>
						<span>Join Our Team &amp; Be Happy</span>
					</div>
		...
		<section id="content">
			<div class="content-wrap">
				<div class="container">
					...
					<div class="row text-center mx-auto" style="max-width: 960px;">
						<div class="col-lg-12">
									...
									<div class="col-lg-3 col-md-6">
										<div class="feature-box fbox-center fbox-plain border-bottom-0">
											...
											<div class="fbox-content">
												<h3><a href="#" class="text-dark">Boat Builders and Shipwright</a></h3>
											</div>
										</div>
									</div>
									<div class="col-lg-3 col-md-6">
							...
							<div class="button button-3d mt-5">Browse More Categories</div>
						</div>
					</div>
				</div>
				...
				<div class="container">
					...
					<div class="row gx-5">
						...
						<div class="col-lg-6">
							...
							<h3><strong class="color">Q.</strong> How do I become an author?</h3>
							...
							<h3><strong class="color">Q.</strong> Helpful Resources for Authors</h3>
							...
							<h3><strong class="color">Q.</strong> How much money can I make?</h3>
							...
							<h3><strong class="color">Q.</strong> Can I offer my items for free on a promotional basis?</h3>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus, fugiat iste nisi tempore nesciunt nemo fuga? Nesciunt, delectus laboriosam nisi repudiandae nam fuga saepe animi recusandae. Asperiores, provident, esse, doloremque, adipisci eaque alias dolore molestias assumenda quasi saepe nisi ab illo ex nesciunt nobis laboriosam iusto quia nulla ad voluptatibus iste beatae voluptas corrupti facilis accusamus recusandae sequi debitis reprehenderit quibusdam. Facilis eligendi a exercitationem nisi et placeat excepturi velit!</p>
							...
							<h3><strong class="color">Q.</strong> An Introduction to the Marketplaces for Authors</h3>
							...
							<h3><strong class="color">Q.</strong> How does the Tuts+ Premium affiliate program work?</h3>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad odio ab quis architecto recusandae doloremque incidunt! Eius, quidem, pariatur necessitatibus commodi aliquid deleniti repudiandae accusantium tempora soluta vel nesciunt est quibusdam iure adipisci aspernatur maiores saepe ea eaque quo harum reprehenderit similique nemo voluptate ullam natus illum magnam alias nobis doloremque delectus ipsa dicta repellat maxime dignissimos eveniet quae debitis ratione.</p>

						</div>

						<div class="col-lg-6">

							<h3><strong class="color">Q.</strong> What Images, Videos, Code or Music Can I Use in my Items?</h3>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad odio ab quis architecto recusandae doloremque incidunt! Eius, quidem, pariatur necessitatibus commodi aliquid deleniti repudiandae accusantium tempora soluta vel nesciunt est quibusdam iure adipisci aspernatur maiores saepe ea delectus ipsa dicta repellat maxime dignissimos eveniet quae debitis ratione assumenda tempore officiis fugiat dolor. Saepe iusto praesentium ullam aliquam impedit.</p>

							<div class="divider divider-right"><a href="#" data-scrollto="#faqs-list"><i class="fa-solid fa-chevron-up"></i></a></div>

							<h3><strong class="color">Q.</strong> Can I use trademarked names in my items?</h3>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eveniet, nisi, laborum autem reprehenderit excepturi harum ipsum quod sit dolorem assumenda magni laudantium saepe recusandae doloremque illo nesciunt aut quos debitis neque reiciendis veritatis iusto eos aliquid voluptatem pariatur eveniet velit?</p>
							...
							<h3><strong class="color">Q.</strong> Tips for Increasing Your Referral Income</h3>
							...
							<h3><strong class="color">Q.</strong> How can I get support for an item which isn't working correctly?</h3>
							...
							<h3><strong class="color">Q.</strong> How do I pay for items on the Marketplaces?</h3>
				...
				<a href="icons.php" class="button button-3d border-bottom-0 button-full text-center text-end fw-light font-primary mt-5 footer-stick" style="font-size: 26px;">
					<div class="container">
						Check out our new Construction related Font Icons? <strong>Check Now</strong> <i class="uil uil-angle-right-b" style="top:3px;"></i>
					</div>
				</a>
