...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>SEO Optimizations - SEO Demo | Canvas</title>
...
<body class="stretched">
	...
	<div id="wrapper">
				...
				<div class="container">
					<div class="header-row">
						...
						<div class="header-misc">
							...
							<a href="demo-seo-about.php" class="button button-rounded ms-3 d-none d-sm-block">Get Started</a>
		...
		<section class="page-title page-title-parallax parallax scroll-detect page-title-center dark include-header include-topbar">
			<img src="demos/seo/images/services/seo-title.jpg" class="parallax-bg">
				...
				<div class="page-title-row">
					...
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">SEO Optimizations</li>
						</ol>
					</nav>
				...
				<div class="container">
					<div class="row align-items-end">
						<div class="col-lg-6">
							...
							<h2 class="display-4 fw-bold">Improve your SEO with Data.</h2>
						...
						<div class="col-lg-6 mt-4 mt-lg-0">
							<img src="demos/seo/images/services/seo.svg" alt="Image">
						</div>
					</div>
					...
					<div class="row mt-4 col-mb-50 mb-0">
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box">
								<div class="fbox-icon mb-4">
									<a href="#"><i class="bi-file-earmark-richtext text-white bg-google"></i></a>
								</div>
								<div class="fbox-content">
									<h3 class="text-transform-none">On-Pages Optimization</h3>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box">
								...
								<div class="fbox-content">
									<h3 class="text-transform-none">Mobile SEO</h3>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box">
								...
								<div class="fbox-content">
									<h3 class="text-transform-none">Local SEO</h3>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box">
								<div class="fbox-icon mb-4">
									<a href="#"><i class="bi-window text-white bg-appstore"></i></a>
								</div>
								<div class="fbox-content">
									<h3 class="text-transform-none">Website Analytics</h3>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box">
								<div class="fbox-icon mb-4">
									<a href="#"><i class="fa-solid fa-spinner bg-info"></i></a>
								</div>
								<div class="fbox-content">
									<h3 class="text-transform-none">Page loading speed</h3>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box">
								<div class="fbox-icon mb-4">
									<a href="#"><i class="bi-code bg-danger"></i></a>
								</div>
								<div class="fbox-content">
									<h3 class="text-transform-none">Customizing Codes</h3>
