	...
	<div id="wrapper">
						...
						<div class="fslider h-100 shadow-sm" data-arrows="true" data-autoplay="6000" data-loop="true">
							<div class="flexslider h-100">
								<div class="slider-wrap h-100">
									<div class="slide h-100" style="background: url('demos/car/images/dealers/1.jpg') center center; background-size: cover;">
										<div class="slide-caption bg-dark card shadow-sm ms-4"><div class="card-body fw-semibold py-1 px-2 text-light">2011</div></div>
										<div class="slide-caption d-flex justify-content-between align-items-center flex-row dark slider-caption-bottom bg-dark slider-caption-bg py-4 px-4">
											<div class="w-75">
												...
												<p class="fw-light text-white-50">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eos ullam blanditiis voluptas quam iste tenetur laboriosam consectetur dignissimos recusandae, incidunt veritatis fugit!</p>
											</div>
											<h2 class="fw-bold h2 mb-0">$15,39,000</h2>
										</div>
									</div>
									<div class="slide h-100" style="background: url('demos/car/images/dealers/2.jpg') center center; background-size: cover;">
										<div class="slide-caption bg-dark card shadow-sm ms-4"><div class="card-body fw-semibold py-1 px-2 text-light">2012</div></div>
										<div class="slide-caption d-flex justify-content-between align-items-center flex-row dark slider-caption-bottom bg-dark slider-caption-bg py-4 px-4">
											<div class="w-75">
									...
									<div class="slide h-100" style="background: url('demos/car/images/dealers/3.jpg') center center; background-size: cover;">
										<div class="slide-caption bg-dark card shadow-sm ms-4"><div class="card-body fw-semibold py-1 px-2 text-light">2013</div></div>
										<div class="slide-caption d-flex justify-content-between align-items-center flex-row dark slider-caption-bottom bg-dark slider-caption-bg py-4 px-4">
											<div class="w-75">
								...
								<form action="#" method="post" class="mb-0">
									<div class="row">
										...
										<div class="col-12 mt-3">
											...
											<select class="selectpicker customjs" title="Select Brand"  data-size="7" data-live-search="true" multiple style="width:100%;">
										...
										<div class="col-12 mt-3">
											...
											<select class="selectpicker customjs" data-size="7" data-live-search="true" title="Select Model" style="width:100%; line-height: 30px;">
												<optgroup label="AUDI">
										...
										<div class="col-12 mt-3 input-daterange travel-date-group">
											...
											<input type="text" id="template-contactform-date" name="template-contactform-date" value="" class="form-control text-start">
		...
		<section id="content">
			...
			<div class="content-wrap py-0">
				...
				<div class="row border-bottom align-content-stretch flex-wrap">
						...
						<div id="portfolio" class="portfolio row gutter-20 col-mb-30">
							...
							<article class="portfolio-item col-12 col-sm-6 col-lg-4 cf-sedan">
								<div class="grid-inner">
									...
									<div class="portfolio-desc">
										<h3><a href="demo-car-dealers.php">Ford Mustang - White</a></h3>
							...
							<article class="portfolio-item col-12 col-sm-6 col-lg-4 cf-suv">
								<div class="grid-inner">
									...
									<div class="portfolio-desc">
										<h3><a href="demo-car-dealers.php">Chevrolet Brown Traverse</a></h3>
							...
							<article class="portfolio-item col-12 col-sm-6 col-lg-4 cf-cabriolet">
								<div class="grid-inner">
									...
									<div class="portfolio-desc">
										<h3><a href="demo-car-dealers.php">Audi 2021 S5 Cabriolet</a></h3>
							...
							<article class="portfolio-item col-12 col-sm-6 col-lg-4 cf-cuv">
								<div class="grid-inner">
									...
									<div class="portfolio-desc">
										<h3><a href="demo-car-dealers.php">BMW 3 Series, ABS</a></h3>
							...
							<article class="portfolio-item col-12 col-sm-6 col-lg-4 cf-supercar">
								<div class="grid-inner">
									...
									<div class="portfolio-desc">
										<h3><a href="demo-car-dealers.php">2021 LEXUS IS 200T FSPORT</a></h3>
							...
							<article class="portfolio-item col-12 col-sm-6 col-lg-4 cf-hatchback">
								<div class="grid-inner">
									...
									<div class="portfolio-desc">
										<h3><a href="demo-car-dealers.php">Chevrolet T430 Hatchback</a></h3>
