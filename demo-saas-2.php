...
<head>
	...
	<meta name="description" content="Create SAAS &amp; AI Subscription Websites with Canvas Template. Get Canvas to build powerful websites easily with the Highly Customizable &amp; Best Selling Bootstrap Template, today.">
	...
	<div id="wrapper">
				...
				<div class="container">
					<div class="header-row">
						...
						<div id="logo" class="col-lg-2 me-lg-auto">
							<a href="index.php" class="w-auto">
								<img class="logo-default" srcset="demos/saas-2/images/logo.png, demos/saas-2/images/logo@2x.png 2x" src="demos/saas-2/images/logo@2x.png" alt="Canvas Logo">
                        ...
                        <div class="header-misc ms-auto col-lg-2 justify-content-lg-end">
							<a href="#" class="button button-border button-rounded rounded border-contrast-500 mx-0" style="--cnvs-btn-fontsize: 1.125rem"><i class="bi-asterisk d-none d-md-inline-block me-2 fs-6"></i>Get Started</a>
						</div>
						...
						<nav class="primary-menu with-arrows">
							...
							<ul class="one-page-menu menu-container" data-easing="easeInOutExpo" data-speed="1250" data-offset="65">
								...
								<li class="menu-item">
									<a href="#" class="menu-link" data-href="#section-examples"><div>Examples</div></a>
								</li>
								<li class="menu-item">
									<a href="#" class="menu-link" data-href="#section-pricing"><div>Pricing</div></a>
								</li>
								<li class="menu-item">
									<a href="#" class="menu-link" data-href="#section-faqs"><div>FAQs</div></a>
								</li>
								<li class="menu-item">
		...
		<section id="content">
			<div class="content-wrap py-0">
						...
						<div class="row align-items-center gy-3">
							...
							<div class="col-lg-8">
								<div class="row g-4 align-items-center justify-content-center">
									<div class="col-md-2 col-4 flex-fill text-center op-08"><img height="46" src="demos/saas-2/images/clients/cnn.svg" alt="Brands"></div>
									<div class="col-md-2 col-4 flex-fill text-center op-08"><img height="46" src="demos/saas-2/images/clients/github.svg" alt="Brands"></div>
									<div class="col-md-2 col-4 flex-fill text-center op-08"><img height="46" src="demos/saas-2/images/clients/google.svg" alt="Brands"></div>
									<div class="col-md-2 col-4 flex-fill text-center op-08"><img height="46" src="demos/saas-2/images/clients/paypal.svg" alt="Brands"></div>
									<div class="col-md-2 col-4 flex-fill text-center op-08"><img height="46" src="demos/saas-2/images/clients/vimeo.svg" alt="Brands"></div>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="container">
									...
									<div class="swiper swiper-tab-container">
										<div class="swiper-wrapper">
											<div class="swiper-slide">
												<img src="demos/saas-2/images/new/tabs/app.svg" alt=".." class="w-100 rounded-xxl">
											</div>
											<div class="swiper-slide">
												<img src="demos/saas-2/images/new/tabs/features.svg" alt=".." class="w-100 rounded-xxl bg-success bg-opacity-10">
											</div>
											<div class="swiper-slide">
												<img src="demos/saas-2/images/new/tabs/pay.jpg" alt=".." class="w-100 rounded-xxl">
											</div>
										</div>
									</div>
								</div>
						...
						<div class="row justify-content-center mt-lg-6 mt-5">
							<div class="col-lg-8 text-center">
								<h3 class="display-4 fw-bolder mb-3 ls-n-2">Why you <span class="gradient-text gradient-color font-secondary px-1 ls-1">Choose</span> Us</h3>
								<p class="lead mb-5 mb-lg-6">Visionary Design, Seamless Integration, Powerful Tools &amp; Unmatched Support.<br>Turning your Ideas into Digital Reality.</p>
							</div>
							<div class="w-100"></div>
							<div class="col-lg-12">
					...
					<div class="container">
						<div class="text-center">
							<h3 class="display-4 fw-bolder ls-n-3 mb-3 position-relative">
								The <span class="gradient-text gradient-color font-secondary px-1 ls-1">cost of doing business</span> <br> shouldn’t cost so damn much</h3>
							<p class="lead mb-5 mb-lg-6">Enjoy budget-friendly options with our flexible pricing<br>Ensure affordability without compromising on quality or value.</p>
						</div>

						<div class="pricing-tenure-switcher font-primary row align-items-center justify-content-center mb-4" data-container="#pricing-switch">
							<div class="col-auto">
								<div class="btn-group rounded-pill position-relative" role="group" aria-label="Basic radio toggle button group">
									<input type="radio" class="btn-check" name="switch-toggle-radio" id="switch-toggle-monthly" checked value="monthly">
									<label class="btn mb-0" for="switch-toggle-monthly"><span>Monthly</span></label>

									<input type="radio" class="btn-check" name="switch-toggle-radio" id="switch-toggle-annually" value="annually">
									<label class="btn mb-0" for="switch-toggle-annually"><span>Annually</span></label>
								</div>
							</div>
						</div>
						...
						<div id="pricing-switch" class="row justify-content-center pricing gx-lg-5">
							...
							<div class="col-xl-5 col-md-6">
								<span class="badge px-3 py-2 mt-2 me-1 bg-white border border-default text-dark rounded-pill fw-normal position-absolute z-9" style="left: 50px; top: -23px;">Most Popular</span>
								<div class="pricing-box position-relative rounded-xxl p-5 h-100 d-flex flex-column bg-contrast-0">
									<div class="row align-items-center">
										<div class="col-lg-6">
											<h3 class="fw-bolder fs-1 ls-n-1 mb-1">Basic</h3>
                                            <p class="mb-0 small lh-base text-contrast-700">Best Plan for Startup Plan.</p>
										</div>

										<div class="col-lg-6">
                                            <div class="pricing-price fw-bolder text-lg-end pt-lg-0 pb-0">
												<div class="pts-content pts-content-monthly">&dollar;5<span class="d-block fs-6 fw-semibold op-05 mb-0 mt-2">per month</span></div>
												<div class="pts-content pts-content-annually">&dollar;60<span class="d-block fs-6 fw-semibold op-05 mb-0 mt-2">per year</span></div>
											</div>
										</div>
									</div>
									<div class="pricing-features bg-transparent border-bottom-0 border-width-2 border-black mt-5 pt-5 pb-3">
										<p class="lead fw-bold mb-3">Included:</p>
										<ul class="iconlist">
											<li class="my-1"><i class="bi-patch-check-fill"></i> <span><strong>SEO</strong> Features</span></li>
											<li class="my-1"><i class="bi-patch-check-fill"></i> <span><strong>1 Users</strong> Access</span></li>
											<li class="my-1"><i class="bi-patch-check-fill"></i> <span><strong>100</strong> User Accounts</span></li>
											<li class="my-1"><i class="bi-patch-check-fill"></i> <span><strong>1 Year</strong> License</span></li>
											<li class="my-1"><i class="bi-patch-check-fill"></i> <span><strong>24/7</strong> Support</span></li>
										</ul>
									</div>
                                    <div class="pricing-action p-0 mt-auto">
                                        <a href="#" class="button fw-semibold w-100 py-3 px-4 d-flex justify-content-between rounded-pill mx-0">Get Started <i class="bi-arrow-right"></i></a>
                                    </div>
							...
							<div class="col-xl-5 col-md-6">
								<div class="pricing-box rounded-xxl p-5 h-100 d-flex flex-column border-0 bg-color bg-opacity-10">
									<div class="row align-items-center">
										<div class="col-lg-6">
											<h3 class="fw-bolder fs-1 ls-n-1 mb-1">Business</h3>
                                            <p class="mb-0 small lh-base text-contrast-700">A Perfect Business Plan For Your Full Team.</p>
										</div>

										<div class="col-lg-6">
											<div class="pricing-price fw-bolder text-lg-end pt-lg-0 pb-0">
												<div class="pts-content pts-content-monthly">&dollar;49<span class="d-block fs-6 fw-semibold op-05 mb-0 mt-2">per month</span></div>
												<div class="pts-content pts-content-annually">&dollar;588<span class="d-block fs-6 fw-semibold op-05 mb-0 mt-2">per year</span></div>
											</div>
										</div>
									</div>
									<div class="pricing-features bg-transparent border-bottom-0 border-width-2 border-dark mt-5 pt-5 pb-3">
										<p class="lead fw-bold mb-3">Included:</p>
										<ul class="iconlist">
											<li class="my-1"><i class="bi-patch-check-fill"></i> <span><strong>Unlimited</strong> Niche Demos</span></li>
											<li class="my-1"><i class="bi-patch-check-fill"></i> <span><strong>SEO</strong> Features</span></li>
											<li class="my-1"><i class="bi-patch-check-fill"></i> <span><strong>Ultimate</strong> Access</span></li>
											<li class="my-1"><i class="bi-patch-check-fill"></i> <span><strong>All</strong> User Accounts</span></li>
											<li class="my-1"><i class="bi-patch-check-fill"></i> <span><strong>Ultimate</strong> License</span></li>
											<li class="my-1"><i class="bi-patch-check-fill"></i> <span><strong>24/7</strong> Support</span></li>
										</ul>
									</div>
					...
					<div class="container">
						<div class="row justify-content-between position-relative">
							<div class="col-lg-5">
								...
								<img src="demos/saas-2/images/svg/faqs.svg" alt="...">
							</div>
				...
				<div class="section pb-0 scroll-detect" style="background-color: #DBF2FF;">
					<div class="container">
						<div class="row justify-content-center g-4">
							<div class="col-lg-6">
								<span class="badge rounded-pill text-bg-primary px-3 py-2 mb-3 fw-normal">Canvas / SAAS Template</span>
								<h3 class="display-5 ls-n-2 fw-bolder mb-0">Crafted to Captivate Attention &amp; Leave a Lasting Impact.</h3>
							</div>
							<div class="col-lg-6">
								<p class="lead pt-lg-5">Experience the pinnacle of creativity and craftsmanship with our high-quality designs, meticulously curated to enhance your brand's identity and resonate powerfully with your audience.</p>
								<a href="#" class="button button-large button-black h-bg-color rounded-pill m-0">Browse Layouts</a>
							</div>

							<div class="w-100"></div>

							<div class="col-lg-9">
								<img src="demos/saas-2/images/new/screen.png" alt="..." class="mt-5" style="transform: translate3d(0,calc(150px * var(--cnvs-scroll-end)),0); transition:transform .1s linear;">
							</div>
						</div>
					</div>
				</div>
				...
				<div id="section-blog" class="page-section pb-5" style="background: linear-gradient(to bottom, transparent 40%, rgba(var(--bs-primary-rgb), .1) 40%);">
					<div class="container py-5">
						<div class="text-center mb-5">
							<h3 class="display-4 fw-bolder ls1 mb-3 position-relative"><span class="gradient-text gradient-color">Editor's </span> Desk</h3>
							<p class="lead">Embrace Creativity with our Latest Designs &amp; Expert Tips<br>Fueling your Projects for exceptional results and growth.</p>
						...
						<div class="row align-items-stretch g-4">
							<div class="col-lg-4">
								<div class="entry d-flex flex-column h-100 mb-0 bg-contrast-0 p-4 rounded-xxl" style="--cnvs-post-item-margin:0;">
									<div class="entry-image mb-3">
										<a href="#">
											<img src="demos/saas-2/images/new/blogs/1.svg" alt="Image 3" class="rounded-6">
										</a>
									</div>
									<div class="entry-desc mb-auto">
										<div class="badge text-bg-primary text-light rounded-pill fw-normal mb-2">Minimalism</div>
										<div class="entry-title">
											<h3 class="mb-0 fs-5 font-body fw-medium"><a href="#">Mastering Minimalism: Crafting Powerful Designs with Less</a></h3>
										</div>
									</div>
							...
							<div class="col-lg-4">
								<div class="entry d-flex flex-column h-100 mb-0 bg-contrast-0 p-4 rounded-xxl" style="--cnvs-post-item-margin:0;">
									<div class="entry-image mb-3">
										<a href="#">
											<img src="demos/saas-2/images/new/blogs/2.svg" alt="Image 3" class="rounded-6">
										</a>
									</div>
									<div class="entry-desc mb-auto">
										<div class="badge text-bg-warning text-light rounded-pill fw-normal mb-2">Communication</div>
										<div class="entry-title">
											<h3 class="mb-0 fs-5 font-body fw-medium"><a href="#">Color Psychology in Design: Unveiling the Emotive Palette of Visual Communication</a></h3>
										</div>
									</div>
									<div class="d-flex text-contrast-600 border-top mt-3 pt-3 small">
							...
							<div class="col-lg-4">
								<div class="entry d-flex flex-column h-100 mb-0 bg-contrast-0 p-4 rounded-xxl" style="--cnvs-post-item-margin:0;">
									<div class="entry-image mb-3">
										<a href="#">
											<img src="demos/saas-2/images/new/blogs/3.svg" alt="Image 3" class="rounded-6">
										</a>
									</div>
									<div class="entry-desc mb-auto">
										<div class="badge text-bg-danger text-light rounded-pill fw-normal mb-2">Trends</div>
										<div class="entry-title">
											<h3 class="mb-0 fs-5 font-body fw-medium"><a href="#">Navigating UX/UI Trends: Designing Intuitive Digital Experiences for Modern Audiences</a></h3>
										</div>
									</div>
									<div class="d-flex text-contrast-600 border-top mt-3 pt-3 small">
										<span>3 days ago</span>
					...
					<div class="row gx-4 gy-5">
						...
						<div class="col-lg-3 col-6">
							...
							<div class="widget widget_links widget-li-noicon">
								...
								<h4 class="fw-bolder text-contrast-1000 text-smaller text-uppercase mb-4">How we Work</h4>
						...
						<div class="col-lg-3 col-6">
							...
							<div class="widget widget_links widget-li-noicon">
								...
								<h4 class="fw-bolder text-contrast-1000 text-smaller text-uppercase mb-4">How we do</h4>
						...
						<div class="col-lg-3 col-6">
							...
							<div class="widget">
								...
								<h4 class="fw-bolder text-contrast-1000 text-smaller text-uppercase mb-4">Need Help?</h4>

								<ul class="list-unstyled">
									<li class="mb-3"><a class="text-dark" href="#"><i class="me-3 color bi-telephone-fill"></i>+0 (11) 222 333</a></li>
									<li class="mb-3"><a class="text-dark" href="#"><i class="me-3 color bi-envelope-fill"></i>no-reply@canvas.com</a></li>
									<li class="mb-3"><i class="me-3 color bi-calendar-week-fill"></i>Mon - Sat | 09:00 - 16:00</li>
