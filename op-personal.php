...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Personal - One Page Module | Canvas</title>

	<style>
		#header:not(.sticky-header) #logo a { opacity: 0; pointer-events: none; }
	</style>
...
<body class="stretched overlay-menu">
	...
	<div id="wrapper">
		...
		<!-- Header
		============================================= -->
		<header id="header" class="full-header transparent-header header-size-custom" data-sticky-shrink="false" data-sticky-offset="full" data-sticky-offset-negative="200">
			<div id="header-wrap">
				<div class="container">
		...
		<section id="slider" class="slider-element slider-parallax min-vh-100 include-header">
			<div class="slider-inner" style="background-image: url('one-page/images/page/1.jpg'); background-position: top center;">

				<div class="vertical-middle text-start slider-element-fade">
					<div class="container py-5">
						<div class="emphasis-title mb-5">
							<h1 class="text-uppercase fw-bold" style="font-size: 52px; letter-spacing: 10px; word-spacing: 5px;">Darcy Shearer</h1>
							<span class="text-uppercase" style="color: #888;letter-spacing:10px; font-size: 18px">Graphics Designer</span>
							<p class="lead mt-5" style="max-width: 600px; line-height: 1.8; color: #AAA">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Id hic neque alias! Accusamus, perspiciatis. Dicta accusantium, consequuntur maxime vour sequi cumque, labore consequuntur veritatis animi sint non voluptatibus.</p>
						</div>
						<div class="d-flex mt-5" style="--cnvs-socialicon-gap:0.5rem;">
							...
							<a href="#" class="social-icon si-small rounded-circle text-white bg-github" title="Github">
								<i class="fa-brands fa-github"></i>
								<i class="fa-brands fa-github"></i>
							</a>
							<a href="#" class="social-icon si-small rounded-circle text-white bg-pinterest" title="Pinterest">
