    ...
    <section id="carpinteria-aluminio" class="py-5">
      <div class="container">
        ...
        <div class="text-center mb-5">
          <h2 class="fw-bold text-uppercase" style="color:#003b6f;">Plegables de Aluminio</h2>
          <p class="lead text-muted mx-auto" style="max-width: 700px; text-align: justify">
            Los sistemas de puertas y ventanas plegables de aluminio son una solución innovadora y versátil para
            maximizar
            el espacio y la funcionalidad en cualquier ambiente. Ideales para conectar interiores con exteriores, estos
            sistemas permiten abrir completamente un espacio, creando una transición fluida entre áreas. Con perfiles
            delgados y resistentes, las puertas plegables de aluminio ofrecen una estética moderna y elegante, además de
            una excelente durabilidad y resistencia a las inclemencias del tiempo.
          </p>
        </div>
        ...
        <div class="row align-items-center g-5">
          <!-- Imagen principal -->
          <div class="col-lg-6">
            <img src="demos/construction/images/products/plegables-de-aluminio/1.jpg" alt="Carpintería de Aluminio"
              class="img-fluid rounded shadow-sm w-100">
          </div>

          <!-- Descripción -->
          <div class="col-lg-6">
            <h3 class="fw-semibold mb-3">Versatilidad, amplitud y diseño moderno</h3>
            <p>
              Los sistemas plegables de aluminio permiten abrir amplios espacios con un diseño elegante y funcional.
              Ideales para conectar interiores con exteriores, terrazas o jardines, combinan resistencia, ligereza y una
              excelente capacidad de aislamiento térmico y acústico.
            </p>
            <ul class="list-unstyled">
              <li><i class="fa-solid fa-check text-danger me-2"></i> Apertura total para mayor amplitud y luminosidad
              </li>
              <li><i class="fa-solid fa-check text-danger me-2"></i> Estructura resistente y ligera en aluminio</li>
              <li><i class="fa-solid fa-check text-danger me-2"></i> Diseño elegante con alto nivel de aislamiento</li>
            </ul>
          </div>
        ...
        <div class="row align-items-center g-5">
          <!-- Descripción -->
          <div class="col-lg-6">
            <p style="text-align: justify;">Con los cerramientos plegables de aluminio se permiten cerrar terrazas de
              restaurantes, viviendas, divisiones exteriores e interiores, etc
              <br><br>
              Con ello se ofrece una mayor hermeticidad al agua y al viento, logrando el cerramiento de una habitación,
              terraza, sin ningún tipo de obra.
            </p>

          </div>
          <!-- Imagen secundaria -->
          <div class="col-lg-6">
            <img src="demos/construction/images/products/plegables-de-aluminio/2.jpg" alt="Carpintería de Aluminio"
              class="img-fluid rounded shadow-sm w-100">
          </div>
