...
<body class="stretched">
	...
	<div id="wrapper">
		...
		<!-- Header
		============================================= -->
		<header id="header" class="no-sticky dark border-0">
			<div id="header-wrap">
				<div class="container">
					<div class="header-row">
						...
						<nav class="primary-menu">
							...
							<ul class="menu-container">
								...
								<li class="menu-item">
									<a class="menu-link" href="index.php"><div>Men</div></a>
								</li>
								<li class="menu-item">
									<a class="menu-link" href="index.php"><div>Women</div></a>
								</li>
								<li class="menu-item">
									<a class="menu-link" href="index.php"><div>Kids</div></a>
								</li>
							</ul>
		...
		<!-- Hero Section
		============================================= -->
		<section id="slider" class="slider-element block-slider-2" style="background: rgb(255,255,255); background: linear-gradient(0deg, rgba(255,255,255,0) 0%, rgba(255,255,255,0) 25%, #080E2C 25%);">

			<div class="container">
				<div class="swiper_wrapper min-vh-60 min-vh-lg-75" data-loop="true">
				...
				<div class="swiper swiper-parent">
					<div class="swiper-wrapper">
						<div class="swiper-slide dark">
							<div class="container">
								<div class="slider-caption slider-caption-center">
									<p class="mb-4 text-white text-smaller text-uppercase ls-4" data-animate="fadeInUpSmall">Shop for Men</p>
									<div class="overflow-hidden"><h2 data-animate="fadeInUpSmall" data-delay="200">Your feet will never <br>look the same again.</h2></div>
									<div class="overflow-hidden">
										<a href="#" class="button button-border button-light button-rounded button-large ms-0 mt-4" data-animate="fadeInUpSmall" data-delay="400">Shop Now</a>
									</div>
								</div>
							</div>
							<div class="swiper-slide-bg" style="background-image: url('images/blocks/preview/slider-2/1.jpg');"></div>
						</div>
						...
						<div class="swiper-slide dark">
							<div class="container">
								<div class="slider-caption slider-caption-center">
									<p class="mb-4 text-white text-smaller text-uppercase ls-4" data-animate="fadeInUpSmall">Shop for Women</p>
									<div class="overflow-hidden"><h2 data-animate="fadeInUpSmall" data-delay="200">You will be able to go anywhere.</h2></div>
									<div class="overflow-hidden">
										<a href="#" class="button button-border button-light button-rounded button-large ms-0 mt-4" data-animate="fadeInUpSmall" data-delay="400">Shop Now</a>
									</div>
								</div>
						...
						<div class="swiper-slide dark">
							<div class="container">
								<div class="slider-caption slider-caption-center">
									<p class="mb-4 text-white text-smaller text-uppercase ls-4" data-animate="fadeInUpSmall">Shop for Kids</p>
									<div class="overflow-hidden"><h2 data-animate="fadeInUpSmall" data-delay="200">Bring power to your steps</h2></div>
									<div class="overflow-hidden">
										<a href="#" class="button button-border button-light button-rounded button-large ms-0 mt-4" data-animate="fadeInUpSmall" data-delay="400">Shop Now</a>
									</div>
								</div>
							</div>
							<div class="swiper-slide-bg" style="background-image: url('images/blocks/preview/slider-2/3.jpg');"></div>
						</div>
				...
				<div class="swiper-pagination" swiper-slides-total="03"></div>
			</div>
			</div>
