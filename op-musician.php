...
<head>
	...
	<link href="https://fonts.googleapis.com/css2?family=Source+Sans+Pro:wght@300;400;600;700&family=Roboto:wght@300;400;500;700&family=Rochester&display=swap" rel="stylesheet">
	...
	<!-- Document Title
	============================================= -->
	<title>Musician - One Page Module | Canvas</title>
	...
	<style>
		...
		.font-brush { font-family: 'Rochester', cursive !important; }
	</style>
...
<body class="stretched overlay-menu">
	...
	<div id="wrapper">
		...
		<!-- Header
		============================================= -->
		<header id="header" class="full-header transparent-header header-size-custom" data-sticky-shrink="false" data-sticky-offset="full" data-sticky-offset-negative="75">
			<div id="header-wrap">
				<div class="container">
		...
		<section id="slider" class="slider-element slider-parallax min-vh-100 include-header">
			<div class="slider-inner" style="background-image: url('one-page/images/page/musician.jpg');">

				<div class="vertical-middle slider-element-fade" style="z-index: 9;">
					<div class="container">
						<div class="row">
							<div class="col-md-7">
								<div class="emphasis-title mb-5">
									<h1 class="font-brush fw-normal ls-0" style="font-size: 82px;">Darcy Shearer</h1>
									<span class="text-uppercase d-block mt-3" style="letter-spacing:10px; font-size: 18px">Musician</span>
									<p class="lead mt-5 text-black-50" style="line-height: 1.7;">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Id hic neque alias! Accusamus, perspiciatis. Dicta accusantium, consequuntur maxime vour sequi cumque.</p>
								</div>
								<div class="d-flex mt-5" style="--cnvs-socialicon-gap-x:0.5rem;">
									...
									<a href="#" class="social-icon rounded-circle bg-dark h-bg-pinterest" title="Pinterest">
										<i class="fa-brands fa-pinterest-p"></i>
										<i class="fa-brands fa-pinterest-p"></i>
									</a>
								</div>
							</div>
							<div class="col-md-5 mt-5 mt-md-0 d-flex align-items-md-center justify-content-md-center">
				...
				<canvas id="smokebg"></canvas>

				<div class="h-100 image-t" style="background: url('one-page/images/page/musician-t.png'); background-size: cover; background-position: center center;"></div>

				<a href="#" data-scrollto="#section-about" data-easing="easeInOutExpo" data-speed="1250" data-offset="70" class="one-page-arrow"><i class="bi-chevron-down infinite animated fadeInDown"></i></a>
	...
	<script>
		...
		var context,particles=[],particleCount=30,maxVelocity=2,targetFPS=33,canvasWidth=400,canvasHeight=400,imageObj=new Image;function Particle(t){this.x=0,this.y=0,this.xVelocity=0,this.yVelocity=0,this.radius=5,this.context=t,this.draw=function(){this.image?this.context.drawImage(this.image,this.x-128,this.y-128):(this.context.beginPath(),this.context.arc(this.x,this.y,this.radius,0,2*Math.PI,!1),this.context.fillStyle="rgba(255, 255, 255, 0)",this.context.fill(),this.context.closePath())},this.update=function(){this.x+=this.xVelocity,this.y+=this.yVelocity,this.x>=canvasWidth?(this.xVelocity=-this.xVelocity,this.x=canvasWidth):this.x<=0&&(this.xVelocity=-this.xVelocity,this.x=0),this.y>=canvasHeight?(this.yVelocity=-this.yVelocity,this.y=canvasHeight):this.y<=0&&(this.yVelocity=-this.yVelocity,this.y=0)},this.setPosition=function(t,i){this.x=t,this.y=i},this.setVelocity=function(t,i){this.xVelocity=t,this.yVelocity=i},this.setImage=function(t){this.image=t}}function generateRandom(t,i){return Math.random()*(i-t)+t}function init(){var t=document.getElementById("smokebg");if(t.getContext){context=t.getContext("2d");for(var i=0;i<particleCount;++i){var e=new Particle(context);e.setPosition(generateRandom(0,canvasWidth),generateRandom(0,canvasHeight)),e.setVelocity(generateRandom(-maxVelocity,maxVelocity),generateRandom(-maxVelocity,maxVelocity)),particles.push(e)}}else alert("Please use a modern browser")}function draw(){context.fillStyle="rgba(255, 255, 255, 0.5)",context.fillRect(0,0,400,400),particles.forEach(function(t){t.draw()})}function update(){particles.forEach(function(t){t.update()})}imageObj.onload=function(){particles.forEach(function(t){t.setImage(imageObj)})},imageObj.src="http://www.blog.jonnycornwell.com/wp-content/uploads/2012/07/Smoke10.png",init();
