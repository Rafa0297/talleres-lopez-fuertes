...
<body class="stretched overlay-menu">
	...
	<div id="wrapper">
		...
		<!-- Header
		============================================= -->
		<header id="header" class="transparent-header dark header-size-custom" data-sticky-shrink="false" data-sticky-class="not-dark" data-sticky-offset="full" data-sticky-offset-negative="70">
			<div id="header-wrap">
				<div class="container">
		...
		<section id="slider" class="slider-element slider-parallax min-vh-100 dark include-header">
			<div class="slider-inner">
							...
							<div class="fslider" data-easing="easeInOutExpo" data-arrows="false" data-pagi="false" data-speed="1100" data-pause="4000" data-hover="false">
								<div class="flexslider">
									<div class="slider-wrap">
										<div class="slide"><h2 class="fw-bold font-body" style="font-size: 96px; line-height: 1.15;">we create<br>amazing brand<br>experiences</h2></div>
										<div class="slide"><h2 class="fw-bold font-body" style="font-size: 96px; line-height: 1.15;">we design<br>super awesome<br>websites</h2></div>
										<div class="slide"><h2 class="fw-bold font-body" style="font-size: 96px; line-height: 1.15;">we make<br>client's projects<br>prosper</h2></div>
									</div>
								</div>
							</div>
						</div>
				...
				<a href="#" class="one-page-arrow dark" data-scrollto="#section-about" data-easing="easeInOutExpo" data-speed="1250" data-offset="65"><i class="bi-chevron-down infinite animated fadeInDown"></i></a>
